...
\begin{abstract}
    ...
    (\path{audits/2026-05-13_cpsv16_ft_definition_audit.md}) records which
...
catalogued in
\path{audits/2026-05-13_cpsv16_ft_definition_audit.md} and
...
(\path{audits/2026-05-13_cpsv16_ft_paper_vs_code_structural_map.md}~\S5).
...
\path{Full/FixedBlockSingleton.lean} used
...
\begin{itemize}
    ...
    \item TNLean audit memos
          ...
          \path{audits/2026-05-13_cpsv16_ft_sorry_discharge_plan.md},
          \path{audits/2026-05-13_cpsv16_ft_deletion_candidates_and_archaeology.md},
