...
\newcommand{\TNMPOLocalPurification}{%
    \begin{tikzpicture}[tn picture]
        ...
        \draw[tn phys leg, densely dashed, rounded corners]
            (tnA.south) -- (0,0) -- (0.78,0) -- (0.78,-0.52) -- (tnAc.east);
        \node at (-0.28,0.82) {$A$};
...
\newcommand{\TNEtaSectorDecomposition}{%
    \begin{tikzpicture}[tn picture]
        ...
        \node at (3.20,0.78) {$r_h$};
        \node at (4.32,0.78) {$l_k$};
        \node at (3.76,-0.80) {$\eta_{k,h}=r_h l_k\geq 0$};
    \end{tikzpicture}%
}
