...
\newcommand{\TNEtaSectorDecomposition}{%
    \begin{tikzpicture}[tn picture]
        \TN@tensordot{tnRh}{(-0.56,0)}
        \TN@tensordot{tnLk}{(0.56,0)}
        \draw[tn leg] (tnRh.east) -- (tnLk.west);
        \TN@upleg{tnRh}{0.50}
        \TN@downleg{tnRh}{0.50}
        \TN@upleg{tnLk}{0.50}
        \TN@downleg{tnLk}{0.50}
        \node at (-0.56,0.78) {$r_k$};
        \node at (0.56,0.78) {$l_h$};
...
\newcommand{\TNMPDOCyclicEtaContraction}{%
    \begin{tikzpicture}[tn picture]
        \foreach \x/\lab in {-2.55/k_0,-0.85/k_1,0.85/k_2} {
            \TN@tensordot{tnL\lab}{(\x,0.34)}
            \TN@tensordot{tnR\lab}{(\x+0.68,0.34)}
            \draw[tn leg] (tnL\lab.east) -- (tnR\lab.west);
            \TN@upleg{tnL\lab}{0.42}
            \TN@downleg{tnL\lab}{0.42}
            \TN@upleg{tnR\lab}{0.42}
            \TN@downleg{tnR\lab}{0.42}
        }
        \draw[tn leg] (tnRk_0.east) -- (tnLk_1.west);
        \draw[tn leg] (tnRk_1.east) -- (tnLk_2.west);
        \draw[tn leg] (tnRk_2.east)
            .. controls (2.34,0.34) and (2.34,-0.38) .. (1.90,-0.38)
            -- (-2.92,-0.38)
            .. controls (-3.34,-0.38) and (-3.34,0.34) .. (tnLk_0.west);
        \node at (-2.21,1.10) {$l_{k_0}\otimes r_{k_0}$};
        \node at (-0.51,1.10) {$l_{k_1}\otimes r_{k_1}$};
        \node at (1.19,1.10) {$l_{k_2}\otimes r_{k_2}$};
        \node at (2.05,0.34) {$\cdots$};
        \node at (0,-0.90)
