...
\newcommand{\TNMPOCell}[3]{%
    \begin{tikzpicture}[tn picture]
        \TN@mpositeWithOpenLegs{tnM}{(0,0)}{#1}
        \TN@label{tnMNOpen}{(0,0.22)}{#2}
        \TN@label{tnMSOpen}{(0,-0.22)}{#3}
    \end{tikzpicture}%
}
...
\newcommand{\TNEtaSectorDecomposition}{%
    \begin{tikzpicture}[tn picture]
        \TN@factorwithlegs{tnRh}{(-0.56,0)}{r_k}
        \TN@factorwithlegs{tnLk}{(0.56,0)}{l_h}
        \TN@vconnectports{tnRhE}{tnLkW}
...
\newcommand{\TNMPDOSectorAdaptedDecomposition}{%
    \begin{tikzpicture}[tn picture]
        ...
        \TN@factorpath{ (-0.45,-0.58) rectangle (4.22,0.58);}
...
\newcommand{\TNMPDOFixedFinalComparisonUnitary}{%
    \begin{tikzpicture}[tn picture, scale=0.86]
        ...
        \node[tn label, fill=white, inner sep=1pt] at (-2.28,3.17)
            {$\displaystyle\sum_{|w|=S}c_{\varepsilon}(w)\,(\,\cdot\,)^{w}$};
        \TN@mterminal{ffSelectorSource}{(0.12,2.62)}
        \TN@mterminal{ffSelectorTarget}{(1.05,2.62)}
        \TN@mconnectports{ffSelectorSource}{ffSelectorTarget}
        ...
        \TN@mport{ffLComparison}{ffLroot}{east}
        \TN@mport{ffRComparison}{ffRroot}{west}
        \TN@mconnectports{ffRComparison}{ffLComparison}
        \node[above] at ($(ffLComparison)!0.5!(ffRComparison)$)
        ...
        \TN@mport{ffFW}{ffF}{west}
        \TN@mport{ffFE}{ffF}{east}
        \TN@mterminal{ffHLeft}{(-3.36,-1.48)}
        \TN@mterminal{ffHRight}{(3.36,-1.48)}
        \TN@mterminal{ffDLeft}{(-3.36,-2.08)}
        \TN@mterminal{ffDRight}{(3.36,-2.08)}
        \TN@mconnectports{ffHRight}{ffFE}
        \TN@mconnectports{ffFW}{ffHLeft}
        \TN@mconnectports{ffDRight}{ffDLeft}
        \node[below] at ($(ffDLeft)!0.5!(ffDRight)$)
            {$1_{D_\varepsilon}$};
        \node at (0,-2.62)
...
\newcommand{\TNMPDOFourfoldBondReassociationPentagon}{%
    \begin{tikzpicture}[tn picture, scale=0.92]
        \TN@expression[inner sep=3pt]{assocL}{(-5.00,0)}{(((A\times B)\times C)\times D)}
        \TN@expression[inner sep=3pt]{assocLI}{(-3.00,1.80)}{((A\times(B\times C))\times D)}
        \TN@expression[inner sep=3pt]{assocM}{(1.00,1.80)}{(A\times((B\times C)\times D))}
        \TN@expression[inner sep=3pt]{assocR}{(4.20,0)}{(A\times(B\times(C\times D)))}
        \TN@expression[inner sep=3pt]{assocP}{(-0.30,-1.80)}{((A\times B)\times(C\times D))}
...
\newcommand{\TNMPDOCompleteZipperFusionPentagon}{%
    \begin{tikzpicture}[tn picture, scale=0.82]
        % (((a b) c) d)
        \TN@vterminal{pLa}{(-5.70,0.75)}
        \TN@vterminal{pLb}{(-5.15,0.75)}
        \TN@vterminal{pLc}{(-4.60,0.75)}
        \TN@vterminal{pLd}{(-4.05,0.75)}
        \TN@fusionmap[minimum width=0.28cm, minimum height=0.20cm,
            inner sep=0.4pt]{pLf}{(-5.42,0.22)}{}
        \TN@fusionmap[minimum width=0.28cm, minimum height=0.20cm,
            inner sep=0.4pt]{pLg}{(-5.00,-0.28)}{}
        \TN@fusionmap[minimum width=0.28cm, minimum height=0.20cm,
            inner sep=0.4pt]{pLe}{(-4.56,-0.80)}{}
        \TN@vterminal{pLroot}{(-4.56,-1.28)}
        \TN@vconnectports{pLa}{pLfLeft}
        \TN@vconnectports{pLb}{pLfRight}
        \TN@vconnectports{pLfOut}{pLgLeft}
        \TN@vconnectports{pLc}{pLgRight}
        \TN@vconnectports{pLgOut}{pLeLeft}
        \TN@vconnectports{pLd}{pLeRight}
        \TN@vconnectports{pLeOut}{pLroot}
        \foreach \n/\t in {pLa/a,pLb/b,pLc/c,pLd/d}
            \node[above] at (\n) {$\t$};
        \node[left] at ($(pLfOut)!0.5!(pLgLeft)$) {$f$};
        \node[left] at ($(pLgOut)!0.5!(pLeLeft)$) {$g$};
        \node[below] at (pLroot) {$e$};

        % ((a (b c)) d)
        \TN@vterminal{pLIa}{(-4.20,3.52)}
        \TN@vterminal{pLIb}{(-3.65,3.52)}
        \TN@vterminal{pLIc}{(-3.10,3.52)}
        \TN@vterminal{pLId}{(-2.55,3.52)}
        \TN@fusionmap[minimum width=0.28cm, minimum height=0.20cm,
            inner sep=0.4pt]{pLIh}{(-3.38,2.99)}{}
        \TN@fusionmap[minimum width=0.28cm, minimum height=0.20cm,
            inner sep=0.4pt]{pLIg}{(-3.78,2.49)}{}
        \TN@fusionmap[minimum width=0.28cm, minimum height=0.20cm,
            inner sep=0.4pt]{pLIe}{(-3.28,1.97)}{}
        \TN@vterminal{pLIroot}{(-3.28,1.49)}
        \TN@vconnectports{pLIb}{pLIhLeft}
        \TN@vconnectports{pLIc}{pLIhRight}
        \TN@vconnectports{pLIa}{pLIgLeft}
        \TN@vconnectports{pLIhOut}{pLIgRight}
        \TN@vconnectports{pLIgOut}{pLIeLeft}
        \TN@vconnectports{pLId}{pLIeRight}
        \TN@vconnectports{pLIeOut}{pLIroot}
        \foreach \n/\t in {pLIa/a,pLIb/b,pLIc/c,pLId/d}
            \node[above] at (\n) {$\t$};
        \node[right] at ($(pLIhOut)!0.5!(pLIgRight)$) {$h$};
        \node[left] at ($(pLIgOut)!0.5!(pLIeLeft)$) {$g$};
        \node[below] at (pLIroot) {$e$};

        % a ((b c) d)
        \TN@vterminal{pMa}{(0.10,3.52)}
        \TN@vterminal{pMb}{(0.65,3.52)}
        \TN@vterminal{pMc}{(1.20,3.52)}
        \TN@vterminal{pMd}{(1.75,3.52)}
        \TN@fusionmap[minimum width=0.28cm, minimum height=0.20cm,
            inner sep=0.4pt]{pMh}{(0.92,2.99)}{}
        \TN@fusionmap[minimum width=0.28cm, minimum height=0.20cm,
            inner sep=0.4pt]{pMi}{(1.34,2.49)}{}
        \TN@fusionmap[minimum width=0.28cm, minimum height=0.20cm,
            inner sep=0.4pt]{pMe}{(0.84,1.97)}{}
        \TN@vterminal{pMroot}{(0.84,1.49)}
        \TN@vconnectports{pMb}{pMhLeft}
        \TN@vconnectports{pMc}{pMhRight}
        \TN@vconnectports{pMhOut}{pMiLeft}
        \TN@vconnectports{pMd}{pMiRight}
        \TN@vconnectports{pMa}{pMeLeft}
        \TN@vconnectports{pMiOut}{pMeRight}
        \TN@vconnectports{pMeOut}{pMroot}
        \foreach \n/\t in {pMa/a,pMb/b,pMc/c,pMd/d}
            \node[above] at (\n) {$\t$};
        \node[left] at ($(pMhOut)!0.5!(pMiLeft)$) {$h$};
        \node[right] at ($(pMiOut)!0.5!(pMeRight)$) {$i$};
        \node[below] at (pMroot) {$e$};

        % a (b (c d))
        \TN@vterminal{pRa}{(4.05,0.75)}
        \TN@vterminal{pRb}{(4.60,0.75)}
        \TN@vterminal{pRc}{(5.15,0.75)}
        \TN@vterminal{pRd}{(5.70,0.75)}
        \TN@fusionmap[minimum width=0.28cm, minimum height=0.20cm,
            inner sep=0.4pt]{pRj}{(5.42,0.22)}{}
        \TN@fusionmap[minimum width=0.28cm, minimum height=0.20cm,
            inner sep=0.4pt]{pRi}{(5.00,-0.28)}{}
        \TN@fusionmap[minimum width=0.28cm, minimum height=0.20cm,
            inner sep=0.4pt]{pRe}{(4.56,-0.80)}{}
        \TN@vterminal{pRroot}{(4.56,-1.28)}
        \TN@vconnectports{pRc}{pRjLeft}
        \TN@vconnectports{pRd}{pRjRight}
        \TN@vconnectports{pRb}{pRiLeft}
        \TN@vconnectports{pRjOut}{pRiRight}
        \TN@vconnectports{pRa}{pReLeft}
        \TN@vconnectports{pRiOut}{pReRight}
        \TN@vconnectports{pReOut}{pRroot}
        \foreach \n/\t in {pRa/a,pRb/b,pRc/c,pRd/d}
            \node[above] at (\n) {$\t$};
        \node[right] at ($(pRjOut)!0.5!(pRiRight)$) {$j$};
        \node[right] at ($(pRiOut)!0.5!(pReRight)$) {$i$};
        \node[below] at (pRroot) {$e$};

        % (a b) (c d)
        \TN@vterminal{pPa}{(-0.85,-2.10)}
        \TN@vterminal{pPb}{(-0.30,-2.10)}
        \TN@vterminal{pPc}{(0.30,-2.10)}
        \TN@vterminal{pPd}{(0.85,-2.10)}
        \TN@fusionmap[minimum width=0.28cm, minimum height=0.20cm,
            inner sep=0.4pt]{pPf}{(-0.58,-2.63)}{}
        \TN@fusionmap[minimum width=0.28cm, minimum height=0.20cm,
            inner sep=0.4pt]{pPj}{(0.58,-2.63)}{}
        \TN@fusionmap[minimum width=0.28cm, minimum height=0.20cm,
            inner sep=0.4pt]{pPe}{(0,-3.18)}{}
        \TN@vterminal{pProot}{(0,-3.66)}
        \TN@vconnectports{pPa}{pPfLeft}
        \TN@vconnectports{pPb}{pPfRight}
        \TN@vconnectports{pPc}{pPjLeft}
        \TN@vconnectports{pPd}{pPjRight}
        \TN@vconnectports{pPfOut}{pPeLeft}
        \TN@vconnectports{pPjOut}{pPeRight}
        \TN@vconnectports{pPeOut}{pProot}
        \foreach \n/\t in {pPa/a,pPb/b,pPc/c,pPd/d}
            \node[above] at (\n) {$\t$};
        \node[left] at ($(pPfOut)!0.5!(pPeLeft)$) {$f$};
        \node[right] at ($(pPjOut)!0.5!(pPeRight)$) {$j$};
        \node[below] at (pProot) {$e$};
...
\newcommand{\TNMPDOUnweightedZipperReconstruction}{%
    \begin{tikzpicture}[tn picture, scale=0.95]
        ...
        \TN@vport{uzTopHW}{uzTopH}{west}
        \TN@vport{uzTopHE}{uzTopH}{east}
        ...
        \TN@component[minimum width=0.72cm, minimum height=0.52cm, inner sep=1pt]
            {uzBotH}{(0.80,0)}{H}
        \TN@vport{uzBotHW}{uzBotH}{west}
        \TN@vport{uzBotHE}{uzBotH}{east}
        ...
        \TN@vport{uzRecHW}{uzRecH}{west}
        \TN@vport{uzRecHE}{uzRecH}{east}
...
\newcommand{\TNAppendixBAdjacentBondProjectors}{%
    \begin{tikzpicture}[tn picture, scale=0.92]
        ...
        \TN@vport{rfpPhiZeroW}{rfpPhiZero}{west}
        \TN@vport{rfpPhiZeroE}{rfpPhiZero}{east}
        \TN@vport{rfpPhiOneW}{rfpPhiOne}{west}
        \TN@vport{rfpPhiOneE}{rfpPhiOne}{east}
...
\newcommand{\TNAppendixBPhysicalSupportTransport}{%
    \begin{tikzpicture}[tn picture, scale=0.90]
        ...
        \TN@vport{rfpTPhiZeroW}{rfpTPhiZero}{west}
        \TN@vport{rfpTPhiZeroE}{rfpTPhiZero}{east}
        \TN@vport{rfpTPhiOneW}{rfpTPhiOne}{west}
        \TN@vport{rfpTPhiOneE}{rfpTPhiOne}{east}
