...
\begin{lemma}[Ces\`aro means remain density matrices]
    ...
    \leanok
    \uses{thm:channel_preserves_density, thm:density_convex}
...
\begin{proof}\leanok
    \uses{thm:pf_eigenvector_existence, thm:adjoint_transfer_ne_zero, thm:psd_eigenvector_pd_irred, thm:kraus_conjTranspose_irreducible, thm:kraus_map_cp}
