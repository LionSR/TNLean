...
\begin{theorem}[Blocking commutes with physical maps]
    \label{thm:block_tensor_rotate_physical}
...
\begin{proof}\leanok
    ...
    distributing gives, for each word~$v$, the summand
    $(\prod_kW_{b_kv_k})\,C^{v_0}\cdots C^{v_{L-1}}$.  Reindexing the sum over
