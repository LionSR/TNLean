...
\begin{lemma}[Left-canonical normalization under blocking]
    \label{lem:left_canonical_blocking}
...
\begin{lemma}[Irreducibility from a faithful fixed point]
    \label{lem:channel_posdef_fixed_point_unique_irreducible}
...
\begin{lemma}[Fixed-point criteria for irreducibility after primitive blocking]%
    ...
    \uses{def:blocked_tensor, def:irreducible_tensor, def:primitive_mps,
        def:fixed_point_proj, lem:left_canonical_blocking,
        lem:channel_posdef_fixed_point_unique_irreducible,
