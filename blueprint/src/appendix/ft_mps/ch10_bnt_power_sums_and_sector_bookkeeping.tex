...
\begin{lemma}[Exact sector matching under eventual proportionality]
...
\begin{lemma}[Full-basis matching under eventual proportionality]
...
\begin{proof}\leanok
    ...
    Lemma~\ref{lem:sector_bnt_proportional_exact_match} to each sector of
