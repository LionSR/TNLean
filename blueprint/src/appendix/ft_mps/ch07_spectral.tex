...
\begin{proof}\leanok
    \uses{thm:psd_fp_exists, thm:primitive_fixedPoint_compl_lt_one_irred_channel}
...
\begin{lemma}[Normalized peripheral unitary]
    ...
    \leanok
    \uses{lem:peripheral_unitary_eigenvector, lem:peripheral_unitary_powers, lem:irreducible_unital_fixed_points_scalar}
