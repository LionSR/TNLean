...
Schmidt-rank linear algebra behind the maximal-overlap theorem, the extremal
projection bounds in Ky Fan's maximum principle, the right-tensor identities
behind the Choi-compression criteria, and the elementary closure properties
of $k$-positive maps.
