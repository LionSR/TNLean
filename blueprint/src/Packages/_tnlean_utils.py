...
# row: a number with a unit, or a named length with an optional factor in
# front of it.  Anything else there is mathematics, and reading it as a gap
# turns the row into an error box.
