...
The following example, from \cite[Example~3.4]{Cirac2016MPDO_arXiv}, separates
physical correlation independence from the renormalization fixed-point condition.
...
\begin{theorem}[Failure of the renormalization fixed-point equation]
    ...
    \leanok
    \uses{def:cpsv16_example_34_tensor, def:mps_transfer_idempotence, def:physical_blocking_isometry}
