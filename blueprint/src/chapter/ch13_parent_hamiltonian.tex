...
normal matrix product states. For $N\ge2$ and $1<L\le N$, the parent Hamiltonian
is frustration-free with unique ground state $V^{(N)}(A)$. For normal tensors,
word-span injectivity after blocking determines the boundary-closure
identities that match open-interval restrictions to the periodic chain.
