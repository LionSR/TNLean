...
For normal tensors with injectivity length $L_0$, uniqueness holds whenever
$L_0 < L \le N$ with $N \ge L_0 + 1$; word-span injectivity after blocking
determines the boundary-closure identities that match open-interval restrictions
to the periodic chain.
