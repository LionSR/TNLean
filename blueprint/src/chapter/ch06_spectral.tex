...
\begin{proof}
    ...
    with the Wedderburn--Artin theorem for semisimple rings over an
    algebraically closed field (Mathlib
    \texttt{IsSemisimpleRing.exists\_algEquiv\_pi\_matrix\_of\_isAlgClosed}).
\end{proof}
