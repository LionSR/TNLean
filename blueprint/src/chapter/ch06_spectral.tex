...
\begin{proof}
    ...
    The argument uses only the Kadison--Schwarz inequality
...
\begin{proof}
    ...
    \uses{thm:spectral_radius_le_one, def:gauge_phase_equiv,
          ...
          thm:multiplicative_domain, thm:simplicity, thm:skolem_noether}
    ...
    The same
    Kadison--Schwarz $\to$ multiplicative domain $\to$
    Skolem--Noether argument appears in the
    single-block case in~\cite{PerezGarcia2007Matrix}.
\end{proof}
...
\begin{proof}
    ...
    The square-case spectral-gap argument applies,
    with the last step replaced by the observation that
    no invertible intertwiner exists when $D_1 \neq D_2$.
\end{proof}
