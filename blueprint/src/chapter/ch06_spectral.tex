...
\subsection{Cyclic decomposition declarations}

\begin{definition}[Corner preservation]
    \lean{MPSTensor.PreservesCorner}
    \leanok
...
\begin{definition}[Corner subspace]
    \lean{MPSTensor.cornerSubmodule}
    \leanok
...
\begin{theorem}[Cyclic projections from a peripheral unitary]
    \lean{MPSTensor.exists_cyclic_projections_of_peripheral_unitary}
    \leanok
...
\begin{theorem}[Peripheral cyclic structure (channel namespace)]
    \lean{PeripheralSpectrum.peripheral_eigenvalues_cyclic_structure}
    \leanok
    \uses{thm:peripheral_cyclic_structure}
    Channel-level statement: the peripheral eigenvalues form a finite cyclic set.
\end{theorem}
...
\begin{theorem}[Peripheral cyclic group with period divisibility]
    ...
    \uses{thm:peripheral_cyclic_group}
    This theorem is formalized, while the multiplicity-one refinement is currently pending.
\end{theorem}
