...
\begin{proof}
    ...
    together with the trace-preserving normalization~(\ref{eq:spec_tp_normalization})
    ...
    The argument uses only the trace-preserving normalization~(\ref{eq:spec_tp_normalization})
