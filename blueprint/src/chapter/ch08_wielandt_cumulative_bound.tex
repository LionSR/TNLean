...
\begin{definition}[Strengthened strong irreducibility]
    ...
    fixed point and uniqueness of the peripheral eigenvalue; the definition
    above strengthens it by also requiring irreducibility.
\end{definition}
...
\begin{theorem}[Strengthened form of the primitivity equivalence]
    ...
    eigenvalue and a positive-definite corresponding eigenvector. Here
    item~(3) includes the additional irreducibility condition.
\end{theorem}
