...
\begin{figure}[ht]
    ...
    \begin{tenkz}[cols=4, boundary=periodic]
        \tn[label pos=135, ports={90:physical:$i_1$, 270:physical:$j_1$}]{\mathcal K} &
        \tn[label pos=135, ports={90:physical:$i_2$, 270:physical:$j_2$}]{\mathcal K} &
        \tn[label pos=135, ports={90:physical:$i_3$, 270:physical:$j_3$}]{\mathcal K} &
        \tn[skin=ring]{R_4}
    \end{tenkz}
...
\begin{proof}
    \leanok
    \uses{def:mpdo_normalized_four_site_tail, lem:mpo_eval_word_append}
...
\begin{proof}
    \leanok
    \uses{thm:mpdo_inverse_map_hayashi_sector_comparison, thm:mpdo_inverse_map_hayashi_sector_offdiagonal}
...
\begin{theorem}[Existence of the sector tensors]
    ...
    \begin{align}
        ...
        \notag
    \end{align}
    The neighboring operators $\eta_{k,h}$ are formed from these tensors
...
\begin{proof}
    \leanok
    \uses{thm:mpdo_sector_factorization, thm:mpdo_normalized_four_site_tail_entry_ne_zero}
