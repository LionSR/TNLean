...
Theorem~\ref{thm:asym_power_sum_coefficients} concerns blocked lengths and
eventual coefficients. The result below gives a power-sum expansion at every
positive original length, without blocking. Normality means injectivity after
some blocking, as in Definition~\ref{def:normal}; the tensors need not be
