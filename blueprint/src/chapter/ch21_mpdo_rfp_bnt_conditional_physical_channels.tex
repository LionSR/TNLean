...
\begin{theorem}[BNT algebra clause implies a renormalization fixed point]
    ...
    (ii)$\Rightarrow$(i) of
    \cite[Theorem~4.14, lines~972--993]{Cirac2016MPDO_arXiv}, using the mixed
    prefix gauge normalization of
    \cite{gap:cpsv16_two_site_sector_unitary_gauge_gap} and completing the
    physical maps on discarded complements as in
