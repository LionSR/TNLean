...
\begin{theorem}[BNT algebra clause implies a renormalization fixed point]
    ...
    \textbf{Local fix (mixed prefix gauge and discarded complement):}
    ...
    documented in \cite{gap:cpsv16_two_site_sector_unitary_gauge_gap}. The physical
    maps are completed on discarded complements as documented in
