...
\begin{lemma}[One-step block intersection from block restrictions]
    ...
    \leanok
    \uses{lem:pgvwc07_trace_decompositions_from_block_restrictions, lem:left_boundary_trace_decomposition_mem_block_ground_spaces}
...
\begin{lemma}[Period-window form of the block intersection identity]
    ...
    \leanok
    \uses{lem:period_window_word_tuple_span_padding, lem:block_restriction_intersection_subspace}
...
\begin{lemma}[BNT block separation gives one block-intersection step]
    ...
    \leanok
    \uses{lem:bnt_direct_sum_block_separation_word_span, lem:block_restriction_intersection_subspace}
    Under the hypotheses of
...
\begin{lemma}[BNT block separation with a block-injectivity window]
    ...
    \leanok
    \uses{lem:direct_sum_two_block_dimension_step, lem:pair_trace_separation_to_pairwise_block_separation, lem:block_separating_equations_from_pairwise_separation, lem:period_window_block_restriction_intersection}
...
\begin{lemma}[Normalized block-separating equations give all large product spans]
    ...
    \leanok
    \uses{def:pairwise_block_separating_words, lem:bnt_direct_sum_block_separation_word_span, thm:wordspan_propagation_unital}
...
\begin{lemma}[Positive square-root gauging preserves irreducibility]
    ...
    \lean{Kraus.isIrreducibleFamily_tpGauge_of_isIrreducibleMap}
    \leanok
    \uses{def:irreducible_tensor}
...
\begin{theorem}[Prepared-gauge simultaneous product span]
    ...
    \leanok
    \uses{def:blockwise_product_word_span, def:blocks_not_gauge_phase_equiv}
...
\begin{proof}
    \leanok
    \uses{lem:tp_gauge_equiv, thm:tp_gauge_from_adjoint_fixed, thm:irreducible_tensor_to_transfer_map, lem:tp_gauge_preserves_irreducibility, lem:gauge_phase_equiv_transport_left_right, lem:gauge_invariance_block_injective, thm:is_normal_tensor_of_is_normal_left_canonical, thm:cpsv_normal_mpv_phase_gauge, lem:bnt_direct_sum_block_separation_word_span, thm:word_tuple_span_gauge_invariance}
...
\begin{proof}
    \leanok
    \uses{thm:wordspan_propagation_unital, lem:unital_simultaneous_product_span_propagation, thm:pgvwc_prepared_gauge_product_span}
...
\begin{proof}
    \leanok
    \uses{thm:pgvwc_product_span_source_length, lem:product_span_block_image_direct_sum}
...
\begin{proof}
    \leanok
    \uses{thm:pgvwc_product_span_source_length, lem:block_restriction_intersection_subspace}
...
\begin{theorem}[Doubly normalized simultaneous product span]
    ...
    \leanok
    \uses{def:blockwise_product_word_span, def:blocks_not_gauge_phase_equiv, def:mpv_overlap}
...
\begin{proof}
    \leanok
    \uses{thm:wordspan_propagation_unital, lem:bnt_direct_sum_block_separation_word_span, lem:unital_simultaneous_product_span_propagation}
...
\begin{proof}
    \leanok
    \uses{thm:pgvwc_product_span_doubly_normalized, lem:product_span_block_image_direct_sum}
...
\begin{proof}
    \leanok
    \uses{thm:pgvwc_product_span_doubly_normalized, lem:block_restriction_intersection_subspace}
