...
with $\tau\otimes\tau=1\oplus\tau$, with fusion rules and $F$-symbols
following the string-net construction in~\cite[Appendix~D.1]{Bultinck2017Anyons}.
From these data, one obtains MPOs on a two-label physical space whose
periodic fusion and state-action identities can be verified directly.
