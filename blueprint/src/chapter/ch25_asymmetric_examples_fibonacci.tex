...
with $\tau\otimes\tau=1\oplus\tau$. The fusion rules and F-symbols
used here are those of the string-net construction
in~\cite[Appendix~D.1]{Bultinck2017Anyons}. We construct the displayed
MPOs on a two-label physical space from these data and verify their
periodic fusion and state-action identities directly.
...
The physical alphabet here has dimension two, rather than the full
triple-index alphabet of the categorical string-net construction.
In particular, the convention $\sigma=\varphi^{-1/2}$ in these letters must
not be replaced by $\varphi^{-1}$.
