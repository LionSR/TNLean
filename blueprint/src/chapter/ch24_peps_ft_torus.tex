...
\begin{center}
    \TNPEPSTorusGeometry
\end{center}
Translations act on the vertices and edges, and transporting a tensor along a
translation preserves the generated state. This is the setting in which the
normal Fundamental Theorem specializes to a single site-independent tensor and
produces the global phase of \cite[Theorem~3]{Molnar2018NormalPEPS}.
