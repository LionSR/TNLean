...
\begin{theorem}[Local virtual insertion realized physically on either endpoint]%
    ...
    \begin{center}
        \begin{tenkzfree}
            \tnput[ports={west:virtual,east:virtual,north:physical}]
                {realMAone}{(0,0)}{A_1}
            \tnput[ring, role=operator, ports={west:virtual,east:virtual}]
                {realM}{(8mm,0)}{M}
            \tnput[ports={west:virtual,east:virtual,north:physical}]
                {realMAtwo}{(16mm,0)}{A_2}
            \tnput[ports={west:virtual,east:virtual,north:physical}]
                {realMAthree}{(28mm,0)}{A_3}
            \tnput[boundary, ports={south:physical}]{realMPone}{(0,7mm)}{}
            \tnput[boundary, ports={south:physical}]{realMPtwo}{(16mm,7mm)}{}
            \tnput[boundary, ports={south:physical}]{realMPthree}{(28mm,7mm)}{}
            \tnjoin{realMAone.east}{realM.west}
            \tnjoin{realM.east}{realMAtwo.west}
            \tnjoin{realMAtwo.east}{realMAthree.west}
            \tnjoin[route=arc, out=-90, in=-90]
                {realMAthree.east}{realMAone.west}
            \tnjoin{realMAone.north}{realMPone.south}
            \tnjoin{realMAtwo.north}{realMPtwo.south}
            \tnjoin{realMAthree.north}{realMPthree.south}
        \end{tenkzfree}
        \(\;=\;\)
        \begin{tenkzfree}
            \tnput[ports={west:virtual,east:virtual,north:physical}]
                {realOoneAone}{(0,0)}{A_1}
            \tnput[ports={west:virtual,east:virtual,north:physical}]
                {realOoneAtwo}{(14mm,0)}{A_2}
            \tnput[ports={west:virtual,east:virtual,north:physical}]
                {realOoneAthree}{(28mm,0)}{A_3}
            \tnput[ring, role=operator, ports={south:physical,north:physical}]
                {realOone}{(0,7mm)}{O_1}
            \tnput[boundary, ports={south:physical}]{realOonePone}{(0,14mm)}{}
            \tnput[boundary, ports={south:physical}]{realOonePtwo}{(14mm,7mm)}{}
            \tnput[boundary, ports={south:physical}]{realOonePthree}{(28mm,7mm)}{}
            \tnjoin{realOoneAone.east}{realOoneAtwo.west}
            \tnjoin{realOoneAtwo.east}{realOoneAthree.west}
            \tnjoin[route=arc, out=-90, in=-90]
                {realOoneAthree.east}{realOoneAone.west}
            \tnjoin{realOoneAone.north}{realOone.south}
            \tnjoin{realOone.north}{realOonePone.south}
            \tnjoin{realOoneAtwo.north}{realOonePtwo.south}
            \tnjoin{realOoneAthree.north}{realOonePthree.south}
        \end{tenkzfree}
        \(\;=\;\)
        \begin{tenkzfree}
            \tnput[ports={west:virtual,east:virtual,north:physical}]
                {realOtwoAone}{(0,0)}{A_1}
            \tnput[ports={west:virtual,east:virtual,north:physical}]
                {realOtwoAtwo}{(14mm,0)}{A_2}
            \tnput[ports={west:virtual,east:virtual,north:physical}]
                {realOtwoAthree}{(28mm,0)}{A_3}
            \tnput[ring, role=operator, ports={south:physical,north:physical}]
                {realOtwo}{(14mm,7mm)}{O_2}
            \tnput[boundary, ports={south:physical}]{realOtwoPone}{(0,7mm)}{}
            \tnput[boundary, ports={south:physical}]{realOtwoPtwo}{(14mm,14mm)}{}
            \tnput[boundary, ports={south:physical}]{realOtwoPthree}{(28mm,7mm)}{}
            \tnjoin{realOtwoAone.east}{realOtwoAtwo.west}
            \tnjoin{realOtwoAtwo.east}{realOtwoAthree.west}
            \tnjoin[route=arc, out=-90, in=-90]
                {realOtwoAthree.east}{realOtwoAone.west}
            \tnjoin{realOtwoAone.north}{realOtwoPone.south}
            \tnjoin{realOtwoAtwo.north}{realOtwo.south}
            \tnjoin{realOtwo.north}{realOtwoPtwo.south}
            \tnjoin{realOtwoAthree.north}{realOtwoPthree.south}
        \end{tenkzfree}
    \end{center}
...
\begin{theorem}[Equal neighboring physical actions recover a virtual insertion]%
    ...
    \begin{center}
        \begin{tenkzfree}
            \tnput[ports={west:virtual,east:virtual,north:physical}]
                {recoverOoneBone}{(0,0)}{B_1}
            \tnput[ports={west:virtual,east:virtual,north:physical}]
                {recoverOoneBtwo}{(14mm,0)}{B_2}
            \tnput[ports={west:virtual,east:virtual,north:physical}]
                {recoverOoneBthree}{(28mm,0)}{B_3}
            \tnput[ring, role=operator, ports={south:physical,north:physical}]
                {recoverOone}{(0,7mm)}{O_1}
            \tnput[boundary, ports={south:physical}]{recoverOonePone}{(0,14mm)}{}
            \tnput[boundary, ports={south:physical}]{recoverOonePtwo}{(14mm,7mm)}{}
            \tnput[boundary, ports={south:physical}]{recoverOonePthree}{(28mm,7mm)}{}
            \tnjoin{recoverOoneBone.east}{recoverOoneBtwo.west}
            \tnjoin{recoverOoneBtwo.east}{recoverOoneBthree.west}
            \tnjoin[route=arc, out=-90, in=-90]
                {recoverOoneBthree.east}{recoverOoneBone.west}
            \tnjoin{recoverOoneBone.north}{recoverOone.south}
            \tnjoin{recoverOone.north}{recoverOonePone.south}
            \tnjoin{recoverOoneBtwo.north}{recoverOonePtwo.south}
            \tnjoin{recoverOoneBthree.north}{recoverOonePthree.south}
        \end{tenkzfree}
        \(\;=\;\)
        \begin{tenkzfree}
            \tnput[ports={west:virtual,east:virtual,north:physical}]
                {recoverOtwoBone}{(0,0)}{B_1}
            \tnput[ports={west:virtual,east:virtual,north:physical}]
                {recoverOtwoBtwo}{(14mm,0)}{B_2}
            \tnput[ports={west:virtual,east:virtual,north:physical}]
                {recoverOtwoBthree}{(28mm,0)}{B_3}
            \tnput[ring, role=operator, ports={south:physical,north:physical}]
                {recoverOtwo}{(14mm,7mm)}{O_2}
            \tnput[boundary, ports={south:physical}]{recoverOtwoPone}{(0,7mm)}{}
            \tnput[boundary, ports={south:physical}]{recoverOtwoPtwo}{(14mm,14mm)}{}
            \tnput[boundary, ports={south:physical}]{recoverOtwoPthree}{(28mm,7mm)}{}
            \tnjoin{recoverOtwoBone.east}{recoverOtwoBtwo.west}
            \tnjoin{recoverOtwoBtwo.east}{recoverOtwoBthree.west}
            \tnjoin[route=arc, out=-90, in=-90]
                {recoverOtwoBthree.east}{recoverOtwoBone.west}
            \tnjoin{recoverOtwoBone.north}{recoverOtwoPone.south}
            \tnjoin{recoverOtwoBtwo.north}{recoverOtwo.south}
            \tnjoin{recoverOtwo.north}{recoverOtwoPtwo.south}
            \tnjoin{recoverOtwoBthree.north}{recoverOtwoPthree.south}
        \end{tenkzfree}
        \(\;\Longrightarrow\;\)
        \begin{tenkzfree}
            \tnput[ports={west:virtual,east:virtual,north:physical}]
                {recoverWBone}{(0,0)}{B_1}
            \tnput[ring, role=operator, ports={west:virtual,east:virtual}]
                {recoverW}{(8mm,0)}{W}
            \tnput[ports={west:virtual,east:virtual,north:physical}]
                {recoverWBtwo}{(16mm,0)}{B_2}
            \tnput[ports={west:virtual,east:virtual,north:physical}]
                {recoverWBthree}{(28mm,0)}{B_3}
            \tnput[boundary, ports={south:physical}]{recoverWPone}{(0,7mm)}{}
            \tnput[boundary, ports={south:physical}]{recoverWPtwo}{(16mm,7mm)}{}
            \tnput[boundary, ports={south:physical}]{recoverWPthree}{(28mm,7mm)}{}
            \tnjoin{recoverWBone.east}{recoverW.west}
            \tnjoin{recoverW.east}{recoverWBtwo.west}
            \tnjoin{recoverWBtwo.east}{recoverWBthree.west}
            \tnjoin[route=arc, out=-90, in=-90]
                {recoverWBthree.east}{recoverWBone.west}
            \tnjoin{recoverWBone.north}{recoverWPone.south}
            \tnjoin{recoverWBtwo.north}{recoverWPtwo.south}
            \tnjoin{recoverWBthree.north}{recoverWPthree.south}
        \end{tenkzfree}
    \end{center}
    ...
    \begin{center}
        \begin{tenkzfree}
            \tnput[ports={0:virtual,110:virtual,north:physical}]
                {edgeEqAone}{(-10mm,-5mm)}{A_1}
            \tnput[ports={180:virtual,55:virtual,141:virtual,north:physical}]
                {edgeEqAtwo}{(8mm,-5mm)}{A_2}
            \tnput[ports={235:virtual,155:virtual,north:physical}]
                {edgeEqAthree}{(16mm,6mm)}{A_3}
            \tnput[ports={-25:virtual,190:virtual,north:physical}]
                {edgeEqAfour}{(4mm,15mm)}{A_4}
            \tnput[ports={10:virtual,-70:virtual,-39:virtual,north:physical}]
                {edgeEqAfive}{(-12mm,11mm)}{A_5}
            \tnput[ring, role=operator, ports={-39:virtual,141:virtual}]
                {edgeEqAX}{(-2mm,3mm)}{X}
            \tnput[boundary, ports={south:physical}]{edgeEqAPone}{(-10mm,2mm)}{}
            \tnput[boundary, ports={south:physical}]{edgeEqAPtwo}{(8mm,2mm)}{}
            \tnput[boundary, ports={south:physical}]{edgeEqAPthree}{(16mm,13mm)}{}
            \tnput[boundary, ports={south:physical}]{edgeEqAPfour}{(4mm,22mm)}{}
            \tnput[boundary, ports={south:physical}]{edgeEqAPfive}{(-12mm,18mm)}{}
            \tnjoin{edgeEqAone.0}{edgeEqAtwo.180}
            \tnjoin{edgeEqAtwo.55}{edgeEqAthree.235}
            \tnjoin{edgeEqAthree.155}{edgeEqAfour.-25}
            \tnjoin{edgeEqAfour.190}{edgeEqAfive.10}
            \tnjoin{edgeEqAfive.-70}{edgeEqAone.110}
            \tnjoin{edgeEqAtwo.141}{edgeEqAX.-39}
            \tnjoin{edgeEqAX.141}{edgeEqAfive.-39}
            \tnjoin{edgeEqAone.north}{edgeEqAPone.south}
            \tnjoin{edgeEqAtwo.north}{edgeEqAPtwo.south}
            \tnjoin{edgeEqAthree.north}{edgeEqAPthree.south}
            \tnjoin{edgeEqAfour.north}{edgeEqAPfour.south}
            \tnjoin{edgeEqAfive.north}{edgeEqAPfive.south}
        \end{tenkzfree}
        \(\;=\;\)
        \begin{tenkzfree}
            \tnput[ports={0:virtual,110:virtual,north:physical}]
                {edgeEqBone}{(-10mm,-5mm)}{\widetilde B_1}
            \tnput[ports={180:virtual,55:virtual,141:virtual,north:physical}]
                {edgeEqBtwo}{(8mm,-5mm)}{\widetilde B_2}
            \tnput[ports={235:virtual,155:virtual,north:physical}]
                {edgeEqBthree}{(16mm,6mm)}{\widetilde B_3}
            \tnput[ports={-25:virtual,190:virtual,north:physical}]
                {edgeEqBfour}{(4mm,15mm)}{\widetilde B_4}
            \tnput[ports={10:virtual,-70:virtual,-39:virtual,north:physical}]
                {edgeEqBfive}{(-12mm,11mm)}{\widetilde B_5}
            \tnput[ring, role=operator, ports={-39:virtual,141:virtual}]
                {edgeEqBX}{(-2mm,3mm)}{X}
            \tnput[boundary, ports={south:physical}]{edgeEqBPone}{(-10mm,2mm)}{}
            \tnput[boundary, ports={south:physical}]{edgeEqBPtwo}{(8mm,2mm)}{}
            \tnput[boundary, ports={south:physical}]{edgeEqBPthree}{(16mm,13mm)}{}
            \tnput[boundary, ports={south:physical}]{edgeEqBPfour}{(4mm,22mm)}{}
            \tnput[boundary, ports={south:physical}]{edgeEqBPfive}{(-12mm,18mm)}{}
            \tnjoin{edgeEqBone.0}{edgeEqBtwo.180}
            \tnjoin{edgeEqBtwo.55}{edgeEqBthree.235}
            \tnjoin{edgeEqBthree.155}{edgeEqBfour.-25}
            \tnjoin{edgeEqBfour.190}{edgeEqBfive.10}
            \tnjoin{edgeEqBfive.-70}{edgeEqBone.110}
            \tnjoin{edgeEqBtwo.141}{edgeEqBX.-39}
            \tnjoin{edgeEqBX.141}{edgeEqBfive.-39}
            \tnjoin{edgeEqBone.north}{edgeEqBPone.south}
            \tnjoin{edgeEqBtwo.north}{edgeEqBPtwo.south}
            \tnjoin{edgeEqBthree.north}{edgeEqBPthree.south}
            \tnjoin{edgeEqBfour.north}{edgeEqBPfour.south}
            \tnjoin{edgeEqBfive.north}{edgeEqBPfive.south}
        \end{tenkzfree}
    \end{center}
...
\begin{theorem}[Scalar reduction of the residual two-tensor gauges]%
    ...
    \begin{center}
        \begin{tenkzfree}
            \tnput[ports={35:virtual,0:virtual,-35:virtual,north:physical}]
                {scalarA}{(0,0)}{A_1}
            \tnput[boundary, ports={west:virtual}]{scalarAup}{(14mm,6mm)}{}
            \tnput[boundary, ports={west:virtual}]{scalarAmid}{(14mm,0)}{}
            \tnput[boundary, ports={west:virtual}]{scalarAlow}{(14mm,-6mm)}{}
            \tnput[boundary, ports={south:physical}]{scalarAphys}{(0,8mm)}{}
            \tnjoin{scalarA.35}{scalarAup.west}
            \tnjoin{scalarA.0}{scalarAmid.west}
            \tnjoin{scalarA.-35}{scalarAlow.west}
            \tnjoin{scalarA.north}{scalarAphys.south}
        \end{tenkzfree}
        \(\;=\;\)
        \begin{tenkzfree}
            \tnput[ports={35:virtual,0:virtual,-35:virtual,north:physical}]
                {scalarBZ}{(0,0)}{B_1}
            \tnput[box, role=operator,
                ports={160:virtual,200:virtual,20:virtual,-20:virtual}]
                {scalarZ}{(8mm,-3mm)}{Z}
            \tnput[boundary, ports={west:virtual}]{scalarZup}{(14mm,6mm)}{}
            \tnput[boundary, ports={west:virtual}]{scalarZmid}{(16mm,0)}{}
            \tnput[boundary, ports={west:virtual}]{scalarZlow}{(14mm,-8mm)}{}
            \tnput[boundary, ports={south:physical}]{scalarZphys}{(0,8mm)}{}
            \tnjoin{scalarBZ.35}{scalarZup.west}
            \tnjoin{scalarBZ.0}{scalarZ.160}
            \tnjoin{scalarBZ.-35}{scalarZ.200}
            \tnjoin{scalarZ.20}{scalarZmid.west}
            \tnjoin{scalarZ.-20}{scalarZlow.west}
            \tnjoin{scalarBZ.north}{scalarZphys.south}
        \end{tenkzfree}
        \(\;=\;\)
        \begin{tenkzfree}
            \tnput[ports={35:virtual,0:virtual,-35:virtual,north:physical}]
            ...
            \tnput[box, role=operator,
                ports={160:virtual,200:virtual,20:virtual,-20:virtual}]
                {scalarU}{(8mm,3mm)}{U}
            \tnput[boundary, ports={west:virtual}]{scalarUup}{(14mm,8mm)}{}
            \tnput[boundary, ports={west:virtual}]{scalarUmid}{(16mm,0)}{}
            \tnput[boundary, ports={west:virtual}]{scalarUlow}{(14mm,-6mm)}{}
            \tnput[boundary, ports={south:physical}]{scalarUphys}{(0,8mm)}{}
            \tnjoin{scalarBU.35}{scalarU.160}
            \tnjoin{scalarBU.0}{scalarU.200}
            \tnjoin{scalarU.20}{scalarUup.west}
            \tnjoin{scalarU.-20}{scalarUmid.west}
            \tnjoin{scalarBU.-35}{scalarUlow.west}
            \tnjoin{scalarBU.north}{scalarUphys.south}
        \end{tenkzfree}
        \(\;=\;\)
        \begin{tenkzfree}
            \tnput[ports={35:virtual,0:virtual,-35:virtual,north:physical}]
            ...
            \tnput[box, role=operator,
                ports={160:virtual,200:virtual,20:virtual,-20:virtual}]
                {scalarW}{(9mm,5mm)}{W}
            \tnput[boundary, ports={west:virtual}]{scalarWup}{(16mm,9mm)}{}
            \tnput[boundary, ports={west:virtual}]{scalarWmid}{(16mm,0)}{}
            \tnput[boundary, ports={west:virtual}]{scalarWlow}{(16mm,-7mm)}{}
            \tnput[boundary, ports={south:physical}]{scalarWphys}{(0,8mm)}{}
            \tnjoin{scalarBW.35}{scalarW.160}
            \tnjoin{scalarBW.-35}{scalarW.200}
            \tnjoin{scalarW.20}{scalarWup.west}
            \tnjoin{scalarW.-20}{scalarWlow.west}
            \tnjoin{scalarBW.0}{scalarWmid.west}
            \tnjoin{scalarBW.north}{scalarWphys.south}
        \end{tenkzfree}
    \end{center}
    ...
    the three subspaces $I_\alpha\otimes \End(\beta\otimes\gamma)$,
    $\End(\alpha\otimes\beta)\otimes I_\gamma$, and the analogous
...
\begin{theorem}[Generalized two-injective-tensor comparison]%
    ...
    $b,X,\eta_1,\eta_2,\sigma_1,\sigma_2$.  The following diagram records the
    three-shared-bond proof subcase used in the source, with the external
    boundary indices restored:
    ...
    \begin{center}
        \begin{tenkzfree}
            \tnput[ports={west:virtual,20:virtual,0:virtual,-20:virtual,
                north:physical}]
                {twoInjAone}{(0,0)}{A_1}
            \tnput[ports={east:virtual,160:virtual,180:virtual,200:virtual,
                north:physical}]
                {twoInjAtwo}{(28mm,0)}{A_2}
            \tnput[ring, role=operator, ports={200:virtual,-20:virtual}]
                {twoInjAX}{(14mm,5mm)}{X}
            \tnput[boundary, ports={south:physical}]{twoInjAPone}{(0,8mm)}{}
            \tnput[boundary, ports={south:physical}]{twoInjAPtwo}{(28mm,8mm)}{}
            \tnput[boundary, ports={east:virtual}]{twoInjAEtaOne}{(-8mm,0)}{}
            \tnput[boundary, ports={west:virtual}]{twoInjAEtaTwo}{(36mm,0)}{}
            \tnjoin{twoInjAone.20}{twoInjAX.200}
            \tnjoin{twoInjAX.-20}{twoInjAtwo.160}
            \tnjoin{twoInjAone.0}{twoInjAtwo.180}
            \tnjoin[route=arc, out=-20, in=200]
                {twoInjAone.-20}{twoInjAtwo.200}
            \tnjoin[label=\eta_1]{twoInjAone.west}{twoInjAEtaOne.east}
            \tnjoin[label=\eta_2]{twoInjAtwo.east}{twoInjAEtaTwo.west}
            \tnjoin{twoInjAone.north}{twoInjAPone.south}
            \tnjoin{twoInjAtwo.north}{twoInjAPtwo.south}
        \end{tenkzfree}
        \(\;=\;\)
        \begin{tenkzfree}
            \tnput[ports={west:virtual,20:virtual,0:virtual,-20:virtual,
            ...
            \tnput[ports={east:virtual,160:virtual,180:virtual,200:virtual,
                north:physical}]
                {twoInjBtwo}{(28mm,0)}{B_2}
            \tnput[ring, role=operator, ports={200:virtual,-20:virtual}]
                {twoInjBX}{(14mm,5mm)}{X}
            \tnput[boundary, ports={south:physical}]{twoInjBPone}{(0,8mm)}{}
            \tnput[boundary, ports={south:physical}]{twoInjBPtwo}{(28mm,8mm)}{}
            \tnput[boundary, ports={east:virtual}]{twoInjBEtaOne}{(-8mm,0)}{}
            \tnput[boundary, ports={west:virtual}]{twoInjBEtaTwo}{(36mm,0)}{}
            \tnjoin{twoInjBone.20}{twoInjBX.200}
            \tnjoin{twoInjBX.-20}{twoInjBtwo.160}
            \tnjoin{twoInjBone.0}{twoInjBtwo.180}
            \tnjoin[route=arc, out=-20, in=200]
                {twoInjBone.-20}{twoInjBtwo.200}
            \tnjoin[label=\eta_1]{twoInjBone.west}{twoInjBEtaOne.east}
            \tnjoin[label=\eta_2]{twoInjBtwo.east}{twoInjBEtaTwo.west}
            \tnjoin{twoInjBone.north}{twoInjBPone.south}
            \tnjoin{twoInjBtwo.north}{twoInjBPtwo.south}
        \end{tenkzfree}
    \end{center}
    Then
    \[
...
\begin{proof}
    ...
    equation~(\ref{eq:peps_residual_equality}) at the two endpoint choices shows that $g$
