...
\begin{theorem}[Normal-tensor fixed-point characterization]%
    ...
    A normal tensor is a renormalization fixed point if and only if it has the
    square-root fixed-point form of
    Definition~\ref{def:is_isometry_canonical_form}. Its bond dimension is
    necessarily positive, rather than subject to an additional hypothesis, and
    no left-canonical hypothesis is imposed on the original tensor. This is the
