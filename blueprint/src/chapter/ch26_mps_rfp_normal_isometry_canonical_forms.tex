...
\begin{theorem}[Normal-tensor fixed-point characterization]%
    ...
    \begin{align}
        ...
        \notag
    \end{align}
    Its bond dimension is necessarily positive. This is the
    corrected form of Lemma~B.1 in
    \cite[Appendix~B, lines~1274--1301]{Cirac2016MPDO_arXiv}.
\end{theorem}
\begin{proof}\leanok
...
cross-block physical orthogonality. Those additional equations are not part of
the single-block square-root form of
Theorem~\ref{thm:isometry_canonical_form_of_rfp_nt}, which is what applies to
each block here.
