...
\subsection{Project-specific block-injective canonical-form interface}
\label{subsec:rfp_project_canonical_form}

The following predicate is a project-specific interface used chiefly in this
chapter. It is stronger and differently normalized than the CPSV canonical
form of Definition~\ref{def:cpsv_canonical_form}; the two should not be
identified.
