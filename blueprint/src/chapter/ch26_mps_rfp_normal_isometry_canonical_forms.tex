...
\begin{definition}[Square-root fixed-point form]%
    ...
    \begin{align}
        ...
        \notag
    \end{align}
    Following \cite[Appendix~B]{Cirac2016MPDO_arXiv}, the square-root factor
    $\sqrt{\rho}$ is required by the unit pair-index isometry and
    reference-tensor construction \cite{gap:cpsv16_rfp_isometry_scope}.
