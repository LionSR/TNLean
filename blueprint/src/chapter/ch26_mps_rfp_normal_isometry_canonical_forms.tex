...
\begin{theorem}[Normal-tensor fixed-point characterization]%
    ...
    \uses{def:nt_cpsv, def:mps_transfer_idempotence,
        def:is_isometry_canonical_form, thm:cpsv_normal_bond_dim_pos}
...
\end{theorem}
\begin{proof}\leanok
    \uses{thm:cpsv_normal_bond_dim_pos, thm:cpsv_normal_tp_gauge,
        thm:cpsv_normal_eventually_injective, thm:gauge_invariance_normal,
        lem:rfp_parent_gauge_invariance,
