...
\begin{proof}
    ...
    coefficientwise, yielding \eqref{eq:blocked_boundary_map_transport}.
\end{proof}
...
\begin{proof}
    ...
    \eqref{eq:blocked_boundary_map_transport} give
    \begin{align}
    ...
    \end{align}
    which is \eqref{eq:blocked_local_ground_space_transport}. Orthogonal
    projection onto the image of a subspace under a unitary then gives
    \eqref{eq:blocked_ground_projector_conjugacy}.
\end{proof}