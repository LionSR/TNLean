...
\begin{proof}
    \leanok
    \uses{thm:ssa_equality_product_marginal_petz_recovery,
        thm:hjpw_recovered_bipartite_ambient_blocks,
        thm:hjpw_recovered_dilation_ambient_blocks}
...
\begin{theorem}[Hayashi SSA-equality characterization]
    ...
    and the recovered supported-sector states. Theorem~%
    \ref{thm:hjpw_recovered_tripartite_ambient_blocks} combines equations~(11),
    (14), and~(15) to prove the unnormalized ambient tripartite blocks in HJPW
    factor order, including zero complementary blocks. Defining the sector
    probabilities, normalizing the left factors when their weights are nonzero,
    choosing harmless density factors at zero weight, and constructing the
