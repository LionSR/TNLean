...
\begin{proof}\leanok
    ...
    has $p_j=0$, only its left factor is replaced by a normalized filler. On a
    complementary sector both factors may be fillers. These choices are made
    only at this final boundary, and multiplication by $p_j$ makes them
