...
\begin{definition}[Blocked middle tensor at an edge]%
    ...
    \begin{center}
        ...
        \begin{tenkz}[rows={wire}, cols=5, frame=circle, bonds=none]
            ...
            \tnmark[form=enclosure, slot=selected, label pos=90]{blockAone}{$A'_2$}
            \tnmark[form=enclosure, slot=secondary, label pos=90]{blockAfive}{$A'_1$}
            ...
            \tnmark[form=enclosure, slot=collar, label pos=n]
