...
\begin{theorem}[BNT theorem witnesses give source equations]%
    ...
    \begin{align}
        ...
        \label{eq:mpdo_bnt_witness_same_length_product}\\
        m_\gamma &= \sum_{\alpha,\beta} c^{(1)}_{\alpha,\beta,\gamma}m_\alpha m_\beta.
        \label{eq:mpdo_bnt_witness_idempotent_law}
    \end{align}
    ...
    \eqref{eq:mpdo_bnt_witness_same_length_product} and
    \eqref{eq:mpdo_bnt_witness_idempotent_law} rewrites them with the
    coefficients as $\chi$-traces,
    \begin{align}
        O_L(M_\alpha)O_L(M_\beta)
        &= \sum_\gamma \operatorname{tr}(\chi_{\alpha,\beta,\gamma}^{\,L}) O_L(M_\gamma),
        \label{eq:mpdo_bnt_witness_same_length_product_chi}\\
        m_\gamma
        &= \sum_{\alpha,\beta} \operatorname{tr}(\chi_{\alpha,\beta,\gamma}) m_\alpha m_\beta.
        \label{eq:mpdo_bnt_witness_idempotent_law_chi}
    \end{align}
    ...
    $\chi$-matrices, so \eqref{eq:mpdo_bnt_witness_same_length_product_chi}
    and \eqref{eq:mpdo_bnt_witness_idempotent_law_chi} hold equally with
    ...
    \[
        ...
        = \operatorname{tr}\!\left(
            \chi_{\sigma_n(i),\sigma_n(j),\tau_n(k)}^{\,n}\right).
    \]
\end{theorem}
\begin{proof}\leanok
