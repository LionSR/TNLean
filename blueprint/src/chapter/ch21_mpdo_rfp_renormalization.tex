...
\begin{proof}
    ...
    \begin{align}
        ...
        \notag
    \end{align}
    Since $V^\dagger V=\Id$, both displayed channels give the required two
    closure identities. Conversely, trace preservation of $\mathcal T$ gives
    idempotence of the physical-trace transfer of $M(A)$, as in
