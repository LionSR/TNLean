...
\begin{theorem}[Fibonacci rank obstruction cited against strong fixed points]
    ...
    described in \cite[Appendix~D, lines~2118--2176]{Cirac2016MPDO_arXiv}, and
    set
    \begin{align}
    ...
    exclude such $r$ and $s$.  The diagram labelled ``Strong-RFP'' does not
    specify an unambiguous algebraic predicate, so no general rank-growth
