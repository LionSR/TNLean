...
region-insertion identities determine the boundary conjugation uniquely: two
invertible matrices $Z_1,Z_2$ realizing the same insertion identity satisfy, for
every boundary matrix $M$,
\[
