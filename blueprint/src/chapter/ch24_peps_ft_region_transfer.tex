...
Reading a region $R$ and its complement $V\setminus R$ as two-block tensors, the
one-vertex-against-complement comparison forces the boundary conjugations to
agree, and the per-edge gauges combine into one gauge relating the two tensors.
This proves the Fundamental Theorem for injective PEPS,
Theorem~\ref{thm:fundamentalTheorem_PEPS}, the formalization of
