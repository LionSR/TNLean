...
\begin{theorem}[Injectivity of local physical realization]%
    ...
    \leanok
    \uses{def:peps_physRealizeLocalOp, thm:peps_physRealizeLocalOp_spec, def:IsVertexInjective}
...
\begin{theorem}[Recovery of a virtual operation from a physical realization]%
    ...
    \leanok
    \uses{def:IsVertexInjective, thm:peps_localVirtualOpOfPhysicalOp_spec}
