...
\begin{corollary}[Fusion tensors of periodic matrix product operator
    ...
    Let $(U_g)_{g\in G}$ be matrix product operators with injective
    tensors $T_g$ forming a representation of a group on periodic
    chains of every positive length, $U_gU_h=U_{gh}$. Then for all $g,h$
