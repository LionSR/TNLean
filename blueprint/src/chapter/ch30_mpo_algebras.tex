...
\begin{example}[Ising]%
    ...
    \lean{IsingTwist.isingBlock, IsingTwist.isingFusion,
    ...
    The Ising operators $A_1$, $A_\psi$ and $A_\sigma$ of
    Section~\ref{sec:asymex_ising_tensors} form a fusion algebra with unit
