...
whose periodic operators multiply according to fusion
rules~\cite{GarreRubio2023MPOSym}. Under periodic boundary conditions, the
symmetry acts on periodic matrix product states as an invariant
subspace~\cite[Section~3]{GarreRubio2023MPOSym}; see
