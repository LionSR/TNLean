...
\begin{proof}
    \leanok
    \uses{thm:mpdo_t0_map_cptp, thm:mpdo_physical_sector_t1_preparation_cptp, thm:mpdo_t2_map_cptp}
...
\begin{theorem}[$\mathcal S$ is trace-preserving completely positive]
    ...
    \leanok
    \uses{thm:mpdo_s0_map_cptp, thm:mpdo_physical_sector_s1_map_cptp, thm:mpdo_s2_map_cptp}
