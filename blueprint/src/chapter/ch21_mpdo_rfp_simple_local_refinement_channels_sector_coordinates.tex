...
\begin{theorem}[Positivity and zero-weight neighboring operators]
    ...
    \leanok
    \uses{def:mpdo_physical_sector_three_site_neighboring_operator, def:mpdo_neighboring_trace_factorization, thm:mpdo_physical_sector_three_site_neighboring_operator_trace}
...
\begin{definition}[The three-site neighboring-state preparation $\mathcal T_1$]
    ...
    \leanok
    \uses{def:mpdo_physical_sector_three_site_neighboring_operator, def:mpdo_neighboring_trace_factorization, thm:mpdo_physical_sector_three_site_neighboring_operator_properties}
...
\begin{theorem}[$\mathcal T_1$ is trace-preserving completely positive]
    ...
    \leanok
    \uses{def:mpdo_physical_sector_t1_preparation, thm:mpdo_physical_sector_t1_density_properties}
...
\begin{definition}[The refinement channel $\mathcal T$]
    ...
    \leanok
    \uses{def:mpdo_t0_map, def:mpdo_physical_sector_t1_preparation, def:mpdo_t2_map}
...
\begin{proof}
    \leanok
    \uses{thm:mpdo_t0_map_cptp, thm:mpdo_physical_sector_t1_preparation_cptp, thm:mpdo_t2_map_cptp, lem:is_kraus_cptp_comp}
...
\begin{definition}[The coarse-graining channel $\mathcal S$]
    ...
    \leanok
    \uses{def:mpdo_s0_map, def:mpdo_physical_sector_s1_map, def:mpdo_s2_map}
...
\begin{theorem}[$\mathcal S$ is trace-preserving completely positive]
    ...
    \leanok
    \uses{thm:mpdo_s0_map_cptp, thm:mpdo_physical_sector_s1_map_cptp, thm:mpdo_s2_map_cptp, lem:is_kraus_cptp_comp}
...
\begin{definition}[Two- and three-site sector coordinates]
    ...
    \leanok
    \uses{def:mpdo_two_site_sector_closure, def:mpdo_three_site_sector_closure}
...
\begin{theorem}[Diagonal outer-sector block of the three-site closure]
    ...
    \leanok
    \uses{def:phys_close, def:mpdo_sector_boundary_operator, def:mpdo_physical_sector_three_site_neighboring_operator, def:mpdo_physical_sector_closure_coordinates, def:mpdo_three_site_subspin_regrouping}
...
\begin{proof}
    \leanok
    \uses{thm:mpdo_three_site_sector_closure_factorization, def:mpdo_physical_sector_factorization}
...
\begin{theorem}[Off-diagonal outer-sector entries of the three-site closure]
    ...
    \leanok
    \uses{def:mpdo_physical_sector_factorization, def:mpdo_physical_sector_closure_coordinates, def:mpdo_three_site_subspin_regrouping}
...
\begin{theorem}[Regrouped two-site closure block]
    ...
    \leanok
    \uses{thm:mpdo_two_site_sector_closure_factorization, def:mpdo_physical_sector_closure_coordinates, def:mpdo_two_site_subspin_regrouping}
    For every virtual matrix $X$ and outer-sector pair $(k,h)$,
    \begin{align}
...
\begin{theorem}[Diagonal-block action of $\mathcal T_0$]
    ...
    \leanok
    \uses{def:mpdo_t0_map, def:mpdo_two_site_subspin_regrouping}
...
\begin{theorem}[Partial trace of a factorized two-site block]
    ...
    \leanok
    \uses{thm:mpdo_t0_same_block_action, def:mpdo_neighboring_trace_factorization}
...
\begin{proof}
    \leanok
    \uses{thm:mpdo_physical_sector_t1_density_properties, thm:mpdo_physical_sector_three_site_neighboring_operator_trace}
...
\begin{theorem}[Diagonal-block action of $\mathcal T_1$]
    ...
    \leanok
    \uses{def:mpdo_physical_sector_t1_preparation, thm:mpdo_t1_scaled_block_preparation}
...
\begin{theorem}[Refinement of the two-site closure]
    ...
    \leanok
    \uses{def:phys_close, def:mpdo_physical_sector_t_map, def:mpdo_physical_sector_closure_coordinates, def:mpdo_neighboring_trace_factorization}
...
\begin{proof}
    \leanok
    \uses{thm:mpdo_t0_regrouped_two_site_closure_block, thm:mpdo_t0_factorized_block_action, thm:mpdo_t1_factorized_block_action, thm:mpdo_t1_off_diagonal_action, thm:mpdo_regrouped_three_site_closure_block, thm:mpdo_regrouped_three_site_closure_off_diagonal}
...
\begin{theorem}[Coarse-graining of the three-site closure]
    ...
    \leanok
    \uses{def:phys_close, def:mpdo_physical_sector_s_map, def:mpdo_physical_sector_closure_coordinates, def:mpdo_neighboring_trace_factorization}
    Assume the neighboring-operator trace factorization of
    Definition~\ref{def:mpdo_neighboring_trace_factorization}. For every
...
\begin{proof}
    \leanok
    \uses{thm:mpdo_regrouped_three_site_closure_block, thm:mpdo_two_site_sector_closure_factorization, thm:mpdo_three_site_sector_closure_factorization, thm:mpdo_physical_sector_three_site_neighboring_operator_trace, def:mpdo_physical_sector_factorization, def:mpdo_physical_sector_closure_coordinates, def:mpdo_physical_sector_s1_map}
