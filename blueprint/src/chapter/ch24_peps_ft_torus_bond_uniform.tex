...
$P_A(R)=\prod_{e\notin\partial R} D_A(e)$ for the product of bond dimensions
over the non-boundary edges of $R$.
...
\begin{proof}
    ...
    non-boundary for $R$:
    $e'\notin\partial\phi(R)$ if and only if
    $\phi^{-1}(e')\notin\partial R$.
    Reindexing the product over non-boundary edges by the edge bijection
    $e\mapsto\phi(e)$ gives the stated equality.
\end{proof}
...
\begin{theorem}[Translation invariance of the interior-bond product]%
    ...
    \leanok
    \uses{def:peps_torus_translation_invariant, thm:peps_regionInteriorBondProd_map}
...
\begin{proof}
    ...
    $W_j=Q(s_j;L,K)$ and $W_{j'}=Q(s_{j'};L,K)$.
...
\begin{theorem}[Uniform horizontal per-step bond transport]%
    ...
    \leanok
    \uses{def:peps_corner_extension, thm:peps_regionInteriorBondProd_staircaseWindow_eq}
    ...
    \begin{align}
        \Ext_{W_j\subseteq U_j}
        (P_j\,I_{B,W_j,g,M_1})
         & =
        \Ext_{W_{j+1}\subseteq U_j}
        (P_j\,I_{B,W_{j+1},g,M_2}).
        \label{eq:peps_horizontal_uniform}
    \end{align}
\end{theorem}
\begin{proof}
    \leanok
    ...
    \begin{align}
        \Ext_{W_j\subseteq U_j}
        (P_B(W_{j+1})\,I_{B,W_j,g,M_1})
         & =
        \Ext_{W_{j+1}\subseteq U_j}
        (P_B(W_j)\,I_{B,W_{j+1},g,M_2}).
        \label{eq:peps_horizontal_cross}
    \end{align}
    By Theorem~\ref{thm:peps_regionInteriorBondProd_staircaseWindow_eq},
    $P_B(W_{j+1})=P_B(W_j)=P_j$.
    Substituting this equality into (\ref{eq:peps_horizontal_cross})
    gives (\ref{eq:peps_horizontal_uniform}).
\end{proof}
...
\begin{theorem}[Uniform vertical per-step bond transport]%
    ...
    \begin{align}
        ...
        \Ext_{W_{j+1}\subseteq U_j}
        (P_j\,I_{B,W_{j+1},g,M_2}).
        \label{eq:peps_vertical_uniform}
    \end{align}
\end{theorem}
\begin{proof}
    \leanok
    ...
    \begin{align}
        ...
        \Ext_{W_{j+1}\subseteq U_j}
        (P_B(W_j)\,I_{B,W_{j+1},g,M_2}).
        \label{eq:peps_vertical_cross}
    \end{align}
    The uniformity theorem gives $P_B(W_{j+1})=P_B(W_j)=P_j$.
    Substituting this equality into (\ref{eq:peps_vertical_cross})
    gives (\ref{eq:peps_vertical_uniform}).
\end{proof}
