...
Fundamental Theorem~\cite{PerezGarcia2008StringOrder}. For injective
tensors, physical on-site symmetries determine virtual gauges, those
gauges define projective representations on the bond space, and the
same virtual data controls string-order phenomena.
...
linear map.  The statements of this section are TNLean auxiliaries not
