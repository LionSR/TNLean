...
\begin{proof}\leanok
    ...
    The same-phase hypothesis supplies on-site symmetry for both
    tensors via the virtual representation intertwining: the gauge
    matrix conjugates each tensor component, giving a gauge equivalence
    and hence equal matrix product vectors.
