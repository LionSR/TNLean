...
These conclusions concern the specified defect and its normalization.
Failure of $A_L/4$ to be idempotent on odd rings does not, by itself,
give a general obstruction to condensation or compute an anomaly
class.
...
\begin{remark}[Scope of the compression results]%
    ...
    every word of length at least four, while the twelve split pair blocks
