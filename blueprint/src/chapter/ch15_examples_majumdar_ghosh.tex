...
\begin{remark}\label{rem:majumdar_ghosh_bond_dimension}
    Contracting the valence-bond shorthand of \cite{Cirac2021Matrix} with the
    singlet matrix $Y$ yields the $D = 3$ representation in
    Definition~\ref{def:majumdar_ghosh_tensor}; see
...
its periodic ground space exhibits dimer degeneracy.
