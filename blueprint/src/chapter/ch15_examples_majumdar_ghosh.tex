...
\begin{lemma}[The three-site term as a projector]%
    ...
    interaction of the Majumdar--Ghosh tensor. It is the projector
    $P^{3/2}$ onto total spin $\tfrac32$ of three spin-$\tfrac12$ sites.
\end{lemma}
...
\begin{theorem}[Ground space of the Majumdar--Ghosh Hamiltonian]%
    ...
    \begin{align}
        H_{N}+\tfrac{3N}{8}
         & =\tfrac34\sum_{i}P^{3/2}_{i,i+1,i+2}
        =\tfrac34H_{N,\mathrm{MG}}^{(3)},
