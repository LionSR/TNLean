...
\begin{theorem}[Isotypic-component decomposition]%
    ...
    \leanok
    \uses{thm:starSubalgebra_orthogonal_irreducible_decomposition, lem:starSubalgebra_isOrtho_sSup_not_sameIsotype, lem:starSubalgebra_sameIsotype_of_le_sSup, lem:starSubalgebra_sameIsotype_refl, lem:starSubalgebra_sameIsotype_symm, lem:starSubalgebra_sameIsotype_trans}
...
\begin{theorem}[Spatial tensor factorization of the isotypic components]%
    ...
    \leanok
    \uses{thm:starSubalgebra_orthogonal_isotypic_decomposition, thm:starSubalgebra_adapted_orthonormal_basis} Let $S$ be a $*$-subalgebra of $\MN{D}$. Then $\C^D$ is the supremum
...
\begin{proof}
    \leanok
    \uses{thm:starSubalgebra_orthogonal_isotypic_decomposition, thm:starSubalgebra_adapted_orthonormal_basis} Theorem~\ref{thm:starSubalgebra_orthogonal_isotypic_decomposition}
...
\begin{proof}
    \leanok
    \uses{thm:starSubalgebra_orthogonal_isotypic_decomposition, thm:starSubalgebra_adapted_orthonormal_basis}
...
\begin{proof}
    \leanok
    \uses{thm:starSubalgebra_global_adapted_orthonormal_basis, lem:starSubalgebra_unitary_change_of_basis_block}
...
\begin{proof}
    \leanok
    \uses{thm:commuting_overlapping_middle_coefficients, thm:starSubalgebra_complementary_spatial_actions}
...
\begin{proof}
    \leanok
    \uses{thm:starSubalgebra_global_adapted_orthonormal_basis, lem:starSubalgebra_unitary_change_of_basis_block, lem:starSubalgebra_double_commutant, lem:starSubalgebra_scalar_commutant_irreducible, def:starSubalgebra_intertwiner, def:starSubalgebra_sameIsotype}
    Let $(f_{k,i,j})$ be the adapted orthonormal basis of
