...
\begin{proof}
    \leanok
    Regard $T$ as the associated positive linear map. Positive linear maps
    between matrix $C^*$-algebras preserve the adjoint operation, and the
    adjoint on $\MN{D}$ is the conjugate transpose.
\end{proof}
