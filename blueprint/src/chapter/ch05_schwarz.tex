...
\begin{remark}
    The restriction-to-commutative-subalgebra step invokes two results not
    proved here: (a)~a positive map restricted to a commutative
    $C^*$-subalgebra is completely positive
    \cite[Prop.~1.6]{Wolf2012Quantum}, and (b)~the Arveson extension theorem
    \cite[Prop.~1.7]{Wolf2012Quantum}, which lifts the restricted CP map back
    to $\MN{D}$.
\end{remark}
