...
\begin{theorem}[Trace concavity of real powers]\label{thm:trace_rpow_concave_axiom}
    \lean{TNLean.trace_rpow_concave}
    \leanok
...
\begin{proof}\leanok
    ...
    conclusion. See Bhatia, \emph{Matrix Analysis}, Ch.~V.
\end{proof}
...
\begin{proof}\leanok
    Direct application of Theorem~\ref{thm:trace_rpow_concave_axiom}.
\end{proof}

\begin{theorem}[Trace convexity of real powers]\label{thm:trace_rpow_convex_axiom}
    \lean{TNLean.trace_rpow_convex}
    \leanok
    \uses{lem:diagonal_jensen_of_convexOn}
...
\begin{proof}\leanok
    ...
    Theorem~\ref{thm:trace_rpow_concave_axiom}, with scalar convexity
...
\begin{proof}\leanok
    Direct application of Theorem~\ref{thm:trace_rpow_convex_axiom}.
\end{proof}
