...
makes them available is that the union of two injective regions is again
injective. The proof decomposes a union $A\cup B$ into the four pieces
$A\setminus B$, $A\cap B$, $B\setminus A$, and the complement
$V\setminus(A\cup B)$, and descends a kernel condition through the resulting
contraction chain. Iterating gives injectivity of every finite union of
injective regions.
