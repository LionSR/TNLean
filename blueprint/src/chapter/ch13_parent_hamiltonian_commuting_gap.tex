...
\begin{theorem}[Commutation of the adjacent virtual bond projectors]
    ...
    \begin{center}
        \begin{tenkzfree}
            ...
            \tnregion[slot=selected, label={$\operatorname{supp}(P_{01})$},
                label pos=south,
                name=bondProjectorZero]{bondPhiZero}
            \tnregion[slot=selected, label={$\operatorname{supp}(P_{12})$},
                label pos=south,
    ...
    \begin{center}
        \begin{tenkzfree}
            ...
            \tnregion[slot=secondary, outline,
                label={$\operatorname{supp}((P_2)_{01})$},
            ...
            \tnregion[slot=secondary, outline,
                label={$\operatorname{supp}((P_2)_{12})$},
...
\begin{proof}
    ...
    loop tensors are normal renormalization fixed points.  Since the normal
    tensor $B$ belongs eventually to the span of their periodic matrix product
    vectors, normal-tensor orthogonality identifies $B$, up to a unit phase and
    an invertible virtual change of basis, with one of these loop tensors.
