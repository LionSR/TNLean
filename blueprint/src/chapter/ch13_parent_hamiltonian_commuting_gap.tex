...
\begin{proof}\leanok
    ...
    trace-preserving gauge, the Appendix~B virtual-bond projectors give the
    adjacent three-site commutator; cyclic transport gives all pairwise
    commutators on every chain with $N>2$.  Transporting back proves the claim.
\end{proof}
