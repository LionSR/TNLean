...
\begin{theorem}[All-chain nearest-neighbor commuting parent-Hamiltonian ground spaces imply a renormalization fixed point]\label{thm:nncph_implies_rfp}
    ...
    \leanok
    \uses{def:is_rfp, def:has_nncph_ground_spaces, def:normal}
    Let $B$ be normal and in left-canonical form. Suppose that, for a family of
    BNT components $A_j$, the nearest-neighbor parent Hamiltonian of $B$ has the
