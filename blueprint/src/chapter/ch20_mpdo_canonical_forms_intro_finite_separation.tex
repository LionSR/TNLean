...
\begin{remark}[Finite-word span and trace separation]%
    ...
    span were proper, a nonzero linear functional would annihilate it. Every
    such functional is a sum of matrix trace pairings, contradicting
    separation. This finite-word property is not the literal one-letter
