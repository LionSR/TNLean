...
\begin{definition}[Normalized BNT-refined horizontal form for an MPO]
    ...
    \begin{align}
        ...
        \notag
    \end{align}
    This gives the representative-grouped canonical decomposition
    of \cite[Section~2.3]{Cirac2016MPDO_arXiv}: the direct sum exhausts the
    full bond dimension $D$, each copy weight is nonzero and normalized, and
