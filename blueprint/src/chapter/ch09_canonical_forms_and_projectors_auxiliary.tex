...
\begin{definition}[CPSV canonical form]
    ...
    \end{align}
    Every weight $\mu_k$ is nonzero by convention: a summand of
    \eqref{eq:cpsv_canonical_form} with vanishing weight contributes nothing
    and is dropped from the list of blocks. No ordering or separation
