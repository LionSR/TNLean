...
\begin{definition}[CPSV canonical form]
    ...
    \end{align}
    Every weight $\mu_k$ is nonzero by definition: the summands of
    \eqref{eq:cpsv_canonical_form} are the nonzero terms of line~246 of
    \cite{Cirac2016MPDO_arXiv}. No ordering or separation condition is imposed;
    the normalization \eqref{eq:cpsv_weight_normalization} is recorded
    separately from canonical-form membership.
...
\begin{theorem}[Removing zero-weight blocks at positive length]%
    ...
    \leanok
    \uses{def:same_mpv2_pos, def:block_diagonal_tensor, thm:mpv_decomposition}
