...
\begin{definition}[Unnormalized positive-length PGVWC07 data]%
...
\begin{theorem}[Construction of the positive-length PGVWC07 witness]%
    ...
    More precisely, the checked construction has four stages. First, a nonzero
    ...
    family and the total bond-dimension bound. Finally, these data are packaged
    as a witness in the sense of
...
\begin{proof}\leanok
    ...
    \begin{align}
        ...
        \notag
    \end{align}
    Nonzero scalar rescaling preserves irreducibility. The checked proof passes
