...
\begin{proof}
    ...
    \[
        ...
        \mathcal T_M^2=\mathcal T_M.
    \]
    Faithfulness of the transfer-matrix representation identifies the first
    equality with idempotence of the transfer map of $A$.
\end{proof}
...
\begin{theorem}[Nondegenerate PRFP equivalence]
    ...
    An MPO tensor is a nondegenerate purification renormalization fixed point if
    and only if it has a local purification and
    \[
        \mathcal T_M\ne0,
        \qquad
        \mathcal T_M^2=\mathcal T_M.
