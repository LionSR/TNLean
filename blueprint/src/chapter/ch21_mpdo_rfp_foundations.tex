...
\begin{definition}[Bare global purification RFP witness]
    ...
    \]
    This records the displayed conditions of Definition~4.4 in
...
\begin{definition}[Bare global purification RFP]
    ...
    displayed conditions of Definition~4.4 in
...
\begin{theorem}[Nondegenerate PRFP equivalence]
    ...
    \[
        ...
        \mathcal T_M^2=\mathcal T_M.
    \]
    This is the normalized, nonzero tensor-level PRFP--ZCL equivalence supported
    by \cite[lines~744--786]{Cirac2016MPDO_arXiv}.
\end{theorem}
...
\begin{corollary}[A nondegenerate purification RFP satisfies the global PRFP predicate]
    ...
    positive-length global purification predicate of Definition~4.4 in
