...
\begin{theorem}[An idempotent physical-trace transfer without fixed-tensor
    ...
    \leanok
    \uses{def:mpdo, def:phys_close, def:mpo_physical_trace_transfer, def:is_rfp_via_ts, def:cpsv_example412_site_sign, def:cpsv_example412_configuration_sign}
...
\begin{definition}[Existence of a purifying fixed-point tensor]
    ...
    This auxiliary condition records the density-operator equation at
