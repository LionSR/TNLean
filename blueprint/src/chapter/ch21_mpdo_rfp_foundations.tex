...
\begin{theorem}[Local purification RFP with nonzero physical-trace transfer has source ZCL]
    ...
    nonzero, then $M$ has source zero correlation length. This is the forward
    implication from a purification renormalization fixed point to zero
    correlation length, at the level of the local tensor condition and the source
    physical-trace transfer object.
