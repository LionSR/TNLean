...
\begin{corollary}[Irreducibility in Kraus-map notation]
    \label{cor:kraus_map_irreducible_of_transfer_map}
    \lean{Kraus.isIrreducibleMap_mapLM_of_transferMap}
    \leanok
    \uses{def:irreducible_cp, thm:kraus_map_eq_transfer_map}
