...
expressed as a sum of decaying exponentials whose rate defines the spatial
correlation length. For tensors generating parent Hamiltonians
(Chapter~\ref{ch:parent_hamiltonian}), this spectral gap controls ground-state
correlations.
