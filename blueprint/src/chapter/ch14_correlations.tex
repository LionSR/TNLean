...
\begin{figure}[ht]
    ...
    \caption{The isometry canonical form of a normal renormalization fixed
        ...
        physical index. The source expression carries a bare $\Lambda$
        \cite[Appendix~B, lines~1275--1289]{Cirac2016MPDO_arXiv}; the square
        root is the corrected weight recorded in
        \texttt{docs/paper-gaps/cpsv16\_rfp\_isometry\_scope.tex}.}
...
\begin{figure}[ht]
    ...
    \caption{The per-block canonical form
        ...
        The picture is blockwise only, matching the entry above, which omits
        the cross-block physical orthogonality of
        \cite[Section~3.4, lines~543--561]{Cirac2016MPDO_arXiv}; see
        \texttt{docs/paper-gaps/cpsv16\_rfp\_isometry\_scope.tex}.}
