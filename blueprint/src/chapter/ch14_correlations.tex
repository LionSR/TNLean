...
The companion quantum-channel volume~\cite[``Complementary transfer-map gap for primitive maps'']{QICLean2026Blueprint}
establishes $\rho(\E_A-P)<1$ for primitive channels qualitatively. This section gives
