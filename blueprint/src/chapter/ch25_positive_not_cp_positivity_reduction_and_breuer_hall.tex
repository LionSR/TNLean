...
\begin{theorem}[The Breuer--Hall map is indecomposable]
    ...
    \uses{def:breuer_hall_map, def:decomposable_positive_map,
        thm:breuer_hall_positive, lem:indecomposable_of_ppt_witness}
...
\begin{proof}
    ...
    \uses{def:breuer_hall_map, thm:breuer_hall_positive,
        lem:indecomposable_of_ppt_witness}
    ...
    Lemma~\ref{lem:indecomposable_of_ppt_witness}, $T_{\mathrm{BH}}$ is not
    decomposable.
\end{proof}
