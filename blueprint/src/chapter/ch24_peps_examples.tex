...
\begin{theorem}[Coefficients of the classical-model PEPS]%
    ...
    On a torus with $w,h\ge 3$ the classical-model PEPS has coefficient
...
\begin{theorem}[Diagonal expectation values are Gibbs averages]%
    ...
    Let $w,h\ge 3$ and let $O=\sum_{\sigma}O(\sigma)\ket{\sigma}\bra{\sigma}$
    be a diagonal observable. For the classical-model PEPS state
...
\cite[Appendix~A, ``PEPS from classical models'']{Cirac2021Matrix}. This
