...
\begin{lemma}[The symmetric subspace has dimension five]%
    ...
    \lean{TNLean.PEPS.legKronecker_mul, TNLean.PEPS.legKronecker_one,
        TNLean.PEPS.legKronecker_transpose, TNLean.PEPS.comp_perm_eq_iff,
        TNLean.PEPS.legPermMatrix_mul, TNLean.PEPS.legPermMatrix_conjTranspose,
        TNLean.PEPS.legPermMatrix_mul_legKronecker, TNLean.PEPS.card_perm_fin_four,
...
\begin{definition}[AKLT tensor]%
    ...
    \lean{TNLean.PEPS.akltSingletY, TNLean.PEPS.akltLegs,
...
\begin{lemma}[Entries and physical span of the AKLT tensor]%
    ...
    \lean{TNLean.PEPS.akltSingletY_apply, TNLean.PEPS.akltLegs_apply,
...
\begin{theorem}[$SU(2)$ covariance of the AKLT tensor]%
    ...
    \lean{TNLean.PEPS.mul_akltSingletY, TNLean.PEPS.akltSiteTensor_covariant,
        TNLean.PEPS.adjugate_eq_star_of_mem_specialUnitaryGroup,
    ...
    \begin{align}
        ...
        \notag
    \end{align}
    The physical action is the spin-$2$ representation, the restriction of
    $U^{\otimes 4}$ to the range of $\Pi_{\mathrm{sym}}$. For an arbitrary
    $2\times 2$ matrix $U$ the same identity holds with $\bar U$ replaced by
