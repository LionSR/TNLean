...
\begin{theorem}[Virtual symmetry of the primal quantum-double network]%
    ...
    \leanok
    \uses{def:peps_quantum_double_primal, thm:peps_quantum_double_primal_fusion,
        lem:peps_torus_string_pull_through}
    ...
    Theorem~\ref{thm:peps_quantum_double_primal_fusion}.
\end{theorem}
