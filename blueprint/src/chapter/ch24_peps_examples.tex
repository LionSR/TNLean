...
\begin{definition}[Torus PEPS of a four-leg tensor]%
    ...
    \cite[Appendix~A, ``Two dimensions: PEPS'']{Cirac2021Matrix}.
\end{definition}
...
\begin{theorem}[The cluster PEPS]%
    ...
    \begin{align}
        ...
        \notag
    \end{align}
    Up to the factor $2^{-N/2}$ this is the coefficient of the state obtained
    by applying controlled-$Z$ gates on all nearest-neighbour bonds to
...
\begin{definition}[CZX tensor]%
    ...
    \cite[Appendix~A, ``The CZX model'']{Cirac2021Matrix}. Two neighbouring
    sites list the qubits of their common side in opposite orders, and the
    bond joins equal qubits: it identifies the pair $(a,b)$ at one end with
    the pair $(b,a)$ at the other. The CZX PEPS reads the down and left labels
    of the tensor in reverse.
\end{definition}
