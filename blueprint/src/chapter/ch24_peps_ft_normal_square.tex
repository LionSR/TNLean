...
\begin{definition}[Rectangular covers of square-lattice regions]%
    ...
    \begin{tenkzequation}
        ...
        \begin{tenkzlattice}[rows=4, cols=4, boundary legs]
            \tnregion[slot=selected, outline, label={2\times3},
                label at=center]{(1-2,1-3)}
            \tnregion[slot=secondary, outline, inset=1,
                label={3\times2}, label at=center]{(2-4,3-4)}
        \end{tenkzlattice}
    \end{tenkzequation}
\end{definition}
...
\begin{theorem}[Normal edge blocking to a three-site injective chain]%
    ...
    \begin{tenkzequation}
        ...
        % contractions and boundary type (V,P)=(28,0); the open blocked chain
        % has two cut virtual bonds and three physical legs, so (V,P)=(2,3).
        ...
        \begin{tenkzfree}
            ...
            \tnput[boundary, ports={east:virtual}]
                {normalBlockWest}{(-7mm,0)}{}
            \tnput[boundary, ports={west:virtual}]
                {normalBlockEast}{(31mm,0)}{}
            ...
            \tnjoin{normalBlockWest.east}{normalBlockAone.west}
            \tnjoin[role=marked]
                {normalBlockAone.east}{normalBlockAtwo.west}
            \tnjoin{normalBlockAtwo.east}{normalBlockAthree.west}
            \tnjoin{normalBlockAthree.east}{normalBlockEast.west}
