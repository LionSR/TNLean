...
\begin{theorem}[Eventual linear independence of periodic vectors]%
    ...
    Following \cite[lines~589--609]{DeLasCuevas2017Irreducible}, this establishes linear independence of the periodic vectors without asserting spanning of the ambient vector \cite{gap:dccsp17_periodic_overlap_route_alignment}.
\end{theorem}
...
\begin{theorem}[Scalar-weight specialization of the mixed-overlap theorem]
    ...
    This formulation specializes the preceding multiplicity-bearing theorem to scalar weights per block.
\end{theorem}
\begin{proof}\leanok
...
\begin{theorem}[Finite matching from the periodic overlap dichotomy]
    ...
    This establishes the finite matching step of \cite[Theorem~3.4]{DeLasCuevas2017Irreducible}.
\end{theorem}
\begin{proof}\leanok
