...
\begin{theorem}[Eventual linear independence of periodic vectors]%
    ...
    This establishes linear independence along the common-period subsequence
    without the spanning assertion of \cite[lines~589--609]{DeLasCuevas2017Irreducible};
    see \cite{gap:dccsp17_periodic_overlap_route_alignment}.
\end{theorem}
