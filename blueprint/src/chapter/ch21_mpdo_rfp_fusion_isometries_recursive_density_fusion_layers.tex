...
\begin{theorem}[Positivity of the terminal transfer matrices]%
    ...
    in \cite[lines~1010--1016]{Cirac2016MPDO_arXiv}; it does not assert that
    $T_\gamma$ is a projection or give the subsequent spectral, Hamiltonian,
    or Gibbs decomposition.
