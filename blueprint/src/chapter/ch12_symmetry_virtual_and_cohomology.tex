...
\begin{definition}[Agreement of factor-system cohomology classes]\label{def:projectively_equivalent}
    ...
    Two projective representations are projectively equivalent when their
    factor systems are cohomologous. This relation compares only their classes
    in $H^2(G,\C^\times)$ and does not assert an intertwining equivalence
    between the underlying representation spaces.
\end{definition}
