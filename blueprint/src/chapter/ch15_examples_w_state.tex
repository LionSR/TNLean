...
\begin{remark}[No fixed-bond translation-invariant family]%
    ...
    boundary vectors. As observed in \cite{Cirac2021Matrix}, a
    translation-invariant periodic representation requires a bond dimension
    growing with system size ($D^3\log D=\Omega(N)$ via the quantum Wielandt
    inequality); this asymptotic lower bound is not formalized in the present
    development.
