...
\begin{remark}[No fixed-bond translation-invariant family]%
    ...
    boundary vectors. Any translation-invariant matrix product state
    representing $\ket{W_N}$ with periodic boundary conditions requires a bond
    dimension growing with system size, $D^3\log D=\Omega(N)$, by the
    representation theory of \cite{PerezGarcia2007Matrix} and the quantum
    Wielandt inequality \cite{Cirac2021Matrix}.
