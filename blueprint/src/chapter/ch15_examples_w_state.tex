...
\begin{proof}
    ...
    \uses{lem:w_state_cut_rank, lem:pgvwc07_block_tuple_span,
        lem:pgvwc07_cut_rank_lower_bound}
...
\begin{theorem}[Single-length bound at prime length]%
    ...
    \uses{thm:w_state_canonical_bound, thm:pgvwc07_positive_length_witness,
        ...
        lem:periodic_period_le_sq, def:w_indicator}
...
\begin{proof}
    ...
    Rescaled and gauged, each block is periodic with a period $m_j\leq D^2<N$ by
    Lemma~\ref{lem:periodic_period_le_sq}. The reduction of
    ...
    block is primitive, and the general quantum Wielandt bound gives condition C1
    at $L_0=(D^2+1)^2$. Grouping the blocks whose states agree up to a phase power
