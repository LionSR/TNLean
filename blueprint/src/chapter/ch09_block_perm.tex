...
\begin{remark}
    Lemma~\ref{thm:repeated_word_trace_identity} is a word-evaluation identity.
    It is not a block-separation theorem: the proof below separates blocks by
    the mixed-transfer peeling argument of Lemma~\ref{lem:block_sep_core}.
    The later equal-case BNT weight comparison uses the finite power-sum
    identity of Chapter~\ref{ch:bnt}.
\end{remark}
