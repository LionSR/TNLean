...
\begin{remark}\label{rem:overlap_hypothesis}
    ...
    In the formalization, it is assumed directly as a
    hypothesis in the canonical form predicate.
    This avoids the need to formalize the full classification
    of peripheral spectra of irreducible channels.
\end{remark}
