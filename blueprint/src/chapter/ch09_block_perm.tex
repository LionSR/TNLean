...
\begin{proof}
    ...
    (since $R_k$ is simple).
    Diagrammatically the ring isomorphism can only reshuffle these
    indecomposable ideals:
    \[
        \TNBlockPermutation{\pi}{\Id}
    \]
...
\begin{proof}
    ...
    At the assembled level this is the direct-sum transport
    \[
        \TNDirectSumAssembly{\bigoplus_k \MN{D_k}}{\bigoplus_k \MN{D_{\pi(k)}}}{\operatorname{diag}(X_k)}.
    \]
...
\begin{proof}
    ...
    a decaying tail:
    \[
        \TNBlockTailEstimate{\mu_1^N V(A_1)}{\bigl|\mu_2/\mu_1\bigr|^N}.
    \]
...
\begin{proof}
    ...
    The final step is the block-diagonal gauge construction
    \[
