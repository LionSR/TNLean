...
\begin{proof}\leanok
	...
	adjoint transfer map (if $\E_A^\dagger$ had a nontrivial invariant
	projection $P$, then taking adjoints would show that $\Id - P$ is
	invariant for $\E_A$, contradicting irreducibility of $\E_A$), and
