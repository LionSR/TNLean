...
% descend to every common-weight absorbed BNT representative.  The low-level
% implication from these inherited analytic properties to the printed
% per-representative factorization is refuted by
% thm:mpdo_sal_zcl_bnt_sector_structure_counterexample.  The source-context
% factorization remains #6775.  A direct sector-coarsening or sector-mixing
% construction of the blocked channel pairs is the alternative route in
% #6793; their composition through the orthogonal outer physical sectors is
% formalized in #6632.
...
\begin{theorem}[Conditional composition of absorbed BNT channels]
    ...
    \leanok
    \uses{def:is_rfp_via_ts, def:mpdo_two_site_blocking, def:mpdo_common_sector_weight_absorption, thm:mpdo_absorbed_representative_boundary_decomposition, thm:mpdo_projective_resolution_channel_cptp}
...
\begin{proof}\leanok
    \uses{thm:mpdo_absorbed_representative_boundary_decomposition, thm:mpdo_projective_resolution_channel_cptp}
