...
% factorization remains #6775.  The source constructs each blocked channel
% pair from that factorization and then projects onto the orthogonal outer
% physical sectors; the latter composition is formalized in #6632.  The
