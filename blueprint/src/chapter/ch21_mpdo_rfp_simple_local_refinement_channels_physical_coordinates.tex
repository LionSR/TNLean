...
\begin{theorem}[Conditional assembly of absorbed BNT channels]
    ...
    assembly underlying \cite[Appendix~C.2, lines~1646--1665 and
...
\begin{theorem}[Blocking channels after common-weight absorption]
    ...
    derive a complete outer support resolution, or extend the channels on its
    orthogonal complement after proving that the closures lie in the active
    corner. Given the complete resolution, the combination through the outer
    physical projections is
    Theorem~\ref{thm:mpdo_absorbed_bnt_channel_assembly}. The completeness
    step remains unproved.
    % The follow-up is tracked by GitHub issue #6807.
\end{theorem}
