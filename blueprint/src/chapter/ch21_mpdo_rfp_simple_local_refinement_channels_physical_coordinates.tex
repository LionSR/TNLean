...
% positivity, SAL, and literal ZCL, and then combine those Case-I data into the
% all-sector structure required by implication (ii) => (v). The conditional
...
\begin{theorem}[Blocking channels from SAL and ZCL (all-sector Case-II boundary)]
    ...
    MPDO positivity, SAL, and literal ZCL, and then to combine its Case-I data
    into the all-sector structure required by Proposition~C.7. That Case-II
    passage is not yet formalized.
\end{theorem}
