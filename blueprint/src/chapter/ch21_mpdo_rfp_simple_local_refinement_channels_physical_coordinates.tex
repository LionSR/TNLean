...
\begin{theorem}[Conditional two-site blocking theorem from neighboring trace factorization]
    ...
    Definition~\ref{def:is_rfp_via_ts}. This establishes the channel construction of
    \cite[Proposition~C.7]{Cirac2016MPDO_arXiv} for one supplied factorization;
    see \cite{gap:cpgsv17_pf_rank_one}.
\end{theorem}
