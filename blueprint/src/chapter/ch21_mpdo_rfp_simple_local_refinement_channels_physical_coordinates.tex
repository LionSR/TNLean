...
% Positivity, SAL, and literal ZCL now descend to every absorbed BNT
% representative. The remaining input is the all-sector structural
% factorization of thm:mpdo_sal_zcl_bnt_sector_structure.
% The conditional
