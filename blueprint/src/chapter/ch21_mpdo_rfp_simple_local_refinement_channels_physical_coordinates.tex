...
\begin{theorem}[Blocking channels from representative trace factorizations]
    ...
    \uses{def:mpdo_physical_sector_factorization,
        def:mpdo_neighboring_trace_factorization,
        def:mpdo_bnt_layer_orthogonality,
        def:mpdo_common_sector_weight_absorption,
        def:is_rfp_via_ts, def:mpdo_two_site_blocking}
...
\begin{proof}\leanok
    \uses{cor:mpdo_common_weight_bnt_layer_supports,
        thm:mpdo_blocked_original_tensor_is_rfp_via_ts,
        thm:mpdo_absorbed_bnt_channel_support_completion}
