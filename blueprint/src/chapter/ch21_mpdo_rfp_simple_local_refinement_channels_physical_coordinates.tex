...
% which remains unformalized rather than refuted. The direct corrected rank-one
% criteria thm:psd_trace_powers_rank_one_t and
% thm:pairing_idempotent_rank_one_t require respectively positive
% semidefiniteness or linear independence and do not establish this implication.
% The conditional blocking theorem thm:mpdo_blocked_original_tensor_is_rfp_via_ts
