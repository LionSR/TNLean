...
\begin{theorem}[Periodic Fundamental Theorem]\leanok
	...
	\noindent\emph{Remark.}
	The Lean formalization proves this under the additional hypothesis that the
	periodic-overlap dichotomy (Proposition~3.3 of~\cite{DeLasCuevas2017Irreducible})
	holds; that hypothesis will be discharged once the dichotomy is fully formalized.
\end{theorem}
