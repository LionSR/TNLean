...
\begin{definition}[MPV phase equivalence for nonzero blocks]
...
\begin{theorem}[Common nonzero blocks with overlap-span data give sector comparison]%
\label{thm:after_blocking_sector_common_blocks_overlap_span}
	...
	block tensors whose nonzero blocks have nonzero bond dimensions, are
...
\begin{theorem}[Common nonzero blocks with derived overlap data and span comparison]%
\label{thm:after_blocking_sector_common_blocks_injective_span}
	...
	addition that the nonzero blocks are one-site injective, and that the two chosen
...
\begin{proof}
	...
	injectivity from the nonzero blocks to the chosen basis blocks.  The assumed span
...
\begin{theorem}[Common nonzero blocks with nonzero-block span equality give sector comparison]%
...
\begin{theorem}[Common nonzero blocks with a common MPV phase cover give sector comparison]%
...
\begin{theorem}[Common nonzero blocks with common MPV phase-cover data give sector comparison]%
\label{thm:after_blocking_sector_common_blocks_common_phase_cover}
	...
	nonzero blocks are trace-preserving, primitive, irreducible, injective, and have
...
\begin{theorem}[Common nonzero blocks with zero-tail agreement and overlap-span data]%
...
\begin{remark}[Remaining hypotheses for the unconditional equal-case theorem]\notready
	...
	The common-family comparison data is also formalized in reusable forms.  A
