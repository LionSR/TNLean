...
\begin{proof}
	...
	assemble to a global gauge equivalence.
\end{proof}
...
\begin{remark}[Status note]\notready
	...
	still requires one final assembly step: combining Route~B weight recovery with
...
\begin{remark}[Relation to normal canonical form]\notready
	...
	The present blueprint works exclusively with period-$1$ blocks,
