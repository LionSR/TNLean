...
\label{thm:afterBlocking_sectorComparison_reindexed_commonPhaseCover}
	...
	\uses{def:common_primitive_phase_cover_hypotheses,
		def:common_sector_relabeling_hypothesis}
		Let $A$ and $B$ have the same MPV family.  Assume the blocked-word identification
...
\label{thm:afterBlocking_sectorComparison_reindexed_proportional}
	...
	\uses{def:common_primitive_proportional_hypotheses,
		def:common_sector_relabeling_hypothesis}
		Let $A$ and $B$ have the same MPV family, and assume the blocked-word identification
