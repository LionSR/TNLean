...
\label{thm:bnt_sectorDecomposition_pair_overlapSpan_of_commonPhaseCover}
	\lean{MPSTensor.exists_bnt_sectorDecomposition_pair_with_overlapSpan_of_commonPhaseCover}
	\leanok
	\uses{def:mpv_common_phase_cover}
...
\label{thm:bnt_sectorDecomposition_pair_overlapSpan_of_proportionalDecompositionConclusion}
	\lean{MPSTensor.exists_bnt_sectorDecomposition_pair_with_overlapSpan_of_proportionalDecompositionConclusion}
	\leanok
	Let two block families be trace-preserving, primitive, irreducible, injective,
...
\begin{proof}
	...
	\uses{thm:common_phase_cover_of_proportional_decomposition,
		thm:bnt_sectorDecomposition_pair_overlapSpan_of_commonPhaseCover}
...
\label{thm:after_blocking_sector_of_proportionalDecompositionConclusion}
	\lean{MPSTensor.fundamentalTheorem_after_blocking_1606_sector_of_proportionalDecompositionConclusion}
	\leanok
	\uses{thm:common_phase_cover_of_proportional_decomposition,
...
\label{thm:after_blocking_sector_zeroTail_of_proportionalDecompositionConclusion}
	\lean{MPSTensor.fundamentalTheorem_after_blocking_1606_sector_zeroTail_of_proportionalDecompositionConclusion}
	\leanok
...
\begin{proof}
	\leanok
	\uses{lem:sameMPV2_live_of_zeroTail_eq,
		thm:bnt_sectorDecomposition_pair_overlapSpan_of_proportionalDecompositionConclusion,
		thm:sector_basis_overlap_span_to_matching,
		thm:route_b_hetero_sector_matching}
...
\begin{remark}[Remaining inputs for the unconditional equal-case theorem]\notready
	...
	is the exact agreement, after relabeling blocked physical words, that identifies the canonical blocked
