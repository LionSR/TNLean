...
\begin{theorem}[Proportional Fundamental Theorem in normal canonical form]\label{thm:ft_proportional_nt}
...
\begin{theorem}[Sector comparison from common blocks]%
...
\begin{theorem}[Sector comparison from derived overlap data]%
...
\begin{theorem}[Sector comparison from nonzero-block spans]%
...
\begin{theorem}[Sector comparison from phase-cover data]%
...
\begin{definition}[Proportional-comparison hypotheses for common primitive sectors]%
\label{def:common_primitive_proportional_hypotheses}
	...
	comparison for the two block families. These hypotheses apply to the
	representative or grouped BNT sectors used in the comparison, not to an
	unprocessed flattened list of cyclic sectors. It is the BNT-comparison version
...
\begin{theorem}[Sector comparison from proportional-comparison data]%
...
\begin{theorem}[Common-length sectors and span consequences]%
...
\begin{remark}[Equal-case comparison after canonical reduction]\notready
	...
	CPSV argument, recover the multiplicities and the weights.  The blockwise gauge
