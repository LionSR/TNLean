...
representatives, and then state the sector-decomposition surface that keeps the
...
\label{def:common_primitive_bnt_cover_hypotheses}
	...
	comparison surface is the sector-decomposition data with repeated copies and
	weights, not this strict-order constructor.  The length-zero identity and the
