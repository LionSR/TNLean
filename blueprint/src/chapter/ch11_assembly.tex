...
\label{thm:bnt_sector_decomp_pair_overlap_span_of_common_phase_cover}
	\lean{MPSTensor.exists_bnt_sector_decomposition_pair_with_overlap_span_of_common_phase_cover}
	\leanok
	\uses{def:mpv_common_phase_cover,
		thm:bnt_sector_decomp_pair_overlap_span_of_block_span,
		lem:mpv_common_phase_cover_span_eq}
	Let two nonzero-weight block families be trace-preserving, primitive,
	irreducible, injective, and carry nonzero weights. If they have common MPV
	phase-cover data, then there exist BNT sector decompositions $P$ and $Q$ for
...
\label{thm:bnt_sector_decomp_pair_overlap_span_of_proportional_decomposition}
	\lean{MPSTensor.exists_bnt_sector_decomposition_pair_with_overlap_span_of_bnt_proportional_decomposition}
	\leanok
	\uses{thm:common_phase_cover_of_proportional_decomposition,
		thm:bnt_sector_decomp_pair_overlap_span_of_common_phase_cover}
	Let two nonzero-weight block families be trace-preserving, primitive,
	irreducible, injective, and carry nonzero weights. If a BNT
	proportional-decomposition comparison supplies a permutation, equal bond
...
\label{thm:after_blocking_sector_bnt_proportional_decomposition}
	\lean{MPSTensor.fundamentalTheorem_after_blocking_1606_sector_of_bnt_proportional_decomposition}
	\leanok
	\uses{thm:common_phase_cover_of_proportional_decomposition,
...
\label{thm:after_blocking_sector_zero_tail_bnt_proportional_decomposition}
	\lean{MPSTensor.fundamentalTheorem_after_blocking_1606_sector_zero_tail_of_bnt_proportional_decomposition}
	\leanok
...
\begin{proof}
	...
	matching and heterogeneous sector comparison theorems then give the
	sector-weight conclusion.
\end{proof}
