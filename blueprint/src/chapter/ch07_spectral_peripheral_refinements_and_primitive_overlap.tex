...
The results in this section concerning peripheral eigenvalues, cyclic
projections, and peripheral eigenspaces are stated for completely positive finite
Kraus maps, rather than the general Schwarz-map setting of Wolf
Theorem~6.6; see \cite{gap:wolf_thm6_6_kraus_scope}.


\subsection{Cyclic decomposition of irreducible finite Kraus maps}

The cyclic decomposition proceeds by normalizing a peripheral eigenvalue to a
unitary eigenvector, constructing the discrete Fourier spectral projections,
and restricting the map to the resulting invariant corners
$P\MN{D}P\cong\MN{n}$; details appear in
...
For a primitive quantum channel or transfer map, removing the rank-one Perron
projection $P$ leaves a complementary map $E-P$ with spectral radius strictly
less than $1$ \cite[Theorem~6.7]{Wolf2012Quantum}. Trace convergence and
self-overlap asymptotics follow from this spectral gap, with the rank-one
projection $P=P_\rho$ and its trace properties developed in
Section~\ref{sec:app_spectral_perron_projection} following
