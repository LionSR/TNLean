...
the substitution argument of Section~\ref{subsec:paper_bnt_substitution} below.
...
argument of Section~\ref{subsec:paper_bnt_substitution}.
...
Section~\ref{subsec:paper_bnt_strong_match_bijective_symmetry}, the per-block
