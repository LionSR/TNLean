...
\begin{theorem}[Permutation rigidity for proportional MPV decompositions]\label{thm:bnt_perm_prop}
	...
	This is the restricted comparison step used inside the proof of
	\cite[Theorem~\texttt{thm1}, lines~1170--1192]{Cirac2016MPDO_arXiv};
	it is not the theorem itself.  The formulation assumes the decomposition
	coefficients that the source proof derives from BNT form, and uses the
