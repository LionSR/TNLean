...
\begin{definition}[Normal canonical form with BNT separation]\label{def:normal_cf_bnt}
	...
	\end{enumerate}
	As in Definition~\ref{def:cf_bnt}, the strict ordering is a
	restricted already grouped condition, not the multiplicity-bearing
	BNT normal form used in the general comparison theorem.
\end{definition}
