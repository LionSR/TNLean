...
\label{lem:bnt_two_family_overlap_orthonormal_li}
	...
	\leanok
	\uses{def:mpv_overlap, lem:bnt_overlap_orthonormal_li}
...
\begin{proof}\leanok
	Apply the Gram-matrix argument of Lemma~\ref{lem:bnt_overlap_orthonormal_li}
	to the disjoint union of the two index sets.  The within-family hypotheses
	give the diagonal and off-diagonal limits inside each block, and the mixed
	overlap hypothesis gives the off-diagonal limits between the two blocks.
\end{proof}
