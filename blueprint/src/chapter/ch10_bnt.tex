...
For a basis of normal tensors $A_1,\ldots,A_g$, write
$M_j=\operatorname{diag}(\mu_{j,1},\ldots,\mu_{j,r_j})$. The corresponding
canonical-form tensor has the coefficient decomposition
% Source: CPSV16, Section 2.3, Eq. II_ABasicTensors, source lines 283--301.
% Source-faithfulness verdict: graphical Eq. 19 replaces direct sums by tensor
% products and is explicitly declared nonliteral at source lines 304--313.
...
\[
    ...
    \end{array}
\]
This is the decomposition used below to separate the normal blocks.
