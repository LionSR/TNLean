...
\begin{theorem}[Normalized operators under an isometric physical inclusion]
    ...
    \leanok
    \uses{def:block_entropy, def:mpdo_single_kraus_map,
...
\begin{proof}\leanok
    \uses{thm:mpdo_normalized_state_physical_isometry_transport,
        thm:mpdo_block_reduced_state_single_kraus_sitewise}
...
\begin{proof}\leanok
    \uses{def:mpdo_orthogonal_commuting_sector_family_to_proportional,
...
\begin{theorem}[Proportional orthogonal commuting-bond sectors with ZCL satisfy SAL]
    ...
    \leanok
    \uses{def:mpdo_proportional_orthogonal_commuting_sector_family, def:mpdo,
        def:injective, def:mpo_source_zcl, def:is_sal}
...
\begin{theorem}[Printed Case-II commuting-form implication]
    ...
    \notready
    \uses{def:mpdo_simple_tensor, def:is_sal, def:mpdo_source_gsnnch,
        def:mpo_source_zcl}
...
\begin{theorem}[A compatible sector decomposition with ambient ZCL satisfies SAL]
    ...
    \leanok
    \uses{def:mpo_tensor, def:sector_weight_data,
      def:global_gauge_of_blocks, def:same_mpv2_pos,
      def:blockwise_product_word_span,
      def:mpdo_doubled_phys_trace_transfer,
      def:mpdo_common_sector_weight_absorption,
      def:mpdo_proportional_orthogonal_commuting_sector_family,
      def:mpo_source_zcl, def:is_sal}
...
\begin{proof}\leanok
    \uses{thm:mpdo_proportional_commuting_sector_positivity,
      thm:mpdo_proportional_orthogonal_commuting_sector_zcl_sal,
