...
% CPSV16 Proposition `prop3to4`, lines 1786--1796, instead starts from
% `AppKxKy=0`, `AppUkU=rl`, `Appetakhetc`, `Apptralktrrk`, and `AppPsiPhi`.
% The exact source-hypothesis capstone is tracked in
% docs/paper-gaps/cpsv16_gsnnch_sector_decomposition.tex and issue #5065.
