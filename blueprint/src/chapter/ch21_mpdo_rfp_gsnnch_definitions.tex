...
\begin{proof}\leanok
    ...
    congruence.  After splitting the chain into the retained interval and its
    complement, the isometry on the traced-out factor disappears under the
    partial trace, leaving the displayed congruence on the retained factor.
\end{proof}
