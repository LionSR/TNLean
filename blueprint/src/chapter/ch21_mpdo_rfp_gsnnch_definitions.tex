...
\begin{theorem}[Orthogonal commuting-bond sectors with ZCL satisfy SAL]
    ...
    % **Scope restriction (sectorwise source ZCL):** CPSV16 Appendix C.2,
    % Proposition prop4to2, lines 1801--1808, states the conclusion from the
    % orthogonal GSNNCH form alone, but its proof applies Proposition 4to2,
    % which assumes ZCL at lines 1597--1600. Theorem 4.9(iii), lines
    % 851--893, assumes ZCL for the full tensor. This theorem instead assumes
    % MPDO positivity, injectivity, normality, and source ZCL separately for
    % every sector. It proves this specialization, not the printed
    % GSNNCH-only proposition. See
