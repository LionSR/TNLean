...
\begin{theorem}[Proportional orthogonal commuting-bond sectors with ZCL satisfy SAL]
    ...
    % canonical Case II application, biCF and the nonzero absorbed weight
    % supply sector injectivity, and ambient source ZCL descends to every
    % absorbed sector. Sector MPDO positivity and absorbed-sector normalized
    % normality remain explicit independent inputs.
    % See docs/paper-gaps/cpsv16_commuting_form_to_sal.tex.
\end{theorem}
