...
\begin{proof}\leanok
    ...
    nonempty normalized marginal is the sum of the sector marginals with
    weights $p_x$.  The first-site support identity and $P_xP_y=0$ for
    $x\ne y$ make these summands pairwise orthogonal.  Hence
    \[
...
\begin{corollary}[Orthogonal commuting sector sums preserve SAL]
    ...
    \uses{thm:mpdo_local_orthogonal_sum_sal,
        ...
        def:mpdo_orthogonal_commuting_sector_family}
    Let $K_x$ be a nonempty finite family with orthogonally supported
    commuting sector products, and let $n_x$ be positive natural numbers.
