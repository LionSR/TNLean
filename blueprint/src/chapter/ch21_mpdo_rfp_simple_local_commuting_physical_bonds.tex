...
\begin{theorem}[Global direct-sum form of the sector closures]
    ...
    \leanok
    \uses{thm:mpdo_two_site_sector_closure_factorization, thm:mpdo_three_site_sector_closure_factorization, def:mpdo_physical_sector_factorization, def:mpdo_global_sector_closure_coordinates}
...
\begin{definition}[Two-site sector bond]
    ...
    \leanok
    \uses{def:mpdo_minimal_neighboring_operator, def:mpdo_global_sector_closure_coordinates}
...
\begin{theorem}[Positivity of the two-site sector bond]
    ...
    \leanok
    \uses{def:mpdo_physical_sector_two_site_bond, thm:matrix_pos_semidef_block_diagonal}
...
\begin{definition}[Two-site bond in physical coordinates]
    ...
    \leanok
    \uses{def:mpdo_physical_sector_two_site_bond, def:mpdo_physical_sector_factorization}
...
\begin{proof}
    \leanok
    \uses{def:mpdo_physical_two_site_bond, thm:mpdo_generic_two_site_translation_identities}
...
\begin{theorem}[Positivity of the physical two-site bond]
    ...
    \leanok
    \uses{def:mpdo_physical_two_site_bond, thm:mpdo_physical_sector_two_site_bond_pos}
    Suppose that $\eta_{k,h}$ is positive semidefinite for every pair of
...
\begin{theorem}[Three-site translation identities]
    ...
    \leanok
    \uses{def:mpdo_physical_two_site_bond, def:mpdo_three_site_pair_lifts}
...
\begin{theorem}[Commutativity of adjacent physical bonds]
    ...
    \leanok
    \uses{def:mpdo_physical_two_site_bond, def:mpdo_global_sector_closure_coordinates, thm:mpdo_three_site_pair_lifts, thm:mpdo_fixed_sector_adjacent_bonds_comm}
...
\begin{theorem}[Commutativity on disjoint cyclic windows]
    ...
    \leanok
    \uses{lem:cyclic_window_support_offsets, lem:cyclic_windows_overlap_symmetry}
...
\begin{theorem}[Adjacent physical bonds on periodic chains]
    ...
    \leanok
    \uses{thm:mpdo_cyclic_local_embedding_mul, thm:mpdo_physical_adjacent_bonds_comm}
...
\begin{theorem}[Commutativity of the crossed two-site translates]
    ...
    \leanok
    \uses{def:mpdo_global_sector_closure_coordinates, def:mpdo_physical_sector_two_site_bond, def:mpdo_physical_two_site_bond}
    ...
    This establishes the translated-bond commutativity of
    \cite[Appendix~C.2, Proposition~C.8]{Cirac2016MPDO_arXiv} at length two.
\end{theorem}
...
\begin{theorem}[Disjoint physical bonds on periodic chains]
    ...
    \leanok
    \uses{def:mpdo_physical_two_site_bond, thm:mpdo_disjoint_cyclic_local_embeddings_comm}
...
\begin{theorem}[Pairwise commutativity of the physical bonds]
    ...
    \leanok
    \uses{lem:two_site_cyclic_window_overlap_cases, thm:mpdo_periodic_adjacent_physical_bonds_comm, thm:mpdo_physical_two_site_crossed_bonds_comm, thm:mpdo_periodic_disjoint_physical_bonds_comm}
...
\begin{theorem}[Exact product of physical-sector bonds]
    ...
    \leanok
    \uses{def:mpdo_physical_sector_factorization, def:mpdo_physical_two_site_bond, thm:mpdo_physical_sector_chain_decomposition}
...
\begin{theorem}[Positive translation-invariant bond datum]
    ...
    \leanok
    \uses{thm:mpdo_physical_two_site_bond_pos, thm:mpdo_periodic_pairwise_physical_bonds_comm}
...
\begin{theorem}[$\eta$-local structure from a positive physical-sector factorization]
    ...
    \leanok
    \uses{thm:mpdo_exact_physical_sector_bond_product, thm:mpdo_positive_translation_invariant_bond_data, def:mpdo_eta_local_structure_data}
...
\begin{corollary}[$\eta$-local structure from SAL]%
    ...
    \leanok
    \uses{thm:mpdo_eta_local_structure_of_positive_physical_sector_factorization, thm:mpdo_eta_coherent_positive_choice}
...
\begin{corollary}[Normal representative for the SAL-selected bond]%
    ...
    \leanok
    \uses{def:mpdo_fixed_bond_product_tensor, def:mpdo_physical_sector_factorization, def:nt_cpsv}
    ...
    In particular, the scalar is one, providing the normal fixed tensor
    representation selected in Proposition~C.8 of \cite{Cirac2016MPDO_arXiv}.
\end{corollary}

\begin{proof}
    \leanok
    \uses{thm:mpdo_exact_physical_sector_bond_product, thm:mpdo_eta_coherent_positive_choice}
