...
\begin{theorem}[Square-root characterization of fixed points]
    ...
    \begin{align}
        ...
        \notag
    \end{align}
    In \cite[Theorem~3.11]{Cirac2016MPDO_arXiv}, $\bigoplus_{j,q}$ denotes a
    simultaneous direct sum in both physical and virtual spaces; the
    square-root factor $\sqrt{\rho_j}$ is required by the reference-tensor
    construction \cite{gap:cpsv16_rfp_isometry_scope}.
\end{theorem}
