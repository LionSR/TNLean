...
\begin{theorem}[Phase-class residual isometries]%
    ...
    The square-root factor $\sqrt{\lambda_{j,\alpha}}$ is required by the
    reference-tensor construction \cite[line~1300]{Cirac2016MPDO_arXiv}, as
    documented in \cite{gap:cpsv16_rfp_isometry_scope}.
\end{theorem}
\begin{proof}\leanok
