...
\begin{theorem}[Active phase-class residual isometries]%
    ...
    \lean{MPSTensor.IsCPSVCanonicalForm.exists_activeBNT_residualIsometryFamily}
    \leanok
...
\begin{proof}\leanok
    \uses{thm:cpsv_canonical_form_active_bnt_refinement,
        lem:rfp_coisometry_reconstruction_iff,
        thm:cpsv_active_weight_norm_one_and_block_rfp,
        thm:normal_rfp_iff_isometry_canonical_form,
        thm:bnt_locally_orthogonal_of_rfp_direct_sum,
        lem:mixed_transfer_eq_zero_of_conj,
        lem:residual_isometry_entry}
...
\begin{corollary}[Basis tensors of a fixed point]
    ...
    \uses{def:cpsv_canonical_form, def:bnt_cpsv,
        ...
        def:is_residual_isometry_family,
        thm:cpsv_active_weight_norm_one_and_block_rfp,
        thm:cpsv_active_phase_class_residual_isometries,
