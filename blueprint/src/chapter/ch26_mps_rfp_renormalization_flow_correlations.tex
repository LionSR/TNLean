...
\begin{definition}[One-letter doubled-MPO virtual-gauge condition]
    ...
    \leanok
    \uses{def:mpdo_two_site_blocking, def:gauge_equiv}
...
\begin{theorem}[The printed pure blocking-up-to-gauge equivalence is false]
    ...
    \leanok
    \uses{def:blocked_tensor, def:one_letter_mpdo_virtual_gauge_rfp,
...
\begin{proof}
    \leanok
    \uses{thm:blocked_gauge_phase_to_doubled_mpdo,
