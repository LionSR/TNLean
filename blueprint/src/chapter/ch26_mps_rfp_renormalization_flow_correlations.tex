...
\begin{definition}[One-letter blocking up to virtual gauge and phase]
    ...
    \cite[equation~\texttt{RFP-gauge}, lines~2100--2107]{Cirac2016MPDO_arXiv}.
...
\begin{theorem}[The printed pure blocking-up-to-gauge equivalence is false]
    ...
    \begin{align}
        ...
        \notag
    \end{align}
    The tensor is in CPSV canonical form and its weights satisfy the
    normalization at source line~246. It satisfies the blocking-up-to-gauge
