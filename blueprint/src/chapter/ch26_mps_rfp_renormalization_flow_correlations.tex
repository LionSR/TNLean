...
\begin{proof}\leanok
    ...
    Doubling cancels this phase. On the matrix unit $e_{21}$, the transfer-map
    powers carry the distinct factors $\omega$ and $\omega^2$, so the transfer
    map cannot be idempotent.
\end{proof}
