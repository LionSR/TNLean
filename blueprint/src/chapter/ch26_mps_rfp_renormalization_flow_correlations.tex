...
\begin{theorem}[The printed pure blocking-up-to-gauge equivalence is false]
    ...
    \leanok
    \uses{def:blocked_tensor, def:doubled_tensor,
    ...
    \begin{align}
        ...
        \notag
    \end{align}
    The doubled MPO tensor is in CPSV canonical form, and its four scalar-block
    weights satisfy the source normalization convention. It also satisfies the literal
