...
\begin{lemma}[An MPS blocking witness gives the doubled-MPO condition]
    \label{lem:blocked_gauge_phase_to_doubled_mpdo}
...
\begin{theorem}[The printed pure blocking-up-to-gauge equivalence is false]
    ...
    \begin{align}
        ...
        \notag
    \end{align}
    The tensor is in CPSV canonical form and its weights satisfy the source
    normalization convention. Its doubled tensor satisfies the literal
...
\begin{proof}
    \leanok
    \uses{lem:blocked_gauge_phase_to_doubled_mpdo,
    ...
    Doubling cancels this phase. If the transfer map were idempotent, all of
