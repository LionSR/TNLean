...
\begin{theorem}[Scalar reduction of the residual two-tensor gauges]%
    ...
    \begin{align}
        ...
        \notag
    \end{align}
    Following \cite[Section~3]{Molnar2018NormalPEPS}, this establishes the scalar
    reduction of residual virtual operators across exposed legs \cite{gap:peps_injective_ft_section3_route}.
\end{theorem}
\begin{proof}\leanok
