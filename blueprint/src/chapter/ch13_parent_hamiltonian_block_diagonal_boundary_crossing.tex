...
\begin{proof}
    ...
    \begin{equation}\label{eq:ph_boundary_crossing_scaled_boundary_equal}
        \mu_j^NX_j=\mu_j^NY_j.
    \end{equation}
    Equation~\eqref{eq:ph_boundary_crossing_scaled_boundary_equal} therefore says
    that $\mu_j^NX_j$ commutes with every
