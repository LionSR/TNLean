...
\begin{theorem}[The displaced invariant projector of a nontrivial periodic
    ...
    \leanok
    \uses{def:vertical_tensor_mpdo, def:no_periodic_vectors, def:mpdo_vertical_one_site_actions, def:support_proj}
...
\begin{proof}
    \leanok
    \uses{thm:spectral_unital_gauge_schwarz_setup, lem:eigenvalue_transport_unital_gauge, thm:transfer_peripheral_cyclic_structure, thm:cyclic_decomposition_irreducible_schwarz, lem:kraus_cyclic_shift, lem:support_proj_range_factorization}
...
\begin{theorem}[Reduction of the periodic-sector step to the
    ...
    \leanok
    \uses{def:mpdo, def:mpdo_noninvariant_projector_noncommuting, def:mpdo_periodic_vector_yields_cyclic_projector, def:vertical_tensor_mpdo, def:no_periodic_vectors}
...
\begin{proof}
    \leanok
    \uses{thm:mpdo_displaced_invariant_projector, thm:mpdo_cyclic_projector_reduction}
