...
\begin{lemma}[Virtual bond gauge -- 3-site case]%
    ...
    In the paper~\cite{Molnar2018NormalPEPS}, Lemma~1 is stated for
    arbitrary chain length $n \ge 3$ and any bond position, with
    uniqueness of $Z$ up to scalar.
    The Lean formalization currently proves the 3-site case stated above;
    the chain-level generalization is future work.
\end{lemma}
