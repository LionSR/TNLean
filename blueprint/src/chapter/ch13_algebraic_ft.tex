...
\begin{proof}
    ...
    and $i$, with $Z_n = Z_0$.
    Uniqueness up to a common scalar follows from the uniqueness of
    $Z$ in the 3-site virtual bond gauge (see the discussion after
    Lemma~\ref{lem:virtual_bond_gauge}).
\end{proof}
