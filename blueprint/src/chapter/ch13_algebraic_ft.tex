...
\begin{proof}
    ...
    and $i$, with $Z_n = Z_0$.
    Uniqueness up to a common scalar follows because any two inner
    automorphisms $\operatorname{Ad}(Z)$ and $\operatorname{Ad}(Z')$
    agreeing on $\MN{D}$ differ by a central scalar
...
\begin{remark}
    The result above establishes gauge equivalence of blocked constant
    chains; recovering gauges for the original unblocked site tensors
    is future work.
\end{remark}
