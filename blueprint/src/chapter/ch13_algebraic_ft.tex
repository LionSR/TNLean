...
lemmas underlie the injective PEPS theorem of Chapter~\ref{ch:peps_ft} and the
normal PEPS theorem on arbitrary graphs, where the graph geometry enters only
