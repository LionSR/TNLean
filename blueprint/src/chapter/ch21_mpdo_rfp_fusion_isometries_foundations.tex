...
\begin{definition}[Full-support labelled fusion family]%
    ...
    A \emph{full-support labelled fusion family} over a finite set of labels
    consists of tensors $M_\gamma$ with a common physical dimension and
    ...
    \cite[Theorem~4.14(iii)]{Cirac2016MPDO_arXiv}. The definition records only
    the labelled tensors and their fusion data; it does not require the
    labelled family itself to be a basis of normal tensors. In the later
    tensor-attached applications, the tensors are supplied by the vertically
    read basis of normal tensors from
    \cite[Proposition~4.13]{Cirac2016MPDO_arXiv}, and hence carry the BNT
    structure needed there; their physical dimension is the bond dimension of
    the original tensor. Statement (iii) of the source theorem additionally
    asserts the idempotent identity for the trace scalars of the vertical
    decomposition, recorded separately by
