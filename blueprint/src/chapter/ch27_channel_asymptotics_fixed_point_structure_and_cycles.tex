...
\begin{theorem}[Density blocks after restriction to maximal stationary support]%
    ...
    Theorem~\ref{thm:wolf_6_14}. The completed support transport and the
    remaining classification boundary are documented in the companion record
    \cite{gap:wolf_theorem6_14_fixed_point_projection_gap}.
\end{theorem}
