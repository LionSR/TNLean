...
\begin{theorem}[Permutation and $\Z_d$ on-site symmetry]\label{thm:ghz_d_symmetric}
    ...
    \leanok
    \uses{def:ghz_tensor_d, def:on_site_symmetric, thm:ghz_d_mpv}
    ...
    this action, and in particular under the cyclic group $\Z_d$ acting by the
    cyclic shift $\ket{i}\mapsto\ket{i+1 \bmod d}$.
\end{theorem}
