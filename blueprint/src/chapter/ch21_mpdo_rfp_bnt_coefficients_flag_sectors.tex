...
\begin{definition}[Flag sectors of the twisted quantum dimer]%
	...
	Definition~\ref{def:mpdo_bnt_label_operator_family}. Their BNT properties
	are proved below, rather than assumed in this definition.
	This tensor is an example motivated by the question of
	\cite[lines~995--1010]{Cirac2016MPDO_arXiv}; it is not a
	tensor stated there.
\end{definition}
...
\begin{theorem}[Product law for the closed operators of the flag sectors]%
	...
	identify the sectors as a BNT; that assertion is proved below.
	The tensor is an example motivated by the question of
...
\begin{theorem}[Horizontal canonical form of the twisted quantum dimer]%
	...
	The doubled-index tensor is in CF in the sense of
	...
	\begin{align}
		...
		\notag
	\end{align}
	The physical-trace transfer of $\widehat B_1$ vanishes. The tensor is an
	example motivated by the question of
	\cite[lines~995--1010]{Cirac2016MPDO_arXiv}; it is not a tensor stated
	there.
\end{theorem}
\begin{proof}\leanok
...
\begin{theorem}[The twisted quantum dimer is not simple]%
	...
	has nilpotent physical-trace transfer. The tensor is an example
...
\begin{proof}\leanok
	...
	blockings of $\widehat B_0$ and $\widehat B_1$. Its BNT refinement
...
\begin{theorem}[Vertical canonical form of the twisted quantum dimer]%
	...
	sectors already have the normalization required of NT in the CPSV sense
	is verified below.
	The tensor is an example motivated by the
...
\begin{theorem}[Vertical BNT algebra of the twisted quantum dimer]%
	...
	Theorem~\ref{thm:mpdo_twisted_dimer_two_label_rescaling_stable}.
	The two flag sectors are NT in the sense of
	...
	and linear independence already proved, this gives a BNT of the
	vertically viewed tensor, as in
	...
	coefficients length independent. No comparison with a blocked BNT,
	fusion isometry, or renormalization map is asserted.
	The tensor is an example motivated by the question of
	\cite[lines~995--1010]{Cirac2016MPDO_arXiv}; it is not a tensor stated
	there.
\end{theorem}
