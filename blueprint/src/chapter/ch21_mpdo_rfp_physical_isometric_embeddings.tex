...
\begin{theorem}[Transport under an isometric physical embedding]
    ...
    This isometric invariance applies to the normal-block and per-sector
    constructions in \cite[lines~217--246, 1628--1665, 1740--1782]{Cirac2016MPDO_arXiv}.
\end{theorem}
...
\begin{proof}
    ...
    between irreducibility of a Kraus family and its transfer map preserve
    normality without requiring a separate spectral argument.
