...
\begin{proof}
    \leanok
    Equality of traces is preserved by conjugation and restricts to the
    diagonal slot because off-diagonal blocks vanish when taking powers
    along words in a flag basis. The scalar factor carries across words by
    the length $|w|$.
\end{proof}
