...
\begin{remark}[Group operators from a three-cocycle and the anomaly]%
    ...
    product state (Theorem~\ref{thm:mpoalg_no_symmetric_normal}). In
    particular a symmetric parent Hamiltonian cannot have a normal matrix
    product state as its unique ground state; for gapped local Hamiltonians
    whose ground states are matrix product states, the symmetry forces a
    degenerate ground space, and the sources argue more generally that such
