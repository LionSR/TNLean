...
\begin{remark}[Groups represented by matrix product unitaries]%
    ...
    $U_g$ is injective and simple and
...
\begin{remark}[Group operators from a three-cocycle and the anomaly]%
    ...
    particular a symmetric local Hamiltonian cannot have a normal matrix
    product state as its unique ground state, and the sources argue more
    generally that such Hamiltonians are critical or symmetry breaking
