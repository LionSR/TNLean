...
\begin{theorem}[Power sums of modulus one]%
    \label{thm:mpoalg_unimodular_power_sum}
...
\begin{proof}
    \leanok
    \uses{thm:mpoalg_unimodular_power_sum, thm:asym_unblocked_coefficients,
    ...
    Theorem~\ref{thm:mpoalg_unimodular_power_sum} finishes the proof.
\end{proof}
