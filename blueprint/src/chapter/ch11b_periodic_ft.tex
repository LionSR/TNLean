...
\begin{remark}[Proportional periodic FT]\leanok
    ...
    The current Lean endpoint is a \emph{split-data} theorem: if one has periodic
    block families together with explicit decompositions of two total MPV families
    into those blocks, coefficient arrays converging to nonzero limits, and
