...
\begin{remark}[Proportional periodic FT]\notready
    ...
    The former Lean statement of this remark used coefficient arrays with
    nonzero limits as hypotheses.  That is not the hypothesis set of the
    source theorem, and the corresponding Lean declaration has been removed.
