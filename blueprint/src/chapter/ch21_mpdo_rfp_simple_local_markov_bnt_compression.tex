...
\begin{lemma}[Physical-trace transfer after common-weight absorption]
    \label{lem:mpdo_absorbed_bnt_sector_phys_trace_transfer}
...
\begin{proof}\leanok
    \uses{def:global_gauge_of_blocks,
      ...
      lem:mpdo_absorbed_bnt_sector_phys_trace_transfer}
