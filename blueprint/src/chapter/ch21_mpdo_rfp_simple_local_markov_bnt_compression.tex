...
\begin{proof}\leanok
    \uses{def:global_gauge_of_blocks,
      ...
      lem:mpdo_copy_weight_eq_common_weight,
      thm:mpdo_absorbed_bnt_sector_phys_trace_transfer}
...
\begin{proof}\leanok
    \uses{def:global_gauge_of_blocks, def:gauge_equiv,
      thm:gauge_invariance, lem:mpdo_trace_loop_chain,
