...
\begin{theorem}[Separating projectors for a simple tensor satisfying ZCL and SAL]
    ...
    \leanok
    \uses{thm:mpdo_simple_weight_copy_independent, thm:mpdo_sal_bnt_separating_projectors_copy_independent}
...
\begin{proof}\leanok
    \uses{cor:mpdo_simple_zcl_weight_copy_independent, lem:mpdo_simple_blockwise_zcl_equation, thm:mpdo_absorbed_bnt_sector_phys_trace_transfer}
