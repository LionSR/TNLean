...
\begin{theorem}[Resolution of the identity by Hayashi-sector projections]
    ...
    \leanok
    \uses{def:orthogonal_projection_channel, def:mpdo_hayashi_sector_projection}
...
\begin{proof}
    \leanok
    \uses{def:mpdo_hayashi_sector_projection, lem:orthogonal_projection_mul_eq_zero_of_sum_eq_one, thm:star_projection_coisometric_transport, thm:orthogonal_projection_star_projection_channel}
