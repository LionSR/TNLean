...
\begin{theorem}[Analytic properties of absorbed BNT representatives]
    ...
    nonnilpotent physical-trace transfers. Suppose that $K$ saturates the area
    law and satisfies literal zero correlation length,
    $\mathcal T_K^2=\mathcal T_K$. For every BNT label $s$, let
    $\mathcal K_s=\mu_sA_s$ be the absorbed BNT representative. Then
