...
\begin{proof}
    ...
    the corresponding theorem in the companion quantum-channel volume~\cite[``Raw Petz factorization for a product reference'']{QICLean2026Blueprint}. The singular-support
