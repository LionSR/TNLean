...
\begin{proof}\leanok
    \uses{def:global_gauge_of_blocks, lem:mpdo_doubled_phys_trace_transfer_to_mps, lem:mpdo_doubled_phys_trace_transfer_blockwise, lem:mpdo_copy_weight_eq_common_weight, thm:mpdo_absorbed_bnt_sector_phys_trace_transfer}
