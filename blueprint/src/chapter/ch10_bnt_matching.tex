...
\begin{proof}\leanok
    ...
    Equality of the positive-length MPV families is eventual nonzero
    proportionality with scalar $1$. Apply the proportional exact matcher of
    Lemma~\ref{lem:sector_bnt_proportional_exact_match}.
\end{proof}
