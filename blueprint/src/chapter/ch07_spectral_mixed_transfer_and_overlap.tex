...
\begin{proof}
    \leanok
    \uses{thm:spectral_radius_le_one, def:gauge_phase_equiv, thm:qpf, thm:right_canonical_gauge, thm:simplicity, thm:skolem_noether}
...
\begin{proof}\leanok
    \uses{thm:transfer_operator_gap_rect, lem:spectral_radius_pow_zero, thm:overlap_trace_rect}
...
\begin{proof}
    \leanok
    \uses{thm:modulus_one_gauge, thm:qpf, thm:right_canonical_gauge, thm:transfer_psd_fp_pd_irred, thm:gauged_intertwining_core, thm:gauged_intertwining_gauge_phase, thm:skolem_noether}
