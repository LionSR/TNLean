...
\begin{proof}\leanok
    ...
    Theorem~\ref{thm:entropy_kronecker}. The three reduced states factor as
    block-diagonal direct sums of the corresponding partial traces of the
    components, so, writing $H = -\sum_j p_j\log p_j$, the four entropies expand as
    \[
        \begin{aligned}
