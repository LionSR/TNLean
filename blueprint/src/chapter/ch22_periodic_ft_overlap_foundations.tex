...
\begin{theorem}[Product-one sector scalars after choosing a root]
    ...
    \cite[Appendix~A, lines~1072--1080]{DeLasCuevas2017Irreducible}: after
    Theorem~\ref{thm:periodic_product_tensor_phase_extraction} has extracted
    scalars independent of the sector coordinates, choosing a common $m$-th
    root of their product leaves a product-one family of sector scalars.
\end{theorem}
...
\begin{definition}[Off-diagonal sector decomposition]%
    ...
    Retaining the projections and corner isomorphisms as data gives the witness-bearing formulation.
...
\begin{lemma}[Ambient corner right inverse from the sector right inverse]
    ...
    \leanok
    \uses{lem:periodic_cornerprod_flatten, lem:periodic_block_flatten_word_compat}
