...
String order parameters characterize symmetry-protected topological phases
through non-local correlators with a unitary string and endpoint operators
\cite{PerezGarcia2008StringOrder}. In matrix product states, this physical
behavior corresponds to virtual-boundary nondecay and virtual local covariance.
...
\begin{definition}[Periodic finite-chain symmetry overlap]
    ...
    \end{align}
    In the thermodynamic limit, the normalized stationary-boundary functional
    $T_L(A,u,\Lambda)$ corresponds to this periodic overlap.
\end{definition}
