...
\begin{theorem}[Fixed-volume C3 ground projections with right spectators]
    ...
    Suppose that $A$ has nonzero bond dimension, is block injective at length
    $L_0>0$, and satisfies $L_0+1\leq n$.  The kernel of the range-$(L_0+1)$
    prefix Hamiltonian on
