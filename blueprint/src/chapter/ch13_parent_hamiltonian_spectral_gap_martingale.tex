...
\begin{theorem}[Arbitrary-increment mixed Gram of the overlapping spectator boundary maps]%
    ...
    The one-site identity is the specialization $q=1$.  This provides the
    algebraic whole-increment identity of condition C3$'$ in
...
% Source: References/cond-mat_9410110/main.tex, condition C3, lines 1083--1094.
\begin{theorem}[Open-chain martingale condition C3]
...
% Source: References/cond-mat_9410110/main.tex, condition C3, lines 1083--1094;
% proof of Theorem 2.1(i), lines 1178--1259.
\begin{theorem}[Fixed-final-volume martingale condition C3]
...
Gauging by the square root of a positive fixed point of the transfer map and
rescaling its spectral radius to one puts a normal tensor into normalized primitive
form, following \cite[Theorem~4]{PerezGarcia2007Matrix} and
\cite[Section~3]{Nachtergaele1996Spectral}, yielding the finite-range spectral
gap for general normal tensors.
...
\begin{proof}
    ...
    parent Hamiltonians equal, so both the kernel and the norm bound coincide.
    Block injectivity of $B$ at length $l$ passes to $\zeta A$ by
