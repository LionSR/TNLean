...
\begin{theorem}[Positive parent interactions for every canonical decomposition]
...
\begin{proof}
    ...
    Apply the canonical projector gap of
    Theorem~\ref{thm:canonical-decomposition-gap-simultaneous-injectivity} at
    range $R$, then the comparison theorem for the fixed interaction $h$. The
    constants depend on $h$ but not on $N$.
\end{proof}
...
\begin{theorem}[Positive parent interactions at the simultaneous injectivity range]
    ...
    span the direct sum of the matrix algebras of these representatives. For
