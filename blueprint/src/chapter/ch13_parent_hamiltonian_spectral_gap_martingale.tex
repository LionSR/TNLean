...
\begin{theorem}[Scalar path sums]
    ...
    $P^3=Q$ of Theorem~\ref{thm:fnw_dimension_markov_matrix} hold over $\R$.
...
\begin{proof}
    ...
    Theorem~\ref{thm:fnw_dimension_markov_matrix}, read in $\R$.
    For the path sums, apply the identities for $P^2$ and $P^3$, and use
    $u_b^2=w_e^2=1$.
