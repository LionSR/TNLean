...
% non-Cartesian witness in
% thm:mpdo_sal_zcl_bnt_sector_structure_counterexample refutes only the
% low-level implication from the inherited analytic properties.  It does not
% supply an ambient simple-biCF reconstruction, so the source-context
% absorbed-representative assertion remains open in #6775.
