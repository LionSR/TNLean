...
\begin{proof}
    \leanok
    \uses{thm:mpdo_eta_coherent_positive_choice,
...
\begin{proof}
    \uses{def:mpdo_normalized_four_site_tail,
      ...
      thm:mpdo_three_site_closure_reduced,
      thm:mpdo_inverse_map_active_sector_witnesses,
...
\begin{proof}
    \leanok
    \uses{thm:mpdo_inverse_map_active_sector_witnesses,
      thm:mpdo_active_sector_three_step_return_and_primitivity,
...
\begin{theorem}[Literal-ZCL specialization of the active trace relations]%
    ...
    \leanok
    \uses{def:injective, def:is_sal, def:mpo_physical_trace_transfer,
...
\begin{proof}\leanok
    \uses{thm:mpdo_sal_literal_idempotence_source_zcl,
...
\begin{proof}
    \leanok
    \uses{thm:mpdo_active_sector_singleton,
      thm:mpdo_active_trace_matrix_pow_two_eq,
      thm:mpdo_active_trace_matrix_literal_zcl_powers}
...
\begin{proof}
    \leanok
    \uses{thm:mpdo_physical_sector_rephasing_invariance,
      thm:mpdo_zero_weight_reparameterized_neighboring_operator,
      lem:mpdo_sector_tensor_left_zero_of_weight_zero}
...
\begin{proof}
    \leanok
    \uses{thm:cpsv_normal_bond_dim_pos,
      def:mpdo_normalized_four_site_tail,
      def:mpdo_zero_weight_reparameterized_inverse_map_factorization,
      thm:mpdo_four_site_sal_eta_structure,
      thm:mpdo_normalized_four_site_tail_entry_ne_zero,
      thm:mpdo_three_site_closure_reduced,
      thm:mpdo_inverse_map_active_sector_witnesses,
      thm:mpdo_casei_rank_one_coefficients,
      thm:mpdo_rephased_zero_weight_incident_vanish}
