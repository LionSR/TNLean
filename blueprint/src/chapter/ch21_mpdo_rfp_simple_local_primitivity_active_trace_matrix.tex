...
\begin{lemma}[Reduction to the active sector]
    ...
    \begin{align}
        ...
        \notag
    \end{align}
    This reconciles the full sector index set $I$ with the active sector set
    $I_*$.
\end{lemma}
...
\begin{theorem}[Normalized Case-I rank-one coefficients]
    ...
    \begin{align}
        ...
        \notag
    \end{align}
    This establishes the normal Case-I rank-one and normalization equations on
    the active sectors from
