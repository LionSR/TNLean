...
\begin{theorem}[Transported vertical-sector composites are identities]
    ...
    \begin{align}
      \widetilde S\circ\widetilde T
        ...
        \label{eq:mpdo_transported_vertical_sector_ST_id}\\
      \widetilde T\circ\widetilde S
        &=\operatorname{id}_{\mathcal A_2}.
        \label{eq:mpdo_transported_vertical_sector_TS_id}
    \end{align}
...
\begin{proof}\leanok
    ...
    \eqref{eq:mpdo_transported_vertical_sector_ST_id} and
    \eqref{eq:mpdo_transported_vertical_sector_TS_id}.
\end{proof}
...
\begin{theorem}[Positive original-label corner decomposition]
    ...
    \[
      ...
      \frac{\operatorname{tr}D_{\gamma(j)}}
           {\operatorname{tr}D^{(2)}_{\sigma(\gamma(j))}},
    \]
