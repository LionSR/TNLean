...
\begin{theorem}[Periodic block decomposition from a global cut]
    ...
    pairwise inequivalent up to gauge and phase, and injective at a common
    length $L_0>0$. Assume
    ...
    \path{Papers/quant-ph_0608197/MPSarchive.tex}:742--763 for the canonical
    normalization and 1424--1456 for the block-diagonal parent theorem.
\end{theorem}
