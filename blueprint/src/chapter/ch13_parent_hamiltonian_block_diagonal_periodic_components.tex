...
\begin{proof}\leanok
    \uses{lem:bnt_block_diagonal_open_boundary_matrices_source_length_doubly_normalized, thm:pgvwc_product_span_doubly_normalized, lem:parent_cyclic_translate_preserves_chain_space, lem:block_boundary_intertwiner_from_global_cut}
