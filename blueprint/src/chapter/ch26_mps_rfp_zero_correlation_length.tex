...
\begin{theorem}[Two source gaps in the zero-correlation-length characterization]
    ...
    \uses{def:cpsv_canonical_form, def:bnt_cpsv, def:source_bnt_zcl, def:mps_transfer_idempotence, thm:halved_weight_zcl_not_rfp, thm:bell_pair_chain_not_cid, thm:is_positive_gap_physical_cid_of_is_rfp}
    \notready
...
\begin{theorem}[The adjacent gap refutes the printed three-way equivalence]
    ...
    \uses{def:cpsv_canonical_form, def:source_bnt_zcl, def:mps_transfer_idempotence, def:has_nncph_ground_spaces, thm:halved_weight_zcl_not_rfp, thm:bell_pair_chain_not_cid, thm:is_positive_gap_physical_cid_of_is_rfp}
    \notready
...
\end{lemma}
\begin{proof}\leanok
    \uses{def:stationaryState, thm:bnt_rank_one_observables_sharp_length, lem:zcl_direct_sum_sector_calculus}
