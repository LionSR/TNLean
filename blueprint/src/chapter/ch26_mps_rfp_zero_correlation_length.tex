...
\begin{remark}[Remaining obstructions in the printed converse]
    ...
    subleading left and right eigenvectors used at lines 1260--1268.
    Theorem~\ref{thm:zcl_subleading_pair_excludes_cid} remains the formal
    record of the printed spectral argument, taking the normalized nonzero
    subleading pair as an explicit hypothesis.
\end{remark}
