...
\begin{lemma}[Positive-gap restriction, unfolded]%
    ...
    and only if $(A_j)_j$ is a basis of normal tensors for $A$, the physical
    correlations of $A$ are independent of separation whenever both
    complementary gaps are positive, and the components $(A_j)_j$ are locally
    orthogonal:
    \begin{align}
        \mathrm{BNT}((A_j)_j, A) \land \mathrm{CID}_+(A) \land \mathrm{LocOrtho}((A_j)_j).
        \notag
    \end{align}
\end{lemma}
\begin{proof}\leanok
