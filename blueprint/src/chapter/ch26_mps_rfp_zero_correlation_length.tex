...
\begin{theorem}[Two source gaps in the zero-correlation-length characterization]
    ...
    gap and its scope are recorded in
    ...
    prove the unrestricted biconditional of
    \cite[Theorem~3.8]{Cirac2016MPDO_arXiv} or the unrestricted three-way
    equivalence of \cite[Theorem~3.10]{Cirac2016MPDO_arXiv}. The converse and
    equivalence results below require their stated unit-weight,
    multiplicity-one, or spectral hypotheses. The printed statements are
    recorded here as refuted, not as theorems awaiting proof.
\end{theorem}
\begin{proof}
...
\begin{theorem}[Conditional positive-gap equivalence at the multiplicity-one representative]%
    ...
    \leanok
    \uses{def:is_positive_gap_bnt_zcl, def:mps_transfer_idempotence, def:sector_bnt_cf, thm:zcl_subleading_pair_excludes_cid}
...
\end{theorem}
\begin{proof}\leanok
    \uses{thm:zcl_subleading_pair_excludes_cid, thm:direct_sum_transfer_idempotent_iff_pairwise_mixed, thm:is_positive_gap_bnt_zcl_of_is_rfp_direct_sum}
...
\end{theorem}
\begin{proof}\leanok
    \uses{thm:positive_gap_bnt_zcl_conditional_converse, thm:rfp_multiplicity_one_bnt_has_nncph_ground_spaces}
...
\begin{theorem}[Physical ZCL implies idempotence under the spectral assumption]%
    ...
    \leanok
    \uses{def:mps_transfer_idempotence, def:sector_bnt_cf, thm:positive_gap_bnt_zcl_conditional_converse}
...
\end{theorem}
\begin{proof}\leanok
    \uses{thm:positive_gap_bnt_zcl_conditional_converse, lem:is_positive_gap_bnt_zcl_of_source_bnt_zcl}
