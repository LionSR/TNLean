...
tensor-network content, proved in the companion quantum-channel volume~\cite[``Left absorption by the marginal support projector'', ``Right absorption by the marginal support projector'', ``Partial trace over the left factor'']{QICLean2026Blueprint}. The
...
quantum-channel volume~\cite[``Left absorption by the right marginal support'', ``Right absorption by the right marginal support'']{QICLean2026Blueprint} alongside the
