...
\begin{remark}[Exact-length spanning and block injectivity]
    ...
    provides the bridge to the exact-length bound $S_N(A)=\MN{D}$ of
    \cite[Theorem~1]{Sanz2010Quantum}. This exact-length spanning is equivalent
    to injectivity of $\Gamma_N$ and one-site injectivity of the blocked tensor
    $A^{[N]}$ (Lemma~\ref{lem:blocking_transfer}).
\end{remark}
