...
\begin{theorem}[Index Theorem]
  ...
  \notready
  \discussion{6023}
  \uses{def:equivalent-tensors}
  For MPU tensors under the source's standing canonical-form convention, take
  the index defined from any simple blocking, with no reduced source datum or
  admissibility hypothesis. This index has the following properties.
  \begin{enumerate}
...
\begin{corollary}[Continuous choice of standard form]
  ...
  % docs/paper-gaps/mpu_canonical_form_full_support.tex.
  \uses{prop:continuity-index,thm:mpu_admissible_index,SF,ThmFund1,
    def:mpu_reduced_full_support_source_datum,
    def:mpu_admissible_equivalence_datum}
...
\begin{proposition}[Local characterization of time reversal]
  ...
  % docs/paper-gaps/mpu_canonical_form_full_support.tex.
  \uses{FundamentalMPU,thm:mpu_admissible_index,SF,
    def:mpu_reduced_full_support_source_datum}
...
\begin{proof}
  \uses{eq:sigma-from-trace}
  Substitute the gauge transformations into the trace formula. The adjacent
  unitary factors cancel, and cyclicity of the trace removes the remaining
  conjugation.
\end{proof}
...
\begin{proposition}[Well-definedness of the time-reversal sign]
  ...
  % Documented in docs/paper-gaps/mpu_canonical_form_full_support.tex.
  \uses{lem:mpu_sigma_gauge_invariant,lem:equivalent-symmetry,
    def:mpu_reduced_full_support_source_datum,
    def:mpu_admissible_equivalence_datum}
...
\begin{proof}
  ...
  time-reversal relations give the elementary unwinding identity relating
  $(\Id\otimes v\otimes\Id)(u\otimes x)$ to its adjoint with factor $\zeta$.
