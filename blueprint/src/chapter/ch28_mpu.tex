...
\cite{gap:gnvw12_support_algebra_star_closure}.
Full matrix factors $\mathcal B_1=M_I(\mathbb C)$ and
$\mathcal B_2=M_J(\mathbb C)$ suffice for the MPU spin chain because every
one-site algebra is isomorphic to $M_d(\mathbb C)$
\cite[lines~2320--2334]{Cirac2017MPU}; see
