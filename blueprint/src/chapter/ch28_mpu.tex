...
\begin{theorem}[Reflected open two-site source factorization]
    ...
    \end{align}
    Thus the physical row of $b$ is $(j_2,j_1)$, while its source column is
...
\begin{definition}[Standard form]
    ...
    \notready
    \discussion{6019}
    \uses{ThmFund1, def:mpu_source_uv, thm:mpu_source_u_open_two_site, thm:mpu_source_v_open_two_site}
...
\begin{proof}\leanok
    \uses{thm:mpu_source_u_open_two_site, thm:mpu_source_v_open_two_site, thm:mpdo_blocking_product, thm:mpdo_block_two_as_positive_blocking, thm:mpu_source_ranks_physical_reindexing, lem:mpu_iterated_physical_blocking}
