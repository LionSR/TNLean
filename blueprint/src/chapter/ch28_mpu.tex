...
\begin{theorem}[Admissible Index Theorem]
  ...
  \uses{prop:mpu_admissible_index_well_defined,lem:mpu_index_tensor,
    ...
    def:mpu_admissible_equivalence_datum,prop:continuity-index,
...
\begin{corollary}[Continuous choice of standard form]
  ...
  % docs/paper-gaps/mpu_canonical_form_full_support.tex.
  \uses{prop:continuity-index,thm:mpu_admissible_index,
    def:mpu_admissible_standard_form,
    thm:mpu_admissible_simple_tensor_equivalence,
    def:mpu_reduced_full_support_source_datum,
    def:mpu_admissible_equivalence_datum}
...
\begin{lemma}[Transformation with swaps and symmetry equivalence]
  ...
  % Definition~\ref{def:mpu_admissible_equivalence_datum}. Documented in
  % docs/paper-gaps/mpu_canonical_form_full_support.tex.
  \uses{threeMPU,threeMPU2,def:strictly-equivalent-symmetry,
    def:equivalent-symmetry,def:mpu_reduced_full_support_source_datum,
    def:mpu_admissible_equivalence_datum}
