...
\begin{theorem}[Shifted zero trace powers force nilpotence]
  ...
  \begin{align}
    ...
    &A^n&=0.
  \end{align}
  Thus $A$ is nilpotent. This is the elementwise nilpotence assertion used
  before the nil-matrix theorem in \cite[line~410]{Cirac2017MPU}. It requires
  neither the missing first moment nor positivity, normality, or
  diagonalizability.
\end{theorem}
