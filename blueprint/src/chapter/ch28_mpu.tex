...
\begin{theorem}[Coordinate identities for the reduced projection]
  ...
  \lean{Matrix.isSymmetricProjection_toEuclideanLin,
    Matrix.toEuclideanLin_reducedProjection,
...
\begin{theorem}[Reduced representative under a supplied positive fixed pair]
  ...
  \lean{MPOTensor.mpo_virtualSandwich_reducedProjection_eq,
    MPOTensor.transferMap_virtualSandwich_same,
    MPOTensor.transferMap_virtualSandwich_reducedProjection,
    MPOTensor.trace_compressed_fixedPair_reducedProjection,
    MPOTensor.compressed_fixedPair_posDef_reducedProjection}
  \leanok
  \uses{thm:mpu_matrix_reduced_projection,
  ...
  in this statement are supplied explicitly.
