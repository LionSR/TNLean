...
For the transfer-matrix spectrum argument of \cite[Proposition~1]{Cirac2017MPU}
...
\begin{lemma}[Rank-one diagonal idempotent]
...
\begin{proof}\leanok
  ...
  Lemma~\ref{thm:mpu_diagonal_one_at}.  For $1\le k\le n$ we have
