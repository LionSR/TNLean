...
$\Lambda\subset\mathbb Z$, let
\begin{align}
  \mathcal A_\Lambda
    &= M_d^{\otimes\Lambda}
     \cong M_{\{0,\ldots,d-1\}^{\Lambda}}(\mathbb C).
\end{align}
This algebra carries its operator norm.  It is the finite-region construction
used in the QCA appendix of \cite{Cirac2017MPU}; no completion is taken here.
