...
\begin{proof}\leanok
  ...
  \end{align}
  The support criterion for a positive semidefinite matrix $\rho$ states that
  \begin{align}
    \operatorname{supp}(\rho)(Vx)\neq0\quad\text{for every }x\neq0
    \quad\Longrightarrow\quad V^\dagger\rho V\succ0.
  \end{align}
  Applying it to $L$ and $R$ yields
  \begin{align}
