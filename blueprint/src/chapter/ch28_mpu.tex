...
\begin{proposition}[Normalization obstruction in the printed CZX tensor]
    \label{prop:czx_printed_normalization_obstruction}
...
\begin{remark}
    ...
    arXiv:2502.20257, equations \texttt{eq:deltas} and \texttt{eq:MPU\_CZX},
    are $\sqrt{2}H$, and the latter diagram also has a $Z$ gate on each
