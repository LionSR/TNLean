...
\begin{theorem}[Blocked double-layer diagonal is a transfer power]
    ...
    If $D>1$, then at the stabilization exponent $J$ this diagonal is the
    same reindexing of the rank-one projector $|\rho)(\Phi|$.
\end{theorem}
...
% Paper gap: docs/paper-gaps/mpu_one_letter_mixed_residual_trace.tex
% Tracking issue: https://github.com/LionSR/TNLean/issues/5807
