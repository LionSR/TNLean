...
specialization of the coefficient construction in Schumacher--Werner
Section~4.3 and of the leastness and commutant statements in
Gross--Nesme--Vogts--Werner Lemma~7.

\textbf{Scope restriction (full matrix factors and star-closed input):}
Lemma~7 permits arbitrary finite-dimensional $C^*$-algebras
$\mathcal B_1$ and $\mathcal B_2$ and an ordinary subalgebra
$\mathcal A\subseteq\mathcal B_1\otimes\mathcal B_2$.  The statements below
instead take $\mathcal B_1=M_I(\mathbb C)$ and
$\mathcal B_2=M_J(\mathbb C)$ and assume that $\mathcal A$ is a
star-subalgebra.  Both restrictions hold for the MPU spin chain: every
one-site algebra is isomorphic to $M_d(\mathbb C)$, and the input algebra is
the image of a local full matrix star-algebra under the star-automorphism
$\omega$ \cite[lines~2300--2306 and 2313--2334]{Cirac2017MPU}.  The general
GNVW theorem is not claimed here; see
\cite{gap:gnvw12_support_algebra_matrix_star_scope}.
