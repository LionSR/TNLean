...
\begin{theorem}[Commutation of overlapping support algebras]
    ...
    Schumacher--Werner Lemma \path{sppcomm}
...
\begin{proof}\leanok
    \uses{thm:commuting_overlapping_middle_coefficients,
        def:qca_left_coefficient_set,def:qca_right_coefficient_set,
        def:qca_left_support_algebra,def:qca_right_support_algebra}
    For $X\in\mathcal A_1$, $Y\in\mathcal A_2$, $i,i'\in I$, and
    $k,k'\in K$, applying
    Theorem~\ref{thm:commuting_overlapping_middle_coefficients} to
