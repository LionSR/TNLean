...
\begin{proposition}[Local characterization of time reversal]
  ...
  Let an index-zero MPU be in standard form, with one-site physical space
...
\begin{proposition}[Admissible local characterization of time reversal]
  ...
  \uses{thm:mpu_admissible_fundamental,thm:mpu_admissible_index,
    def:mpu_admissible_standard_form,
    def:mpu_reduced_full_support_source_datum}
  Let an MPU of index zero be in admissible standard form. Suppose its
  one-site tensor
...
\begin{proposition}[Admissible local characterization of transposition]
  ...
  % No preservation under blocking is asserted. Documented in
  % docs/paper-gaps/mpu_canonical_form_full_support.tex.
  \uses{thm:mpu_admissible_fundamental,def:mpu_admissible_index,
    def:mpu_admissible_standard_form,
    def:mpu_reduced_full_support_source_datum}
  Let an MPU of index zero be in admissible standard form. Suppose its
  one-site tensor
...
\begin{corollary}[Equivalence of conjugation-symmetric MPUs after blocking]
  ...
  All conjugation-invariant MPUs are equivalent under conjugation symmetry.
...
\begin{proposition}[CZX]
  ...
  \end{align}
  where $CZ=\operatorname{diag}(1,1,1,-1)$. Its tensor is
  \begin{align}
    \mathcal U_{\ell r}^{ud}
