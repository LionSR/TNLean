...
\begin{theorem}[Full active support under physical blocking]
    ...
    \leanok
    \uses{def:mpu_full_active_support, def:mpu_active_blocks_blocking_equiv, thm:cpsv_literal_canonical_form_positive_blocking}
...
\begin{theorem}[Shifted traces normalize every active weight]
    ...
    \leanok
    \uses{def:mpu_active_transfer_eigenvalue}
...
\begin{proof}\leanok
    \uses{lem:transfer_map_corner_intertwine, thm:mpu_dependent_block_inclusion_identities, thm:mpu_shifted_trace_power_moments, thm:mpu_shifted_trace_power_spectrum, thm:mpu_trace_power_all, thm:mpu_transfer_matrix_power_trace, thm:mpu_transfer_matrix_vectorization, thm:mpu_transfer_matrix_eigenvalues}
...
\begin{theorem}[Identification with chosen reduced-CFII fixed points]
    ...
    \leanok
    \uses{def:mpu, def:mpu_normalized_flattening, def:cpsv_cfii, def:mpu_full_active_support, def:mpu_ambient_block_inclusion}
...
\begin{proof}\leanok
    \uses{thm:mpu_normalized_transfer_trace, thm:mpu_shifted_transfer_trace_card_active, thm:mpu_active_transfer_eigenvalue_one, thm:mpu_ambient_block_isometry_intertwining, thm:mpu_unique_active_full_support_geometry, thm:matrix_posdef_coisometric_transport, lem:transfer_map_corner_intertwine, thm:transfer_matrix_trace_preserving_identity_left_fixed, thm:mpu_transfer_matrix_vectorization, thm:matrix_vec_identity_trace_pairing, thm:mpu_normalized_transfer_stabilization, thm:mpu_stabilized_fixed_pair_uniqueness}
...
\begin{theorem}[Reduced-CFII data for the forced simple block]
    ...
    \leanok
    \uses{def:mpu, def:mpu_normalized_flattening, def:cpsv_cfii, def:mpu_full_active_support, def:mpdo_physical_blocking, def:mpu_double_layer}
...
\begin{theorem}[Counterexample to the unrestricted source-$v$ Gram identification]
    ...
    \leanok
    \uses{def:mpu_source_v_gram_counterexample_data, def:mpu, def:mpu_simple, def:mpu_double_layer, def:mpu_source_v_dressing, def:mpu_normalized_flattening, def:transfer_map, def:cpsv_cfii, def:mpu_full_active_support}
...
\begin{theorem}[Normality of a full-support normalized MPU representative]
    ...
    \leanok
    \uses{def:mpu, def:mpu_normalized_flattening, def:cpsv_canonical_form, def:mpu_full_active_support, def:normal}
...
\begin{proof}\leanok
    \uses{thm:mpu_normalized_transfer_trace, thm:mpu_shifted_transfer_trace_card_active, thm:mpu_shifted_transfer_trace_primitive, thm:mpu_unique_active_full_support_normal}
...
\begin{definition}[Reduced full-support source datum]
  ...
  \uses{def:mpu, def:mpu_normalized_flattening, def:cpsv_cfii, def:mpu_full_active_support, thm:mpu_reduced_cfii_transfer_stabilization, thm:mpu_normalized_transfer_fin_one}
...
\begin{lemma}[Admissible composition additivity]
  ...
  % docs/paper-gaps/mpu_canonical_form_full_support.tex.
  \uses{def:mpu_admissible_standard_form, def:mpu_admissible_index, prop:mpu_admissible_index_well_defined, thm:mpu_source_cut_rank_blocking, def:mpu_reduced_full_support_source_datum}
...
\begin{theorem}[Normalized transfer data under identity ancillas]
  ...
  \leanok
  \uses{def:mpu, def:mpu_normalized_flattening, def:cpsv_cfii, def:mpu_full_active_support}
...
\begin{theorem}[Reduced representative under a supplied positive fixed pair]
  ...
  \leanok
  \uses{def:mpo_family, def:mpo_transfer_map, def:support_proj, def:mpu_virtual_sandwich, def:mpu_matrix_reduced_projection, lem:mpu_transfer_map_virtual_sandwich, lem:mpu_support_compression_posdef, thm:mpu_matrix_reduced_projection, thm:mpu_two_projection_reduced_projection_transversality}
...
\begin{theorem}[Invertible factor for a reduced projection]
  ...
  \leanok
  \uses{def:support_proj, def:mpu_matrix_reduced_projection, def:mpu_ambient_support_inverse_extension}
...
\begin{theorem}[Source-rank comparison of the hatted and reduced tensors]
  ...
  \leanok
  \uses{def:mpo_family, def:support_proj, def:mpu_virtual_sandwich, def:mpu_matrix_reduced_projection, def:mpu_right_rank, def:mpu_left_rank, def:mpu_ambient_support_inverse_extension, thm:reduced_projection_invertible_factor}
...
\begin{proof}\leanok
  \uses{def:support_proj, def:mpu_virtual_sandwich, thm:mpu_matrix_reduced_projection, thm:mpu_virtual_sandwich_source_ranks, thm:mpu_ambient_support_inverse_extension}
