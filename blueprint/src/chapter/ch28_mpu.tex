...
\begin{proposition}[Conjugation symmetry]
  ...
  % docs/paper-gaps/mpu_canonical_form_full_support.tex.
  \uses{thm:mpu_admissible_fundamental,SF,
    def:mpu_reduced_full_support_source_datum}
...
\begin{proposition}[Orthogonal and symplectic standard forms]
  ...
  % docs/paper-gaps/mpu_canonical_form_full_support.tex.
  \uses{prop1conj,lemma:conjclass-normalform-continuous,
    thm:mpu_admissible_fundamental,
    def:mpu_reduced_full_support_source_datum}
...
\begin{proposition}[Local characterization of time reversal]
  ...
  % docs/paper-gaps/mpu_canonical_form_full_support.tex.
  \uses{thm:mpu_admissible_fundamental,thm:mpu_admissible_index,SF,
    def:mpu_reduced_full_support_source_datum}
...
\begin{proposition}[Local characterization of transposition]
  ...
  % No preservation under blocking is asserted. Documented in
  % docs/paper-gaps/mpu_canonical_form_full_support.tex.
  \uses{thm:mpu_admissible_fundamental,def:index,SF,
    def:mpu_reduced_full_support_source_datum}
  Let an MPU of index zero be in standard form. Suppose its one-site tensor
...
\begin{lemma}[Standard-form path criterion]
  ...
  % docs/paper-gaps/mpu_canonical_form_full_support.tex.
  \uses{def:strictly-equivalent-symmetry,coruvSF,
    thm:mpu_admissible_fundamental,
    def:mpu_admissible_equivalence_datum}
...
\begin{corollary}[Necessary time-reversal invariants]
  ...
  continuously varying reduced full-support source data.
  In particular, each endpoint carries its own datum for all five tensors.
  Then admissible strict equivalence requires equality of both
  $\sigma^{(1)}$ and $\sigma^{(2)}$.
...
\begin{proposition}[Time-reversal and transposition phases of $U_2$ and $U_3$]
  ...
  their conjugate, physical-adjoint, and transposed comparison tensors at both
  blocking lengths, are simple and carry their own reduced full-support source
  data. Suppose the corresponding fixed conjugate, physical-adjoint,
  transposed, and symmetry-image comparison paths carry these data
  continuously. Then the MPUs $\widetilde U_2^{(N)}$ and
  $\widetilde U_3^{(N)}$ are in the same
