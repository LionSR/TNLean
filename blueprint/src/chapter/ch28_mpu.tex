...
\begin{proof}\leanok
  ...
  Conversely, induction and the additive action law show that $\omega$ commutes
  with $\tau_n$ for every $n\geq 0$.  Since $\tau_{-n}=\tau_n^{-1}$, commutation
  with $\tau_n$ implies commutation with $\tau_{-n}$, which covers every integer
  translation.
\end{proof}
