...
\begin{theorem}[Open two-site source factorization]
    ...
    \leanok
    \uses{def:mpu_source_uv, def:mpdo_two_site_blocking, thm:mpu_source_factorization_entries}
...
\begin{proof}\leanok
    \uses{def:threeMPU_supplied_source_factors, def:mpu_source_uv, thm:mpu_shift_source_cuts_ranks}
...
\begin{theorem}[Central gates in the supplied two-site factorizations of $U_2$]
    ...
    \leanok
    \uses{def:threeMPU_supplied_source_factors, def:mpu_source_uv, thm:mpu_source_u_open_two_site, thm:mpu_source_v_open_two_site}
...
\begin{proposition}[Standard forms of the three shift MPUs]
    ...
    \notready
    \discussion{5715}
    \uses{threeMPU, thm:threeMPU_supplied_source_uv_one, thm:threeMPU_U2_supplied_source_uv_two, thm:threeMPU_U3_supplied_source_uv_two}
