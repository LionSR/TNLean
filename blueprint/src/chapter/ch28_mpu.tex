...
\begin{lemma}[A matrix basis adapted to the trace]
    \label{lem:identity_traceless_matrix_basis}
...
\begin{theorem}[Identity plus traceless physical decomposition]
    ...
    \leanok
    \uses{lem:identity_traceless_matrix_basis}
...
\begin{lemma}[Invertible factor for a reduced projection]
  \label{lem:reduced_projection_invertible_factor}
  \lean{Matrix.exists_units_supportInvExtension_reducedProjection_rightFactor}
  \leanok
  \uses{def:support_proj,def:mpu_matrix_reduced_projection,
...
\begin{theorem}[Source-rank comparison of the hatted and reduced tensors]
  ...
  \uses{def:mpo_family,def:support_proj,def:mpu_virtual_sandwich,
    ...
    def:mpu_ambient_support_inverse_extension,
    lem:reduced_projection_invertible_factor}
...
\begin{theorem}[Density of finite-region observables]
  ...
  \uses{def:qca_quasi_local_algebra,def:qca_quasi_local_observable,
    thm:qca_local_observable_finite_support,
    thm:completion_map_dense_range}
