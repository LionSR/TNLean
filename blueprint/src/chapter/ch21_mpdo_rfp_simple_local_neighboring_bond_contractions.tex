...
\begin{lemma}[Projection onto a matrix block]
    \label{lem:block_inclusion_projection}
    \lean{Matrix.sigmaBlockInclusion_mul_conjTranspose_eq_blockProjection}
    \leanok
    The canonical inclusion $V_s$ of a matrix block is an isometry and
...
\begin{theorem}[Flattened sector as an isometric virtual corner]
    ...
    \leanok
    \uses{def:sector_weight_data, lem:block_inclusion_projection}
