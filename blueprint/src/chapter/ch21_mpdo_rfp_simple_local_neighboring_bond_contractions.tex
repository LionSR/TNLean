...
\begin{theorem}[Neighboring bond contraction]
    ...
    \begin{align}
        ...
        \notag
    \end{align}
    This is the single-bond step of the identity forming
...
\begin{theorem}[Flattened sector as an isometric virtual corner]
    ...
    \cite[Section~2.3, equation \emph{II\_Aiplusk1},
        lines~195--219]{Cirac2016MPDO_arXiv}, providing the virtual corner
    structure used in Appendix~C.2.
\end{theorem}
...
\begin{theorem}[Directed-cut annihilation of one-site matrix spaces]%
    ...
    $Y\in\mc A_C$. This is the directed local-orthogonality implication used in
...
\begin{definition}[Inverse-map physical-sector factorization]
    ...
    conclusions rather than hypotheses. This gives the factorization in
...
\begin{theorem}[Finite-chain decomposition of a physical-sector factorization]
    ...
    \begin{align}
        ...
        \notag
    \end{align}
    This establishes the all-length algebraic decomposition of
    \cite[Appendix~C.2, lines~1435--1450]{Cirac2016MPDO_arXiv} under
    the displayed physical-sector factorization.
\end{theorem}
...
\begin{corollary}[SAL gives positive cyclic sector products]
    ...
    \begin{align}
        ...
        \notag
    \end{align}
    This establishes the projected-chain inequality of
...
\begin{theorem}[Gauge and support-coordinate independence of neighboring trace factorizations]
    ...
    \leanok
    \uses{def:gauge_equiv, def:mpdo_neighboring_trace_factorization, def:mpdo_physical_support_restriction}
...
\begin{proof}
    \leanok
    \uses{thm:mpdo_physical_sector_factorization_gauge, thm:mpdo_neighboring_trace_factorization_physical_basis_invariant}
...
The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Cyclic trace identity for rectangular powers'']{QICLean2026Blueprint}.
...
\begin{proof}
    \leanok
    \uses{def:mpdo_neighboring_trace_factorization, def:mpo_physical_trace_transfer, thm:mpdo_closed_sector_physical_trace_transfer, lem:mpdo_trace_loop_chain}
