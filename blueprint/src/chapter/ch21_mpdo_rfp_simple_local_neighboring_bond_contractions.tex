...
\begin{definition}[Inverse-map physical-sector factorization]
    ...
    Hayashi density matrices have trace one. This gives the factorization in
    \cite[Appendix~C.2, lines~1383--1387, 1434--1439]{Cirac2016MPDO_arXiv}.
\end{definition}
...
\begin{theorem}[Identification of the neighboring operators]
    ...
    \begin{align}
        ...
        \notag
    \end{align}
    This matches the definition of the neighboring operators in
    \cite[Appendix~C.2, lines~1441--1445]{Cirac2016MPDO_arXiv}.
\end{theorem}
...
\begin{corollary}[SAL gives a raw physical-sector factorization]
    ...
    factorization \cite[Lemma~C.4]{Cirac2016MPDO_arXiv}.
\end{corollary}
...
\begin{theorem}[Finite-chain decomposition of a physical-sector factorization]
    ...
    \begin{align}
        ...
        \notag
    \end{align}
    This is the all-length algebraic decomposition of
    \cite[Appendix~C.2, lines~1435--1450]{Cirac2016MPDO_arXiv} under the
...
\begin{corollary}[SAL gives positive cyclic sector products]
    ...
    \begin{align}
        ...
        \notag
    \end{align}
    This yields the projected-chain inequality of
...
\begin{figure}[ht]
    ...
    \caption{First each slice is conjugated by $U$ and expressed in the
        ...
        contractions, following the definitions in
