...
\begin{theorem}[Scalar centre forces a full matrix algebra of a definite size]
    ...
    **Scope restriction (single matrix block):**
    This formalizes the single building block of the structure theorem for
    finite-dimensional $C^*$-algebras \cite[Section~5]{SchumacherWerner2004QCA}
    for an algebra already presented inside a matrix algebra, rather than the
    abstract direct-sum decomposition into matrix blocks; documented in
    `docs/paper-gaps/sw04_csform_matrix_scope.tex` \cite{gap:sw04_csform_matrix_scope}.
\end{theorem}
