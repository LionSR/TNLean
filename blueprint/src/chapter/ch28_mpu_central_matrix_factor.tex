...
\begin{theorem}[Scalar centre forces a full matrix algebra of a definite size]
    ...
    This is the single-block case of the structure theorem for
    finite-dimensional $C^*$-algebras (Schumacher--Werner
    Proposition~\texttt{Csform} \cite[lines~2082--2098]{SchumacherWerner2004QCA})
    for an algebra presented inside a matrix algebra; see
