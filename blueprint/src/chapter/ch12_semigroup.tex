...
\begin{theorem}[Generators of completely positive semigroups]
...
\begin{theorem}[Conditionally completely positive generators]
...
\begin{theorem}[Complete positivity through the generator]
...
\begin{theorem}[Adjoint kernel and commutant]
...
\begin{theorem}[Faithful stationary states give equality]
...
\begin{theorem}[Rank-deficient fixed densities]
...
\begin{theorem}[Trivial commutant forbids triangular form]%
