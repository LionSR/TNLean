...
\begin{remark}[Status note]\notready
    The semigroup analogue of the irreducible/primitive equivalence is not yet
    fully developed in this chapter. The remaining gap is the passage from the
    qualitative spectral theory of a single time slice to a uniform statement
