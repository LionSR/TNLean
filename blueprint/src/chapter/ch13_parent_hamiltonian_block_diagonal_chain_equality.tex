...
\begin{lemma}[Matrix identities give equality in the finite range]
    ...
    \]
    the following boundary-crossing coordinate identities: for every
    boundary-crossing interval $i$, every word $\beta$ before the cut, and
    every outside word $\rho$ of length $N-L$,
    \[
