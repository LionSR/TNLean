...
comparison in the periodic ring. In the word-indexed versions below, $\beta$
labels the part of a boundary-crossing word before the cut and $\rho$ labels the
part after the cut; the source comparison is the matrix identity
\[
