...
% corollary remains unformalized under the source hypotheses. The direct
% corrected rank-one criteria thm:psd_trace_powers_rank_one_t and
% thm:pairing_idempotent_rank_one_t require respectively positive
% semidefiniteness or linear independence and do not establish this
% corollary. Documented in
...
% remains unformalized under the source hypotheses. The direct corrected
% rank-one criteria thm:psd_trace_powers_rank_one_t and
% thm:pairing_idempotent_rank_one_t require respectively positive
% semidefiniteness or linear independence and do not establish this
% proposition. Documented in
% docs/paper-gaps/cpgsv17_pf_rank_one.tex.
