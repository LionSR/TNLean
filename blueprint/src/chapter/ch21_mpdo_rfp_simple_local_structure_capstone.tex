...
\begin{theorem}[Neighboring positivity and trace factorization on the canonical
    ...
    \begin{align}
        ...
        \notag
    \end{align}
    These identities correspond to \cite[Theorem~4.9(iv), lines~864--889]{Cirac2016MPDO_arXiv};
    their transport through active physical support compression is documented in
