...
\begin{theorem}[Printed simple-MPDO implication chain]
    ...
    the channel pair belonging to one such factorization, and the closing proof
    of Proposition~C.15 first projects onto the orthogonal outer physical
    sectors before applying those pairs. Thus the remaining source step is the
