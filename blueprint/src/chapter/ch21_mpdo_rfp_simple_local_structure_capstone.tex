...
% This node records the algebraic package proved separately from the analytic
% and entropy conditions of the same example.
...
\begin{theorem}[BNT sector structure from SAL and ZCL (all-sector Case-II boundary)]
    ...
    idempotence, normalized fixed-representative simple canonical form, and
    biCF data. Its global weights are $(1/\sqrt2,1)$ and its first absorbed
    transfer radius is $1/2$. Therefore the printed assertion that absorption
