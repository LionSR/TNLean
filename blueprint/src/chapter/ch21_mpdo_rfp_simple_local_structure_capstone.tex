...
% and source-facing ZCL. Example 4.12's normalized RFP maps and full GSNNCH
...
\begin{theorem}[Printed mixed-state separation examples]
    ...
    remain unconstructed. The claimed exclusion from the full GSNNCH class
    also remains open; comparing parity at different chain lengths is
    insufficient because its commuting realization may depend on $N$.
\end{theorem}
...
\begin{theorem}[Scale-two transfer relation and the literal ZCL--RFP obstruction]
    ...
    RFP correction, but its trace-preserving completely positive maps remain
    unconstructed.
\end{theorem}
\begin{proof}\leanok
