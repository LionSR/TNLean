...
\begin{theorem}[Neighboring positivity and trace factorization on the canonical
    ...
    (\texttt{docs/paper-gaps/cpsv16_active_physical_support_compression.tex}).
\end{theorem}
...
\begin{remark}[Printed mixed-state separation examples]
    ...
    satisfies the two channel equations
    (Theorem~\ref{thm:cpsv_example412_normalized_rfp_maps}) without supplying
    the unit-weight convention, and both representatives lie outside the full
    GSNNCH class (Theorems~\ref{thm:cpsv_example412_not_gsnnch}
