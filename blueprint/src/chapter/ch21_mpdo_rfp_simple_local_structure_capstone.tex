...
\begin{theorem}[Algebraic Case-II data for the absorption example]
...
\begin{proof}
    ...
    \[
        \mathcal E_{A_0}=\mathcal E_{A_1}=\operatorname{id}_{\mathbb C}.
    \]
    ...
    \[
        ...
        \qquad \mathcal T_{\mathrm{phys}}(A_1)=1,
    \]
