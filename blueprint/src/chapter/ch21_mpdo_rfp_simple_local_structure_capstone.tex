...
% refute that theorem.
\begin{lemma}[Coefficient absorption need not preserve normality]
    \label{lem:mpdo_caseii_absorption_not_normal}
...
\begin{theorem}[Printed simple-MPDO implication chain]
    ...
    \uses{def:mpdo_simple_cf_tensor, def:mpdo_two_site_blocking,
        ...
        lem:mpdo_caseii_absorption_not_normal}
    ...
    Lemma~\ref{lem:mpdo_caseii_absorption_not_normal} shows that this
...
\begin{theorem}[BNT sector structure from SAL and ZCL (all-sector Case-II boundary)]
    ...
    $s$. Lemma~\ref{lem:mpdo_caseii_absorption_not_normal} gives global
