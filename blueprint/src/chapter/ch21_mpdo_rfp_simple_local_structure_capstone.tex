...
\begin{remark}[Printed simple-MPDO implication chain]
    ...
    assertion. Proposition~C.15 itself therefore remains a missing statement:
    its bare channel conclusion is neither proved nor refuted. These
    false-source and proof-path dispositions are documented in
