...
\begin{proof}
    ...
    \uses{def:cpsv_example410_corrected_tensor,
        thm:cpsv_example410_bond_distribution}
    The sixteen even-parity bond patterns define orthonormal Bell-network
    vectors.  The normalized state is the isometric image of the diagonal
    bond-pattern distribution.  Thus its nonzero roots are precisely the
    nonzero bond weights, and the remaining $4^4-2^4=240$ ambient directions
    together with the eight zero-weight patterns give $248$ zero roots.
\end{proof}
