...
% four-letter rank-one neighboring-trace obstruction below shows that the
% resulting local analytic properties do not alone imply a neighboring trace
% factorization.
...
\begin{theorem}[Prepared BNT decomposition for the rank-one neighboring-trace obstruction]
    ...
    % The source-context contradiction is tracked in GitHub issue #6775.
\end{theorem}
