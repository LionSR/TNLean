...
\begin{proof}\leanok
    \uses{thm:mpdo_equiv_reindex_cptp, lem:is_kraus_cptp_comp,
...
\begin{theorem}[Pair-preserving obstruction for the four-sector witness]
    ...
    \leanok
    \uses{thm:mpdo_pair_preserving_trace_obstruction,
      thm:mpdo_four_sector_witness_rfp,
      thm:mpdo_inverse_map_nonzero_rectangular_remainder,
      thm:mpdo_virtual_spanning_active_trace_counterexample}
...
\begin{theorem}[Normal BNT representatives, biCF, exact assembly, and
  nonnilpotence in the Case-II example]
    ...
    \leanok
    \uses{def:nt_cpsv, def:sector_bnt_cf,
        def:blockwise_product_word_span, rem:word_tuple_span_top,
...
\begin{theorem}[Coefficient absorption need not preserve normality]
    ...
    \uses{def:nt_cpsv, def:mpdo_common_sector_weight_absorption,
        ...
        def:mpdo_simple_cf_tensor, thm:mpdo_caseii_absorption_algebraic_data,
...
\begin{theorem}[Counterexample to the printed implication (iv)$\Rightarrow$(v)]
    ...
    \leanok
    \uses{def:mpdo_two_site_blocking, def:is_rfp_via_ts,
        def:mpdo_neighboring_trace_factorization, def:sector_bnt_cf}
...
\begin{theorem}[Printed simple-MPDO implication chain]
    ...
    \uses{def:mpdo_simple_cf_tensor, def:mpdo_two_site_blocking,
        ...
        thm:mpdo_theorem49_iv_to_v_counterexample}
...
\begin{proof}
    \leanok
    \uses{thm:mpdo_cyclic_edge_weight_tensor,
...
\begin{theorem}[Finite-marginal obstruction to source zero correlation length]
    ...
    \uses{def:mpo_source_zcl,
        ...
        thm:cpsv_example411_binary_block_probability,
...
\begin{proof}
    ...
    \uses{def:mpo_physical_trace_transfer,
        ...
        lem:mpdo_source_zcl_marginal_stability,
        thm:cpsv_example411_binary_support_normalization,
        thm:cpsv_example411_ambient_normalization,
...
\begin{proof}
    \leanok
    \uses{def:cpsv_example411_binary_internal_transition_count,
        thm:cpsv_example411_binary_block_probability}
...
\begin{theorem}[Four-cycle GSNNCH states are quantum Markov]
    ...
    \uses{def:mpdo_source_gsnnch,
        def:entropy_quantum_markov_decomposition,
...
\begin{proof}\leanok
    \uses{def:mpdo_source_gsnnch,
        def:entropy_quantum_markov_decomposition,
        thm:positive_commuting_overlapping_product_markov,
        thm:hayashi_ssa_equality_reverse}
...
\begin{theorem}[Example 4.12 is not GSNNCH]
    ...
    \uses{def:cpsv_example412_literal_tensor,
        thm:cpsv_example412_four_cycle_ssa_defect,
        thm:mpdo_gsnnch_four_cycle_markov}
...
\end{theorem}
\begin{proof}\leanok
    \uses{thm:cpsv_example412_four_cycle_ssa_defect,
        thm:mpdo_gsnnch_four_cycle_markov}
...
\begin{theorem}[Normalized channel fixed point in Example 4.12]
    ...
    \leanok
    \uses{def:cpsv_example412_literal_tensor, def:is_rfp_via_ts,
        thm:cpsv_example412_literal_formula}
    Let
    \begin{align}
        \widehat M&=\frac12 M.
...
\begin{theorem}[Physical sector structure of absorbed BNT representatives]
    ...
    \uses{def:mpdo_simple_cf_tensor, def:sector_bnt_cf,
        def:is_sal, def:mpo_physical_trace_transfer,
        def:mpdo_physical_sector_factorization,
