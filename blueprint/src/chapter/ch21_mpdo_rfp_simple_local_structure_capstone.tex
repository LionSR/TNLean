...
\begin{theorem}[Printed mixed-state separation examples]
    ...
    must concern a separate normalized representative, most likely $(1/2)M$.
\end{theorem}
...
\begin{theorem}[One-site loss and saturation]
    ...
    every proper normalized $L$-site reduced state is $2^{-L}I^{\otimes L}$.
...
\begin{theorem}[Scale-two ZCL and the literal RFP obstruction]
    ...
    condition.  The likely normalized representative $(1/2)M$ is a separate
    object.
\end{theorem}
\begin{proof}\leanok
