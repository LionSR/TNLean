...
\begin{theorem}[Normal BNT representatives, biCF, exact assembly, and
    ...
    \lean{MPOTensor.CaseIIAbsorptionCounterexample.basis_isNormalTensor,
        ...
        MPOTensor.CaseIIAbsorptionCounterexample.sectors_hasFiniteWordTraceSeparation,
...
\begin{theorem}[Ambient neighboring-trace counterexample properties]
    ...
    strictly positive trace at every positive length, satisfies the strong
    area law, and has literal zero correlation length,
    \begin{align}
        \mathcal T_K^2 & =\mathcal T_K.
        \notag
    \end{align}
