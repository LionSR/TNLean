...
% The all-sector normal Case-I coefficient theorem is complete. The remaining
% source step must show that every BNT tensor inherits MPDO positivity, SAL, and
% literal ZCL, then package the physical isometries, left--right tensors, and
...
\begin{theorem}[BNT sector structure from SAL and ZCL (all-sector Case-II boundary)]
    ...
    The all-sector normal Case-I coefficient conclusion of Lemma~C.5 is
    complete. The printed Case-II proof still needs to show that every BNT
    tensor inherits MPDO positivity, SAL, and literal ZCL, and then to package
    the resulting physical isometries, left--right tensors, and coefficients
    into the all-sector structure above. It remains to establish this Case-II
    passage.
\end{theorem}
