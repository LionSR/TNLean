...
\begin{theorem}[Printed simple-MPDO implication chain]
    ...
    not use absorbed-sector normality. Even after the per-BNT factorizations
    are obtained, their channel pairs must still be assembled through the
    mutually orthogonal outer physical supports. These are distinct missing
    steps. The absorbed-normality obstruction concerns the printed proof route
    and does not refute Theorem~4.9 itself.
\end{theorem}
