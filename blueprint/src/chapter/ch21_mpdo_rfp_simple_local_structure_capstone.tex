...
\begin{theorem}[Finite-marginal obstruction to source zero correlation length]
    ...
    its ambient realization has source zero correlation length.

    This conclusion concerns the nonzero up-to-scalar physical-trace relation
    used for the source-facing notion of zero correlation length.  It makes no
    assertion about the distinct legacy convention based on idempotence of the
    doubled-index transfer map.
\end{theorem}
