...
% its full GSNNCH exclusion remains open.
\begin{theorem}[Printed mixed-state separation examples]
    ...
    remains open; comparing parity at different chain lengths is insufficient
    because its commuting realization may depend on $N$.
\end{theorem}
