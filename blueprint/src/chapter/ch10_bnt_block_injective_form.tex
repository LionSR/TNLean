...
\begin{theorem}[Total dimension of the active BNT representatives]
    ...
    \leanok
    \uses{def:cpsv_canonical_form, thm:cpsv_canonical_form_active_bnt_refinement}
...
\begin{proof}
    \leanok
    \uses{thm:cpsv_canonical_form_active_bnt_refinement, thm:cpsv_active_bnt_dimension_bound, thm:cpsv_bnt_sharp_span_ambient_cap, thm:cpsv_bnt_blocked_simultaneous_span}
