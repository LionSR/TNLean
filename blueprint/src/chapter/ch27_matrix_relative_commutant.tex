...
\end{align}
which always contains the scalar matrices $\C\Id_q$.  This chapter shows
that equality in
...
at \cite[lines~1276--1286]{Gross2012IndexTheory} is not strict, because a
...
at \cite[lines~1306--1314]{Gross2012IndexTheory} is not strict, because
