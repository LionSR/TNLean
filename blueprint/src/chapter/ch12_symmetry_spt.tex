...
\begin{theorem}[One-dimensional symmetric gapped-phase classification]
    ...
    \notready
    \uses{def:is_same_spt_phase, def:h2_cx}
    Fix a unitary on-site representation of a group $G$.  In the injective MPS
    setting, equivalently for unique ground states of finite-range parent
    Hamiltonians after allowing finite blocking, changes of bond dimension by
    trivial ancillary sectors, and smooth deformations within the injective
    class, two tensors are connected by a symmetry-preserving uniformly
