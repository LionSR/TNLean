...
\begin{theorem}[Simultaneous representations of the blocked vertical operator]
    ...
    \cite[Appendix~C.4, lines~2011--2018]{Cirac2016MPDO_arXiv}, with the
    exponent $(m_\gamma/n_\gamma)^L$ as in
...
\begin{theorem}[Coverage of active product corners by the blocked BNT]
    ...
    \begin{align}
        ...
        \notag
    \end{align}
    The choices may be made simultaneously. Active product corner coverage
    and per-pair support are documented in
    \cite{gap:cpsv16_bnt_uniqueness_zero_coefficient, gap:cpsv16_figure11_per_pair_support}.
\end{theorem}
