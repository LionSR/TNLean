...
\begin{theorem}[Fusion coisometries from normalized product corners]
    ...
    \cite[Appendix~C.4, lines~2020--2029]{Cirac2016MPDO_arXiv}, retaining only
    active product corners \cite{gap:cpsv16_bnt_uniqueness_zero_coefficient},
    accounting for fixed-pair support \cite{gap:cpsv16_figure11_per_pair_support},
    and using coisometric fusion onto the active sum
    \cite{gap:cpsv16_figure11_fusion_coisometry}.
\end{theorem}
