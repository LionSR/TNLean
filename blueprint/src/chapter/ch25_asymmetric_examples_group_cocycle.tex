...
give one explicit cocycle in each cohomology class. This section states the
periodic construction for an arbitrary normalized three-cocycle and then
evaluates it for three groups.
...
Schuch~\cite[Section~IV.C]{GarreRubioSchuch2024DomainWall} write the
...
\begin{definition}[The cocycles of the cyclic groups]
    ...
    \lean{MPOTensor.GroupCocycle.cyclicCocycle,
        MPOTensor.GroupCocycle.rootOfUnity,
        MPOTensor.GroupCocycle.rootOfUnity_pow,
...
cocycle targeted in Section~\ref{sec:asymex_z2z2}. It is a standard
representative and is not taken
from~\cite{GarreRubio2023MPOSym,GarreRubioSchuch2024DomainWall}.

\begin{definition}[The mixed cocycle of type II]
    \label{def:asymex_group_cocycle_klein}
    \lean{MPOTensor.GroupCocycle.kleinCocycle,
...
\begin{theorem}[The instance for the group of order four]
    ...
    \lean{MPOTensor.GroupCocycle.kleinCocycle_isCocycle,
        MPOTensor.GroupCocycle.kleinCocycle_isNormalized,
        MPOTensor.GroupCocycle.kleinCocycle_norm,
