...
\begin{definition}[Algebra conditions for a vertical canonical decomposition]%
    ...
    tensors $M_\alpha$ form a basis of normal tensors of the vertical tensor and the conditions
...
\begin{proof}\leanok
    \uses{def:mpdo_virtual_perBlockLinearExtension, thm:linear_ext_mul, lem:perBlockLinearExtension_mul}
...
\begin{proof}\leanok
    \uses{thm:mpdo_virtual_perBlockLinearExtension_mul, thm:simplicity, lem:trace_ne_zero, lem:perBlockLinearExtension_bijective}
...
\begin{proof}\leanok
    \uses{thm:mpdo_virtual_perBlockLinearExtension_mul, thm:mpdo_virtual_perBlockLinearExtension_bijective, thm:positive_perBlockLinearExtension_unitary}
