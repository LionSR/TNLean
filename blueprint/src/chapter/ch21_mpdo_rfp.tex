...
precede the simple local and commuting structures. The boundary-theory
interlude begins with the homogeneous square-lattice PEPS tensor and the
project's local ket-bra doubled MPO convention. The transfer fixed point, the PEPS renormalization
relation, and the induced boundary channels remain to be constructed. The
general case and its algebraic characterization continue in
