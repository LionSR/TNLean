...
\begin{proof}\leanok
    ...
    left matrix unit at the next.  Their common finite index gives a positive
    virtual dimension, with one inactive state covering the empty physical
    space.  Contracting adjacent factors reconstructs every
