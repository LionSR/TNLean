...
\begin{proof}\leanok
    In the first translated bond, agreement outside its two-site window is
    equality of the third coordinate; in the second it is equality of the
    first coordinate.  Evaluating matrix entries gives the two tensor-product
    lifts.  Positivity gives Hermiticity.  Finally, transport the commutation
    of the two length-three translates through the common identification.
\end{proof}
