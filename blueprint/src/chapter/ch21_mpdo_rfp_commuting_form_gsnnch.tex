...
\begin{theorem}[Closed cyclic edge-weight identity]
    ...
    \]
    In the virtual trace there is precisely one nonzero cyclic virtual
    configuration.
\end{theorem}
...
\begin{definition}[Fixed tensor for a bond-product family]
    ...
    \[
        ...
        \qquad (N\geq2).
    \]
    A cyclic scalar edge-weight expression for the entries of the product
    gives such a tensor with virtual dimension $d^2$.
\end{definition}
