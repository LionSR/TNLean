...
\begin{remark}[Entropy-side construction]
    ...
    commutator cases are assembled into full pairwise commutativity in
    Theorem~\ref{thm:mpdo_physical_bond_translates_comm}. Only the all-length
    product identity in~(\ref{eq:mpdo_eta_product_form}) remains open.
