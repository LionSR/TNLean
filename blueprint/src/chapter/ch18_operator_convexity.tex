...
\begin{lemma}[Value of the Lieb integral]\label{lem:lieb_integral_value}
    ...
    \leanok
    \uses{lem:reflection_integral, lem:lieb_integrand_integrable}
...
\begin{proof}\leanok
    Apply the scaling substitution $t=(a/b)\,u$ to the integral and reduce to the
    reflection integral of Lemma~\ref{lem:reflection_integral}, collecting the
    factors $a^s b^{1-s}$.
\end{proof}
