...
\begin{proof}
    ...
    Inductively replace the residual letters before the final letter by the
    corresponding $B$ letters.  Expanding the final residual letter leaves
    two copies of the reduction identity, hence gives
    (\ref{eq:mps_reduction_residual_sandwich}).
\end{proof}
...
\begin{proof}
    \leanok
    Peel the residual letters successively, retaining the two exterior words.
    The reduction identity identifies the two terms created at the last
    residual letter.
\end{proof}
