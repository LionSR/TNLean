...
\begin{definition}[Residual nilpotency length]
    ...
    zero.  The residual nilpotency length
...
\begin{theorem}[Nilpotency of the selected-reduction residual algebra]
    ...
    algebra elements is zero, so $D_B$ is a residual-word nilpotency bound.
    Consequently the least bound $\ell(B,A;V,W)$ is itself a bound, and
    \begin{align}
        \ell(B,A;V,W) & \leq D_B.
