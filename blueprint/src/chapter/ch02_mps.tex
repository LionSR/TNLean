...
\begin{theorem}[Corrected strict-window residual expansion]
    ...
    printed in \cite{Molnar2018SemiInjective} is false: it introduces empty
    central words and omits the pure residual term.  Formula
...
\begin{theorem}[Residual trace vanishing and elementwise nilpotence]
    ...
    This is the nil-algebra step in the proof of Proposition~21 of
...
\begin{definition}[Exterior buffer length of a reduction]
    ...
    equation of \cite{FrancoRubio2025MPUGauging}, \texttt{main.tex} lines
    1409--1498, with exterior length $m\geq\ell$ and central length
    $|\mathbf c|=n+1$, $n\geq0$.
\end{definition}
...
\begin{theorem}[Common blocking of a finite family of reductions]
    ...
    This is the sentence in \cite{FrancoRubio2025MPUGauging} and in the
    footnote to Theorem~1 of \cite{GarreRubioSchuch2024DomainWall} that the
    nilpotency length can be reduced to $1$ by blocking.  The blocked
    residual letters need not vanish, and the blocked nilpotency length of
