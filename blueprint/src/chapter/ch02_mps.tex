...
\begin{remark}\leanok
    Unit gauge-phase equivalence imposes $|\zeta|=1$. Since such a phase is
    nonzero, unit gauge-phase equivalence implies gauge-phase equivalence. The
    general definition retains arbitrary nonzero block-scaling factors.
\end{remark}
