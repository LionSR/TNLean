...
This is the active, nonzero, converse-covered form of
\cite[Theorem~2.10]{Cirac2016MPDO_arXiv} and
\cite[Theorem~IV.4]{Cirac2021Matrix}.  The normalized, left-canonical BNT class
of Definition~\ref{def:sector_bnt_cf} excludes an unrelated normal
representative whose coefficient vanishes at every length.  The literal BNT
definitions in both references allow such a representative, so their
unrestricted cardinality conclusions require this additional
converse-coverage condition.
...
\begin{theorem}[Equal BNT canonical forms are globally conjugate]%
    ...
    This is the active, nonzero, converse-covered form of
    \cite[Corollary~2.11]{Cirac2016MPDO_arXiv} and
    \cite[Corollary~IV.5]{Cirac2021Matrix}.  The literal BNT definitions permit
    an unrelated normal representative with coefficient zero at every positive
    length.  In the equal case, inactive zero-weight summands can therefore
    change the ambient bond dimension while preserving every positive-length
    MPV.  The dimension equality and global conjugacy asserted here apply to
    the restricted BNT class of Definition~\ref{def:sector_bnt_cf}, not to the
    unrestricted literal definitions.
\end{theorem}
...
\begin{corollary}[Canonical Form II unitary refinement in the equal case]%
    ...
    \begin{align}
        ...
        \notag
    \end{align}
    This is the active, nonzero, converse-covered equal case of
    \cite[Corollary~A.6, lines~1197--1199]{Cirac2016MPDO_arXiv}.  The literal
    statement still permits inactive zero-weight summands and therefore does
    not determine the ambient bond dimension from positive-length MPVs.
\end{corollary}
