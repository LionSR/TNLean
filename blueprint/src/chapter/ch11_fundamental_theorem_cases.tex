...
\begin{theorem}[Multi-block fundamental theorem for normal tensors]%
    ...
    is nonzero. If the total tensors $P_{\mathrm{tot}}$,
...
% CPSV16 Corollary A.6 (`thm:Fundamental-CFII`), lines 1197--1199: the
% proportional part is this corollary and the equal part is
% cor:sector_bnt_equal_unitary_global_gauge below.
% Local fix (nonzero coefficients): docs/paper-gaps/cpsv16_bnt_uniqueness_zero_coefficient.tex and
...
\begin{corollary}[Canonical Form II unitary refinement of proportional matching]%
    ...
    Theorem~\ref{thm:cpgsv_multiblock_ft_source}, there exist a bijection
...
\begin{theorem}[Equal BNT canonical forms are globally conjugate]%
    ...
    positive number of copies and every copy weight is nonzero. Then their
    total bond dimensions coincide; writing the common value as~$D$, there is one
...
\begin{proof}\leanok
    ...
    which combine into the block-diagonal global gauge.
\end{proof}
...
\begin{corollary}[Canonical Form II unitary refinement in the equal case]%
    ...
    Definition~\ref{def:sector_bnt_cf}. Their total bond dimensions
