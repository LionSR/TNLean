...
\begin{proof}
    ...
    The standard finite-dimensional Wedderburn theorem in
    \cite[Proposition~1.5]{Wolf2012Quantum} supplies $U$ and the block form
    (\ref{eq:schwarz_star_algebra_blocks}). Conjugate by $U$ to identify the
    ambient space with
