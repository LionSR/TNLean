...
\begin{proof}
    \leanok
    \uses{thm:ring_perm, thm:dim_preserved, thm:component_map_bijective, thm:skolem_noether}
...
\begin{proof}\leanok
    \uses{lem:perBlockLinearExtension_mul, lem:perBlockLinearExtension_bijective, thm:unitary_skolem_noether_matrix}
