...
\begin{theorem}[Ring isomorphisms match block ideals]\label{thm:ring_perm}
    \lean{Matrix.exists_blockEquiv_of_ringEquiv_pi_simple}
    \lean{Matrix.ringEquiv_pi_simple_permutes_blockIdeals}
    \leanok
    \uses{def:block_ideal}
...
\begin{theorem}[Paired component maps are bijections]\label{thm:component_map_bijective}
    \lean{Matrix.mem_blockIdeal_iff}
    \lean{Matrix.pi_single_mem_blockIdeal}
    \lean{Matrix.blockComponentMap}
    \lean{Matrix.ringEquiv_maps_single_support_between}
    \lean{MPSTensor.ringEquiv_maps_single_support}
    \lean{Matrix.ringEquiv_symm_maps_blockIdeal_between}
    \lean{Matrix.blockComponentMap_injective}
    \lean{Matrix.blockComponentMap_surjective}
    \lean{Matrix.blockComponentMap_bijective}
