...
\begin{remark}[Relation to normal-MPS corollary]
    The theorem above establishes gauge equivalence for the blocked chains;
    recovering sitewise gauges for the original unblocked tensors is a separate
    unblocking step yielding the normal-MPS corollary of \cite{Molnar2018NormalPEPS}.
\end{remark}
