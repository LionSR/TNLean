...
\begin{proof}
    \leanok
    \uses{thm:linear_ext, thm:linear_ext_mul, thm:simplicity, lem:trace_ne_zero, lem:linear_map_to_alg, thm:skolem_noether}
    ...
    is a $\C$-algebra automorphism. Theorem~\ref{thm:skolem_noether} gives
