...
\begin{theorem}[Injectivity of the trace pairing map]\label{thm:trace_pairing_injective}
    ...
    \leanok
    \uses{def:trace_pairing_map, def:injective, thm:trace_nondeg}
    If $A$ is injective, then $\ker \Phi_A = \{0\}$.
\end{theorem}

\begin{proof}
    \leanok
    \uses{def:injective, thm:trace_nondeg, def:trace_pairing_map}
...
\begin{theorem}[Existence and uniqueness of the linear extension]\label{thm:linear_ext}
    ...
    \leanok
    \uses{def:injective, def:same_mpv, thm:trace_pairing_injective}
...
\begin{proof}
    \leanok
    \uses{thm:linear_ext, thm:trace_pairing_injective, lem:same_mpv_trace}
