...
\begin{proof}\leanok
    ...
    \begin{align}
        ...
        \notag
    \end{align}
    the corresponding theorem in the companion quantum-channel volume~\cite[``Rectangular Kraus freedom with general finite index types'']{QICLean2026Blueprint} then supplies the isometry $V$
