...
\begin{definition}[The second displayed circuit tuple]
    ...
    same action as $R^{\mathrm{CZX}}$ on the prescribed defect subspace. Since
    the other three defect domains and maps are not supplied, this does not
    place the two tuples in one fully defined four-sector completion class.
...
\begin{theorem}[Dimensions for the second displayed tuple at three and four sites]
    ...
    follows from them. They assert nothing about the physical completion class
    of the CZX defect data, since the three remaining defect domains and maps
    are not supplied, and they give no value for the minimum or the maximum of
    the dimension over completions. Compared with
