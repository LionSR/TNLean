...
\begin{theorem}[Unitarity at every bulk length]
    ...
    \end{align}
    This is the unitarity assertion following the truncated-symmetry
    diagram in \cite[lines~2062--2101]{FrancoRubio2025MPUGauging},
    between the displayed input and output spaces. Neither simplicity
    of the physical adjoint nor unitarity of supplied gates is assumed.
    The assertion does not identify each endpoint source space with a
    physical site, specialize to a finite-group family, prove agreement
    with a global symmetry on interior observables, or establish the
    complementary movement identity.
