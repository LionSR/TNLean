...
\subsection{The scalar class for $\Z_2$}
\label{sec:mpug_z2_scalar_class}
...
\begin{theorem}[Normalized $L$-symbol ratio]
    ...
    \cite[lines~5326--5329]{FrancoRubio2025MPUGauging}.
    % Source anchor: arXiv:2502.20257, lines 5326--5329.
\end{theorem}
...
\begin{theorem}[Trivial scalar gauge class for $\Z_2$]
    ...
    \end{align}
    This is the direct scalar gauge-class criterion underlying
    \cite[lines~5331--5341]{FrancoRubio2025MPUGauging}.
\end{theorem}
...
\begin{theorem}[Nontrivial scalar gauge class for $\Z_2$]
    ...
    \end{align}
    This is the scalar cohomology classification used in the proposition of
    \cite[lines~5336--5341]{FrancoRubio2025MPUGauging}.
    % Source anchor: arXiv:2502.20257, lines 5331--5341.
\end{theorem}
...
The tensor-diagram identity labeled \texttt{eq:sigmadiag} in the source,
including the identification
$T_sT_s^*=\sigma(s)\mathbf 1$, remains pending in parent issue~\#7357 and
depends on issues~\#7322, \#7323, and~\#7331. Consequently, the proposition
identifying the full MPU anomaly with the nontrivial time-reversal SPT class is
not formalized here.
