...
\end{theorem}
\begin{proof}\leanok
    \uses{ThmFund1, cor:mpug_staircase_gates_unitary,
        thm:mpug_truncated_symmetry_zero, thm:mpug_truncated_symmetry_left_growth,
        def:mpug_truncated_symmetry}
    Theorem~\ref{ThmFund1} gives unitary $u$, and
    Corollary~\ref{cor:mpug_staircase_gates_unitary} gives unitary $w_L$,
    ...
    they leave both endpoint coordinates unchanged. Tensoring unitary
    maps with identities, composing them, and reindexing preserve both
    Gram identities. The induction therefore covers every $N$, not just
