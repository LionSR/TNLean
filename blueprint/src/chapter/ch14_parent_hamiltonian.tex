...
\begin{proof}
    ...
    the left by $A^a$ in (\ref{eq:ph_common_middle_one_sided}):
    \[
...
\begin{proof}
    ...
    $\eta\le(1-\gamma)/m$ first weakens that estimate to the displayed one
    (\ref{eq:ph_finite_overlap_norm_compression}). The
