...
% Lean jargons to be eliminated: `restrictLastₗ`, `restrictFirstₗ`
...
\begin{proof}
  ...
  \begin{enumerate}
    ...
    \item Apply the decomposition map (one-sided inverse,
      Theorem~\ref{thm:one_sided_inverse}): summing over~$i$ with the
      decomposition coefficients of the identity yields
...
\begin{proof}
  ...
  \texttt{finrank\_eq\_one\_iff\_of\_nonzero'} in both directions.
\end{proof}
