...
\begin{proof}
    \notready
    Once Theorem~\ref{thm:friedrichs_gap_bound} is formalized without the remaining
    Friedrichs-angle blocker, this wrapper proof is immediate by taking $\gamma$ to be the
    explicit constant produced there.
\end{proof}
