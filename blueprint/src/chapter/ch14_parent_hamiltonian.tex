...
\begin{lemma}[Pair algebra projections are full]
    ...
    \lean{MPSTensor.algebra_adjoin_eq_top_of_isInjective}
    \lean{MPSTensor.subalgebra_prod_eq_top_of_axes}
    \lean{MPSTensor.matrixPairSubalgebra_eq_top_of_axes}
    \lean{MPSTensor.leftAxisIdeal}
    \lean{MPSTensor.rightAxisIdeal}
    ...
    \lean{MPSTensor.fstProjection_injective_of_rightAxisIdeal_eq_bot}
    \lean{MPSTensor.sndProjection_injective_of_leftAxisIdeal_eq_bot}
    \lean{MPSTensor.leftAxisIdealHetero}
    \lean{MPSTensor.rightAxisIdealHetero}
    \lean{MPSTensor.matrixPairSubalgebra_eq_top_of_leftAxisIdealHetero_eq_top}
    \lean{MPSTensor.matrixPairSubalgebra_eq_top_of_rightAxisIdealHetero_eq_top}
    \lean{MPSTensor.fstProjectionHetero_injective_of_rightAxisIdeal_eq_bot}
    \lean{MPSTensor.sndProjectionHetero_injective_of_leftAxisIdeal_eq_bot}
    \lean{MPSTensor.fstProjectionHetero_surjective_of_map_eq_top}
    \lean{MPSTensor.sndProjectionHetero_surjective_of_map_eq_top}
    \lean{MPSTensor.matrixAlgEquiv_dim_eq}
    \lean{MPSTensor.matrixPairSubalgebra_algEquiv_of_axisIdealsHetero_eq_bot}
    \lean{MPSTensor.fstProjection_surjective_of_map_eq_top}
    \lean{MPSTensor.sndProjection_surjective_of_map_eq_top}
