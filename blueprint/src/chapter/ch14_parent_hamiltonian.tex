...
\begin{definition}[Route B use of the product-word span condition]\label{def:route_b_product_word_span}
    ...
    span requirement in CPGSV21 \S IV.C: after blocking, the parent ground space
    is generated by the basis of normal tensors, with the improved bound coming
    from block-diagonal boundary conditions.
\end{definition}
