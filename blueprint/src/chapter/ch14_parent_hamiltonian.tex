...
\begin{lemma}[Conditional reduction to block-diagonal boundary conditions]
    ...
    boundary-condition step in \cite[lines~2126--2128]{Cirac2021Matrix}; the
    ground-space theorem below uses the conservative length range of
...
\begin{theorem}[Containment in the space generated by a basis of normal tensors]
    ...
    $A_1,\ldots,A_g$ a basis of normal tensors, and if $L_0$ is a common
    injectivity length for the blocks with
    \[
        L\ge 3(g-1)(L_0+1)+1,
        \qquad
        N\ge L+L_0,
...
\begin{proof}
    \notready
    The length hypotheses are the conservative range in
    ...
    block-diagonal re-growing step. In formulas, the remaining structural step
