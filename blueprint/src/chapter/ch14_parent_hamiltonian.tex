...
current Lean formalization instead uses the chain ground space
(Definition~\ref{def:chain_ground_space}); a bridge theorem equating
this with the Hamiltonian kernel is not yet stated explicitly here.
