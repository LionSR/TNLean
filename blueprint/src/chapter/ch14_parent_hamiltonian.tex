...
\begin{definition}[Ground-space map]\label{def:ground_space_map}
  ...
  indices $\sigma_1,\dots,\sigma_L$, and the lower box denotes the boundary
  matrix $X$ inserted on the virtual bond before taking the trace.
\end{definition}
...
\begin{definition}[Translated local term]\label{def:local_term_parent}
  ...
  projector acts, while the surrounding chain is left unchanged.
\end{definition}
