...
\begin{lemma}[Separation of the two-boundary edge contraction]
    ...
    \leanok
    \uses{def:mpdo_generic_eta_rank_one_trace_factorization, def:mpdo_right_partial_trace_map}
...
\begin{theorem}[$\eta$-local structure gives the one-sector GSNNCH form]
    ...
    \leanok
    \uses{thm:mpdo_eta_local_structure_has_commuting_bond_product, thm:mpdo_commuting_bond_product_has_gsnnch_form}
