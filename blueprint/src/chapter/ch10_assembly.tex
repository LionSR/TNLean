...
\begin{proof}\leanok\uses{thm:overlap_decay}
    ...
    (by the spectral gap).
    This is the ``primitive branch'' of the argument,
    where the overlap orthonormality hypotheses are
    assumed directly rather than derived from
    proportional MPVs with convergent coefficients.
\end{proof}
