...
\begin{proof}\leanok
    ...
    condition. Its all-zero matrix entry at $N=1$ is $1/2$, so the closed MPO
    family is nontrivial at a positive length. Choose the one-site blocking.
...
\begin{theorem}[Nonvanishing source simplicity of the rescaling-stable dimer]
    ...
    \uses{def:mpdo_nonvanishing_source_simple_tensor,
        thm:mpdo_bnt_label_rescaling_stable_source_simple,
        thm:mpdo_bnt_label_rescaling_stable_ismpdo}
