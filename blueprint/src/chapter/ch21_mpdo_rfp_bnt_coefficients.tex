...
\begin{definition}[Flag sectors of the twisted quantum dimer]%
    ...
    Write $\mu=\frac58$, the square root of the vertical spectral radius
    $\mu^2=(x^2+y^2)/2$ of each sector at $x=\frac78$, $y=\frac18$. The
    normalized sector $\widehat M_f=M_f/\mu$ has, at the bond pair
    $((p,p',k),(q,q',k'))$, the letter
    \begin{align}
    ...
    $(p,q)$ and whose column off the right bits $(p',q')$. Its entry between
...
\begin{lemma}[Closed operators of the flag sectors]%
    ...
    whose column off the right bits of the last letters, with the product of
