...
\begin{proof}\leanok
    \uses{thm:mpdo_bnt_label_rescaling_stable_nonvanishing_source_simple,
...
\begin{proof}\leanok
    \uses{thm:is_normal_tensor_of_is_normal_left_canonical,
        lem:mpo_doubled,
        thm:mpdo_bnt_label_rescaling_stable_length_dependence,
        thm:mpdo_bnt_label_rescaling_stable_chi_uniform}
...
\begin{theorem}[Uniform $\chi$-trace-power form of the explicit one-label
    ...
    \uses{def:mpdo_positive_bnt_label_chi_trace_power_form,
        lem:mpdo_positive_bnt_label_chi_eq_trace_matrix_pow,
        thm:mpdo_bnt_label_rescaling_stable_length_dependence,
        thm:mpdo_bnt_label_rescaling_stable_chi_attachment}
...
\begin{theorem}[Bare horizontal periodic equality does not determine vertical BNT coefficients]%
    ...
    \leanok
    \uses{def:mpdo, def:same_mpv2_pos,
        def:mpdo_vertical_coefficient_presentation_counterexample}
...
\begin{theorem}[Length independence is not preserved by bare horizontal periodic equality]%
    ...
    \leanok
    \uses{def:same_mpv2_pos, def:mpdo_bnt_label_length_independent,
        def:mpdo_vertical_coefficient_presentation_counterexample}
...
\end{theorem}
\begin{proof}\leanok
    \uses{thm:mpdo_vertical_coefficients_not_presentation_invariant}
