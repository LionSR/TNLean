...
\begin{proof}\leanok
    ...
    $\operatorname{tr}\sigma=C_{00}+C_{11}=1$.
...
\begin{proof}\leanok
    ...
    \begin{align}
        ...
        \notag
    \end{align}
    For every boundary matrix $A\in M_4(\mathbb C)$, the one-site
    closure has entries
    \begin{align}
        [Q_1(A)]_{(l,r),(l',r')} & =C_{ll'}A_{(r,r'),(l,l')}.
        \notag
    \end{align}
    ...
    \begin{align}
        [\mathcal T_Q(Q_1(A))]_{a,b}
         & =[Q_1(A)]_{(l,v),(l',v')}\sigma_{(r,u),(r',u')}
        \notag                                             \\
         & =\begin{cases}
                C_{ll'}C_{uu'}A_{(v,v'),(l,l')}
                  & \text{if } r=u \text{ and } r'=u', \\
                0 & \text{otherwise}
            \end{cases}
        \notag                                             \\
    ...
    Applying the retraction gives the coarse-graining equation.
\end{proof}
