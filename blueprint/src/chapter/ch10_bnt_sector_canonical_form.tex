...
\cite[Section~2]{Cirac2016MPDO_arXiv}, defined on a sector decomposition with
...
\begin{theorem}[Positive blocking preserves a basis of normal tensors]
    ...
    This transport statement is derived from the definitions; it is not a
    separately stated theorem of CPSV16.
\end{theorem}
...
\begin{theorem}[Sector BNT form of normalized CPSV canonical data]%
    ...
    \end{align}
    Thus the dimension is the total dimension of the blocks, not the
...
\begin{theorem}[Equal-ambient gauge equivalence for CPSV canonical forms]%
    ...
    \end{align}
    Unused ambient coordinates are allowed. The
