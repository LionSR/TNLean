...
\begin{figure}[ht]
    ...
    summands, and chooses orthogonal projectors $P_1$ and $P_2$.  The first
    two diagrams give the cross contractions
    $P_1{\cal K}P_2=P_2{\cal K}P_1=0$, while the corresponding two-site
    contraction in the last diagram also vanishes.  For
