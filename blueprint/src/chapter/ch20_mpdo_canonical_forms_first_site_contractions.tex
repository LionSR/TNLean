...
\begin{lemma}[Blockwise equality from agreement on the MPV family]
    ...
    Following \cite{gap:cpgsv17_bicf_block_separation}, the block-injective
    hypothesis separates blocks without grouping gauge-equivalent copies,
    specializing the source lemma to pairwise distinct blocks.
\end{lemma}
