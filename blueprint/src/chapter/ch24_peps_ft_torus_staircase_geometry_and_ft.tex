...
\begin{theorem}[Fundamental Theorem for normal PEPS on the torus]%
    ...
    \leanok
    \uses{thm:fundamentalTheorem_normalSquarePEPS, thm:peps_oneVertexComplementComparison, def:peps_torus_translation_invariant, thm:peps_torusUniformBondDim_of_translationInvariant, def:GaugeEquivPEPS}
