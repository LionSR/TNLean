...
\begin{lemma}[Separated normal canonical-form hypotheses produce a common phase cover]%
	...
	(per-length coefficient arrays with unit-modulus dominant blocks on each
	side and a per-length non-zero proportionality scalar) gives a common MPV phase cover
	of the two basis families.
