...
recorded as a formalization of Corollary~\texttt{II\_cor2}: it assumed common
weights, common block count, and common bond dimensions, while the source
theorem derives the matching data.  The general CPSV theorem still passes
