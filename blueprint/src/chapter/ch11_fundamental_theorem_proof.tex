...
\label{lem:proportional_tensor_from_blocks_weighted_states_at_length}
	...
	\leanok
	\uses{def:block_diagonal_tensor, def:mpv_state}
...
\label{lem:weighted_state_sequence_to_proportional_tensor_from_blocks}
	...
	\leanok
	\uses{def:nonzero_proportional_mpv, def:block_diagonal_tensor, def:mpv_state}
...
\label{lem:eventual_weighted_state_sequence_to_proportional_tensor_from_blocks}
	...
	\leanok
	\uses{def:eventually_nonzero_proportional_mpv, def:block_diagonal_tensor,
		def:mpv_state}
...
% retired: cpsv16_ft_paper_vs_code_structural_map 2026-05-13
% The former residual-span/CFLI coefficient-extraction helpers were removed here.
...
\label{lem:dominant_phase_adjusted_scalar_convergence}
	...
	\[
		...
		\longrightarrow 1 .
	\]
	This is the dominant phase-adjusted scalar convergence: only the leading
	projected scalar convergence is asserted; exact selected-summand equality
	for tail subtraction requires an additional argument.
...
% retired: cpsv16_ft_paper_vs_code_structural_map 2026-05-13
% The former phase-adjusted selected/tail asymptotic helpers were removed here.
...
% retired: cpsv16_ft_paper_vs_code_structural_map 2026-05-13
% The former combined projection-packaging helper was removed here.
...
% retired: cpsv16_ft_paper_vs_code_structural_map 2026-05-13
% The former dominant-partner and leading-tail peel hooks were removed here.
...
% retired: cpsv16_ft_paper_vs_code_structural_map 2026-05-13
% The former leading-only wrappers and no-tail singleton base cases were removed here.
