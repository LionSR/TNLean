...
\begin{proof}\leanok
	...
	overlap dichotomy and the equal-MPV lemma.  Their composition would make
	two distinct BNT blocks in the same family have a non-decaying mutual
	overlap, contradicting BNT block separation.
\end{proof}
