...
\label{lem:proportional_tensor_from_blocks_adjusted_weighted_inner_sequence}
	...
	For proportional assembled BNT tensors, one may choose a nonzero scalar
	sequence \(c_N\) such that the normalized weighted projections are related
	by the adjusted scalar \(c_N(\nu/\mu)^N\).
\end{lemma}
