...
\cite[Corollary~\texttt{II\_cor2}, lines~1173--1199]{Cirac2016MPDO_arXiv}.
In the proof, this corollary is obtained by matching the BNT blocks and then
comparing the sector-weight power sums.
...
\begin{lemma}[Common-block equal-MPV comparison]\label{lem:ft_equal_same_structure}
	...
	This is the one-copy-per-sector, common-block specialization of
	CPSV16 Corollary~\texttt{II\_cor2}; the source corollary derives the
	block matching and multiplicities instead of assuming them
	\cite[Corollary~\texttt{II\_cor2}, lines~1173--1199]{Cirac2016MPDO_arXiv}.
\end{lemma}
