...
the block-diagonal MPV families.  The former common-structure wrapper is not
...
\begin{lemma}[Separated normal canonical-form hypotheses produce a common phase cover]%
	...
	(per-length coefficient arrays with unit-modulus dominant block and
	per-length non-zero proportionality scalar) gives a common MPV phase cover
