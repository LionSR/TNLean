...
\label{lem:common_phase_cover_of_separated_normal_bnt}
	...
	\textbf{Unfaithful:} This lemma is stated and callable, but its proof inherits
	two admitted sub-lemmas from
	\texttt{fundamentalTheorem\_of\_separated\_normalCFBNT\_data} in
	\texttt{NonzeroOverlap.lean}.  See \texttt{docs/paper-gaps/cpsv16\_cf\_normalization\_and\_proportional\_comparison.tex}
	and issue \#1559.
\end{lemma}
