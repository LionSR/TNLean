...
\begin{definition}[Periodic-sector projector]
    ...
    Let $M$ be an MPO tensor and let $p\ge 1$.  A \emph{periodic-sector
    projector} for $M$ with exponent $p$ is an orthogonal projector $Q$ on
...
\begin{theorem}[No periodic-sector projector for a matrix product density
    ...
    Let $M$ generate matrix product density operators.  Then for no $p\ge 1$
    does $M$ admit a periodic-sector projector with exponent $p$.
\end{theorem}
