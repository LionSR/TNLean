...
\begin{proof}
    ...
    a length-$p$ word.  The invariance statement follows by checking the two
    one-site actions letter by letter.
\end{proof}

\begin{theorem}[Invariant non-commuting projectors are periodic-sector
    projectors]
    \label{thm:mpdo_periodic_sector_projector_of_cyclic}
...
\begin{proof}
    \leanok
    \uses{thm:mpdo_periodic_sector_projector_of_cyclic,
    ...
    Theorem~\ref{thm:mpdo_periodic_sector_projector_of_cyclic}.  The
