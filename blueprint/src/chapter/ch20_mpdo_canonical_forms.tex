...
\begin{theorem}[Blockwise reduction from first-site contractions]
    ...
    gauge-equivalent repeated blocks are excluded. Documented in
    \path{docs/paper-gaps/cpgsv17_bicf_block_separation.tex}.
\end{theorem}
...
\begin{theorem}[Blockwise reduction for the MPO contractions]
    ...
    \textbf{Scope restriction (per-block separation).} Inherited from
    Theorem~\ref{thm:blockwise_opposite_insert_eq}; decompositions with
    gauge-equivalent repeated blocks are excluded
    (\path{docs/paper-gaps/cpgsv17_bicf_block_separation.tex}).
\end{theorem}
