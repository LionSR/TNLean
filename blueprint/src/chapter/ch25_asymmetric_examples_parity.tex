...
$\Z_2$ symmetry reflected on the virtual bond space. The matrix $P$ selects virtual
...
This establishes word normality by spanning the full virtual matrix algebra
$\MN{2}$.
