...
\begin{lemma}[Trace adjointness of a Kraus map]
...
\begin{lemma}[Trace adjointness of a transfer map]
    \label{lem:trace_mul_transfer_map_adjoint_mps}
    \lean{trace_mul_transferMap_adjoint}
    \leanok
    \uses{def:transfer_map, lem:trace_mul_transfer_map_adjoint}
    The trace-adjoint identity of Lemma~\ref{lem:trace_mul_transfer_map_adjoint}
