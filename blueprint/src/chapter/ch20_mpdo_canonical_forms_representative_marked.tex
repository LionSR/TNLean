...
\begin{theorem}[Original-coordinate marked Lemma L]
    ...
    Thus the separation conclusion does not require the marked trace identity
    for the empty tail word. This is the positive-tail form of the argument in
    \cite[Appendix~C.3, lines~1835--1858]{Cirac2016MPDO_arXiv}: the source
    assumes first-site agreement at every positive system size, while its
    proof separates the representatives at a suitable nonzero tail length.
\end{theorem}
