...
\begin{theorem}[Full-coordinate marked trace bridge]
    \label{thm:cpsv_full_coordinate_marked_trace_bridge}
    ...
    \begin{align}
        ...
        \label{eq:cpsv_full_coordinate_marked_trace_bridge}
    \end{align}
...
\begin{proof}\leanok
    ...
    (\ref{eq:cpsv_full_coordinate_marked_trace_bridge}).
\end{proof}
...
\begin{theorem}[Retained-coordinate representative-grouped Lemma L]
    ...
    \leanok
    \uses{thm:cpsv_full_coordinate_marked_trace_bridge,
        thm:cpsv_active_representative_sector_decomposition,
...
\begin{proof}\leanok
    \uses{thm:cpsv_full_coordinate_marked_trace_bridge,
        ...
        thm:representative_grouped_marked_separation,
        thm:representative_grouped_insert_eq}
    Theorem~\ref{thm:cpsv_full_coordinate_marked_trace_bridge} changes
