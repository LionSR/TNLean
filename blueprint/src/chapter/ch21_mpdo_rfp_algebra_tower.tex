...
\begin{remark}[Why the algebra tower does not imply doubled-index ZCL]%
    ...
    the corresponding theorem in the companion quantum-channel volume~\cite[``Newton--Girard trace recursion'']{QICLean2026Blueprint}. To obtain the trace-power conclusion of
