...
\begin{definition}[Translated edge windows]%
    ...
    corresponding \(7\times7\) examples are recorded explicitly.  This records
    the remaining boundary geometry in the formal route; it is not a
    contradiction of the source theorem.
\end{definition}
