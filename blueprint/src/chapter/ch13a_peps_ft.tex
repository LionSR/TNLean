...
\begin{lemma}[The present local \(T\)-window and \(A_3\) cover obstructions]%
    ...
    \(5\times7\) case is again recorded as a corollary.  The normalized
    vertical edge-complement model has the corresponding \(7\times5\)
    obstruction.
\end{lemma}
...
\begin{proof}\leanok
    ...
    normalized vertical edge-complement statement.
\end{proof}
