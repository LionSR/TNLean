...
\begin{theorem}[Construction from translated edge windows]%
    ...
    normal edge-blocking hypotheses.  This is the conditional construction;
...
\begin{definition}[Normal square-lattice blocking regions]%
    ...
    displayed \(T\)-region, together with \(n,m\geq7\), give this abstract
    \(R,S,T\) structure, with \(R\)
