...
\end{lemma}
\begin{proof}\leanok
    This is the union lemma~\ref{lem:peps_injectiveRegion_union} in the case
    ...
    the edge-centred union lemma~\ref{lem:peps_injectiveRegion_union_edgeBlocked}
...
\begin{lemma}[Union of two injective regions with positive bonds]%
    ...
    This is the union lemma~\ref{lem:peps_injectiveRegion_union} with the explicit
...
\begin{proof}\leanok
    ...
    of the remaining blocks, so the disjoint union
