...
\end{theorem}
\begin{proof}\leanok
    The complement is a contraction of vertex-injective tensors over
    $V\setminus\{v\}$.  Positivity of the virtual bond dimensions prevents
    empty interior virtual spaces, and the one-point external boundary only
    reindexes the resulting linearly independent family.
\end{proof}
