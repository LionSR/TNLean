...
\begin{lemma}[Union of injective regions]%
    ...
    \end{center}
    The graphical proof proceeds by applying injectivity of $A$, reinserting
    the tensor over $A\cap B$, and then applying injectivity of $B$:
    \begin{center}
...
\begin{definition}[Normal edge-blocking hypotheses]%
    ...
    hypotheses are the uniform version of this datum for every edge.  The local
    blocking picture used in the proof of
    \cite[Theorem~3]{Molnar2018NormalPEPS}:
    \begin{center}
