...
\end{theorem}
\begin{proof}\leanok
    The forward transfer is additive, homogeneous, and has the declared
    multiplicative and unital properties. The backward transfer is its inverse
    because the two coefficient identities and
    Theorem~\ref{thm:peps_regionInsertedCoeff_injective} identify the inserted
    matrices. Hence the forward transfer is a $\C$-algebra isomorphism and has
    the displayed coefficient property.
\end{proof}
