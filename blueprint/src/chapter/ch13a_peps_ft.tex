...
\begin{definition}[Translated edge windows]%
    ...
    package does not apply to a left-boundary horizontal edge or a
    bottom-boundary vertical edge of the \(7\times7\) lattice.  This records
...
\begin{theorem}[Assembly from translated edge windows]%
    ...
    injective regions at every edge.
\end{theorem}
\begin{proof}\leanok
