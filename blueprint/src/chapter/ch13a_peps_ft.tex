...
\begin{definition}[Translated edge windows]%
    ...
    package does not apply to left-boundary horizontal edges or bottom-boundary
    vertical edges; the corresponding \(7\times7\) examples are recorded
    explicitly.  This records the remaining boundary geometry in the formal
