...
\begin{definition}[Translated edge windows]%
    ...
    every edge.  The margin-cover package stores these named predicates, so
    such data force the corresponding horizontal and vertical margin
    inequalities.  In the present open rectangular coordinate model, this
    margin package does not apply to
