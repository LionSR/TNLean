...
\begin{lemma}[Translated horizontal edge-blocking data]%
    ...
    complementary injectivity.  At coordinate origin \(0,0\), the translated
    edge and the three translated regions specialize to the normalized
    horizontal picture.
\end{lemma}
\begin{proof}\leanok
...
\begin{lemma}[Translated vertical edge-blocking data]%
    ...
    rectangular cover, rectangular injectivity and union closure supply that
    complementary injectivity.  At coordinate origin \(0,0\), the translated
    edge and the three translated regions specialize to the normalized vertical
    picture.
\end{lemma}
\begin{proof}\leanok
