...
\begin{definition}[Square-lattice coordinate regions]%
    ...
    both.  Since edges are represented by ordered endpoint pairs, a horizontal
    edge is oriented from left to right and a vertical edge from bottom to top.
...
\begin{lemma}[Translated horizontal edge-blocking data]%
    ...
    injective regions used in the edge-blocked chain.  At coordinate origin
    \(0,0\), the translated edge and the three translated regions specialize
    to the normalized horizontal picture.
\end{lemma}
\begin{proof}\leanok
...
\begin{lemma}[Translated vertical edge-blocking data]%
    ...
    injective regions used in the edge-blocked chain.  At coordinate origin
    \(0,0\), the translated edge and the three translated regions specialize
    to the normalized vertical picture.
\end{lemma}
\begin{proof}\leanok
...
\begin{definition}[Translated edge windows]%
    ...
    used in the edge-blocked chain.
\end{definition}
