...
\begin{definition}[Translated edge windows]%
    ...
    inequalities needed to place these two translated frames.  On coordinate
    right and upward edges, margin-cover data force the corresponding
    horizontal and vertical margin inequalities.  In the present open
    rectangular coordinate model, this margin package does not apply to
