...
\begin{definition}[Translated edge windows]%
    ...
    corresponding window constructors that take these predicates directly.  On
    coordinate right and upward edges, the margin-cover package stores these
    named predicates, so such data force the corresponding horizontal and
    vertical margin inequalities.  In the present open rectangular coordinate
    model, this margin package does not apply to
...
\begin{theorem}[Assembly from translated edge windows]%
    ...
    separate.  Equivalently, it is enough to supply the oriented
