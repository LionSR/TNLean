...
\begin{proof}\leanok
    ...
    $L=p+(g-1)3(p+1)$. Conjugation by the Perron gauges preserves this span.
    Finally, a one-letter evaluation of $A_j^{[L]}$ is precisely a length-$L$
    word evaluation of $A_j$.
\end{proof}
