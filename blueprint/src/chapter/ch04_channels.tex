...
bi-canonical (unital + TP) case; the general MPS situation is handled in
...
\begin{lemma}[Peripheral eigenvalues closed under powers]\label{lem:peripheral_closed_powers_irred_ds}
    \lean{peripheralEigenvalues_pow_mem_of_irreducible_biCanonical}
    \leanok
...
\begin{theorem}[Roots of unity for irreducible bi-canonical (unital + TP) maps]%
    \label{thm:peripheral_roots_of_unity_irred_ds}
    \lean{peripheral_isRootOfUnity_of_irreducible_biCanonical}
    \leanok
    \uses{def:unital_kraus, def:tp_kraus, def:irreducible_cp,
...
The bi-canonical (unital + TP) hypothesis in
Lemma~\ref{lem:peripheral_closed_powers_irred_ds}
...
\begin{remark}\label{rem:adjoint_fp_more_general}\leanok
    ...
    the bi-canonical (unital + TP) condition implies
