...
\begin{proof}\leanok
    The involution on complex matrices is conjugate transpose:
    \[
        P^* = P^\dagger.
    \]
    Hence the two formulations have the same self-adjointness equation and the
    same idempotence equation.
\end{proof}
...
\begin{proof}\leanok
    ...
    $\MN{D}$. From $P^\dagger=P$ and $P^2=P$ one checks
    \[
