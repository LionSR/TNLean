...
$\mathrm{SL}(2,\mathbb{C})$ filtering operations. The SVD normal form is proved
below. The Lorentz normal form theorem
(Theorem~\ref{thm:lorentz_normal_form_qubit}) requires a compactness /
minimisation argument over $\mathrm{SL}(2,\mathbb{C})$ filterings
from \cite[Propositions~2.9 and~2.11]{Wolf2012Quantum};
see \S\ref{subsec:lorentz_normal_form}.
