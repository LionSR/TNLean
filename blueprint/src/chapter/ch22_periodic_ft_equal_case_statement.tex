...
\begin{theorem}[Equal-case coefficient extraction]%
    ...
    \leanok
    \uses{def:same_mpv2, def:periodic_tensor, lem:paper_decomp_formula,
    ...
    $A_j$ periodic of period $m_j$. If $\mc{V}(A)=\mc{V}(B)$ at every positive
    length, then there is an $N_0$ such that
    \begin{align}
        \tr\bigl(R_j^{N}\bigr)
