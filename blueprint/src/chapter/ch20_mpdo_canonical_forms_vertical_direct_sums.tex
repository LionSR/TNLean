...
\begin{proof}[Proof outline]
    ...
    Self-adjointness of the sector compressions gives the marked-chain
    identity used in the proof of Proposition~4.13. The full-coordinate trace
    identity of Theorem~\ref{thm:cpsv_full_coordinate_marked_trace_identity},
    the marked form of
    Theorem~\ref{thm:cpsv_retained_representative_grouped_lemma_l}, and the
    original-coordinate marked Lemma~L identify the corresponding marks on the
    original bond space. The remaining physical Figure-8 argument must turn
    these marked identities into the local Gram-conjugation identity
    \begin{align}
...
% inserted-tensor equality, and invariant-projector closure are complete. The
% physical Figure-8/Gram argument and final coisometric grouping remain open.
