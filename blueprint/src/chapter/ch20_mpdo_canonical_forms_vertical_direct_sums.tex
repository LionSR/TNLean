...
\begin{proof}
    \leanok
    \uses{def:horizontal_cf_mpdo, def:vertical_tensor_mpdo, lem:sector_bnt_weight_unit_exists_of_struct}
...
% independent wrappers over the shared grouped-sector BNT and coisometry results.
