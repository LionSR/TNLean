...
\begin{proof}[Proof outline]
    ...
    $(\alpha,k)$. At some length its compression must be nonzero and positive
    semidefinite, and its trace must have the form
    \begin{align}
...
% exclusion, the normal vertical block decomposition, and the conditional pairwise
% Figure-8/Gram identities are complete. Vertical representative grouping,
