...
\begin{definition}[Multiplicity spaces for a fixed final label]%
    ...
    $F$ in~\cite[Section~3.4]{Bultinck2017Anyons}; no equality with the fusion
    multiplicities of that source is asserted. The corresponding spaces for a
    fixed final label are $\mathcal H^{\mathrm L}_{\varepsilon}\otimes\C^{D_\varepsilon}$
