...
\begin{proof}
    \leanok
    \uses{lem:parent_hamiltonian_cyclic_window_ordered_cross_term_gap, rem:projection_geometry_rowsum_identities}
...
\begin{lemma}[Parent-Hamiltonian gap from a cyclic overlap compression constant]
    ...
    This all-vector compression form provides a sufficient condition for
    the anticommutator martingale estimate in
...
\begin{lemma}[Parent-Hamiltonian gap from a cyclic operator-product norm constant]
    ...
    This symmetric (operator-product) counterpart of
    Lemma~\ref{lem:parent_hamiltonian_cyclic_overlap_norm_constant_gap} uses
    the anticommutator conversion of
    Remark~\ref{rem:projection_geometry_rowsum_identities}; see
