...
\begin{proof}\leanok
    ...
    (\ref{eq:channel_positive_mean_ergodic}). Its positivity,
...
\begin{proof}\leanok\uses{thm:ks_gap_decomp_channels}
    By (\ref{eq:channel_ks_gap}), the Kadison--Schwarz gap is a sum of
    positive semidefinite terms $\sum_iR_i^\dagger R_i$. If the gap
