...
\begin{proof}\leanok
    \uses{thm:transfer_peripheral_cyclic_structure, thm:cyclic_decomposition_irreducible_schwarz, thm:adjoint_fixed_projection_block_decomp_isometry}
...
\begin{proof}\leanok
    \uses{thm:transfer_peripheral_cyclic_structure, thm:cyclic_sector_decomp_after_blocking, thm:blocked_sector_unconditional}
