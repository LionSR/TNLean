...
\begin{theorem}[The dimer RFP has length-dependent coefficients in its chosen vertical BNT decomposition]%
    ...
    Theorem~4.14 of \cite{Cirac2016MPDO_arXiv} without requiring the source
    normalization that every canonical weight has modulus at most one with at
    least one weight reaching one.
