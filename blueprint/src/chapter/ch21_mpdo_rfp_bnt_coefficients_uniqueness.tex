...
\begin{theorem}[The dimer RFP has length-dependent coefficients in its chosen vertical BNT decomposition]%
    ...
    \begin{align}
        ...
        \notag
    \end{align}
    This provides an example addressing the question following
    \cite[Theorem~4.14]{Cirac2016MPDO_arXiv} for this chosen decomposition
    without the unit-modulus weight normalization
    \cite{gap:cpsv16_unit_weight_rfp_scale_tension}.
\end{theorem}
