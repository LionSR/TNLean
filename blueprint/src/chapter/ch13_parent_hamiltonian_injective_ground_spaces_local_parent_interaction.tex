...
weighted spectral radius of the transfer remainder. In particular, the
geometric estimate is available for every source-admissible rate
$0<\lambda<1$, with a positive rate-dependent prefactor.
