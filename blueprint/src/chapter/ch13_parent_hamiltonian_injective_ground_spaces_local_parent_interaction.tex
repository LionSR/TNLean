...
of Lemma~6.2.
% The final common-subspace projector geometry belongs to issue #7601. No inverse or finite Gram
matrix, pseudoinverse, periodic coercivity, comparison of unequal kernels,
cyclic replacement, dimension prefactor, identity $a_-(m)=1-a(m)$,
identification $k=D$, or claim $C_\lambda=k^2$ enters these results.
