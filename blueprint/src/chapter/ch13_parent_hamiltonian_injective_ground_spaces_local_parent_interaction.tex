...
The passage from these boundary estimates to the overlapping-projector bound
of Lemma~6.2 in Ref.~\cite{Fannes1992Finitely} requires the lower boundary
constant $a_-(m)$ from Lemma~5.3. The two additional contributions are
$a(m)/a_-(m)$ and $a(m)^2/a_-(m)$, whose sum is
$a(m)(1+a(m))/a_-(m)$.
