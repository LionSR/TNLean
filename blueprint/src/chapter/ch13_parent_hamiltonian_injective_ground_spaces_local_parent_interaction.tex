...
% These identities compare the transfer-map conventions without invoking
% the weighted decay estimate of FNW Lemma 5.2.
...
% The theorem does not identify C_lambda with k^2 or k with D.
...
% Source: FNW 1992, Equations (5.8)-(5.9) and right-boundary recursion for Lemma 5.3.
...
% Lower-boundary assertions of FNW 1992, Lemma 5.3.
...
lower-boundary inequality $1-a(m)\leq a_-(m)$, and the decay bound
$a(m)\leq c\lambda^m$, where $\lambda$ lies strictly between the weighted
spectral radius of the transfer remainder and
one~\cite{gap:cpgsv21_martingale_overlap}.
