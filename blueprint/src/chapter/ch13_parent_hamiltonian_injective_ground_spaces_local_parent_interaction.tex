...
\begin{proof}
    ...
    The reassociated tail boundary map with a one-site suffix is the tail
    boundary map on $l+1$ sites, whose range is the open-chain tail ground
    space; the left boundary map with a one-site interval has the open-chain
    left ground space as its range.  Substituting $\ell=1$ in the geometric
    estimate gives the display.
\end{proof}
