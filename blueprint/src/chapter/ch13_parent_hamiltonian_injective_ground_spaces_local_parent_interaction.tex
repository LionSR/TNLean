...
Nachtergaele imports the projector estimate of the previous section in the
rational geometric form
\begin{align}
    \left\lVert
...
\cite[Equation~(6.1)]{Nachtergaele1996Spectral}.  The results below derive
this bound from the FNW coefficient $a(m)(1+a(m))/a_-(m)$, the
lower-boundary inequality $1-a(m)\leq a_-(m)$, and the prescribed-rate estimate
$a(m)\leq c\lambda^m$.
