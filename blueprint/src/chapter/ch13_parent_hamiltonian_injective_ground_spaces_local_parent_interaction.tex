...
The linear estimate remains separate from the aggregate contribution below.
...
No inverse or finite Gram matrix, pseudoinverse, periodic coercivity,
comparison of unequal kernels, cyclic replacement, dimension prefactor,
identity $a_-(m)=1-a(m)$, identification $k=D$, or claim
$C_\lambda=k^2$ enters these results.
...
existential rate-dependent one.  Both deviations are recorded in
...
\begin{theorem}[Geometric FNW projector defect for a primitive tensor]
    ...
    \leanok
    \uses{def:primitive_mps, def:l_blk_injective,
        thm:fnw_projector_defect_geometric, thm:fnw_mixing_quantity_geometric,
