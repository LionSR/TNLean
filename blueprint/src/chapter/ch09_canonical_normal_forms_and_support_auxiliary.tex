...
\begin{theorem}[Spectral cyclic sectors with support isometries]%
    ...
    \begin{proof}\leanok
        \uses{thm:cyclic_decomposition_irreducible_schwarz, thm:adjoint_fixed_projection_block_decomp_isometry}
        Theorem~\ref{thm:cyclic_decomposition_irreducible_schwarz}, applied to
