...
\begin{theorem}[Classical estimate for normalized diagonal cut coefficients]
    ...
    \leanok
    \uses{thm:mpo_diagonal_cut_rank, thm:classical_mutual_information_le_log_rank, thm:matrix_rank_scalar_extension}
...
\begin{proof}\leanok
    ...
    Theorem~\cite[``Faithful compression onto the support'']{QICLean2026Blueprint}.
\end{proof}
...
\begin{proof}\leanok
    ...
    Theorems~\cite[``Logarithm of a tensor product on its support'']{QICLean2026Blueprint},
...
\begin{proof}\leanok
    ...
    Theorem~\cite[``Faithful compression onto the support'']{QICLean2026Blueprint}, while
...
\begin{proof}\leanok
    Apply the corresponding lemma in the companion quantum-channel volume~\cite[``Functional calculus under unitary conjugation'']{QICLean2026Blueprint} to the function $x\mapsto x^s$.
\end{proof}
...
\begin{proof}\leanok
    Apply
    the corresponding theorem in the companion quantum-channel volume~\cite[``Multiplicative functional calculus on positive tensor products'']{QICLean2026Blueprint} to
...
\begin{proof}\leanok
    ...
    finite coordinate set. The corresponding lemma in the companion quantum-channel volume~\cite[``Reindexing invariance of the quantum relative entropy'']{QICLean2026Blueprint} and
    ...
    The corresponding theorem in the companion quantum-channel volume~\cite[``Relative entropy against the product of the marginals'']{QICLean2026Blueprint} identifies its left
...
\begin{proof}\leanok
    \uses{def:mpdo_split_normalized_mpo, lem:mpdo_chain_mutual_information_bipartition, thm:mpdo_periodic_cut_operator_schmidt_rank, thm:mutual_information_le_log_operator_schmidt_rank, thm:operator_schmidt_rank_pos}
