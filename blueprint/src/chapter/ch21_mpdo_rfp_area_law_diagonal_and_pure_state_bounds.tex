...
\begin{proof}\leanok
    ...
    $\rank_{\R}P\leq D^2$.
    Theorem~\cite[``Classical mutual information is bounded by ordinary rank'']{QICLean2026Blueprint} gives
...
\begin{theorem}[Two virtual boundaries bound the operator-Schmidt rank]
    ...
    This is the two-virtual-boundary algebraic step for the
...
the Umegaki endpoint.  The statements below concern this algebraic expression in the regime
$1<\alpha\leq2$.
...
\begin{theorem}[Finite-chain mutual information from the operator bond]
    ...
    \begin{align}
        ...
        \notag
    \end{align}
    No global positivity, local purification, canonical form, or separate
    positive-bond-dimension hypothesis is required. The cuts $L=0$ and $L=N$
    are included.
\end{theorem}
...
\begin{theorem}[Finite-chain mutual-information estimate for matrix product density operators]
    ...
    \begin{align}
        ...
        \notag
    \end{align}
    This is the finite-chain estimate invoked in the proof of
    Proposition~4.5 of \cite{Cirac2016MPDO_arXiv}. The nonzero-trace hypothesis
    states explicitly the normalization convention preceding that proposition.
\end{theorem}
...
\begin{remark}[Boundedness of the mutual information]
    ...
    By Theorem~\cite[``Coefficient-space characterization of operator-Schmidt rank'']{QICLean2026Blueprint}, the two virtual
    ...
    Theorem~\ref{thm:mpdo_finite_chain_mutual_information_two_log} gives the
    stronger estimate
    \begin{align}
    ...
    positive semidefinite and has positive trace.
