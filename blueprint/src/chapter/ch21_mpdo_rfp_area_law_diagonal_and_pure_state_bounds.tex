...
The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Joint probability distribution and marginals'']{QICLean2026Blueprint}.



The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Entropy and classical mutual information'']{QICLean2026Blueprint}.



The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Entropy is bounded by the logarithm of the support cardinality'']{QICLean2026Blueprint}.



The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Classical mutual information is bounded by ordinary rank'']{QICLean2026Blueprint}.
...
\begin{theorem}[Classical estimate for normalized diagonal cut coefficients]
    ...
    \leanok
    \uses{thm:mpo_diagonal_cut_rank, thm:matrix_rank_scalar_extension}
...
\end{theorem}
\begin{proof}\leanok
    Normalization by the nonzero scalar $Z^{-1}$ does not change real rank.
    Faithful scalar extension does not change rank by
    Theorem~\ref{thm:matrix_rank_scalar_extension}; hence
    Theorem~\ref{thm:mpo_diagonal_cut_rank} gives
    $\rank_{\R}P\leq D^2$.
    Applying \cite[``Classical mutual information is bounded by ordinary rank'']{QICLean2026Blueprint} gives
...
\begin{lemma}[Sum of diagonal coefficients and trace]
    ...
    For every MPO tensor $M$ and cut lengths $L,R$, the sum of the real parts
    of the diagonal coefficients satisfies $Z=\re\tr\rho^{(L+R)}(M)$.
\end{lemma}
\begin{proof}\leanok
...
\begin{theorem}[Classical estimate for a positive diagonal finite-chain operator]
    ...
    \leanok
    \uses{def:mpo_normalized_diagonal_cut_distribution, thm:mpo_diagonal_cut_rank}
...
\end{corollary}
\begin{proof}\leanok
    \uses{thm:mpo_diagonal_finite_chain_classical_mutual_information, lem:mpo_diagonal_cut_mass_trace}
...
The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Positivity of the operator-Schmidt rank'']{QICLean2026Blueprint}.
...
\begin{theorem}[Two virtual boundaries bound the operator-Schmidt rank]
    ...
    \begin{align}
        ...
        \notag
    \end{align}
    This decomposes $\sigma^{(N)}_{L:K}$ via the trace identity
    $\tr(AB)=\sum_{a,b}A_{ab}B_{ba}$ with the normalization scalar absorbed into
    the left factor, formalizing the two-virtual-boundary factorization in
    \cite[Proposition~4.5]{Cirac2016MPDO_arXiv}.
\end{theorem}
...
The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Coefficient-space characterization of operator-Schmidt rank'']{QICLean2026Blueprint}.



The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Operator-Schmidt rank under local isometries'']{QICLean2026Blueprint}.



The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Support of a bipartite positive operator'']{QICLean2026Blueprint}.



The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Compression to both marginal supports'']{QICLean2026Blueprint}.



The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Partial traces under product isometries'']{QICLean2026Blueprint}.



The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Faithful marginals after simultaneous support compression'']{QICLean2026Blueprint}.



The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Channel of a faithful bipartite marginal'']{QICLean2026Blueprint}.
...
The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Isometric conjugation into a larger matrix algebra'']{QICLean2026Blueprint}.



The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Functional calculus under rectangular isometric conjugation'']{QICLean2026Blueprint}.



The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Trace preservation under isometric inclusion'']{QICLean2026Blueprint}.



The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Compression cancels isometric expansion'']{QICLean2026Blueprint}.



The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Reconstruction from a reference support'']{QICLean2026Blueprint}.



The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Relative entropy under support compression'']{QICLean2026Blueprint}.



The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Functional calculus under transpose'']{QICLean2026Blueprint}.




The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Logarithm of a positive square root'']{QICLean2026Blueprint}.



The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Logarithm of a real power'']{QICLean2026Blueprint}.



The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Support-aware vector-state Jensen inequality for the logarithm'']{QICLean2026Blueprint}.



The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Order-two sandwiched trace functional'']{QICLean2026Blueprint}.



The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Nonnegativity of the order-two functional'']{QICLean2026Blueprint}.



The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Faithful cyclic form of the order-two functional'']{QICLean2026Blueprint}.



The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Relative entropy bounded by the faithful order-two functional'']{QICLean2026Blueprint}.



The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Order-two sandwiched functional under support compression'']{QICLean2026Blueprint}.



The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Reduction of the singular order-two comparison to the faithful case'']{QICLean2026Blueprint}.



The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Relative entropy bounded by the support-restricted order-two functional'']{QICLean2026Blueprint}.


\section{Rectangular Choi matrices and a range-dimension estimate}

The rectangular Choi correspondence \cite[Proposition~2.1]{Wolf2012Quantum}
bounds the order-two Choi functional of a Hilbert--Schmidt contraction by its
range dimension, bounding mutual information in terms of operator-Schmidt rank.


The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Matrix of a linear map in matrix-unit bases'']{QICLean2026Blueprint}.



The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Unnormalized rectangular Choi matrix'']{QICLean2026Blueprint}.



The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Frobenius norm under rectangular Choi reshaping'']{QICLean2026Blueprint}.



The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Matrix-unit Parseval identity for a rectangular Choi matrix'']{QICLean2026Blueprint}.



The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Hilbert--Schmidt contraction'']{QICLean2026Blueprint}.



The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Rectangular Choi norm bounded by the range dimension'']{QICLean2026Blueprint}.



The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Full-support eigenbasis whitening as a Choi matrix'']{QICLean2026Blueprint}.



The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Full-support eigenbasis whitened Choi estimate'']{QICLean2026Blueprint}.



The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Real powers under unitary conjugation'']{QICLean2026Blueprint}.



The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Real powers of positive tensor products'']{QICLean2026Blueprint}.



The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Inverse quarter-power from iterated square roots'']{QICLean2026Blueprint}.



The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Unitary invariance of the order-two functional'']{QICLean2026Blueprint}.



The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Reindexing invariance of the order-two functional'']{QICLean2026Blueprint}.



The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Faithful marginal whitening bound'']{QICLean2026Blueprint}.



The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Marginal-support whitening bound'']{QICLean2026Blueprint}.


For trace-one $\rho$ and $\alpha>1$, the total sandwiched R\'enyi trace is the
quantity inside the logarithm of the sandwiched R\'enyi divergence
\cite[Equation~(3)]{Beigi2013Sandwiched}
\cite[Definition~2]{MullerLennert2013Renyi} for $\rho,\omega\geq0$ with
$\ker\omega\subseteq\ker\rho$. For singular $\omega$, negative powers denote
the generalized inverse on $\supp\omega$. The regime $1<\alpha\leq2$ connects
the Umegaki relative entropy at $\alpha\to 1$ to the order-two functional.


The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Total sandwiched R\'enyi trace'']{QICLean2026Blueprint}.



The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Nonnegativity on the faithful domain'']{QICLean2026Blueprint}.



The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Order-one sandwiched trace'']{QICLean2026Blueprint}.



The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Order-two sandwiched trace'']{QICLean2026Blueprint}.



The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Mutual information from operator-Schmidt rank'']{QICLean2026Blueprint}.


\begin{theorem}[Finite-chain mutual information from the operator bond]
    \label{thm:mpdo_finite_chain_mutual_information_two_log}
    \lean{MPOTensor.mutualInfoChain_le_two_log_bondDim}
    \leanok
    \uses{def:mutual_info_chain}
    Let $M$ be an MPO tensor of operator bond dimension $D$. Fix a chain of
    length $N$ and a cut with $0\leq L\leq N$. If the corresponding
    finite-chain operator is positive semidefinite and has nonzero trace, then
    \begin{align}
        I_L^{(N)} & \leq 2\log D.
        \notag
    \end{align}
    The bound holds for all cuts $0\leq L\leq N$ without assuming local
    purification or canonical form.
\end{theorem}

\begin{proof}\leanok
    \uses{def:mpdo_split_normalized_mpo, lem:mpdo_chain_mutual_information_bipartition, thm:mpdo_periodic_cut_operator_schmidt_rank}
    Reindex the normalized chain operator across the consecutive cut. Its
    trace is one, and its positivity is preserved by this reindexing. Hence
    \begin{align}
        I_L^{(N)}
         & \leq \log\operatorname{OSR}(\sigma^{(N)}_{L:N-L})
        \leq \log D^2
        =2\log D.
        \notag
    \end{align}
    Nonzero trace makes the normalized operator nonzero, so its
    operator-Schmidt rank is positive. If $D=0$, then every finite-chain trace
    vanishes. Hence $D>0$, which justifies the last logarithmic identity.
\end{proof}

\begin{theorem}[Finite-chain mutual-information estimate for matrix product density operators]
    \label{thm:mpdo_finite_chain_mutual_information_four_log}
    \lean{MPOTensor.IsMPDO.mutualInfoChain_le_four_log_bondDim}
    \leanok
    \uses{def:mutual_info_chain, def:mpdo}
    Let $M$ be a matrix product density operator of operator bond dimension
    $D$. For every positive chain length $N$, every cut $0\leq L\leq N$, and
    every nonzero finite-chain trace,
    \begin{align}
        I_L^{(N)} & \leq 4\log D.
        \notag
    \end{align}
    This establishes the finite-chain mutual-information bound invoked in
    \cite[Proposition~4.5]{Cirac2016MPDO_arXiv}.
\end{theorem}

\begin{proof}\leanok
    \uses{def:mpdo, thm:mpdo_finite_chain_mutual_information_two_log}
    Global positivity supplies positivity at the chosen positive chain
    length. Apply Theorem~\ref{thm:mpdo_finite_chain_mutual_information_two_log}.
    The same nonzero-trace argument gives $D>0$, hence
    $0\leq\log D$ and $2\log D\leq4\log D$.
\end{proof}

\begin{remark}[Boundedness of mutual information]
    The proof of \cite[Proposition~4.5]{Cirac2016MPDO_arXiv} invokes the
    uniform estimate $I_L\leq4\log D$ for every MPDO, referencing the
    purification of local completely positive maps \cite{Wolf2008AreaLaws}.
    For such maps, data processing and the pure-state boundary estimate yield
    \begin{align}
        I(A:B)_{\rho}
         & \leq I(A:B)_{\ketbra{\Psi}{\Psi}}
        =2S(A)_{\ketbra{\Psi}{\Psi}}
        \leq2\lvert\partial A\rvert\log D = 4\log D.
        \notag
    \end{align}
    General positive MPOs need not admit such a local purification.

    The two virtual bonds bound the operator-Schmidt rank by $D^2$
    \cite[``Coefficient-space characterization of operator-Schmidt rank'']{QICLean2026Blueprint},
    even though the ordinary rank of a marginal can grow exponentially (for
    instance, a product of full-rank single-site density matrices has
    $\rank(\rho_L)=(\rank q)^L$ while $I_L=0$).

    Theorem~\ref{thm:mpdo_finite_chain_mutual_information_two_log} provides the
    uniform bound $I_L^{(N)}\leq2\log D$ whenever the finite-chain operator is
    positive semidefinite with positive trace. For diagonal states,
    Theorem~\ref{thm:mpo_diagonal_finite_chain_classical_mutual_information}
    gives an independent verification.

    While the finite-chain bound $I_L^{(N)}\leq 2\log D$ holds uniformly, the
    iterated thermodynamic limit in \cite[Proposition~4.5]{Cirac2016MPDO_arXiv}
    can fail, as demonstrated by Theorem~\ref{thm:parity_mpdo_no_thermodynamic_limit}
    and documented in \cite{gap:cpgsv17_mpdo_mutual_information_bound}.
    The channel-image case is treated in
    Theorem~\ref{thm:local_channel_image_mutual_info_bound}, pure states in
    Proposition~\ref{prop:pure_mutual_info_bound}, and locally purified states
    in Theorem~\ref{thm:lpdo_mutual_info_bound}.
\end{remark}
...
\begin{theorem}[A renormalization fixed point saturates the area law]
    ...
    \leanok
    \uses{def:mps_transfer_idempotence, def:pure_sal, lem:pure_block_entropy_env_charpoly, lem:rfp_schmidt_gram_collapse}
    ...
    This strengthens \cite[Proposition~3.14, lines~606--608]{Cirac2016MPDO_arXiv}
    by deducing area-law saturation from transfer-map idempotence alone, without
...
\begin{proof}\leanok
    ...
    $L$, $L+1$, $N-L$, and $N-(L+1)$ are positive.
    Lemma~\ref{lem:rfp_schmidt_gram_collapse} gives
    \begin{align}
        L_L^\dagger L_L
         & =L_1^\dagger L_1,
        \notag               \\
...
\begin{theorem}[A renormalization fixed point has a constant block-entropy chain]
    ...
    \begin{align}
        ...
        \notag
    \end{align}
    This formalizes the constant-entropy consequence of area-law saturation
    \cite[Definition~3.13, line~600]{Cirac2016MPDO_arXiv} for fixed points.
\end{theorem}
\begin{proof}\leanok
    \uses{thm:rfp-saturates-area-law, lem:pure_sal_const}
...
\begin{proposition}[Pure-state area-law upper bound]\label{prop:pure_area_upper}
    ...
    \leanok
    \uses{lem:operator_schmidt_rank, lem:trace_one_positive_rank, lem:reduced_pure_block_state_density}
...
\begin{lemma}[Nonnegativity of the pure-state block entropy]
    ...
    \leanok
    \uses{def:pure_sal, lem:reduced_pure_block_state_density}
