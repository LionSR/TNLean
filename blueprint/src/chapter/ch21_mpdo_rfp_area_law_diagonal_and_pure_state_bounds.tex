...
estimate is one ingredient in the pending formalization of the finite-chain
mutual-information bound in
\cite[Proposition~4.5]{Cirac2016MPDO_arXiv}, as recorded in
\path{docs/paper-gaps/cpgsv17_mpdo_mutual_information_bound.tex}. It does not
itself assert that bound.
