...
\begin{theorem}[Two virtual boundaries bound the operator-Schmidt rank]
    ...
    \leanok
    \uses{def:mpdo_split_normalized_mpo, def:bipartite_operator_schmidt_rank}
...
\end{theorem}
\begin{proof}\leanok
    \uses{lem:partial_trace_product_isometry, thm:compression_on_support_posDef, thm:operator_schmidt_rank_marginal_support_compression}
...
\begin{theorem}[Channel of a faithful bipartite marginal]
    ...
    \leanok
    \uses{def:bipartite_operator_schmidt_rank, thm:operator_schmidt_coefficient_space}
...
\begin{proof}\leanok
    \uses{thm:cfc_transpose_hermitian, thm:mpdo_support_log_kronecker, thm:log_sqrt_possemidef, thm:log_rpow_posdef, thm:support_log_vector_jensen, thm:sandwiched_renyi_two_weighted}
...
\begin{proof}\leanok
    \uses{thm:compression_on_support_posDef, thm:isometric_embedding_trace, thm:support_compression_reconstruction, thm:relative_entropy_support_compression, thm:sandwiched_renyi_two_support_compression}
...
\begin{theorem}[Faithful marginal whitening bound]
    ...
    \leanok
    \uses{def:sandwiched_renyi_two_trace, def:bipartite_operator_schmidt_rank}
