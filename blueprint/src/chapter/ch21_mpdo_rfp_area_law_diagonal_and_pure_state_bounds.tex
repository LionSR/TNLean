...
\begin{theorem}[Finite-chain mutual-information estimate for matrix product density operators]
    ...
    \begin{align}
        ...
        \notag
    \end{align}
    This is the finite-chain estimate used in the proof of
    \cite[Proposition~4.5]{Cirac2016MPDO_arXiv}, with the nonzero-trace hypothesis
    reflecting the normalization convention.
\end{theorem}
