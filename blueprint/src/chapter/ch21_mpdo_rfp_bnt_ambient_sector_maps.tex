...
\begin{theorem}[Complete positivity of the ambient sector maps]
    ...
    \leanok
    \uses{def:kraus_map_between_direct_sums, def:mpdo_bnt_ambient_sector_maps}
...
\begin{proof}\leanok
    \uses{thm:mpdo_vertical_sector_partial_trace_kraus, lem:mpdo_single_kraus_map_cp, thm:mpdo_equiv_reindex_cptp, lem:is_kraus_cp_comp}
...
\begin{proof}\leanok
    \uses{lem:mpdo_normalized_vertical_sector_positive_trace, lem:mpdo_coisometric_compression_trace, thm:mpdo_equiv_reindex_cptp}
...
\begin{proof}\leanok
    \uses{lem:mpdo_retained_vertical_sector_retraction, thm:mpdo_equiv_reindex_cptp}
