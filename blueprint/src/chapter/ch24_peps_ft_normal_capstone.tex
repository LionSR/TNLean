...
\begin{definition}[Normal PEPS blocking hypotheses]%
    ...
    \begin{tenkzequation}
        ...
        \begin{tenkzlattice}[rows=5, cols=5, boundary legs]
            \tnregion[slot=selected, label=R, label at=center]
                {(2-4,2-4) - (4,4)}
            \tnsite[role=marked, label=$v$]{(4,4)}
        \end{tenkzlattice}
        $\qquad\subset\qquad$
        \begin{tenkzlattice}[rows=5, cols=5, boundary legs]
            \tnregion[slot=selected, label=S, label at=center]{(2-4,2-4)}
            \tnsite[role=marked, label=$v$]{(4,4)}
        \end{tenkzlattice}
        $\qquad S=R\cup\{v\}$
    \end{tenkzequation}
...
\begin{proof}\leanok
    ...
    $\operatorname{tr}(B^{\sigma_0}\cdots B^{\sigma_{n-1}} P_n^{-1})$ with the
