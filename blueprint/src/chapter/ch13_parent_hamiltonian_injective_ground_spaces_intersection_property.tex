...
\begin{remark}[Cyclic interval restrictions]\label{rem:cyclic_window_operators}
    ...
    taken modulo $N$. Reassembling a configuration around itself returns it:
    ...
    \begin{align}
        ...
        \notag
    \end{align}
    Changing one inserted value commutes with the assembly: for $r<L$ and a
    ...
    \begin{align}
        ...
        \notag
    \end{align}
    The remaining listed identities say that deleting the
