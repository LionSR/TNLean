...
\begin{lemma}[End-site and cyclic coordinate identifications]
    \label{lem:adjacent_local_term_coordinate_identifications}
...
\begin{proof}
    ...
    \uses{thm:mem_open_chain_left_ground_space_es,
        ...
        lem:adjacent_local_term_coordinate_identifications}
