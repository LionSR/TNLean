...
\begin{theorem}[Normal tensor: $\mathcal G_{N,L}(A)\subseteq\spn\{V^{(N)}(A)\}$]
    ...
    with $N \ge 2$, $L_0+1<N$, and $L_0 < L \le N$, then
...
% inequality $L_0+1<N$ excludes the minimal ring $N=L_0+1$ in the CPGSV21
% range-$(L_0+1)$ theorem; after specialization to the blocked range $2L_0$,
% it also excludes the two-site case $L_0=1$, $N=2$.
