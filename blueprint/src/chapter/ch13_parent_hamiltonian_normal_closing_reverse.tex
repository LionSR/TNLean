...
\begin{theorem}[Unique ground state throughout the block-injective interaction range]%
    ...
    a unique periodic ground state. These inequalities already imply $N\ge2$
    and $N\ge L_0+1$. Thus this strengthens the finite-size range $N\ge 2L_0$
    printed in PGVWC07, Theorem~\texttt{uniqueGS}~\cite{PerezGarcia2007Matrix}.
\end{theorem}
