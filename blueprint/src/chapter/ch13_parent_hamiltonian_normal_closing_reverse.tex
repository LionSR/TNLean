...
\begin{lemma}[One-step full-ring boundary comparison]
    \label{lem:full_ring_boundary_intertwines_step}
    ...
    \[
        T_{L_0}\!\left(\Gamma_{L_0+1}(X)\right)=\Gamma_{L_0+1}(Y),
    \]
...
\begin{proof}
    ...
    trace gives
    \[
        \Gamma_{L_0}(XA^j)(\beta)=\Gamma_{L_0}(A^jY)(\beta).
    \]
...
\begin{proof}
    ...
    \uses{lem:parent_cyclic_translate_preserves_chain_space,
        ...
        lem:full_ring_boundary_intertwines_step,
        lem:parent_cyclic_translate_add,
        thm:ground_space_map_injective_blk,
        lem:isNBlkInjective_of_le,
    ...
    matrices at successive cuts. Lemma~\ref{lem:full_ring_boundary_intertwines_step}
...
\begin{proof}
    ...
    \[
        \mathcal G_{N,L}(A)\subseteq\mathcal G_{N,L_0+1}(A),
    \]
