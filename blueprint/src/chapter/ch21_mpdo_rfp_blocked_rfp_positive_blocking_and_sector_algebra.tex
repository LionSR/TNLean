...
\begin{lemma}[Closed MPO entries with residual sites]
    ...
    \leanok
    \uses{def:mpdo_physical_blocking, def:mpo_family, lem:mpo_eval_word_append}
    ...
    ordered product of the matrices indexed by two equally long physical
...
\begin{proof}\leanok
    \uses{lem:mpo_eval_word_append}
    Split the two physical words at the two boundaries of the complete
    blocks. The product over the middle segment is the corresponding product
    of the blocked matrices; associativity gives the asserted trace.
\end{proof}
