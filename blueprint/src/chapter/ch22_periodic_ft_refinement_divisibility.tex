...
\begin{definition}[Construction of $\widetilde A$ from the $Z$-gauge]
    ...
    This formal hypothesis isolates the channel-level consequence
    $\E_C = \E_{\widetilde A^{[p]}}$ of the construction in
    \cite[lines~765--810]{DeLasCuevas2017Irreducible} as a conditional input.
\end{definition}
