...
\begin{proof}\leanok
    ...
    zero-block dimension and the nontrivial blocks. Then apply the blockwise
    TP-gauge theorem to the nontrivial blocks. The positive-length equality and
    the dimension identity compose across both steps.
\end{proof}
