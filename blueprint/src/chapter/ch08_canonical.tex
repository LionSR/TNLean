...
\label{def:common_blocked_cyclic_sector_derived_blocks}
	...
	one-shot block data keeps the relabeling of blocked physical words explicit: for the
...
\label{thm:common_blocked_cyclic_sector_reindexed_samempv}
	...
	the explicit relabeling of blocked physical words, with a one-shot block of length
...
\label{thm:common_blocked_cyclic_sector_canonical_label_compat}
	...
	Assume that the canonical one-shot blocked nonzero part agrees, as an
	MPV family, with the relabelled cyclic-sector tensor coming from iterated
	blocking.  Then the canonical weighted nonzero part agrees
...
\label{thm:ft_after_blocking_reindexed_common_sector_live_zero_tail}
	...
	one-shot blocked nonzero blocks with an explicit relabeling of blocked physical words.  The
...
\begin{remark}[Remaining steps toward normal canonical form]%
	...
	Theorem~\ref{thm:after_blocking_sector_zeroTail_of_proportionalDecompositionConclusion}
