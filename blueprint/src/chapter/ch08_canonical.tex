...
\begin{theorem}[Blocking preserves equality of assembled weighted blocks]%
	...
	\leanok
	\uses{thm:samempv_blocking_distributes, thm:block_tensor_to_tensor_from_blocks}
...
\begin{proof}\leanok
	Apply Theorem~\ref{thm:samempv_blocking_distributes} to both assembled
	tensors and rewrite each blocked assembled tensor by
