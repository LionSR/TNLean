...
\begin{theorem}[Cyclic sectors of irreducible TP tensors]%
...
\begin{theorem}[Sorted primitive data form a normal canonical form]%
...
\begin{theorem}[Structural after-blocking form of the fundamental theorem]%
	...
	\lean{MPSTensor.fundamentalTheorem_after_blocking_structural}
	\leanok
	\uses{def:blocked_tensor}
...
\label{thm:ft_after_blocking_per_block_cyclic_live_zero_tail}
	\lean{MPSTensor.fundamentalTheorem_after_blocking_perBlock_cyclic_live_with_zeroTail}
	\leanok
...
\label{thm:ft_after_blocking_common_blocked_cyclic_live_zero_tail}
	\lean{MPSTensor.fundamentalTheorem_after_blocking_commonBlocked_cyclic_live_with_zeroTail}
	\leanok
