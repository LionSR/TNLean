...
\begin{theorem}[Canonical form from primitive fixed-point data]%
	...
	This is a scope-restricted conditional result: it assumes injectivity,
	strict ordering of the weight moduli, nonzero weights, positive bond
	dimensions, and primitive fixed-point data. It is not the full
	translation-invariant canonical-form existence theorem, which starts from
	an arbitrary translation-invariant MPS representation. This restriction is
	documented in \texttt{docs/paper-gaps/pgvwc07\_ti\_canonical\_form\_scope.tex};
	see
	\cite[Theorem~\texttt{Th:TIcanonical}, lines~742--763]{PerezGarcia2007Matrix}.
\end{theorem}
...
\begin{theorem}[Canonical form from peripheral primitivity]%
	...
	This is a scope-restricted conditional result: it assumes injectivity,
	strict ordering of the weight moduli, nonzero weights, positive bond
	dimensions, and peripheral-spectrum primitivity for every block. It is not
	the full translation-invariant canonical-form existence theorem, which
	starts from an arbitrary translation-invariant MPS representation. This
	restriction is documented in
	\texttt{docs/paper-gaps/pgvwc07\_ti\_canonical\_form\_scope.tex}; see
	\cite[Theorem~\texttt{Th:TIcanonical}, lines~742--763]{PerezGarcia2007Matrix}.
\end{theorem}
...
\begin{theorem}[Normal canonical form from a primitive block decomposition]%
		...
		form conditions. This is a scope-restricted conditional result: it assumes
		an existing weighted primitive block decomposition, irreducibility,
		trace-preserving normalization, pairwise distinct weight moduli, nonzero
		weights, and positive bond dimensions. It is not the full
		translation-invariant canonical-form existence theorem, which starts from
		an arbitrary translation-invariant MPS representation. This restriction
		is documented in
		\texttt{docs/paper-gaps/pgvwc07\_ti\_canonical\_form\_scope.tex}; see
		\cite[Theorem~\texttt{Th:TIcanonical}, lines~742--763]{PerezGarcia2007Matrix}.
\end{theorem}
...
\begin{theorem}[Sector decomposition from TP primitive irreducible blocks]
	...
	\uses{thm:overlap_decay_irr_tp, thm:bnt_grouping_gauge_equiv}
