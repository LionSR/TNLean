...
\begin{proof}
    ...
    \cite[Thm.~6.6]{Wolf2012Quantum},
    which characterises irreducibility via absence of
    nontrivial invariant projections.
\end{proof}
...
\begin{definition}[Irreducible tensor]\label{def:irreducible_tensor}
    ...
    projection, i.e.\ $\E_A$ is irreducible as a CP map
...
\begin{proof}
    ...
    In~\cite{PerezGarcia2007Matrix}, this is the standard
    canonical-form reduction.
    Our formalization iterates the invariant-projection splitting
    via strong induction on $D$, rather than appealing to a general
    structure theorem for C*-algebras.
\end{proof}
