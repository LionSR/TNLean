...
\begin{remark}\label{rem:primitivity_reduces_assumptions}
    ...
    This corresponds to \cite[Appendix~A]{Cirac2017Matrix}.
\end{remark}
...
\begin{remark}\label{rem:blocking_primitivity_appendixA}
    ...
    step in \cite[Appendix~A]{Cirac2017Matrix}.
\end{remark}

\section{Canonical form existence pipeline (\cite{Cirac2017Matrix})}%
\label{sec:canonical_pipeline_1606}

This section assembles the components of the canonical-form
construction following \cite[\S2.3 and Appendix~A]{Cirac2017Matrix}.
...
\begin{theorem}[CFII data for irreducible TP blocks]%
    ...
    of \cite[Appendix~A]{Cirac2017Matrix}.
\end{theorem}
...
\cite[Appendix~A]{Cirac2017Matrix}.
