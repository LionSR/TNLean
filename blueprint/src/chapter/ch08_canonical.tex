...
\begin{theorem}[Equal-norm blocks with non-decaying overlap are gauge equivalent]
	...
	The non-decaying-overlap hypothesis must be supplied by the caller from structural properties of the decomposition (cyclic-sector origin, Fundamental Theorem matching, etc.).
