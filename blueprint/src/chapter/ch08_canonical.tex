...
\subsection{External Burnside--Jacobson bridge to algebra span}
...
\begin{theorem}[Burnside--Jacobson bridge for Kraus algebras]\label{thm:burnside_matrix}
...
\begin{remark}\leanok
	...
	The formal bridge used here is precisely
	\[
...
\begin{corollary}[Irreducible action implies eventual cumulative spanning]%
...
\begin{remark}\leanok
	The conclusion of Corollary~\ref{thm:irreducible_action_cumulative_span}
	is a cumulative-span statement.  It proves
	\[
		\algspn(A)=\MN{D},
		\qquad
		\exists N,\ T_N(A)=\MN{D}.
