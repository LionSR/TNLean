...
\begin{remark}[Remaining steps toward normal canonical form]%
	...
	canonical blocked nonzero part and the explicitly relabeled cyclic-sector tensor
	for the whole weighted family.  The conditional statement
	...
	Theorem~\ref{thm:after_blocking_sector_zero_tail_bnt_proportional_decomposition}
	...
	Thus the remaining canonical-form hypotheses are precisely the physical-label
