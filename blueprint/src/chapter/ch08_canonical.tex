...
\begin{theorem}[Phase-class BNT sector construction with one-sided overlap data]
	...
	\leanok
	\uses{def:sector_basis_overlap_ortho_hyps}
	For trace-preserving primitive irreducible blocks of positive bond dimension
...
\begin{proof}\leanok
	\uses{def:mpv_phase_class_data, thm:bnt_li_tp_prim_irr_separated,
		thm:cross_overlap_zero_split}
	The proof reconstructs the phase-class representative construction directly.
	The chosen basis blocks keep positive bond dimension, normalization, and any
	supplied one-site injectivity from the original trace-preserving primitive
