...
\label{thm:common_blocked_cyclic_sector_derived_properties}
	...
	dimensions.  Original nonzero weights remain nonzero after transport.
...
\texttt{CommonBlockedCyclicSectorFamily} record: they express blocked-word
identifications and MPV comparisons between direct and iterated blocking.
They are intermediate constructions consumed by the normal canonical-form reduction and
