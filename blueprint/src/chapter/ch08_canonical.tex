...
\begin{remark}[Remaining steps toward normal canonical form]%
	...
	distinct nonzero weight norms needed before the sorted normal form of
	Theorem~\ref{thm:bnt_sorted_ncf} can be applied.
	...
	Chapter~\ref{ch:periodic_ft_apps}; it is not part of the Chapter~8
	reduction except as a forward reference.
\end{remark}
