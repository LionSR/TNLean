...
\begin{theorem}[Bond-dimension equality from unit-modulus overlap]%
		...
		This is the bond-dimension conclusion of
		\cite[lines~1085--1117]{Cirac2016MPDO_arXiv}, in the left-canonical
...
\begin{theorem}[Gauge-phase equivalence from unit-modulus overlap]%
		...
		% Same-bond-dimension case of \cite[lines~1080--1091]{Cirac2016MPDO_arXiv};
