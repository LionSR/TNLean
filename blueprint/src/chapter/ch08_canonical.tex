...
\begin{proof}\leanok
    ...
    to the nontrivial blocks. The MPV identity composes across both steps.
\end{proof}
...
Theorem~\ref{thm:tp_gauge_arbitrary} and the after-blocking statements of
Chapter~\ref{ch:canonical_after_blocking}.
...
\begin{theorem}[Arbitrary-input PGVWC07 unital dual-diagonal form with zero block]%
    ...
    \[
        \operatorname{MPV}_A
        =
        \operatorname{MPV}_{\mathbf{0}_{D_0}}
        +
...
\begin{proof}\leanok
    ...
    dual-diagonal theorem to this nonzero family. Combining the two MPV
