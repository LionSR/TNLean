...
\begin{definition}[Block-diagonal tensor from blocks]\label{def:tensor_from_blocks}
	...
	Diagrammatically this is the block-diagonal construction
	\[
		\TNDirectSumAssembly{\bigoplus_k \mu_k A_k^i}{A^i}{\operatorname{diag}}.
	\]
\end{definition}
...
\begin{proof}
	...
	\[
		\TNDirectSumAssembly{A^i}{B_{11}^i \oplus B_{22}^i}{U}
	\]
...
\begin{proof}
	...
	The iterated reduction therefore has the repeated shape
	\[
		\TNDirectSumAssembly{A}{\bigoplus_k A_k}{\operatorname{iterate}}.
	\]
...
\begin{proof}
	...
	The reduction turns primitive blocks into canonical-form data:
	\[
		\TNDirectSumAssembly{\text{primitive blocks}}{\text{canonical form}}{\operatorname{diag}}.
	\]
