...
\begin{proof}\leanok
    ...
    \begin{align}
        ...
        \notag
    \end{align}
    This proves (\ref{eq:entropy_support_tensor}). Applying
...
\begin{theorem}[Petz factorization for a maximally mixed factor]
    ...
    H_A\otimes(H_B\otimes H_C)$. This is
    \cite[equation~(10)]{Hayden2004Structure}. It is the tensor-product
    identity for the Petz support formula, not the Koashi--Imoto decomposition.
\end{theorem}
