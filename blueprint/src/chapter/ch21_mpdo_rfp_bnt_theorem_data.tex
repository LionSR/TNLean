...
\begin{theorem}[Terminal sector positivity from the tensor-attached algebra clause]%
    ...
    Let $M$ be a matrix product density operator with a tensor-attached BNT
    algebra clause, and let $M_\gamma$ be any retained normal tensor. Closing
    the two physical legs of $M_\gamma$ gives the bond matrix
    \begin{align}
        T_\gamma
