...
\begin{lemma}[Multiplicativity of the virtual per-block extension]%
    \label{lem:mpdo_virtual_perBlockLinearExtension_mul}
...
\begin{lemma}[Bijectivity of the virtual per-block extension]%
    \label{lem:mpdo_virtual_perBlockLinearExtension_bijective}
    \lean{MPSTensor.perBlockLinearExtension_bijective}
    \leanok
    \uses{lem:mpdo_virtual_perBlockLinearExtension_mul}
    The per-block extension $T_k$ is bijective.
\end{lemma}

\begin{proof}\leanok\uses{lem:mpdo_virtual_perBlockLinearExtension_mul}
...
\begin{proof}\leanok
    \uses{lem:mpdo_virtual_perBlockLinearExtension_mul,
        lem:mpdo_virtual_perBlockLinearExtension_bijective,
