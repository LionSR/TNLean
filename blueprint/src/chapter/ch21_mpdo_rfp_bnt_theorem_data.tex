...
\end{theorem}
\begin{proof}\leanok
    The positive trace-power witness identifies the given coefficients with
    the canonical trace-power family.  Substitute this identity into the
    product law and its length-one idempotent specialization.
\end{proof}
