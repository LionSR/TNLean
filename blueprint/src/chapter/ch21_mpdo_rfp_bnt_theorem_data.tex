...
\begin{definition}[Bond-two singleton and companion Bell data]%
    ...
    \lean{MPOTensor.BondTwoSingletonGramBoundary.deformedOneSite}
    \lean{MPOTensor.BondTwoSingletonGramBoundary.deformedTwoSite}
    \leanok
    \uses{def:mpo_physical_trace_transfer}
    ...
    \begin{align}
        ...
        \notag
    \end{align}
    No identification of $P$ with a two-site operator generated by $A$ is
    included here; that tensor attachment is the subject of
...
\begin{lemma}[Terminal-positive deformation and Bell comparator]%
    ...
    \lean{MPOTensor.BondTwoSingletonGramBoundary.deformedOneSite_eq_terminalJ}
    \lean{MPOTensor.BondTwoSingletonGramBoundary.deformedOneSite_posSemidef}
    \lean{MPOTensor.BondTwoSingletonGramBoundary.deformedTwoSite_not_isHermitian}
    \leanok
    ...
    \begin{align}
        ...
        \notag
    \end{align}
    Independently, $P$ is positive semidefinite while $P_X$ is not Hermitian.
    This Bell-projector calculation is a companion matrix obstruction, not a
    two-site test of $B$.  No theorem here identifies $P$ or $P_X$ with an
    operator generated by $A$ or $B$.
\end{lemma}
...
\begin{theorem}[Terminal and companion Bell Hermiticity force a scalar Gram matrix]%
    ...
    \lean{MPOTensor.BondTwoSingletonGramBoundary.%
        gaugeGram_commutes_terminalJ_of_oneSite_isHermitian}
    \lean{MPOTensor.BondTwoSingletonGramBoundary.%
        gaugeGram_bellCross_of_twoSite_isHermitian}
    \lean{MPOTensor.BondTwoSingletonGramBoundary.%
        gaugeGram_eq_pos_smul_one_of_one_two_isHermitian}
    \leanok
    \uses{def:mpdo_bond_two_singleton_deformation}
    ...
    theorem. The premise does not assert that $P$ is derived from the singleton
    tensor.
\end{theorem}
