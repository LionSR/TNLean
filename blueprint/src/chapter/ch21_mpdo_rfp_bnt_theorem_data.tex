...
\begin{proof}\leanok
    \uses{thm:mpdo_virtual_perBlockLinearExtension_mul, thm:mpdo_virtual_perBlockLinearExtension_bijective, thm:unitary_skolem_noether_matrix}
...
\begin{proof}\leanok
    \uses{thm:mpdo_bnt_exact_sector_gauge_blocked_corner, thm:mpdo_bnt_exact_sector_identity_oblique_physical_span, thm:mpdo_literal_cpsv_positive_blocking, thm:cpsv_original_coordinate_marked_lemma_l, thm:eq3_of_dressed_adjoint}
...
\begin{theorem}[Conditional unitary conjugacy from the positive-tail reflected
    ...
    \leanok
    \uses{def:mpdo, def:cpsv_canonical_form, def:mpdo_bnt_two_site_exact_sector_gauge, thm:normalize_scalar_gram_matrix, thm:normalized_conjugation_of_scalar_gram}
...
\begin{proof}\leanok
    \uses{thm:mpdo_bnt_conditional_identity_marked_gram, thm:normalize_scalar_gram_matrix, thm:normalized_conjugation_of_scalar_gram}
