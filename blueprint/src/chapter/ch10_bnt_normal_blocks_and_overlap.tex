...
\end{theorem}
\begin{proof}
    \uses{lem:trace_mul_transfer_map_adjoint, lem:irreducible_transfer_perron_pair, thm:posDef_adjoint_eigenvector, thm:spectral_radius_real_pf_irred, thm:tp_gauge_from_adjoint_fixed, lem:tp_gauge_equiv, lem:similarity_irred_iff}
    \leanok
