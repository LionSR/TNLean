...
\begin{definition}[Complete positivity on an operator system]
    ...
    map. For $k\ge1$, write $T\otimes\mathrm{id}_k$ for the map sending a
    $k\times k$ block matrix with entries in $S$ to the block matrix
    obtained by applying $T$ to every entry. Then $T$ is \emph{completely
