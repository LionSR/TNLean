...
product density operators are then collected before the two-dimensional
material. Chapters~\ref{ch:peps_foundations_edge_middle}--%
\ref{ch:peps_normal_capstone} close the blueprint with the PEPS analogs.
