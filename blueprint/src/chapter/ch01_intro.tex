...
algebras, and Skolem--Noether. Chapters~\ref{ch:channels}, \ref{ch:qpf},
and~\ref{ch:spectral} develop the transfer-map, Perron--Frobenius, and
...
% note: docs/paper-gaps/rmp_conditional_after_blocking_ft_statement.tex.
...
parent-Hamiltonian consequences, correlation estimates, tensor-network
examples, matrix product operators and density operators, renormalization
fixed points, and periodic tensor families. They also retain the
matrix-product-specific normal-form and asymptotic results needed for these
applications. General quantum-channel representations, dynamical semigroups,
operator convexity, and entropy are developed in the companion quantum-channel
volume~\cite{QICLean2026Blueprint}. A later chapter records standard examples
of positive maps that are not completely positive.
