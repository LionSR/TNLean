...
\begin{proof}\leanok
    ...
    idempotence and pairwise orthogonality.  Transport through the adjoint
    sequential coisometry preserves these identities because the fusion map
    is a coisometry.  Linearity gives the weighted reconstruction of $T_N$.
