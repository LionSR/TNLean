...
\begin{definition}[All-label recursive density operator]%
    ...
    $\alpha_j$ and a diagonal coordinate $q_j$ of $\mu_{\alpha_j}$.  Let
    $L=N-1$ in the successor-indexed formal statement, so its parameter $L$
    represents the physical length $L+1=N$.
    \[
