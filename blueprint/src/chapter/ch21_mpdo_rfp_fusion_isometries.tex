...
\end{theorem}
\begin{proof}\leanok
    The word evaluation of the product tensor expands as a sum over the
    contracted middle configurations of tensor products of word evaluations,
    by induction on the length using the mixed-product property. Taking
    traces turns the tensor products into products of traces, which is the
    entrywise form of the operator product.
\end{proof}
...
\begin{proof}\leanok
    ...
    nonempty word, conjugating each letter by the isometry does not change
    the closed-trace word evaluation, and by the fusion identity the
