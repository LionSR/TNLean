...
\begin{proof}
    \leanok
    \uses{thm:kraus_fixed_support_lower_zero, thm:kraus_lower_zero_invariant_compression}
...
\begin{proof}
    \leanok
    \uses{thm:cp_fixed_support_invariant, thm:nonzero_psd_support, thm:full_support_posdef}
...
\begin{proof}\leanok
    ...
    Theorem~\ref{thm:kraus_tp_gauge_from_adjoint_fixed}. Each conjugated
    summand is
    $(B^i)^\dagger B^i
...
\begin{proof}
    \leanok
    \uses{thm:kraus_posdef_adjoint_eigenvector, thm:kraus_tp_gauge_from_adjoint_fixed}
