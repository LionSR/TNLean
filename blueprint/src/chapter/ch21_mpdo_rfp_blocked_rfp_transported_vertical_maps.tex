...
\begin{proof}\leanok
    \uses{thm:positive_map_trace_preserving_from_fixed_product_span, thm:direct_sum_full_matrix_extension_compatibility, thm:direct_sum_extension_trace_transfer}
