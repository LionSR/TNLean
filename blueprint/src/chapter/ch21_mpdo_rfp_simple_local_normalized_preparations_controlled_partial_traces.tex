...
\begin{theorem}[Diagonal blocks of the controlled dependent partial trace]
    ...
    \leanok
    \uses{def:mpdo_controlled_dependent_partial_trace, def:mpdo_right_partial_trace_map}
...
\begin{proof}
    \leanok
    \uses{thm:mpdo_controlled_kraus_map_cptp, lem:mpdo_right_partial_trace_cptp}
...
\begin{definition}[The two-site partial-trace map $\mathcal T_0$]
    ...
    \leanok
    \uses{def:mpdo_two_site_subspin_regrouping, def:mpdo_controlled_dependent_partial_trace, def:mpdo_equiv_reindex_map}
...
\begin{proof}
    \leanok
    \uses{thm:mpdo_equiv_reindex_cptp, thm:mpdo_controlled_dependent_partial_trace_cptp, lem:is_kraus_cptp_comp}
...
\begin{definition}[The two-site shift $\mathcal S_2$]
    ...
    \leanok
    \uses{def:mpdo_two_site_subspin_regrouping, def:mpdo_equiv_reindex_map}
...
\begin{definition}[The three-site partial-trace map $\mathcal S_0$]
    ...
    \leanok
    \uses{def:mpdo_three_site_subspin_regrouping, def:mpdo_controlled_dependent_partial_trace, def:mpdo_equiv_reindex_map}
...
\begin{definition}[The three-site shift $\mathcal T_2$]
    ...
    \leanok
    \uses{def:mpdo_three_site_subspin_regrouping, def:mpdo_equiv_reindex_map}
...
\begin{definition}[Fiberwise partial-trace maps]
    ...
    \leanok
    \uses{def:mpdo_two_site_subspin_regrouping, def:mpdo_three_site_subspin_regrouping, def:mpdo_right_partial_trace_map, def:mpdo_equiv_reindex_map}
...
\begin{proof}
    \leanok
    \uses{thm:mpdo_equiv_reindex_cptp, lem:mpdo_right_partial_trace_cptp, lem:is_kraus_cptp_comp}
...
\begin{definition}[Fiberwise shifts]
    ...
    \leanok
    \uses{def:mpdo_two_site_subspin_regrouping, def:mpdo_three_site_subspin_regrouping, def:mpdo_equiv_reindex_map}
