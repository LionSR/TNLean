...
\begin{definition}[The two-site partial-trace map $\mathcal T_0$]
    ...
    \leanok
    \uses{def:mpdo_two_site_subspin_regrouping, def:mpdo_controlled_dependent_partial_trace}
...
\begin{proof}
    \leanok
    \uses{thm:mpdo_controlled_dependent_partial_trace_cptp}
...
\begin{definition}[The three-site partial-trace map $\mathcal S_0$]
    ...
    \leanok
    \uses{def:mpdo_three_site_subspin_regrouping, def:mpdo_controlled_dependent_partial_trace}
