The generic controlled dependent partial trace, its diagonal blocks, and its
trace-preserving completely positive property are developed in the companion
volume~\cite[``Controlled dependent partial trace'', ``Diagonal blocks of the controlled dependent partial trace'', ``The controlled dependent partial trace is trace-preserving completely positive'']{QICLean2026Blueprint}.
