...
The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Controlled dependent partial trace'']{QICLean2026Blueprint}.



The corresponding generic result is proved in the companion quantum-channel volume~\cite[``Diagonal blocks of the controlled dependent partial trace'']{QICLean2026Blueprint}.



The corresponding generic result is proved in the companion quantum-channel volume~\cite[``The controlled dependent partial trace is trace-preserving completely positive'']{QICLean2026Blueprint}.
...
\begin{proof}
    ...
    Theorem~\cite[``The controlled dependent partial trace is trace-preserving completely positive'']{QICLean2026Blueprint}, and the
    second by Theorem~\cite[``Equivalence reindexing is trace-preserving completely positive'']{QICLean2026Blueprint}. Their composition is
...
\begin{proof}
    ...
    completely positive by Theorem~\cite[``Equivalence reindexing is trace-preserving completely positive'']{QICLean2026Blueprint}.
\end{proof}
...
\begin{definition}[Three-site subspin regrouping]
    ...
    \leanok
    \uses{def:mpdo_two_site_subspin_regrouping, def:mpdo_eta_omega, def:mpdo_physical_sector_factorization}
...
\begin{proof}
    ...
    Theorems~\cite[``The controlled dependent partial trace is trace-preserving completely positive'']{QICLean2026Blueprint}
    and~\cite[``Equivalence reindexing is trace-preserving completely positive'']{QICLean2026Blueprint}, respectively. Their composition
...
\begin{definition}[Fiberwise partial-trace maps]
    ...
    \leanok
    \uses{def:mpdo_two_site_subspin_regrouping, def:mpdo_three_site_subspin_regrouping}
...
\begin{proof}
    ...
    Theorem~\cite[``Equivalence reindexing is trace-preserving completely positive'']{QICLean2026Blueprint}.
\end{proof}
