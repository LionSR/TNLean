\begin{remark}[Basic-vector coefficients and nearest-neighbor local-term commutation]%
    ...
    \leanok
    \uses{thm:trace_eval_word_eq_sum_cyclic, lem:appendixB_basis_change_parent_interaction, def:appendixB_two_site_basic_space, def:appendixB_qax, def:appendixB_qxb, lem:appendixB_qax_qxb_parent_interaction, lem:appendixB_three_site_parent_lifts, lem:appendixB_lift_commutator_parent_terms}
