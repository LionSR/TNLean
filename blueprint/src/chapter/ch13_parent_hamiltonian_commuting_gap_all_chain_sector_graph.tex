\begin{remark}[Basic-vector coefficients and nearest-neighbor local-term commutation]%
    ...
    \begin{align}
        ...
        \notag
    \end{align}
    This cyclic virtual-pair formula does not imply factorization of a fixed
    physical-word coefficient over disjoint physical pairs. The source instead
    places each virtual pair across neighboring sites and applies an on-site
    physical isometry, as in
