%% =========================================================
%% Chapter: Operator convexity and Jensen inequalities
%% References: Bhatia, Matrix Analysis, Chapter V;
%%             Wolf, Quantum Channels & Operations, Theorem 5.1.
%% =========================================================

\chapter{Operator convexity and Jensen inequalities}\label{ch:operator_convexity}

This chapter collects operator convexity and concavity results, trace
...
\cite[Theorem~5.1]{Wolf2012Quantum}. They are not used in the non-periodic
Fundamental Theorem dependency chain. They appear here as analytic background
for the entropy, matrix product density operator, and parent-Hamiltonian
...
\begin{corollary}[Concavity of Lieb's map in the second argument]
    ...
    the map $B\mapsto\Re\tr(K^\dagger A^s K B_1^{1-s})$ is concave:
    \[
