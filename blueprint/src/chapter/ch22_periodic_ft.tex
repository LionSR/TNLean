...
\begin{theorem}[Blocked equal-case Z-gauge extraction from the periodic theorem]
    ...
    This is only the equal-case application of the periodic Fundamental Theorem:
    the irreducible-form hypothesis on $A^{[p]}$ is an explicit assumption, not
    a consequence of equality of MPV families.
\end{theorem}
