...
\begin{theorem}[Periodic cyclic sectors with support isometries]
    ...
    \begin{proof}
        \leanok
        Apply the cyclic-sector decomposition with support isometries to the
        cyclic-sector decomposition of the periodic tensor, and retain the
        rectangular support isometries supplied by that theorem.
    \end{proof}
\end{theorem}
