...
% Appendix C.2, lines 1465--1470 (the display following the sector
% splitting). The inverse-map layer above supplies the contraction
% mechanism, but the sector splitting of the basis-adapted operator and the
% projector argument itself are not yet formalized, so the statement below
% carries no Lean counterpart.
