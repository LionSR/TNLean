...
\begin{proof}
    \leanok
    Expand the product of the sums defining the neighboring operators. Relabel
    the horizontal configuration cyclically by $g_n\mapsto g_{n+1}$. The
    factors containing $L_n$ and $R_n$ then separate; cyclic invariance of the
    finite product and commutativity of scalar multiplication give the stated
    identity.
\end{proof}
...
\begin{proof}
    ...
    Expanding the trace of the matrix word gives the cyclic sum in
