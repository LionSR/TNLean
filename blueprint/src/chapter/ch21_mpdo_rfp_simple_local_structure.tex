...
\begin{proof}
    ...
    If $T$ were not primitive, choose a positive power whose Frobenius
    decomposition contains at least two primitive diagonal blocks. The
    corresponding sectors split into two nonempty communicating classes. The
