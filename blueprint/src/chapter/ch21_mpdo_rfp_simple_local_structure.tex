...
\begin{theorem}[Evaluation of the three-site inverse-map contraction]
    ...
    \[
        ...
        R_{\beta_3,\alpha_1}.
    \]
    \textbf{Local fix (tail index).} The source display repeats the third-site
    left index in the tail entry. Direct contraction gives
    $R_{\beta_3,\alpha_1}$ as above. This correction is recorded in
