...
\begin{theorem}[Transport of a normal basis along equal MPV families]
    ...
    \leanok
    \uses{def:bnt_cpsv, def:same_mpv}
...
\begin{proof}\leanok
    ...
    are unchanged; substitute the equality of the represented MPV families in
...
\begin{proof}\leanok
    \uses{lem:mpdo_eval_word_scalar_scaling}
    Apply Lemma~\ref{lem:mpdo_eval_word_scalar_scaling} to the two length-$N$
    physical words, then use linearity of the virtual trace.
\end{proof}
...
\begin{proof}\leanok
    \uses{lem:mpdo_eval_word_scalar_scaling}
    Apply Lemma~\ref{lem:mpdo_eval_word_scalar_scaling} to the two length-$L$
    words encoded by the physical block.
\end{proof}
...
\begin{proof}\leanok
    ...
    decomposition as the source basis. Their sector power sums span every
    positive-length family, and the canonical-form gauge preserves the
    represented matrix products. The non-nilpotency condition is unchanged.
\end{proof}
