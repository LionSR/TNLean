...
\begin{theorem}[Presentation independence of BNT nonnilpotency]
    ...
    \leanok
    \uses{def:cpsv_active_bnt_sector_presentation, def:mpdo_doubled_phys_trace_transfer}
...
\begin{proof}\leanok
    \uses{thm:cpsv_active_bnt_presentation_uniqueness, thm:mpdo_doubled_phys_trace_nilpotent_gauge_phase}
...
\begin{definition}[Source-simple tensor]
    ...
    \leanok
    \uses{def:mpdo, def:mpdo_physical_blocking, def:cpsv_active_bnt_sector_presentation, def:mpdo_doubled_phys_trace_transfer}
...
\begin{proof}\leanok
    \uses{def:cpsv_active_bnt_sector_presentation, lem:mpdo_three_first_site_contraction_coefficients, thm:mpdo_closed_chain_physical_blocking}
...
\begin{proof}\leanok
    \uses{thm:mpdo_source_simple_positive_rescaling, thm:mpdo_mpo_scalar_scaling}
...
\begin{proof}\leanok
    \uses{thm:mpdo_nonvanishing_source_simple_positive_rescaling, thm:mpdo_source_simple_positive_rescaling_iff, thm:mpdo_mpo_scalar_scaling}
...
\begin{definition}[Normalized fixed-representative simplicity]
    ...
    \leanok
    \uses{def:mpdo, def:mpdo_physical_blocking, def:mpdo_simple_cf_tensor}
...
\begin{proof}\leanok
    \uses{cor:sector_bnt_cf_basis_normal, thm:is_normal_tensor_of_is_normal_left_canonical, lem:sector_bnt_weight_unit_exists_of_struct, thm:gauge_invariance, def:cpsv_active_bnt_sector_presentation}
...
\begin{theorem}[Normalized simplicity implies nonvanishing source simplicity
    ...
    \leanok
    \uses{def:mpdo_nonvanishing_source_simple_tensor, def:mpdo_simple_tensor}
...
\begin{theorem}[Vanishing separates source simplicity from its strengthening]
    ...
    \leanok
    \uses{def:mpdo_source_simple_tensor, def:mpdo_nonvanishing_source_simple_tensor, def:mpdo_simple_tensor}
...
\begin{proof}\leanok
    \uses{thm:mixed_transfer_quasi_idempotent_of_direct_sum, lem:transfer_map_smul, lem:trace_transfer_map_left_canonical}
...
\begin{proof}\leanok
    \uses{thm:bnt_unit_weight_quasi_idempotent_scalar, thm:cpsv_gauge_transfer_quasi_idempotence}
