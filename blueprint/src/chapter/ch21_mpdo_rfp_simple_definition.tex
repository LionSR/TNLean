...
\begin{definition}[Nonvanishing source-simple tensor]
    ...
    \begin{align}
        ...
        \notag
    \end{align}
    The nonvanishing condition is a project strengthening and is not part of
...
\begin{proof}\leanok
    ...
    $Z^2=I$. Thus tracing $Z^N$ gives the displayed closed-MPO formula, which
    is $2I$ at even lengths and zero at odd lengths. In particular the family
    is positive semidefinite, while $\rho^{(1)}(M)=0$.

    Block two sites. The normalized canonical form has one sector, represented
