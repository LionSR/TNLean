...
\begin{proof}\leanok
    \uses{cor:sector_bnt_cf_basis_normal, thm:is_normal_tensor_of_is_normal_left_canonical, lem:sector_bnt_weight_unit_exists_of_struct, thm:gauge_invariance, def:cpsv_bnt_sector_presentation}
    ...
    is a BNT presentation of the blocked tensor. Its representatives
