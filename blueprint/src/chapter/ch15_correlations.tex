...
\begin{remark}[Lean status]
    The current Lean formalization of this result is a packaging lemma:
    it \emph{assumes} a decomposition
...
\begin{remark}[Lean status]
    Similarly, the current Lean formalization of this bound assumes
    $\|C(X,Y;n)\| \le C_{XY}\,\|\lambda_2\|^n$ as a hypothesis
