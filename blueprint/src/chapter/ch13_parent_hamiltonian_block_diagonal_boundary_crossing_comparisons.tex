...
\begin{lemma}[Local direct-sum constraint from block-diagonal boundary conditions]
    ...
    \leanok
    \uses{lem:block_diagonal_boundary_cyclic_restriction_sum, lem:block_sum_local_ground_space}
...
\begin{proof}
    ...
    Lemma~\ref{lem:block_sum_local_ground_space} identifies $G_L(B)$ with
    $\bigvee_jG_L(A_j)$.
