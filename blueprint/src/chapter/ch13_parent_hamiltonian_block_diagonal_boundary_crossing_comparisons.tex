...
\begin{theorem}[Fixed boundary-crossing $C^j,D^j$ comparison from the local block-sum constraint]
    ...
    \begin{align}
        ...
        \label{eq:parent_fixed_boundary_crossing_comparison}
    \end{align}
...
\begin{proof}
    ...
    (\ref{eq:parent_fixed_boundary_crossing_comparison}).
\end{proof}
...
\begin{proof}
    ...
    (\ref{eq:parent_fixed_boundary_crossing_comparison}). Thus
...
\begin{lemma}[Boundary-crossing cyclic intervals from the boundary matrix identity]
    ...
    \begin{align}
        ...
        &=
        A^j_\beta E.
        \label{eq:parent_boundary_crossing_matrix_identity}
    \end{align}
    Then
    \begin{align}
        R_{i,\tau}\!\left(\Gamma_N^{A_j}(\mu_j^NX_j)\right)
...
\begin{proof}
    ...
    (\ref{eq:parent_boundary_crossing_matrix_identity}). The last expression is
...
\begin{lemma}[Last crossing-window coefficient comparison]
    ...
    \begin{align}
        ...
        &=
        A^j_bE_jA^j_a.
        \label{eq:parent_last_crossing_coefficient_comparison}
    \end{align}
\end{lemma}
...
\begin{proof}
    ...
    gives (\ref{eq:parent_last_crossing_coefficient_comparison}).
\end{proof}
...
\begin{proof}
    ...
    (\ref{eq:parent_last_crossing_coefficient_comparison}). By
