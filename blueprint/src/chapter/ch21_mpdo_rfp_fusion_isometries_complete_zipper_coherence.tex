...
\begin{theorem}[Complete zipper family from a BNT]%
    ...
    In particular, the two zipper identities, exact reconstruction,
    injectivity, and the simultaneous left inverse of the block coefficients
    are conclusions, not additional hypotheses.
\end{theorem}
\begin{proof}\leanok
