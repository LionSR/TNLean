...
\begin{theorem}[Simultaneous left inverse after blocking]%
    ...
    $B_c^{[L]}$ have a simultaneous left inverse at one blocked site, as in
...
\begin{proof}\leanok
    ...
    Definition~\ref{def:mpdo_block_left_inverse}. Each blocked letter of a product is a word of
