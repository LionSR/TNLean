...
\begin{remark}[External cohomological interpretation]%
    ...
    In one-dimensional symmetry-protected topological phases, a $U(1)$-valued factor system
    of a symmetric MPS defines a cohomology class in $H^{2}(G,U(1))$ \cite{PerezGarcia2008StringOrder}.
\end{remark}
