...
See the lean-conventions skill's PROOF_INTEGRITY reference (docs/PROOF_INTEGRITY.md holds only the project addendum) for the full integrity ruleset and docs/paper-gaps/
