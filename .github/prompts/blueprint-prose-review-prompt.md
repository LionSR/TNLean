...
Authoritative source for category B: the lean-conventions skill's `prose_style.md` reference (`the lean-conventions skill's prose_style reference (project-local addenda: docs/project_conventions.md)` holds only the project addendum). Read it once
...
**Read the lean-conventions skill's `prose_style.md` reference (`the lean-conventions skill's prose_style reference (project-local addenda: docs/project_conventions.md)` holds only the project addendum) before reviewing.** It is the single
