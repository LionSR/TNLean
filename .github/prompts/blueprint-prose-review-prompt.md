...
Authoritative source for category B: the lean-conventions skill's prose_style reference, with the project addendum in `docs/project_conventions.md`. Read them once
...
**Read the lean-conventions skill's prose_style reference and the project addendum in `docs/project_conventions.md` before reviewing.** They are the single
