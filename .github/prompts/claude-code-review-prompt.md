...
1. 🔴 **Proof integrity**: Read the lean-conventions skill's PROOF_INTEGRITY reference and the project addendum in `docs/project_conventions.md` for the complete list of proof
