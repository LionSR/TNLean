...
\[ \tenkzkernel \begin{tenkzeq}
  \begin{tenkz}[rows={wire,wire,wire,wire,wire,wire}, cols=5, bonds=none]
    ...
    % Downward pull of the MPO's junction chain; only the final leg keeps the arrowhead.
    ...
    \tnwire[kind=string, route=arc, name=p2,
      cross={over at crossing of p1 and p2}]{jp1}{jp2}
    \tnwire[kind=string, route=arc, dir=to, name=p3,
