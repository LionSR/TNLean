...
\[
  \begin{tenkzfree}
    ...
    \tnjoin[route=arc]{s1.north}{s1.east}
    \tnjoin[route=arc]{s1.south}{s1.west}
    \tnjoin[route=arc]{s2.north}{s2.east}
    \tnjoin[route=arc]{s2.south}{s2.west}
    \tnjoin[route=arc]{s3.north}{s3.east}
    \tnjoin[route=arc]{s3.south}{s3.west}
    \tnjoin[route=arc]{s4.north}{s4.east}
    \tnjoin[route=arc]{s4.south}{s4.west}
