...
\cs_generate_variant:Nn \tenkz_enclosure_register_existing:nn { eV, VV }
...
\cs_new_protected:Npn \tenkz_enclosure_label:nnn #1#2#3
  {
    ...
    \str_case:nnF {#1}
      ...
      { \msg_error:nnn {tenkz}{enclosure-label-pos}{#1} }
...
\cs_new_protected:Npn \tenkz_enclosure_draw:nnnnn #1#2#3#4#5
  {
    ...
    \bool_if:NT \l__tenkz_enclosure_valid_bool
      {
        ...
        \tl_if_blank:nF {#5}
          { \tenkz_enclosure_register_existing:nV {#5}
        ...
        \begin{scope}[local~bounding~box=\l__tenkz_enclosure_result_tl]
          \begin{pgfonlayer}{background}
            \use:e
              {
                \exp_not:N \node
                  [#2, fit=\exp_not:V \l__tenkz_enclosure_fit_tl,
...
\cs_generate_variant:Nn \tenkz_enclosure_draw:nnnnn { VVVVV }
\cs_generate_variant:Nn \tenkz_enclosure_register_existing:nn { nV }
