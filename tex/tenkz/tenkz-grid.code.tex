...
\pgfkeys{
  ...
  /tenkz/span/label~pos/.is~choice,
  /tenkz/span/label~pos/north/.code={
      \tl_set:Nn \l__tenkz_spanlabelpos_tl {north}},
  /tenkz/span/label~pos/south/.code={
      \tl_set:Nn \l__tenkz_spanlabelpos_tl {south}},
  /tenkz/span/label~pos/east/.code={
      \tl_set:Nn \l__tenkz_spanlabelpos_tl {east}},
  /tenkz/span/label~pos/west/.code={
      \tl_set:Nn \l__tenkz_spanlabelpos_tl {west}},
  /tenkz/span/label~pos/north~east/.code={
      \tl_set:Nn \l__tenkz_spanlabelpos_tl {north~east}},
  /tenkz/span/label~pos/north~west/.code={
      \tl_set:Nn \l__tenkz_spanlabelpos_tl {north~west}},
  /tenkz/span/label~pos/south~east/.code={
      \tl_set:Nn \l__tenkz_spanlabelpos_tl {south~east}},
  /tenkz/span/label~pos/south~west/.code={
      \tl_set:Nn \l__tenkz_spanlabelpos_tl {south~west}},
  /tenkz/span/label~pos/center/.code={
      \tl_set:Nn \l__tenkz_spanlabelpos_tl {center}},
}
\NewDocumentCommand \tnspan { O{brace~above} m m }
  {
    ...
    \seq_put_right:Ne \l__tenkz_spans_seq
      { { \int_use:N \l__tenkz_row_int }{ \int_use:N \l__tenkz_col_int }
        { #2 }{ \l__tenkz_spankind_tl }{ \l__tenkz_spanlabelpos_tl }
        { \exp_not:n{#3} } }
  }
    ...
    \prop_get:NnNT \l__tenkz_kind_prop {#1-#2} \l__tenkz_kind_tl
      {
        ...
        \prop_get:NnNT \l__tenkz_name_prop {#1-#2} \l_tmpa_tl
          { \tenkz_enclosure_register_existing:eV {cell:#1-#2} \l_tmpa_tl }
      }
  }
...
\cs_new_protected:Npn \tenkz_draw_span:nnnnnn #1#2#3#4#5#6
  {
