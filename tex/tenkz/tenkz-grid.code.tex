...
\cs_new:Npn \tenkz_face_arity:N #1
  { \str_if_eq:VnTF #1 {center} {1}
      { \str_if_eq:VnTF #1 {rows} {\int_use:N \l__tenkz_cwires_int}
          { \clist_count:V #1 } } }

\cs_new_protected:Npn \tenkz_emit_faceports_one:nnn #1#2#3
  {
    \tenkz_face_ports:nN {#3} \l__tenkz_faceports_tl
    \tenkz@event{faceports|picture=\the\tenkz@pictureid|cell=#1-#2|face=#3|arity=\tenkz_face_arity:N \l__tenkz_faceports_tl|at=\tl_use:N \l__tenkz_faceports_tl}
  }
...
\cs_new_protected:Npn \tenkz_cell_fuse_combined:nnnN #1#2#3#4
  {
    ...
    \bool_lazy_or:nnT
      ...
      { \str_if_eq_p:Vn \l_tmpa_tl {fusec} }
      {
        ...
        \exp_args:NV \tenkz_cell_opts:n \l_tmpb_tl
        \tenkz_fuse_resolve_combined:
        \str_if_eq:VnT \l__tenkz_fcombined_tl {#3}
          { \bool_set_true:N #4 }
      }
  }
...
\cs_new_protected:Npn \tenkz_leg_count:nN #1#2
  {
    ...
    \int_set:Nn #2 { \tenkz_face_arity:N \l__tenkz_faceports_tl }
  }
