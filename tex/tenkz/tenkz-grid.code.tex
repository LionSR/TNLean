...
\cs_new_protected:Npn \tenkz_center_face_contracted:nnnN #1#2#3#4
  {
    ...
    \str_if_eq:nnTF {#3}{west}
      { \int_set:Nn \l__tenkz_centerneighbor_int {#2-1} }
      { \int_set:Nn \l__tenkz_centerneighbor_int {#2+1} }
    \bool_lazy_and:nnT
      { \int_compare_p:nNn {\l__tenkz_centerneighbor_int} > {0} }
      { \int_compare_p:nNn
          {\l__tenkz_centerneighbor_int} < {\l__tenkz_ncols_int+1} }
      {
        \int_step_inline:nnn {#1}{\l__tenkz_centerlast_int}
          {
            \prop_if_in:NeT \l__tenkz_owner_prop
              {##1-\int_use:N\l__tenkz_centerneighbor_int}
              {
                \tenkz_get:NeN \l__tenkz_kind_prop
                  {##1-\int_use:N\l__tenkz_centerneighbor_int}
                  \l__tenkz_pkind_tl
                \str_if_eq:VnF \l__tenkz_pkind_tl {skip}
                  {
                    \str_if_eq:nnTF {#3}{west}
                      { \tenkz_cell_virtual_row_port:nnnN {##1}
                          {\l__tenkz_centerneighbor_int}{east}
                          \l_tmpa_bool }
                      { \tenkz_cell_virtual_row_port:nnnN {##1}
                          {\l__tenkz_centerneighbor_int}{west}
                          \l_tmpa_bool }
                    \bool_if:NT \l_tmpa_bool { \bool_set_true:N #4 }
                  }
              }
          }
      }
