...
\cs_new_protected:Npn \tenkz_pair_wide:nn #1#2
  {
    ...
    % own facing declaration is centred, that partner presents one centred
    ...
    % cells, holes, ghosts, or a facing multi-port list) pairs per
    % named column.
    ...
    \bool_if:NT \l__tenkz_pwsingle_bool
      {
        ...
        \exp_args:NV \tenkz_cell_opts:n \l_tmpb_tl
        \tenkz_face_ports:nN {up} \l__tenkz_faceports_tl
        \str_if_eq:VnF \l__tenkz_faceports_tl {center}
            ...
            \str_if_eq:VnT \l__tenkz_pkind_tl {fuse}
              {
                ...
                \str_if_eq:VnTF \l__tenkz_faceports_tl {center}
                  { \int_compare:nNnT {####1} = {\l__tenkz_first_int}
                      { \int_incr:N \l__tenkz_bvw_int } }
                  {
                    \tenkz_face_ports:nN {east} \l__tenkz_faceports_tl
                    \str_if_eq:VnT \l__tenkz_faceports_tl {center}
                      { \int_compare:nNnT {####1} = {\l__tenkz_last_int}
                          { \int_incr:N \l__tenkz_bve_int } }
                  }
              }
            \bool_lazy_any:nT
