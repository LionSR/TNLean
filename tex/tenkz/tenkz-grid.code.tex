...
\cs_new_protected:Npn \tenkz_cell_opts:n #1
  {
    ...
    \tenkz_normalize_slot_face:Nn \l__tenkz_clegsat_tl
      {\l__tenkz_cphysicalspan_int}
    \tenkz_normalize_slot_face:Nn \l__tenkz_cupat_tl
      {\l__tenkz_cphysicalspan_int}
    \tenkz_normalize_slot_face:Nn \l__tenkz_cdownat_tl
      {\l__tenkz_cphysicalspan_int}
  }
...
\cs_new_protected:Npn \tenkz_center_face_contracted:nnnN #1#2#3#4
  {
    ...
    \int_step_inline:nnn {#1}{\l__tenkz_centerlast_int}
      { \prop_if_in:NeT \l__tenkz_virtualpaired_prop {##1-#2-#3}
          { \bool_set_true:N #4 } }
  }
...
\prop_new:N \l__tenkz_sigopenlower_prop
        ...
        \bool_if:NF \l__tenkz_cnolegs_bool
          {
            \tenkz_face_ports:nN {up} \l__tenkz_faceports_tl
            \str_if_eq:VnTF \l__tenkz_faceports_tl {center}
              { \prop_if_in:NeF \l__tenkz_sigopenlower_prop
                  {#1-\tl_use:N\l__tenkz_pwbase_tl}
                  { \prop_put:Nen \l__tenkz_sigopenlower_prop
                      {#1-\tl_use:N\l__tenkz_pwbase_tl} {}
...
\cs_new_protected:Npn \tenkz_emit_signature:
  {
    ...
    \prop_clear:N \l__tenkz_sigopenlower_prop
...
\cs_new_protected:Npn \tenkz_periodic_endpoints:nnnN #1#2#3#4
  {
    \tenkz_cell_virtual_row_port:nnnN {#1}{#2}{west}
      \l__tenkz_periodicwest_bool
    \tenkz_cell_virtual_row_port:nnnN {#1}{#3}{east}
    ...
    \bool_if:nT
      ...
      }
      {
        \msg_warning:nne {tenkz}{periodic-face-ports}
          {\int_eval:n{#1}}
        \tenkz@event{warning|picture=\the\tenkz@pictureid|code=periodic-face-ports|row=\int_eval:n{#1}}
        \bool_if:NTF \l__tenkz_periodicwest_bool
          {
            \tenkz_anchor:nnnN {#1}{#2}{west} \l__tenkz_pa_tl
            \draw[\tl_use:N \l__tenkz_cell_tl]
              \l__tenkz_pa_tl -- ++\tenkz_stub_vec:n{west};
            \int_incr:N \l__tenkz_bvw_int
          }
          {
            \tenkz_anchor:nnnN {#1}{#3}{east} \l__tenkz_pa_tl
            \draw[\tl_use:N \l__tenkz_cell_tl]
