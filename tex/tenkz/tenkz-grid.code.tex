...
\cs_new_protected:Npn \tenkz_emit_faceports_one:nnnn #1#2#3#4
  {
    ...
    \tenkz@event{faceports|picture=\the\tenkz@pictureid|%
cell=#1-#2|face=#3|%
arity=\tenkz_face_arity:nN {#4} \l__tenkz_faceports_tl|%
at=\tl_use:N \l__tenkz_faceports_tl}
  }
...
\cs_new_protected:Npn \tenkz_emit_faceports_rows:nnn #1#2#3
  { \tenkz@event{faceports|picture=\the\tenkz@pictureid|%
cell=#1-#2|face=#3|arity=\int_use:N\l__tenkz_cwires_int|at=rows} }
                    ...
                    \bool_if:nF { \tenkz_traced_p:nn {#1}{#2} }
                      {
                        \prop_if_in:NeTF \l__tenkz_opencell_prop
                          ...
                          }
                          {
                            ...
                            \tenkz@event{pairleg|picture=\the\tenkz@pictureid|%
upper=#1-#2|lower=\int_eval:n{#1+1}-\l__tenkz_pwbase_tl|%
upper-port=#3|column=\int_eval:n{#2+#3-1}}
                          }
                      }
                  }
                  {
                        ...
                        \bool_if:NTF \l_tmpa_bool
                          { \tenkz_phtrace_site:n {##1} }
                          {
                            \msg_warning:nnnn {tenkz}{phtrace-face-ports}
                              {1}{##1}
                            \tenkz@event{warning|%
picture=\the\tenkz@pictureid|code=phtrace-face-ports|cell=1-##1}
                          }
                      } }
              }
          }
