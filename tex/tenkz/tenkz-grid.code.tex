      ...
      }
      {
        ...
        \prop_get:NeNTF \l__tenkz_tall_prop
          {\int_eval:n{#1}-\l_tmpa_tl} \l_tmpb_tl
          {
            ...
            % glyph.  Split faces retain their separate row-height anchors.
...
\cs_new_protected:Npn \tenkz_cell_no_legs:nnN #1#2#3
  {
    \bool_set_false:N #3
    \prop_get:NeNF \l__tenkz_owner_prop
      {\int_eval:n{#1}-\int_eval:n{#2}} \l__tenkz_nolegsbase_tl
      { \tl_set:Ne \l__tenkz_nolegsbase_tl {\int_eval:n{#2}} }
    \tenkz_get:NeN \l__tenkz_kind_prop
      {\int_eval:n{#1}-\l__tenkz_nolegsbase_tl} \l__tenkz_pkind_tl
    \bool_lazy_or:nnT
      { \str_if_eq_p:Vn \l__tenkz_pkind_tl {tn} }
      { \str_if_eq_p:Vn \l__tenkz_pkind_tl {tnc} }
      {
        \tenkz_get:NeN \l__tenkz_opts_prop
          {\int_eval:n{#1}-\l__tenkz_nolegsbase_tl} \l_tmpb_tl
        \exp_args:NV \tenkz_cell_opts:n \l_tmpb_tl
    ...
    \str_if_eq:VnTF \l__tenkz_faceports_tl {center}
      {
        \tenkz_cell_physical_port:nnnN
          {\int_eval:n{#1+1}}{#2}{up} \l_tmpa_bool
        \bool_if:NT \l_tmpa_bool
          {
...
\prop_new:N \l__tenkz_openlowerowner_prop
\cs_new_protected:Npn \tenkz_open_lower_span:nnn #1#2#3
  {
    ...
    \int_step_inline:nn {\l__tenkz_openlowerspan_int}
      {
        \prop_get:NeNF \l__tenkz_owner_prop
          {\int_eval:n{#1+1}-\int_eval:n{#2+##1-1}} \l__tenkz_pwbase_tl
          { \tl_set:Ne \l__tenkz_pwbase_tl {\int_eval:n{#2+##1-1}} }
        \prop_if_in:NeF \l__tenkz_openlowerowner_prop
          {#1-\l__tenkz_pwbase_tl}
          {
            \prop_put:Nen \l__tenkz_openlowerowner_prop
              {#1-\l__tenkz_pwbase_tl} {}
...
\cs_new_protected:Npn \tenkz_draw_legs:
  {
    ...
    \prop_clear:N \l__tenkz_openlowerowner_prop
