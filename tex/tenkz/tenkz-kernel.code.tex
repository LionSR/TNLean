...
\cs_new_protected:Npn \__tenkz_kernel_r_onwire_arc:n #1
  {
    ...
    \bool_if:NTF \l__tenkz_kernel_r_arc_wrap_bool
      {
        % a wrap's beads stand on its middle run: the two folds are the
        % route's own turns, and the run between the two stations is the
        % stretch a bead can meaningfully divide
      ...
      { \__tenkz_kernel_r_onwire_arc_measure:n {#1} }
    \seq_pop_right:NN \l__tenkz_kernel_ow_run_stack_seq
      \l__tenkz_kernel_ow_t_tl
    \seq_pop_right:NN \l__tenkz_kernel_ow_run_stack_seq
      \l__tenkz_kernel_ow_c_tl
...
% sub-point tolerance.
\cs_new_protected:Npn \__tenkz_kernel_r_onwire_arc_measure:n #1
  {
