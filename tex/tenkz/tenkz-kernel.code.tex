...
\cs_new_protected:Npn \__tenkz_kernel_r_skin_wire:n #1
  {
    ...
    % foreground under an emphwidth paper halo; the recorded band is the
    % wider of the two, per the trace doctrine, so a label erased by the
    % halo cannot pass unflagged.
    \tl_set:Ne \l__tenkz_kernel_ink_stroke_tl
      { \dim_to_decimal_in_sp:n { \__tenkz_dim:n {emphwidth} / 2 } }
    \exp_args:NV \__tenkz_kernel_r_wire_ink_event:nn
