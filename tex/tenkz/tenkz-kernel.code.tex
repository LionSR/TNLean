...
% authored port is, and it records its face under its own key; both readings
% run, so a policy row is not passed over the way it once was when the closure
% read authored cells alone.
...
\cs_new_protected:Npn \__tenkz_kernel_r_trace_leg_ink:nn #1#2
  {
...
\cs_new_protected:Npn \__tenkz_kernel_r_trace_port_ink:n #1
  { \__tenkz_kernel_r_trace_leg_ink:nn {#1} {port-face} }
\cs_new_protected:Npn \__tenkz_kernel_r_trace_policy_ink:n #1
  { \__tenkz_kernel_r_trace_leg_ink:nn {#1} {face} }
