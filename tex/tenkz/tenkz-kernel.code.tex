    ...
    \str_case:enF { \__tenkz_kernel_r_item:nn {#1} {kind} }
      {
        ...
        {port}
          { \__tenkz_kernel_dep_add:e { \__tenkz_kernel_r_item:nn {#1} {record} } }
        {onwire}
...
\cs_new_protected:Npn \__tenkz_kernel_r_wire_route:n #1
  {
    ...
    \str_if_eq:VnT \l__tenkz_kernel_dep_look_tl {string}
...
\cs_new_protected:Npn \__tenkz_kernel_r_onwire:n #1
  {
    ...
    \quark_if_no_value:NTF \l__tenkz_kernel_ow_a_tl
      ...
      }
      {
        ...
        \str_if_eq:VnTF \l__tenkz_kernel_ow_kind_tl {string}
...
% Author label tokens enter one box.  The invisible local-axis measurement
% and the final turned node copy that box, so sizing cannot execute the
% author's tokens twice.
\cs_new_protected:Npn \__tenkz_kernel_hull_measure_glyph:n #1
  {
    \cs_if_exist:cF { l__tenkz_kernel_hull_#1_box }
      { \box_new:c { l__tenkz_kernel_hull_#1_box } }
    ...
    \group_begin:
      ...
      \exp_args:NVV \__tenkz_render_measure_node:nnn
        ...
        {
          \hbox_gset:cn { l__tenkz_kernel_hull_#1_box }
            {
          ...
          \exp_args:Nc \tex_copy:D { l__tenkz_kernel_hull_#1_box }
        }
    \group_end:
    ...
    \fp_compare:nNnF { \l__tenkz_kernel_r_ink_turn_tl } = {0}
      {
        \tl_put_right:Ne \l__tenkz_kernel_r_c_tl
          { , rotate = \tl_use:N \l__tenkz_kernel_r_ink_turn_tl }
      }
