...
% the row and hangs nothing on any return's side.
...
% through this one function, so the two cannot drift.  The envelope walk
% writes the b and c registers, so the ink scan -- which reads the outward
% sign -- runs after it.
