...
\prop_new:N \l__tenkz_kernel_basis_live_prop  % canonical "r-c-k" -> atom id
    ...
    \bool_if:NT \l__tenkz_kernel_basis_member_live_bool
      {
        ...
        \quark_if_no_value:NF \l_tmpc_tl
          {
            \prop_put:Nee \l__tenkz_kernel_basis_live_prop
...
% cell overrides contribute no slot; member-addressed replacements remain
% live; spanning records contribute only their anchor.  Geometry checks each
% bounded member-pair/translation candidate against this index directly, so a
% sparse or nearly complete picture never constructs a live-record square.
\cs_new_protected:Npn \__tenkz_kernel_basis_spacing_candidates:
  {
    ...
    \prop_set_eq:NN \l__tenkz_kernel_basis_spacing_candidate_prop
      \l__tenkz_kernel_basis_live_prop
    \prop_put:Nnn \l__tenkz_kernel_basis_spacing_candidate_prop {slots} {1}
  }
