...
% Stock names are ordinary declarations whose descriptors live in the
% executable registry.  Installing them through the same declaration door
% keeps their authored name in the atom record while geometry and ink resolve
% recursively through the declared base.
