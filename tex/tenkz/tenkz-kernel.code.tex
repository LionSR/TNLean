...
\cs_new_protected:Npn \__tenkz_kernel_port_used_collect:
  {
    ...
    % `physical=` is an expander whose established leg renderer already owns
    % these typed faces.  An explicit matching descriptor supplies its type
    % and label; it must not create a second open leg.
    \__tenkz_model_map_ids:nn {atom}
      {
        \__tenkz_kernel_policy_leg_renders:nT {##1}
          {
                ...
                \str_case:Vn \l__tenkz_kernel_scratch_tl
                  {
                    {up}
                      {
                        \prop_put:Nnn
                          \l__tenkz_kernel_port_used_prop {##1/90/1} {used}
                        \prop_put:Nnn
                          \l__tenkz_kernel_port_policy_prop {##1/90/1} {up}
                      }
                    {down}
                      {
                        \prop_put:Nnn
                          \l__tenkz_kernel_port_used_prop {##1/270/1} {used}
                        \prop_put:Nnn
                          \l__tenkz_kernel_port_policy_prop {##1/270/1} {down}
                      }
                    {updown}
                      {
                        \prop_put:Nnn
...
\cs_new_protected:Npn \__tenkz_kernel_r_wire_ends:n #1
  {
    ...
    \bool_lazy_and:nnT
      ...
      { \l__tenkz_kernel_r_to_bool }
      {
        ...
        \__tenkz_kernel_r_wire_port_label:nn {#1} {from}
        \__tenkz_kernel_r_wire_port_label:nn {#1} {to}
      }
  }
