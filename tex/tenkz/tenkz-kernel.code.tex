...
\msg_new:nnn {tenkz}{kernel-picture-positive}
  { [TKZ-PICTURE-POSITIVE-INTEGER]~#1=#2~must~be~a~positive~integer. }
...
\cs_new_protected:Npn \__tenkz_kernel_sugar_flag:nnn #1#2#3
  {
    \str_case:nnF {#2}
      {
        {true}  {#3}
        % a false-valued sugar flag expands nothing but is still the
        % sugar spelling: strict mode refuses it like the bare word
        {false} { \__tenkz_kernel_sugar:n {#1} }
      }
      {
        \msg_error:nneeee {tenkz}{kernel-choice}
          {#1} {#2} {true|false}
