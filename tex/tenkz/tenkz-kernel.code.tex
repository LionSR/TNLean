            ...
            {all}
              {
                ...
                \prop_if_in:NeT \l__tenkz_model_record_prop { #1 / closed }
                  {
                    \__tenkz_kernel_route_face:n {n}
                    \__tenkz_kernel_route_face:n {w}
                    \__tenkz_kernel_route_face:n {s}
                    \__tenkz_kernel_route_face:n {e}
                  }
              }
          }
...
\prg_new_conditional:Npnn
  \__tenkz_kernel_physical_policy_exits_face:nn #1#2 { p, T, F, TF }
  {
    \str_case:nnF {#1}
      {
        {up}
    ...
    \seq_map_inline:Nn \l__tenkz_kernel_ro_mem_seq
      {
        ...
        \quark_if_no_value:NF \l__tenkz_kernel_ro_tl
          {
            \exp_args:NV
              \__tenkz_kernel_physical_policy_exits_face:nnT
