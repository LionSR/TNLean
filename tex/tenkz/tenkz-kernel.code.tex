...
% A declared basis is one family of translated sites, not a list of unrelated
% page points.  Geometry finds the smallest conservative centre-bearing
        ...
        \__tenkz_geom_frame_if_affine:nT {kpic}
          {
            \__tenkz_geom_basis_spacing:nnnnnnNNN
              ...
              \l__tenkz_kernel_basis_east_prop
              \l__tenkz_kernel_basis_north_prop
            ...
            \tl_set:Ne \l__tenkz_kernel_basis_spacing_floor_tl
              {
                \__tenkz_geom_round:n
                  {
                    \prop_item:Nn
                      \l__tenkz_kernel_basis_spacing_prop {floor}
                  }
              }
            \fp_compare:nNnT
              {
              ...
              {0}
              {
                ...
                \tl_set:Ne \l__tenkz_kernel_basis_spacing_dist_tl
                  {
                    \__tenkz_geom_round:n
                      {
                        \prop_item:Nn
                          \l__tenkz_kernel_basis_spacing_prop {dist}
                      }
                  }
                ...
                \exp_args:Nnneeee \msg_warning:nnnnnn
                  {tenkz}{kernel-frame-basis-spacing}
                  {
                    ...
                    \prop_item:Nn
                      \l__tenkz_kernel_basis_spacing_prop {dr},
                    \prop_item:Nn
                      \l__tenkz_kernel_basis_spacing_prop {dc}
                    )
                  }
