...
\prop_new:N \l__tenkz_kernel_basis_live_prop  % atom id -> canonical "r-c-k"
...
\prop_new:N \l__tenkz_kernel_basis_spacing_candidate_prop % keys or `all`
...
\bool_new:N \l__tenkz_kernel_basis_population_complete_bool
...
\int_new:N  \l__tenkz_kernel_basis_spacing_outer_row_int
\int_new:N  \l__tenkz_kernel_basis_spacing_outer_col_int
\int_new:N  \l__tenkz_kernel_basis_spacing_outer_member_int
\int_new:N  \l__tenkz_kernel_basis_spacing_inner_row_int
\int_new:N  \l__tenkz_kernel_basis_spacing_inner_col_int
\int_new:N  \l__tenkz_kernel_basis_spacing_inner_member_int
...
\tl_new:N   \l__tenkz_kernel_basis_spacing_outer_id_tl
...
\cs_new_protected:Npn \__tenkz_kernel_signature_physical_bearing:nn #1#2
  {
    \__tenkz_kernel_policy_leg_exposed:nnT {#1} {#2}
      {
...
\cs_new_protected:Npn \__tenkz_kernel_signature_physical:nn #1#2
  {
    \str_case:nn {#2}
      {
        {up}
          { \__tenkz_kernel_signature_physical_bearing:nn {#1} {90} }
        {down}
          { \__tenkz_kernel_signature_physical_bearing:nn {#1} {270} }
        {updown}
          {
            \__tenkz_kernel_signature_physical_bearing:nn {#1} {90}
            \__tenkz_kernel_signature_physical_bearing:nn {#1} {270}
    ...
    \bool_if:NT \l__tenkz_kernel_basis_member_live_bool
      {
        ...
        \quark_if_no_value:NF \l_tmpc_tl
          {
            \prop_put:NVe \l__tenkz_kernel_basis_live_prop
              \l__tenkz_kernel_basis_live_id_tl
              { \l_tmpa_tl - \l_tmpb_tl - \l_tmpc_tl }
            \int_compare:nNnF { \l_tmpa_tl } = {#1}
              {
                \bool_set_false:N
                  \l__tenkz_kernel_basis_population_complete_bool
              }
            \int_compare:nNnF { \l_tmpb_tl } = {#2}
              {
                \bool_set_false:N
                  \l__tenkz_kernel_basis_population_complete_bool
              }
            \int_compare:nNnF { \l_tmpc_tl } = {#3}
              {
                \bool_set_false:N
                  \l__tenkz_kernel_basis_population_complete_bool
              }
          }
        \quark_if_no_value:NT \l_tmpc_tl
          {
            \bool_set_false:N
              \l__tenkz_kernel_basis_population_complete_bool
          }
      }
    \bool_if:NF \l__tenkz_kernel_basis_member_live_bool
      { \bool_set_false:N \l__tenkz_kernel_basis_population_complete_bool }
...
\cs_new_protected:Npn \__tenkz_kernel_populate:
  {
    \int_compare:nNnTF { \l__tenkz_kernel_basis_count_int } > {0}
      {
        \bool_set_true:N \l__tenkz_kernel_basis_population_complete_bool
...
\cs_new_protected:Npn
  \__tenkz_kernel_generated_port_end:nnnnnn #1#2#3#4#5#6
  {
...
\cs_new_protected:Npn \__tenkz_kernel_grid_wire_end:nnnnn #1#2#3#4#5
  {
    ...
    \int_compare:nNnTF {#2} = {#4}
      {
        \__tenkz_kernel_generated_port_end:nnnnnn
    ...
    \int_compare:nNnTF {#1} = {0}
      {
        ...
        \__tenkz_kernel_generated_port_end:nnnnnn
          ...
          { \__tenkz_kernel_rows: } {#2} {270} {physical}
      }
      {
        \__tenkz_kernel_closure_wire:nnnn
...
\tl_new:N \l__tenkz_kernel_port_policy_label_tl
...
\prop_new:N \l__tenkz_kernel_port_policy_label_owner_prop
...
\msg_new:nnn {tenkz}{kernel-port-label-conflict}
  { [TKZ-PORT-LABEL-CONFLICT]~typed~port~#2~on~atom~#1~conflicts~with~
    its~physical-policy~label. }
...
\msg_new:nnn {tenkz}{kernel-port-direction}
  { [TKZ-PORT-DIRECTION]~physical~index~wire~#1~cannot~carry~dir=#2. }
\msg_new:nnn {tenkz}{kernel-port-consumed}
  { [TKZ-PORT-CONSUMED]~typed~port~#1~is~consumed~by~both~wire~#2~and~#3. }
\cs_generate_variant:Nn \__tenkz_model_complete:nnn { nVV }
\cs_generate_variant:Nn \__tenkz_model_complete_raw:nnn { nVV }
...
\cs_new_protected:Npn \__tenkz_kernel_port_used_collect:
  {
    ...
    \prop_clear:N \l__tenkz_kernel_port_policy_label_owner_prop
    \__tenkz_model_map_ids:nn {wire}
      {
        \bool_set_true:N \l_tmpa_bool
    ...
    % `physical=` is an expander whose established leg renderer owns the
    % transverse centre of an odd-width host.  That centre has a numbered
    % port identity; an even-width centre lies between slots and consumes
    % none.  A matching descriptor supplies the centre leg's type and label.
    \__tenkz_model_map_ids:nn {atom}
      {
        \__tenkz_kernel_policy_leg_port_slot:nN {##1}
          \l__tenkz_kernel_port_slot_tl
                    ...
                    {up}
                      {
                        \prop_put:Nen
                          \l__tenkz_kernel_port_used_prop
                          {##1/90/\l__tenkz_kernel_port_slot_tl} {used}
                        \prop_put:Nen
                          \l__tenkz_kernel_port_policy_prop
                          {##1/90/\l__tenkz_kernel_port_slot_tl} {up}
                      }
                    {down}
                      {
                        \prop_put:Nen
                          \l__tenkz_kernel_port_used_prop
                          {##1/270/\l__tenkz_kernel_port_slot_tl} {used}
                        \prop_put:Nen
                          \l__tenkz_kernel_port_policy_prop
                          {##1/270/\l__tenkz_kernel_port_slot_tl} {down}
                      }
                    {updown}
                      {
                        \prop_put:Nen
    ...
    \bool_if:NT \l__tenkz_kernel_port_materialize_bool
      {
        \tl_if_blank:VF \l__tenkz_kernel_port_label_tl
          {
            \prop_if_in:NVF
              \l__tenkz_kernel_port_policy_label_owner_prop
              \l__tenkz_kernel_scratch_tl
              {
...
\cs_new_protected:Npn \__tenkz_kernel_port_policy_consume:n #1
  {
    \prop_get:NVN
      \l__tenkz_kernel_port_policy_prop \l__tenkz_kernel_scratch_tl
      \l__tenkz_kernel_port_policy_field_tl
    \quark_if_no_value:NF \l__tenkz_kernel_port_policy_field_tl
      {
        \str_if_eq:VnTF \l__tenkz_kernel_port_type_tl {physical}
          {
            \bool_if:NT \l__tenkz_kernel_port_materialize_bool
              {
                \prop_get:NeN \l__tenkz_model_record_prop
                  {
                    #1/
                    \tl_use:N \l__tenkz_kernel_port_policy_field_tl
                  }
                  \l__tenkz_kernel_port_policy_label_tl
                \quark_if_no_value:NTF
                  \l__tenkz_kernel_port_policy_label_tl
                  {
                    \tl_if_blank:VF \l__tenkz_kernel_port_label_tl
                      {
                        % With no authored policy label, a bonded endpoint
                        % owns the descriptor.  Otherwise the policy leg does.
                        \prop_if_in:NVF
                          \l__tenkz_kernel_port_used_node_prop
                          \l__tenkz_kernel_scratch_tl
                          {
                            \__tenkz_model_complete_raw:nVV {#1}
                              \l__tenkz_kernel_port_policy_field_tl
                  ...
                  {
                    \tl_if_blank:VTF \l__tenkz_kernel_port_label_tl
                      {
                        % Once the policy face is contracted, its label moves
                        % with the port to the external wire owner.
                        \prop_if_in:NVT
                          \l__tenkz_kernel_port_external_consumer_prop
                          \l__tenkz_kernel_scratch_tl
                          {
                          ...
                          \l__tenkz_kernel_port_label_tl
                          {
                            \prop_if_in:NVF
                              ...
                              \l__tenkz_kernel_scratch_tl
                              {
                                \prop_put:NVn
                                  \l__tenkz_kernel_port_policy_label_owner_prop
                                  \l__tenkz_kernel_scratch_tl {policy}
                              }
                          }
                          {
                            \msg_error:nnee
                              {tenkz}{kernel-port-label-conflict} {#1}
                              { \tl_use:N \l__tenkz_kernel_port_face_tl }
                          }
                      }
                  }
          ...
          }
          {
            ...
            \prop_if_in:NVTF
              \l__tenkz_kernel_port_used_prop \l__tenkz_kernel_scratch_tl
              {
                ...
                \__tenkz_kernel_port_policy_consume:n {#1}
...
\cs_new_protected:Npn \__tenkz_kernel_port_wire_physical:n #1
  {
    ...
    \__tenkz_model_get:nnN {#1} {dir} \l__tenkz_kernel_scratch_tl
    \quark_if_no_value:NF \l__tenkz_kernel_scratch_tl
      {
        \str_if_eq:VnF \l__tenkz_kernel_scratch_tl {none}
          {
            \msg_error:nnee {tenkz}{kernel-port-direction} {#1}
              { \tl_use:N \l__tenkz_kernel_scratch_tl }
          }
      }
  }
...
%
% Population records one canonical address per live member record.  The cross
% product below collapses those records to the member-pair/translation mask
% geometry may evaluate.  Whole-cell overrides contribute no member record;
% member-addressed replacements remain live, and a spanning record contributes
% its anchor once rather than one alias per claimed cell.  When every visited
% member slot is live at that same canonical address, the full rectangle has
% every translation by construction; its universal marker then avoids the
% quadratic live-record cross product used only for sparse populations.
\cs_new_protected:Npn \__tenkz_kernel_basis_spacing_candidate_inner:nn #1#2
  {
    \seq_set_split:Nnn \l__tenkz_kernel_basis_spacing_address_seq {-} {#2}
    \int_set:Nn \l__tenkz_kernel_basis_spacing_inner_row_int
      { \seq_item:Nn \l__tenkz_kernel_basis_spacing_address_seq {1} }
    \int_set:Nn \l__tenkz_kernel_basis_spacing_inner_col_int
      { \seq_item:Nn \l__tenkz_kernel_basis_spacing_address_seq {2} }
    \int_set:Nn \l__tenkz_kernel_basis_spacing_inner_member_int
      { \seq_item:Nn \l__tenkz_kernel_basis_spacing_address_seq {3} }
    \bool_lazy_and:nnT
      {
        \int_compare_p:nNn
          { \l__tenkz_kernel_basis_spacing_outer_member_int } <
          { \l__tenkz_kernel_basis_spacing_inner_member_int }
      }
      {
        ! \str_if_eq_p:ee
            { \l__tenkz_kernel_basis_spacing_outer_id_tl } {#1}
      }
      {
        \prop_put:Nee \l__tenkz_kernel_basis_spacing_candidate_prop
          {
            \int_use:N \l__tenkz_kernel_basis_spacing_outer_member_int /
            \int_use:N \l__tenkz_kernel_basis_spacing_inner_member_int /
            \int_eval:n
              {
                \l__tenkz_kernel_basis_spacing_inner_row_int
                - \l__tenkz_kernel_basis_spacing_outer_row_int
              } /
            \int_eval:n
              {
                \l__tenkz_kernel_basis_spacing_inner_col_int
                - \l__tenkz_kernel_basis_spacing_outer_col_int
              }
          }
          {1}
      }
...
\cs_new_protected:Npn \__tenkz_kernel_basis_spacing_candidate_outer:nn #1#2
  {
    \seq_set_split:Nnn \l__tenkz_kernel_basis_spacing_address_seq {-} {#2}
    \int_set:Nn \l__tenkz_kernel_basis_spacing_outer_row_int
      { \seq_item:Nn \l__tenkz_kernel_basis_spacing_address_seq {1} }
    \int_set:Nn \l__tenkz_kernel_basis_spacing_outer_col_int
      { \seq_item:Nn \l__tenkz_kernel_basis_spacing_address_seq {2} }
    \int_set:Nn \l__tenkz_kernel_basis_spacing_outer_member_int
      { \seq_item:Nn \l__tenkz_kernel_basis_spacing_address_seq {3} }
    \tl_set:Nn \l__tenkz_kernel_basis_spacing_outer_id_tl {#1}
    \prop_map_function:NN \l__tenkz_kernel_basis_live_prop
      \__tenkz_kernel_basis_spacing_candidate_inner:nn
  }
...
\cs_new_protected:Npn \__tenkz_kernel_basis_spacing_candidates:
  {
    ...
    \prop_clear:N \l__tenkz_kernel_basis_spacing_candidate_prop
    ...
    \bool_if:NTF \l__tenkz_kernel_basis_population_complete_bool
      { \prop_put:Nnn \l__tenkz_kernel_basis_spacing_candidate_prop {all} {1} }
      {
        \prop_map_function:NN \l__tenkz_kernel_basis_live_prop
          \__tenkz_kernel_basis_spacing_candidate_outer:nn
      }
  }
        ...
        \__tenkz_geom_frame_if_affine:nT {kpic}
          {
            ...
            \__tenkz_geom_basis_spacing:nnnnnNNNN
              ...
              \l__tenkz_kernel_basis_spacing_candidate_prop
...
\cs_new_protected:Npn \__tenkz_kernel_route_host_face_side:nnN #1#2#3
  {
    ...
    \fp_set:Nn \l__tenkz_kernel_ro_x_fp
      { cosd( \l__tenkz_kernel_port_face_tl ) }
    \fp_set:Nn \l__tenkz_kernel_ro_y_fp
      { sind( \l__tenkz_kernel_port_face_tl ) }
    \__tenkz_kernel_ro_basis_unapply:NN
    ...
    \exp_args:NV \__tenkz_kernel_r_face_side:n
      \l__tenkz_kernel_port_face_tl
    \tl_set_eq:NN #3 \l__tenkz_kernel_r_face_side_tl
  }
...
\cs_new_protected:Npn \__tenkz_kernel_route_policy_face_add:nnn #1#2#3
  {
    \__tenkz_kernel_policy_leg_exposed:nnT {#1} {#2}
      {
        \__tenkz_kernel_route_host_face_side:nnN
          {#1} {#2} \l__tenkz_kernel_port_face_tl
...
% Cardinal policy legs use the affine chart's dual basis exactly; arbitrary
% typed faces use the shared orthogonal support fold, which remains valid for
% rotated, sheared, and mixed-carrier contours.
    ...
    \bool_if:NT \l_tmpa_bool
      {
        ...
        \bool_if:NTF \l__tenkz_kernel_leg_planned_bool
          {
            \__tenkz_kernel_r_glyph_anchor_xy:nnNN {#1}
              { \str_if_eq:nnTF {#2} {n} {north} {south} }
              \l__tenkz_kernel_r_x_fp \l__tenkz_kernel_r_y_fp
        ...
        \bool_if:NTF \l__tenkz_kernel_leg_plan_collect_bool
          ...
          { \__tenkz_kernel_r_leg_consume:nnn {#1}{#2}{#3} }
      }
  }

% Enrol one plane-carried physical leg in a discrete topology corridor.
% Rows in the same basis member, face, and logical column share a corridor;
% no page coordinate is rounded or clustered to invent that identity.
...
\cs_new_protected:Npn \__tenkz_kernel_r_leg_consume:nnn #1#2#3
  {
    \bool_if:NT \l__tenkz_kernel_leg_planned_bool
      {
    ...
    % Author-owned up=/down= tokens remain page-upright and execute once at
    % the planned tip; topology creates paths only and emits no label ink.
    \bool_if:NF \l__tenkz_kernel_topology_bool
      {
        ...
        \fp_set:Nn \l__tenkz_kernel_r_tipx_fp
          {
            \l__tenkz_kernel_r_x_fp
            + \l__tenkz_kernel_r_yc_fp
              * cosd( \l__tenkz_kernel_r_leg_turn_tl )
          }
        \fp_set:Nn \l__tenkz_kernel_r_tipy_fp
          {
            \l__tenkz_kernel_r_y_fp
            + \l__tenkz_kernel_r_yc_fp
              * sind( \l__tenkz_kernel_r_leg_turn_tl )
          }
      }
...
\fp_new:N \l__tenkz_kernel_phtrace_nu_fp
\fp_new:N \l__tenkz_kernel_phtrace_nv_fp
\fp_new:N \l__tenkz_kernel_phtrace_su_fp
\fp_new:N \l__tenkz_kernel_phtrace_sv_fp
\fp_new:N \l__tenkz_kernel_phtrace_eu_fp
\fp_new:N \l__tenkz_kernel_phtrace_ev_fp
\fp_new:N \l__tenkz_kernel_phtrace_ur_fp
\fp_new:N \l__tenkz_kernel_phtrace_vt_fp
\fp_new:N \l__tenkz_kernel_phtrace_vb_fp
\fp_new:N \l__tenkz_kernel_phtrace_xb_fp
\fp_new:N \l__tenkz_kernel_phtrace_yb_fp
\fp_new:N \l__tenkz_kernel_phtrace_xs_fp
\fp_new:N \l__tenkz_kernel_phtrace_ys_fp
\cs_new_protected:Npn \__tenkz_kernel_r_physical_trace_xy:nnNN #1#2#3#4
  {
    \__tenkz_geom_basis_apply:nnnnnnNN
      { \l__tenkz_kernel_r_basis_ex_tl }
      { \l__tenkz_kernel_r_basis_ey_tl }
      ...
      \l__tenkz_kernel_r_face_du_tl \l__tenkz_kernel_r_face_dv_tl
    \fp_set:Nn #3
      { \l__tenkz_kernel_r_x_fp + \l__tenkz_kernel_r_face_du_tl }
    \fp_set:Nn #4
      { \l__tenkz_kernel_r_y_fp + \l__tenkz_kernel_r_face_dv_tl }
  }
\cs_new_protected:Npn \__tenkz_kernel_r_physical_trace_affine:n #1
  {
    \__tenkz_kernel_r_glyph_anchor_local:nnNN {#1}{north}
      \l__tenkz_kernel_phtrace_nu_fp \l__tenkz_kernel_phtrace_nv_fp
    \__tenkz_kernel_r_glyph_anchor_local:nnNN {#1}{south}
      \l__tenkz_kernel_phtrace_su_fp \l__tenkz_kernel_phtrace_sv_fp
    \__tenkz_kernel_r_glyph_anchor_local:nnNN {#1}{east}
      \l__tenkz_kernel_phtrace_eu_fp \l__tenkz_kernel_phtrace_ev_fp
    \__tenkz_geom_xy:nNN {#1}
      \l__tenkz_kernel_r_x_fp \l__tenkz_kernel_r_y_fp
    \fp_set:Nn \l_tmpa_fp
      {
    ...
    \fp_set:Nn \l__tenkz_kernel_phtrace_ur_fp
      {
        max(
          \l__tenkz_kernel_phtrace_nu_fp,
          \l__tenkz_kernel_phtrace_su_fp,
          \l__tenkz_kernel_phtrace_eu_fp )
        + \__tenkz_metric_ratio:n {phtracereach} / \l_tmpa_fp
      }
    \fp_set:Nn \l__tenkz_kernel_phtrace_vt_fp
      {
        \l__tenkz_kernel_phtrace_nv_fp
        + \__tenkz_metric_ratio:n {physleg} / \l_tmpb_fp
      }
    \fp_set:Nn \l__tenkz_kernel_phtrace_vb_fp
      {
        \l__tenkz_kernel_phtrace_sv_fp
        - \__tenkz_metric_ratio:n {physleg} / \l_tmpb_fp
      }
    \__tenkz_kernel_r_physical_trace_xy:nnNN
      { \l__tenkz_kernel_phtrace_nu_fp }
      { \l__tenkz_kernel_phtrace_nv_fp }
      \l__tenkz_kernel_r_xb_fp \l__tenkz_kernel_r_yb_fp
    \__tenkz_kernel_r_physical_trace_xy:nnNN
    ...
    \__tenkz_kernel_r_physical_trace_xy:nnNN
      ...
      { \l__tenkz_kernel_phtrace_vt_fp }
      \l__tenkz_kernel_r_tipx_fp \l__tenkz_kernel_r_tipy_fp
    \__tenkz_kernel_r_physical_trace_xy:nnNN
      { \l__tenkz_kernel_phtrace_ur_fp }
      { \l__tenkz_kernel_phtrace_vb_fp }
      \l__tenkz_kernel_leg_bendx_fp \l__tenkz_kernel_leg_bendy_fp
    \__tenkz_kernel_r_physical_trace_xy:nnNN
      { \l__tenkz_kernel_phtrace_su_fp }
      { \l__tenkz_kernel_phtrace_vb_fp }
      \l__tenkz_kernel_phtrace_xb_fp \l__tenkz_kernel_phtrace_yb_fp
    \__tenkz_kernel_r_physical_trace_xy:nnNN
      { \l__tenkz_kernel_phtrace_su_fp }
      { \l__tenkz_kernel_phtrace_sv_fp }
      \l__tenkz_kernel_phtrace_xs_fp \l__tenkz_kernel_phtrace_ys_fp
    \__tenkz_render_stroke:nn { trace }
      {
        ...
        -- \__tenkz_kernel_r_pair:nn
          ...
          { \l__tenkz_kernel_leg_bendy_fp }
        -- \__tenkz_kernel_r_pair:nn
          { \l__tenkz_kernel_phtrace_xb_fp }
          { \l__tenkz_kernel_phtrace_yb_fp }
        -- \__tenkz_kernel_r_pair:nn
          { \l__tenkz_kernel_phtrace_xs_fp }
          { \l__tenkz_kernel_phtrace_ys_fp }
      }
  }
    ...
    \bool_if:NTF \l_tmpa_bool
      {
        ...
        \bool_if:NTF \l__tenkz_kernel_r_basis_plane_bool
          {
            \exp_args:NV \__tenkz_kernel_r_physical_trace_affine:n
              \l__tenkz_kernel_r_tl
          }
          {
            \pgfextractx \l__tenkz_kernel_r_north_x_dim
