...
\msg_new:nnn {tenkz}{kernel-frame-basis-policy}
  { [TKZ-FRAME-BASIS-POLICY]~multi-member~bases~require~explicit~wires;~
    picture~policy~'#1'~has~no~member-level~meaning. }
    ...
    \bool_lazy_or:nnTF
      ...
      }
      {
        \prop_get:NeN \l__tenkz_kernel_basis_claim_prop
          ...
          \l__tenkz_kernel_claim_owner_tl
        \quark_if_no_value:NTF \l__tenkz_kernel_claim_owner_tl
          {
            ...
            \__tenkz_model_complete:nnn { \tl_use:N #2 } {cell-row}
              { \int_use:N \l__tenkz_kernel_claim_row_int }
            \__tenkz_model_complete:nnn { \tl_use:N #2 } {cell-col}
              { \int_use:N \l__tenkz_kernel_claim_col_int }
            \__tenkz_model_complete:nnn { \tl_use:N #2 } {member}
              { \int_use:N \l__tenkz_kernel_pop_int }
            \prop_get:NeN \l__tenkz_kernel_basis_east_prop
              { \int_use:N \l__tenkz_kernel_pop_int }
              \l__tenkz_kernel_claim_owner_tl
            \__tenkz_model_complete:nnn { \tl_use:N #2 } {basis-east}
              { \l__tenkz_kernel_claim_owner_tl }
            \prop_get:NeN \l__tenkz_kernel_basis_north_prop
              { \int_use:N \l__tenkz_kernel_pop_int }
              \l__tenkz_kernel_frame_tl
            \__tenkz_model_complete:nnn { \tl_use:N #2 } {basis-north}
              { \l__tenkz_kernel_frame_tl }
          }
          {
    ...
    \str_if_eq:VnT \l__tenkz_kernel_scratch_tl {grid}
      {
        ...
        \int_compare:nNnT { \l__tenkz_kernel_basis_count_int } > {0}
          {
            \int_compare:nNnF { \l__tenkz_kernel_basis_count_int } = {1}
              { \bool_set_false:N \l_tmpa_bool }
            \prop_get:NnN \l__tenkz_kernel_basis_east_prop {1} \l_tmpa_tl
            \prop_get:NnN \l__tenkz_kernel_basis_north_prop {1} \l_tmpb_tl
            \bool_lazy_and:nnF
    ...
    \quark_if_no_value:NTF \l__tenkz_kernel_r_tl
      ...
      }
      {
        ...
        \quark_if_no_value:NTF \l__tenkz_kernel_r_b_tl
          ...
          {
            \__tenkz_model_get:nnN
              {#1} {basis-east} \l__tenkz_kernel_r_c_tl
            \__tenkz_model_get:nnN
              {#1} {basis-north} \l__tenkz_kernel_r_b_tl
            \__tenkz_geom_place_cell:nnee {#1} {kpic}
              {
                \fp_eval:n
                  {
                    \l__tenkz_kernel_r_row_tl
                    - \l__tenkz_kernel_r_b_tl / 4
                  }
              }
              {
                \fp_eval:n
            ...
            \int_step_inline:nnn
              ...
              }
              {
                \int_step_inline:nnn
                  ...
                  {
                    \__tenkz_kernel_select_cell_records:nnN
                      {##1} {####1} #2
                  }
              }
          }
    ...
    \int_compare:nNnTF { \l__tenkz_kernel_basis_count_int } > {0}
      {
        \int_step_inline:nn { \l__tenkz_kernel_basis_count_int }
          {
            \__tenkz_kernel_basis_record:nnnN {#1}{#2}{##1} \l_tmpb_tl
            \quark_if_no_value:NF \l_tmpb_tl
              {
