...
\msg_new:nnn {tenkz}{kernel-wind-mismatch}
  { [TKZ-WIND-MISMATCH]~string~'#1'~claims~wind=\{#2\},~but~its~
    corridor~route~realizes~wind=\{1,0\} }
...
\cs_new_protected:Npn \__tenkz_kernel_select:nN #1#2
  {
    ...
    \exp_args:NV \tl_if_head_is_group:nTF \l__tenkz_kernel_sel_tl
      {
    ...
    \int_step_inline:nnn
      ...
      { \int_max:nn { \l__tenkz_kernel_r_row_tl } { \l__tenkz_kernel_r_b_tl } }
      {
        \int_step_inline:nnn
          ...
          {
            \prop_get:NnN \l__tenkz_kernel_cell_prop {##1-####1} \l_tmpb_tl
            \quark_if_no_value:NF \l_tmpb_tl
              { \seq_put_right:NV #2 \l_tmpb_tl }
          }
      }
        ...
        \quark_if_no_value:NTF \l__tenkz_kernel_r_c_tl
          ...
          }
          {
            ...
            \regex_replace_all:nnN { \s+ } { }
              \l__tenkz_kernel_r_b_tl
            \str_if_eq:VnF \l__tenkz_kernel_r_b_tl {1,0}
              {
                \msg_error:nnee {tenkz}{kernel-wind-mismatch}
            ...
            \__tenkz_kernel_r_frame_xy:nnNN
              ...
              \l__tenkz_kernel_r_xc_fp \l__tenkz_kernel_r_yc_fp
            \tl_put_right:Ne \l__tenkz_kernel_r_b_tl
              {
                \__tenkz_kernel_r_ppt:nn
                  { \l__tenkz_kernel_r_xc_fp }
                  { \l__tenkz_kernel_r_yc_fp }
            ...
            \exp_args:NVV \__tenkz_string_declare_corridor_wind:nn
              \l__tenkz_kernel_r_sid_tl \l__tenkz_kernel_r_pts_tl
          }
      }
      {
