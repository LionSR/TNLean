...
\prop_new:N \l__tenkz_kernel_cells_orient_prop
...
\bool_new:N \l__tenkz_kernel_cells_pinch_bool
...
\cs_new_protected:Npn \__tenkz_kernel_cells_edges:
  {
    ...
    \prop_clear:N \l__tenkz_kernel_cells_orient_prop
    \prop_clear:N \l__tenkz_kernel_cells_val_prop
    \seq_clear:N \l__tenkz_kernel_cells_starts_seq
    \bool_set_false:N \l__tenkz_kernel_cells_pinch_bool
    \int_step_inline:nnn
      { \l__tenkz_kernel_cells_rmin_int - 1 }
      { \l__tenkz_kernel_cells_rmax_int }
      {
    ...
    \bool_lazy_and:nnTF
      ...
      { ! \__tenkz_kernel_cells_member_p:nn { \int_eval:n {#1+1} }{#2} }
      {
        ...
        \__tenkz_kernel_cells_edge:nnnn
          ...
          { \__tenkz_kernel_cells_key:nn {#1} {#2} } {H}
          {
            \fp_eval:n
              {
      ...
      }
      {
        \bool_lazy_and:nnT
          ...
          { \__tenkz_kernel_cells_member_p:nn { \int_eval:n {#1+1} }{#2} }
          {
            ...
            \__tenkz_kernel_cells_edge:nnnn
              { \__tenkz_kernel_cells_key:nn {#1} {#2} }
              { \__tenkz_kernel_cells_key:nn {#1} { \int_eval:n {#2-1} } } {H}
              {
                \fp_eval:n
                  {
...
\cs_new_protected:Npn \__tenkz_kernel_cells_vedge:nn #1#2
  {
    \bool_lazy_and:nnTF
      ...
      { ! \__tenkz_kernel_cells_member_p:nn {#1} { \int_eval:n {#2+1} } }
      {
        ...
        \__tenkz_kernel_cells_edge:nnnn
          { \__tenkz_kernel_cells_key:nn {#1} {#2} }
          { \__tenkz_kernel_cells_key:nn { \int_eval:n {#1-1} } {#2} } {V}
          {
            \fp_eval:n
              {
        ...
        \bool_lazy_and:nnT
          ...
          { \__tenkz_kernel_cells_member_p:nn {#1} { \int_eval:n {#2+1} } }
          {
            ...
            \__tenkz_kernel_cells_edge:nnnn
              ...
              { \__tenkz_kernel_cells_key:nn {#1} {#2} } {V}
              {
                \fp_eval:n
                  {
...
\cs_new_protected:Npn \__tenkz_kernel_cells_edge:nnnn #1#2#3#4
  {
    % Two half-edges leaving one corner mean the cells meet across that
    % corner and nowhere else, so the boundary passes through the point
    % twice and which strand continues into which is not settled by the
    % corner.  Such a set has no single closed walk, and the reading an
    % author means by one contour over it is the offset hull -- which is
    % what two records on a diagonal have always been drawn as.
    \prop_if_in:NeT \l__tenkz_kernel_cells_end_prop {#1}
      { \bool_set_true:N \l__tenkz_kernel_cells_pinch_bool }
    \prop_put:Nee \l__tenkz_kernel_cells_end_prop {#1} {#2}
    \prop_put:Nen \l__tenkz_kernel_cells_orient_prop {#1} {#3}
    \prop_put:Nee \l__tenkz_kernel_cells_val_prop {#1} {#4}
    \seq_put_right:Ne \l__tenkz_kernel_cells_starts_seq {#1}
  }
...
\cs_new_protected:Npn \__tenkz_kernel_cells_path:
  {
    ...
    \seq_map_inline:Nn \l__tenkz_kernel_cells_starts_seq
      {
        \prop_if_in:NnF \l__tenkz_kernel_cells_seen_prop {##1}
          { \__tenkz_kernel_cells_loop:n {##1} }
      }
  }
\cs_new_protected:Npn \__tenkz_kernel_cells_loop:n #1
  {
    \seq_clear:N \l__tenkz_kernel_cells_loop_seq
    \tl_set:Nn \l__tenkz_kernel_cells_cur_tl {#1}
    \bool_until_do:nn
      { \prop_if_in_p:NV \l__tenkz_kernel_cells_seen_prop
          \l__tenkz_kernel_cells_cur_tl }
      {
        \prop_put:NVn \l__tenkz_kernel_cells_seen_prop
          \l__tenkz_kernel_cells_cur_tl {1}
        \prop_get:NVN \l__tenkz_kernel_cells_orient_prop
          \l__tenkz_kernel_cells_cur_tl \l__tenkz_kernel_cells_o_tl
        \prop_get:NVN \l__tenkz_kernel_cells_val_prop
          \l__tenkz_kernel_cells_cur_tl \l__tenkz_kernel_cells_val_tl
        ...
        \prop_get:NVN \l__tenkz_kernel_cells_end_prop
          \l__tenkz_kernel_cells_cur_tl \l__tenkz_kernel_cells_next_tl
        ...
        \bool_if:NTF \l__tenkz_kernel_hull_chart_bool
          {
            ...
            \bool_lazy_and:nnTF
              ...
              { ! \l__tenkz_kernel_cells_rect_bool }
              {
                ...
                \bool_if:NTF \l__tenkz_kernel_cells_pinch_bool
