...
\cs_new_protected:Npn \__tenkz_kernel_end:
  {
    ...
    % Boundary signatures use the same transported carrier axes as ink.
    % Prepare geometry before emitting records, while keeping all ink after
    % the event stream so audit ordering remains stable.
