        ...
        \bool_if:NT \l_tmpb_bool
          {
            ...
            \exp_args:NV \__tenkz_kernel_port_external_consume:nn
              \l__tenkz_kernel_scratch_tl {#4}
          }
      }
  }
...
\cs_new_protected:Npn
  \__tenkz_kernel_port_closure_node_materialize:n #1
  {
    \prop_get:NVN
    ...
    \quark_if_no_value:NF \l__tenkz_kernel_port_record_tl
      {
        \__tenkz_model_get:nnN
          { \tl_use:N \l__tenkz_kernel_port_record_tl } {origin}
          \l__tenkz_kernel_port_policy_field_tl
        \bool_lazy_or:nnT
          {
            \str_if_eq_p:Vn
              \l__tenkz_kernel_port_policy_field_tl {trace}
          }
          {
            \str_if_eq_p:Vn
              \l__tenkz_kernel_port_policy_field_tl {cup}
          }
          {
            \__tenkz_kernel_node_new:nN
              {
            ...
            \__tenkz_kernel_node_put:NnV
              ...
              \l__tenkz_kernel_port_slot_tl
            \__tenkz_model_get:nnN
              { \tl_use:N \l__tenkz_kernel_port_record_tl } {from}
              \l__tenkz_kernel_port_place_tl
            \quark_if_no_value:NTF \l__tenkz_kernel_port_place_tl
              {
                \__tenkz_model_complete:nnn
              ...
              {
                \__tenkz_model_complete:nnn
                  { \tl_use:N \l__tenkz_kernel_port_record_tl } {to}
                  { \tl_use:N \l__tenkz_kernel_port_node_tl }
              }
            \prop_put:NVV
        ...
        \str_case:Vn \l__tenkz_kernel_ro_side_tl
          {
            ...
            {e}   { \__tenkz_kernel_route_face:nn {e} {none} }
            {w}   { \__tenkz_kernel_route_face:nn {w} {none} }
            {all}
              {
                % A closed all-side route traverses the complete perimeter.
                % An open one selects an endpoint-dependent arc, whose sides
                % cannot be inferred from the model before geometry settles;
                % crossing police, rather than a false derived declaration,
                % remains authoritative for that case.
                \prop_if_in:NeT \l__tenkz_model_record_prop { #1 / closed }
                  {
                    \__tenkz_kernel_route_face:nn {n} {up}
                    \__tenkz_kernel_route_face:nn {w} {none}
                    \__tenkz_kernel_route_face:nn {s} {down}
                    \__tenkz_kernel_route_face:nn {e} {none}
                  }
              }
          }
        ...
        \str_if_eq:VnT \l__tenkz_kernel_ro_tl {port-open}
          {
            ...
            \seq_if_in:NVTF
              \l__tenkz_kernel_ro_mem_seq \l__tenkz_kernel_ro_b_tl
              {
                ...
                \exp_args:NV \__tenkz_kernel_r_face_side:n
                  \l__tenkz_kernel_port_face_tl
                \str_if_eq:VnT \l__tenkz_kernel_r_face_side_tl {#1}
                  {
    ...
    \quark_if_no_value:NF \l__tenkz_kernel_ro_tl
      {
        ...
        \int_step_inline:nnnn {2} {4}
          { \seq_count:N \l__tenkz_kernel_ro_seq }
          {
        ...
        \exp_args:NnV \regex_extract_all:nnN
          { (port-open-[1-9]\d*) }
          \l__tenkz_kernel_ro_tl \l__tenkz_kernel_ro_seq
        \int_step_inline:nnnn {2} {2}
          { \seq_count:N \l__tenkz_kernel_ro_seq }
          {
            \seq_put_right:Ne \l__tenkz_kernel_ro_have_seq
              { \seq_item:Nn \l__tenkz_kernel_ro_seq {##1} }
          }
      }
  }
