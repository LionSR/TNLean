        ...
        {west-east}
          {
            ...
            \bool_lazy_and:nnTF
              ...
              }
              {
                ...
                % the reach is measured through the frame to the outermost
                % of them plus n+1 trace reaches, and the rail leads out
                % past its own reach points by n trace reaches before it
                % turns, so nested returns stand one trace reach apart on
                % every side and the rail crosses no row, no inter-row
                % pairing, and no other return between its reach points.
                \int_compare:nNnTF
                  ...
                  { \l__tenkz_kernel_r_rows_int + 1 }
                  {
                    ...
                    \fp_zero:N \l__tenkz_kernel_r_xc_fp
                    \int_compare:nNnF
                      { \l__tenkz_kernel_r_row_tl } = {1}
                      {
                        \__tenkz_kernel_r_frame_xy:nnNN
                          ...
                          \l__tenkz_kernel_r_xc_fp
                          \l__tenkz_kernel_r_yc_fp
                        \fp_add:Nn \l__tenkz_kernel_r_reach_fp
                          {
                            abs
                              (
                                \l__tenkz_kernel_r_yc_fp
                ...
                \__tenkz_kernel_r_wire_stroke:nn { bond }
                  {
                    \__tenkz_kernel_r_pair:nn
                      { \l__tenkz_kernel_r_x_fp }
                      { \l__tenkz_kernel_r_y_fp }
                    \fp_compare:nNnF { \l__tenkz_kernel_r_xc_fp } = {0}
                      {
                        --
                        \__tenkz_kernel_r_pair:nn
                          {
