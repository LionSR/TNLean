...
% clearance the drawing does not have.
...
% corners.  Half a trace reach is the corner radius, and 0.2929 = 1 - cos 45
% places the mid-point of a quarter turn.
\cs_new_protected:Npn \__tenkz_kernel_r_rail_flat:
  {
    ...
    \__tenkz_kernel_r_rail_pt:nn
      {
        \l__tenkz_kernel_r_wrap_wx_fp
        + 0.2929 * \__tenkz_metric_ratio:n {pairtracereach} / 2
      }
      {
        \l__tenkz_kernel_r_y_fp
        + \l__tenkz_kernel_r_yc_fp
        ...
        {west-east}
          {
            ...
            \bool_lazy_and:nnTF
              ...
              { \int_compare_p:nNn { \l__tenkz_kernel_r_cols_int } > {1} }
              {
                ...
                % closing sector instead of across it.
                \bool_lazy_and:nnT
                  { \l__tenkz_kernel_r_wrap_lend_bool }
                  { \l__tenkz_kernel_r_wrap_rend_bool }
                  {
