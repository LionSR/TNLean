...
\cs_new_protected:Npn \__tenkz_kernel_r_onwire_arc:n #1
  {
    ...
    % walk sixteen chords of the cubic, find where the asked-for share of
    % the total length falls, and read the parameter off that chord
    ...
    \int_step_inline:nn {16}
      {
        \__tenkz_kernel_r_arc_point:nNN { ##1 / 16 }
                ...
                \fp_set:Nn \l__tenkz_kernel_r_arc_t_fp
                  {
                    ( ##1 - 1
                      + ( \l__tenkz_kernel_r_arc_tgt_fp
                        ...
                        / ( \l__tenkz_kernel_r_arc_py_fp
                            - \l__tenkz_kernel_r_arc_px_fp ) ) / 16
                  }
              }
          }
        \fp_set_eq:NN \l__tenkz_kernel_r_arc_px_fp
