...
\cs_new_protected:Npn \__tenkz_kernel_r_onwire_arc:n #1
  {
    ...
    \__tenkz_geom_store:nnn {#1}
      {
        ( 1 - \l__tenkz_kernel_r_arc_t_fp ) ^ 3 * \l__tenkz_kernel_r_x_fp
        + 3 * ( 1 - \l__tenkz_kernel_r_arc_t_fp ) ^ 2
            * \l__tenkz_kernel_r_arc_t_fp * \l__tenkz_kernel_r_arc_cax_fp
        + 3 * ( 1 - \l__tenkz_kernel_r_arc_t_fp )
            * \l__tenkz_kernel_r_arc_t_fp ^ 2 * \l__tenkz_kernel_r_arc_cbx_fp
        + \l__tenkz_kernel_r_arc_t_fp ^ 3 * \l__tenkz_kernel_r_xb_fp
      }
      {
        ( 1 - \l__tenkz_kernel_r_arc_t_fp ) ^ 3 * \l__tenkz_kernel_r_y_fp
        + 3 * ( 1 - \l__tenkz_kernel_r_arc_t_fp ) ^ 2
            * \l__tenkz_kernel_r_arc_t_fp * \l__tenkz_kernel_r_arc_cay_fp
        + 3 * ( 1 - \l__tenkz_kernel_r_arc_t_fp )
            * \l__tenkz_kernel_r_arc_t_fp ^ 2 * \l__tenkz_kernel_r_arc_cby_fp
        + \l__tenkz_kernel_r_arc_t_fp ^ 3 * \l__tenkz_kernel_r_yb_fp
      }
    \seq_pop_right:NN \l__tenkz_kernel_ow_run_stack_seq
      \l__tenkz_kernel_ow_t_tl
    \seq_pop_right:NN \l__tenkz_kernel_ow_run_stack_seq
...
% (LANGUAGE-1.0 section 10) is the geometry: the curve leaves and enters
...
% the finished cubic in \l__tenkz_kernel_r_arc_path_tl.
\cs_new_protected:Npn \__tenkz_kernel_r_arc_controls:n #1
  {
    ...
    % the leaving direction, the arriving direction, and the turn between
    % them folded into [0, 180]
    \fp_set:Nn \l__tenkz_kernel_r_arc_af_fp
      {
        \l__tenkz_kernel_r_arc_tf_fp
        + 90 * ( 1 - \l__tenkz_kernel_r_arc_sf_fp )
      }
    ...
    \fp_set:Nn \l__tenkz_kernel_r_arc_d_fp
      {
        ...
        * \fp_compare:nNnTF { \l__tenkz_kernel_r_arc_d_fp } > { 1 }
            {
              ( 4 * tand ( \l__tenkz_kernel_r_arc_d_fp / 4 ) )
              / ( 6 * sind ( \l__tenkz_kernel_r_arc_d_fp / 2 ) )
            }
            { ( 1 / 3 ) }
      }
    \fp_set:Nn \l__tenkz_kernel_r_arc_cax_fp
      {
        \l__tenkz_kernel_r_x_fp + \l__tenkz_kernel_r_arc_sf_fp
          * \l__tenkz_kernel_r_arc_d_fp
          * cosd ( \l__tenkz_kernel_r_arc_tf_fp )
      }
    \fp_set:Nn \l__tenkz_kernel_r_arc_cay_fp
      {
        \l__tenkz_kernel_r_y_fp + \l__tenkz_kernel_r_arc_sf_fp
          * \l__tenkz_kernel_r_arc_d_fp
    ...
    \tl_set:Ne \l__tenkz_kernel_r_arc_path_tl
      {
        ...
        ~ .. ~ controls ~
        \__tenkz_kernel_r_pair:nn
          { \l__tenkz_kernel_r_arc_cax_fp } { \l__tenkz_kernel_r_arc_cay_fp }
        ~ and ~
        \__tenkz_kernel_r_pair:nn
          { \l__tenkz_kernel_r_arc_cbx_fp } { \l__tenkz_kernel_r_arc_cby_fp }
        ~ .. ~
        \__tenkz_kernel_r_pair:nn
          { \l__tenkz_kernel_r_xb_fp } { \l__tenkz_kernel_r_yb_fp }
      }
...
% outward (the control stands off the glyph), an open end its projection
% word backward (the control stands toward the diagram), and an end that is
% neither leaves the caller's chord preset standing.
\cs_new_protected:Npn \__tenkz_kernel_r_arc_end:nn #1#2
  {
    \__tenkz_model_get:nnN {#1} {#2} \l__tenkz_kernel_r_arc_tl
    \quark_if_no_value:NTF \l__tenkz_kernel_r_arc_tl
      {
        \__tenkz_model_get:nnN {#1} {#2-open} \l__tenkz_kernel_r_arc_tl
        \quark_if_no_value:NF \l__tenkz_kernel_r_arc_tl
          {
            \fp_set:Nn \l__tenkz_kernel_r_arc_t_fp
              {
                \__tenkz_kernel_r_compass:n
                  { \l__tenkz_kernel_r_arc_tl }
              }
            \fp_set:Nn \l__tenkz_kernel_r_arc_s_fp {-1}
          }
      }
