    ...
    \bool_if:NT \l_tmpa_bool
      {
        ...
        % Boundary tips normally dominate this outward coordinate, but a
        % trace may retain closure endpoints after every routing-side site is
        % removed.  Keep the real site centre as the fallback silhouette;
        % the corridor adds the rendered dot radius and daylight below.
