...
% Invariants: records contain no unparsed user syntax; topology is immutable after validation.
...
\cs_new_protected:Npn \__tenkz_model_record_wire:n #1
  { \__tenkz_model_record:nnn {wire} {kind} {#1} }
\cs_new_protected:Npn \__tenkz_model_record_mark:n #1
  { \__tenkz_model_record:nnn {mark} {form} {#1} }
\cs_new_protected:Npn \__tenkz_model_record_frame:n #1
  { \__tenkz_model_record:nnn {frame} {map} {#1} }

% Picture-level fields merge; the picture is a single record without an id.
\cs_new_protected:Npn \__tenkz_model_record_picture:n #1
  {
    \bool_if:NTF \l__tenkz_model_validated_bool
      { \msg_error:nn {tenkz}{model-frozen} }
      {
...
\cs_new_protected:Npn \__tenkz_model_count:nN #1#2
  { \int_set:Nn #2 { \seq_count:c { l__tenkz_model_ #1 _seq } } }
