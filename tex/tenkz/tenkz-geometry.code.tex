...
% basis step, bead-body radius, and page-owned gap.  Member offsets share the
% caller's local east/north units.  With dr/dc equal to member j's cell minus
% member i's cell, their local displacement is
%   east  = dc + step (east_j - east_i),
%   north = -dr + step (north_j - north_i).
...
% The output is empty when fewer than two members are given.
...
\tl_new:N \l__tenkz_geom_basis_spacing_step_tl
    ...
    \tl_set:Ne \l__tenkz_geom_basis_spacing_east_delta_tl
      {
        \fp_eval:n
          {
            \l__tenkz_geom_basis_spacing_step_tl
            * ( \l__tenkz_geom_basis_spacing_east_b_tl
    ...
    \bool_if:NT \l__tenkz_geom_basis_spacing_kind_ok_bool
      {
        ...
        \tl_set:Ne \l__tenkz_geom_basis_spacing_step_tl { \fp_eval:n {#4} }
        \tl_set:Ne \l__tenkz_geom_basis_spacing_radius_tl { \fp_eval:n {#5} }
        \tl_set:Ne \l__tenkz_geom_basis_spacing_gap_tl { \fp_eval:n {#6} }
        \prop_set_eq:NN \l__tenkz_geom_basis_spacing_east_prop #7
        \prop_set_eq:NN \l__tenkz_geom_basis_spacing_north_prop #8
