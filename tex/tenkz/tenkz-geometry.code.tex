...
% canonical live-slot index, bead-body radius, and page-owned gap.  Member
% offsets are already expressed in the caller's local east/north units.  With
...
% defines a conservative direction-free convention.  The strict minimum
% margin and fixed traversal order make the reported witness deterministic.
% The output is empty when no distinct live-member candidate is realizable.
\prop_new:N \l__tenkz_geom_basis_spacing_east_prop
\prop_new:N \l__tenkz_geom_basis_spacing_north_prop
\prop_new:N \l__tenkz_geom_basis_spacing_candidate_prop
...
\int_new:N \l__tenkz_geom_basis_spacing_slot_row_int
\int_new:N \l__tenkz_geom_basis_spacing_slot_col_int
\int_new:N \l__tenkz_geom_basis_spacing_slot_row_start_int
\int_new:N \l__tenkz_geom_basis_spacing_slot_row_end_int
\int_new:N \l__tenkz_geom_basis_spacing_slot_col_start_int
\int_new:N \l__tenkz_geom_basis_spacing_slot_col_end_int
...
\tl_new:N \l__tenkz_geom_basis_spacing_slot_a_tl
\tl_new:N \l__tenkz_geom_basis_spacing_slot_b_tl
\bool_new:N \l__tenkz_geom_basis_spacing_kind_ok_bool
\bool_new:N \l__tenkz_geom_basis_spacing_slot_realized_bool
...
\cs_new_protected:Npn \__tenkz_geom_basis_spacing_candidate_realized:
  {
    \__tenkz_geom_basis_apply:nnnnnnNN
...
\cs_new_protected:Npn \__tenkz_geom_basis_spacing_slot_col:n #1
  {
    \bool_if:NF \l__tenkz_geom_basis_spacing_slot_realized_bool
      {
        \int_set:Nn \l__tenkz_geom_basis_spacing_slot_col_int {#1}
        \prop_get:NeN \l__tenkz_geom_basis_spacing_candidate_prop
          {
            \int_use:N \l__tenkz_geom_basis_spacing_slot_row_int -
            \int_use:N \l__tenkz_geom_basis_spacing_slot_col_int -
            \int_use:N \l__tenkz_geom_basis_spacing_a_int
          }
          \l__tenkz_geom_basis_spacing_slot_a_tl
        \quark_if_no_value:NF \l__tenkz_geom_basis_spacing_slot_a_tl
          {
            \prop_get:NeN \l__tenkz_geom_basis_spacing_candidate_prop
              {
                \int_eval:n
                  {
                    \l__tenkz_geom_basis_spacing_slot_row_int
                    + \l__tenkz_geom_basis_spacing_dr_int
                  } -
                \int_eval:n
                  {
                    \l__tenkz_geom_basis_spacing_slot_col_int
                    + \l__tenkz_geom_basis_spacing_dc_int
                  } -
                \int_use:N \l__tenkz_geom_basis_spacing_b_int
              }
              \l__tenkz_geom_basis_spacing_slot_b_tl
            \quark_if_no_value:NF \l__tenkz_geom_basis_spacing_slot_b_tl
              {
                \str_if_eq:eeF
                  { \l__tenkz_geom_basis_spacing_slot_a_tl }
                  { \l__tenkz_geom_basis_spacing_slot_b_tl }
                  {
                    \bool_set_true:N
                      \l__tenkz_geom_basis_spacing_slot_realized_bool
                  }
              }
          }
      }
...
\cs_new_protected:Npn \__tenkz_geom_basis_spacing_slot_row:n #1
  {
    \bool_if:NF \l__tenkz_geom_basis_spacing_slot_realized_bool
      {
        \int_set:Nn \l__tenkz_geom_basis_spacing_slot_row_int {#1}
        \int_step_function:nnN
          { \l__tenkz_geom_basis_spacing_slot_col_start_int }
          { \l__tenkz_geom_basis_spacing_slot_col_end_int }
          \__tenkz_geom_basis_spacing_slot_col:n
      }
  }

\cs_new_protected:Npn \__tenkz_geom_basis_spacing_candidate_from_slots:
  {
    \bool_set_false:N \l__tenkz_geom_basis_spacing_slot_realized_bool
    \int_set:Nn \l__tenkz_geom_basis_spacing_slot_row_start_int
      { \int_max:nn {1} { 1 - \l__tenkz_geom_basis_spacing_dr_int } }
    \int_set:Nn \l__tenkz_geom_basis_spacing_slot_row_end_int
      {
        \int_min:nn
    ...
    \int_set:Nn \l__tenkz_geom_basis_spacing_slot_col_start_int
      { \int_max:nn {1} { 1 - \l__tenkz_geom_basis_spacing_dc_int } }
    \int_set:Nn \l__tenkz_geom_basis_spacing_slot_col_end_int
      {
        \int_min:nn
    ...
    \int_step_function:nnN
      { \l__tenkz_geom_basis_spacing_slot_row_start_int }
      { \l__tenkz_geom_basis_spacing_slot_row_end_int }
      \__tenkz_geom_basis_spacing_slot_row:n
    \bool_if:NT \l__tenkz_geom_basis_spacing_slot_realized_bool
      { \__tenkz_geom_basis_spacing_candidate_realized: }
  }

\cs_new_protected:Npn \__tenkz_geom_basis_spacing_candidate:
  {
    \prop_if_in:NnTF \l__tenkz_geom_basis_spacing_candidate_prop {slots}
      { \__tenkz_geom_basis_spacing_candidate_from_slots: }
      {
        \prop_if_in:NnTF \l__tenkz_geom_basis_spacing_candidate_prop {all}
          { \__tenkz_geom_basis_spacing_candidate_realized: }
          {
            \prop_if_in:NeT \l__tenkz_geom_basis_spacing_candidate_prop
              {
                \int_use:N \l__tenkz_geom_basis_spacing_a_int /
                \int_use:N \l__tenkz_geom_basis_spacing_b_int /
                \int_use:N \l__tenkz_geom_basis_spacing_dr_int /
...
\cs_new_protected:Npn \__tenkz_geom_basis_spacing_dr:n #1
  {
    ...
    \int_step_function:nnN
      { 1 - \l__tenkz_geom_basis_spacing_cols_int }
      { \l__tenkz_geom_basis_spacing_cols_int - 1 }
...
\cs_new_protected:Npn \__tenkz_geom_basis_spacing_b:n #1
  {
    ...
    \int_step_function:nnN
      { 1 - \l__tenkz_geom_basis_spacing_rows_int }
      { \l__tenkz_geom_basis_spacing_rows_int - 1 }
    ...
    \bool_if:NT \l__tenkz_geom_basis_spacing_kind_ok_bool
      {
        ...
        \prop_set_eq:NN \l__tenkz_geom_basis_spacing_candidate_prop #8
