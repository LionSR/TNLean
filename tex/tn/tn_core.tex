...
\newcommand{\TN@labeledtensor}[4][]{%
    \TN@node[#1]{tn tensor node}{#2}{#3}{$\scriptstyle #4$}%
}
...
\newcommand{\TN@mcompareports}[3][]{%
    ...
    \TNEventInternal{connection|picture=\the\TN@pictureid|type=morphism|from=#2|to=#3|route=comparison}%
}
