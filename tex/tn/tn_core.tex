...
% Select the sole default at load time.  The compatibility names below are
% aliases, not a second set of numerical parameters.
...
% A complete diagram may reserve a rectangular canvas independently of its
% ink.  This fixes uniform outer margins without exposing a client-side path.
\newcommand{\TN@canvas}[2]{%
