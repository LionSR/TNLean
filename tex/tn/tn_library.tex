...
\newcommand{\TN@pepsNormalCollar}{%
    ...
    \end{scope}
    \TN@annotationterminal{tnTopCollarLabel}{(1.50,3.18)}%
...
\newcommand{\TNCardinalGaugeCross}[6]{%
    ...
    \TN@label[anchor=east]{#1WestInsertion.west}
        {(-\TN@labelclearance,0)}{#3}%
    \TN@label[anchor=west]{#1EastInsertion.east}
        {(\TN@labelclearance,0)}{#4}%
    \TN@label[anchor=north]{#1SouthInsertion.south}
        {(0,-\TN@labelclearance)}{#5}%
