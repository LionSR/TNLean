...
\newcommand{\TN@declareThreeSiteChain}[4]{%
    ...
    \TN@label[anchor=north]{#1one}{(0,-0.16)}{#2}
    \TN@label[anchor=north]{#1two}{(0,-0.16)}{#3}
    \TN@label[anchor=north]{#1three}{(0,-0.16)}{#4}%
}
...
\newcommand{\TNLabelAbove}[2]{\TN@label[anchor=south]{#1}{(0,0.24)}{#2}}
\newcommand{\TNLabelBelow}[2]{\TN@label[anchor=north]{#1}{(0,-0.24)}{#2}}
\newcommand{\TNLabelLeft}[2]{\TN@label[anchor=east]{#1}{(-0.24,0)}{#2}}
\newcommand{\TNLabelRight}[2]{\TN@label[anchor=west]{#1}{(0.24,0)}{#2}}
...
\newcommand{\TNCompactTraceCell}[5]{%
    ...
    \if\relax\detokenize{#5}\relax\else
        \TN@label{#1Centre}{(0,\TN@layerpitch)}{#5}%
    \fi
}
