...
The repository ships a LeanBlueprint in `blueprint/` covering both the MPS development and the channel-side Wolf material. As of 2026-04-09, all blueprint chapters have been synchronized to reflect current Lean status via a comprehensive v4 review pass. This includes `ch02_mps.tex`, `ch02b_mpdo.tex`, `ch03_single.tex`, `ch04_channels.tex`, `ch04b_entropy.tex`, `ch05_qpf.tex`, `ch05_schwarz.tex`, `ch06_spectral.tex`, `ch07_wielandt.tex`, `ch08_canonical.tex`, `ch09_block_perm.tex`, `ch10_bnt.tex`, `ch11_assembly.tex`, `ch12_semigroup.tex`, `ch13_algebraic_ft.tex`, `ch13b_symmetry.tex`, `ch14_parent_hamiltonian.tex`, `ch15_correlations.tex`, and `ch16_examples.tex`. The sync covers the stationary-support package, periodic tensor definitions, semigroup sorry closures, MPDO foundations, symmetry / string-order / coboundary entries, chain FT declarations, quantitative spectral gap / correlation decay results, PEPS FT scaffold definitions, the `isCID_implies_isRFP` reverse direction entry, entropy chapter SSA/mutual-information status, block-permutation D≥1 fixes, and AKLT example coefficients.
