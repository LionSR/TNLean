...
The family `c ↦ Y_c` is, for one pair of labels `(a, b)`, the component of a fusion gauge in
the sense of `MPOTensor.CompleteZipperFusionFamily.FusionGauge` (arXiv:1511.08090,
