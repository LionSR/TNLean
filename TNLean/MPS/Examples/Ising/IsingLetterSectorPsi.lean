...
labels carry the middle label `ρ = ψ`, that is `h, h' ∈ {(1,ψ,ψ), (ψ,ψ,1), (σ,ψ,σ)}`: nine
letters, each of which is block diagonal in the block coordinates with the blocks `5 (√2 A_σ)`,
`3 (√2 A_σ)` and sixteen zeros. This is the sector carrying the sign `[F^{ψσψ}_σ] = -1` of the
gauge, the F-symbol `F^{ψσψ}_{σσσ} = -1` of arXiv:1511.08090
(`References/1511.08090/AnyonsPEPS.tex` line 1320).
