...
`Papers/2011.12127/TN-Review-main.tex` lines 2526–2532, and Section II.B.4,
equation `Majchain`, lines 474–478: the state `∑ Tr[Y A^{i₁} ⋯ A^{i_N}] |i₁⟩ ⊗_g ⋯`
has odd parity, and "contrary to the bosonic case" the fermionic description is injective.
...
eigenvector exists, and the tensor is neither injective nor normal.
...
/-- Source: arXiv:1610.07849, `FermionicMPS.tex` line 289; arXiv:2011.12127,
`Papers/2011.12127/TN-Review-main.tex` lines 477–478 ("contrary to the bosonic case").
As a bosonic MPS the tensor is reducible: `(1, i)` is a common eigenvector of both
matrices, with eigenvalues `1` and `i`. -/
...
/-- Source: arXiv:2011.12127, `Papers/2011.12127/TN-Review-main.tex` lines 477–478
("contrary to the bosonic case"). As a bosonic MPS the tensor is not injective. -/
...
/-- Source: arXiv:2011.12127, `Papers/2011.12127/TN-Review-main.tex` lines 477–478
("contrary to the bosonic case"). As a bosonic MPS the tensor is not normal: no blocking
length makes it injective. -/
