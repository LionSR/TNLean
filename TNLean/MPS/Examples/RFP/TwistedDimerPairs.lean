...
the periodic power sum `(7/16)^L + (1/16)^L` of every pair, in the
normalization of the sector tensors here (not the coefficients of Theorem 4.14;
see the header of `TwistedDimer`).
