...
phase-cover or BNT-cover theorems, rather than the retired common-block wrapper
surface. This keeps the formal statement aligned with the paper-level inputs:
