...
This file records the structural data and coefficient-space consequences used for
the forward direction \(\mathrm{RFP}\Rightarrow\mathrm{NNCPH}\) in
arXiv:1606.00608, Theorem 3.10. The structural characterization writes a
canonical-form RFP tensor as
\[
  A^i = X\Lambda U^iX^{-1},
\]
