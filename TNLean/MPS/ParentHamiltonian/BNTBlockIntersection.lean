...
This marker covers the results stated under the doubly normalized
...
The `_of_dualFixedPoint` variants assume the source dual fixed-point
equation and are not covered.
