...
/-!
# Whole-increment projector-defect bounds

This file assembles the exact limiting-metric telescope, the centered overlap
estimate, and the three finite-Gram corrections into a common-ambient projector
bound uniform in the prefix length and suffix-increment length.
...
* `MPSTensor.c3CenteredProjectorResidualES`
* `MPSTensor.c3_injectiveRangeProjector_residual_eq_centered_sub_corrections`
