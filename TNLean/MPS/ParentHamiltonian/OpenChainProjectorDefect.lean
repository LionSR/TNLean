...
/-!
# Open-chain projector-defect bound

This file specializes the finite-Gram correction estimates to the open-chain C3
projector defect, with constants uniform in the spectator length.
