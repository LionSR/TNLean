...
the direct-sum lemma `lem:direct-sum` (lines 1346--1408) and Theorem 12
(`2blocks.2`, lines 1424--1456).
-/
...
arXiv:quant-ph/0608197, the direct-sum lemma `lem:direct-sum`, lines
1346--1408. -/
