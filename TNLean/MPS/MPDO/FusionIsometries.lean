...
In arXiv:1606.00608 Section 4.5 the corresponding object is a pair of linear maps
...
TODO (#611): replace by the compatibility condition from Section 4.5 of
...
In the paper (arXiv:1606.00608 Section 4.5) an MPDO tensor `M` is declared to be a
