...
`TNLean.MPS.MPDO.TwistedDimerCoefficients`. The flag factor of the operator
equals, at every length, the MPDO generated by the density-normalized tensor
$\tfrac12 M$ of Example 4.12 (lines 932--939); this is an identity of generated
operators, not of on-site tensors (`evenFlagState_eq_mpo_Mhat` in
