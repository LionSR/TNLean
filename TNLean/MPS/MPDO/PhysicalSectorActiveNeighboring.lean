...
/-- Deprecated compatibility wrapper for the complete canonical active
compression associated with a physical-sector factorization.

The stored datum is only the simultaneous choice of factor-support
coordinates. New code should use `ActiveFactorSupportData` directly.

Source: arXiv:1606.00608, Appendix C.2, equations `Appetakhetc` and
`etarl`, lines 1435--1450. -/
@[deprecated ActiveFactorSupportData (since := "2026-08-27")]
...
/-- Deprecated compatibility wrapper for the canonical active compression witness. -/
@[deprecated PhysicalSectorFactorization.activeFactorSupportData (since := "2026-08-27")]
noncomputable def canonical
    (F : PhysicalSectorFactorization K) :
    ActivePhysicalCompressionWitness F where
  factorSupport := F.activeFactorSupportData

/-- Deprecated compatibility wrapper for the canonical physical-support restriction. -/
@[deprecated PhysicalSectorFactorization.activePhysicalSupportRestrictionData
  (since := "2026-08-27")]
...
/-- Deprecated compatibility wrapper for the restricted factorization. -/
@[deprecated PhysicalSectorFactorization.activeRestrictedPhysicalSectorFactorization
  (since := "2026-08-27")]
...
/-- Deprecated compatibility wrapper exposing the restricted factorization at
the tensor supplied by the canonical restriction datum. -/
@[deprecated PhysicalSectorFactorization.activeRestrictedPhysicalSectorFactorization
  (since := "2026-08-27")]
...
/-- Deprecated compatibility wrapper for the active-sector correspondence. -/
@[deprecated PhysicalSectorFactorization.activeSectorFinEquiv (since := "2026-08-27")]
noncomputable def sectorCorrespondence
    (W : ActivePhysicalCompressionWitness F) :
    Fin W.factorization.sectorCount ≃ FactorActiveSector F :=
  F.activeSectorFinEquiv

/-- Deprecated compatibility wrapper for the exact neighboring congruence.

Source: arXiv:1606.00608, Appendix C.2, equations `Appetakhetc` and
`etarl`, lines 1435--1450. -/
@[deprecated "Use the enclosing namespace's active restricted neighboring congruence."
  (since := "2026-08-27")]
...
/-- Deprecated compatibility wrapper for positive semidefiniteness of every
restricted neighboring operator.

Source: arXiv:1606.00608, Appendix C.2, equation `Appetakhetc`, lines
1435--1450. -/
@[deprecated "Use the enclosing namespace's active restricted neighboring positivity theorem."
  (since := "2026-08-27")]
...
/-- Deprecated compatibility wrapper for preservation of neighboring traces. -/
@[deprecated
  PhysicalSectorFactorization.activeRestrictedPhysicalSectorFactorization_neighboringOperator_trace
  (since := "2026-08-27")]
theorem neighboringOperator_trace
    ...
    (W.factorization.neighboringOperator j l).trace =
      (F.neighboringOperator
        (W.sectorCorrespondence j).1
        (W.sectorCorrespondence l).1).trace :=
  F.activeRestrictedPhysicalSectorFactorization_neighboringOperator_trace
    W.factorSupport hK hpos j l

/-- Deprecated compatibility wrapper for the neighboring trace factorization
on the active physical restriction. -/
@[deprecated "Use the enclosing namespace's active restricted trace factorization."
  (since := "2026-08-27")]
noncomputable def neighboringTraceFactorization
    (W : ActivePhysicalCompressionWitness F)
    (hK : Kraus.IsInjective K.toMPSTensor)
    (H : NeighboringTraceFactorization F) :
    NeighboringTraceFactorization W.factorization :=
  F.activeRestrictedPhysicalSectorFactorization_neighboringTraceFactorization
    W.factorSupport hK H
