...
Theorem 4.14 (source label `thm:IV.13`). It uses the same diagonal matrices and
trace scalars on both sides, and does not assert the full equivalence for an
underlying MPDO tensor.

Source: arXiv:1606.00608, Theorem 4.14(ii)--(iii), source label `thm:IV.13`,
lines 972--993, and Appendix C.4, lines 1929--1947 and 2046 of
`Papers/1606.00608/MPDO-22-12-17-2.tex`. -/
