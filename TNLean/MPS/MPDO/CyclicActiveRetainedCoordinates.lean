...
`docs/paper-gaps/cpsv16_commuting_form_to_sal.tex`. -/
@[deprecated "Use `Fin.cons` and `Fin.addCases` directly." (since := "2026-08-27")]
...
`docs/paper-gaps/cpsv16_commuting_form_to_sal.tex`. -/
@[deprecated "Use `Fin.cons` directly." (since := "2026-08-27"), simp]
theorem threeSectorFiberEquiv_symm_apply_zero
    (F : PhysicalSectorFactorization K)
    (t : Fin 3 → Fin F.sectorCount)
    (z : F.SectorIndex (t 0) ×
...
`docs/paper-gaps/cpsv16_commuting_form_to_sal.tex`. -/
@[deprecated "Use `Fin.cons` directly." (since := "2026-08-27"), simp]
theorem threeSectorFiberEquiv_symm_apply_one
    (F : PhysicalSectorFactorization K)
    (t : Fin 3 → Fin F.sectorCount)
    (z : F.SectorIndex (t 0) ×
      (F.SectorIndex (t 1) × F.SectorIndex (t 2))) :
...
`docs/paper-gaps/cpsv16_commuting_form_to_sal.tex`. -/
@[deprecated "Use `Fin.cons` directly." (since := "2026-08-27"), simp]
theorem threeSectorFiberEquiv_symm_apply_two
    (F : PhysicalSectorFactorization K)
    (t : Fin 3 → Fin F.sectorCount)
    (z : F.SectorIndex (t 0) ×
      (F.SectorIndex (t 1) × F.SectorIndex (t 2))) :
