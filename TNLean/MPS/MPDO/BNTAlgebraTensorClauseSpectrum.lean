...
* `MPOTensor.BNTAlgebraTensorClause.toMultiplicitySpectrumComparison` is the deprecated
  compatibility constructor retaining only the resulting multiplicity-spectrum comparison.
...
Source: arXiv:1606.00608, Appendix C.4, lines 2046--2058 of
`Papers/1606.00608/MPDO-22-12-17-2.tex`. -/
@[deprecated "Use `(H.toTwoSiteMultiplicitySpectrum hCanonical hM).toComparison`."
  (since := "2026-08-27")]
