...
/-!
# Overlap infrastructure for BNT sector matching

This module contains the overlap consequences and eventual linear-independence
construction shared by exact and proportional sector matching.
-/
