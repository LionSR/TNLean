...
heterogeneous `IsCanonicalFormBNT` families. It builds on the equal-case and proportional-case
theorems from `EqualProportional.lean` and overlap convergence machinery from
