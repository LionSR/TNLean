...
This module assembles **Theorem 5**: the self-contained equal-case fundamental theorem for
heterogeneous `IsCanonicalFormBNT` families. It is a thin wrapper that re-exports the
machinery developed in three supporting sub-modules and exposes the public theorem
