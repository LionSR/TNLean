...
-/
import TNLean.MPS.FundamentalTheorem.FullAux

/-!
# Full Fundamental Theorem of MPS — Heterogeneous Equal Case

This module proves **Theorem 5**: the self-contained equal-case fundamental theorem for
heterogeneous `IsCanonicalFormBNT` families. It builds on the overlap-dichotomy machinery
from `FullAux.lean`, the equal-case and proportional-case theorems from
`EqualProportional.lean`, and overlap convergence machinery from
`OverlapConvergenceAux.lean`.
