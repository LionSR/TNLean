...
It is an external algebraic input for the canonical-form reduction: the
arXiv:1606.00608 reduction uses invariant subspaces to reach an irreducible
action, but it does not cite or prove Burnside/Jacobson.
...
Downstream modules combine this with finite-dimensional cumulative-span
stabilization before applying the separate Wielandt/normality inputs.
