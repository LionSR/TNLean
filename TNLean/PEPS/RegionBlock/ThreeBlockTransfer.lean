...
(`TNLean.PEPS.RegionBlock.BlockCoeffTransfer`) into the per-edge gauge of
`TNLean.PEPS.RegionBlock.RegionReconcile`, for two tensors blocked around the same
edge into the same red/blue/complement triple.
