...
The host merge's red-to-blue crossing label is the blue configuration's red-to-blue
crossing label, the second argument the bond-model-conjugated matrix reads. -/
