...
/-!
# Peeling a torus staircase onto one bond

This module is the public import aggregator for the geometric boundary decomposition, the
end-window coupling and virtual-operation extraction, the bond-inserted region construction, the
single-bond consequence of the staircase equality, and the window-independence of the resulting
bond insertion.
-/
