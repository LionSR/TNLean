...
/-! ### Red-region projection of the translated interior blocking datum

The translated interior blocking datum at a horizontal edge carries the coordinate
red region of the translated edge blocking, independent of the region-injectivity
predicate `κ`.  This projection lemma exposes that region syntactically so the
single-crossing geometry applies without unfolding the full datum. -/
