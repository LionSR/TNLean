...
@[deprecated "Use the translation-invariance equation directly." (since := "2026-08-27")]
...
@[deprecated "Use `transportBlockingDataAlong A (translate a b) D` directly."
  (since := "2026-08-27")]
...
@[deprecated "Use the corresponding projection of `transportBlockingDataAlong`."
  (since := "2026-08-27"), simp]
theorem translateBlockingData_red {A : Tensor (torusGraph width height) d}
    (hA : IsTorusTranslationInvariant A) (a : ZMod width) (b : ZMod height)
    {e : Edge (torusGraph width height)}
    (D : NormalEdgeBlockingData (regionInjectivityDataOf (G := torusGraph width height) A)
      (torusGraph width height) e) :
...
@[deprecated "Use the corresponding projection of `transportBlockingDataAlong`."
  (since := "2026-08-27"), simp]
theorem translateBlockingData_blue {A : Tensor (torusGraph width height) d}
    (hA : IsTorusTranslationInvariant A) (a : ZMod width) (b : ZMod height)
    {e : Edge (torusGraph width height)}
    (D : NormalEdgeBlockingData (regionInjectivityDataOf (G := torusGraph width height) A)
      (torusGraph width height) e) :
...
@[deprecated "Use the corresponding projection of `transportBlockingDataAlong`."
  (since := "2026-08-27"), simp]
theorem translateBlockingData_complement {A : Tensor (torusGraph width height) d}
    (hA : IsTorusTranslationInvariant A) (a : ZMod width) (b : ZMod height)
    {e : Edge (torusGraph width height)}
    (D : NormalEdgeBlockingData (regionInjectivityDataOf (G := torusGraph width height) A)
      (torusGraph width height) e) :
...
Source: arXiv:1804.04964, Section 3, proof of Theorem 3, line 1498 of
`Papers/1804.04964/paper_normal.tex`. -/
@[deprecated "Use `isCrossingEdge_transportBlockingDataAlong` at `translate a b`."
  (since := "2026-08-27")]
