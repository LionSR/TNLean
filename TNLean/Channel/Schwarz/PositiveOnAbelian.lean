...
-- The sequential Hermitian diagonalization proof below expands several finite-dimensional
-- basis constructions; removing the heartbeat cap avoids false timeouts during elaboration.
