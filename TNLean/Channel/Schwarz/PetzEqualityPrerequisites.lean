...
This is the singular-support algebra in Jenčová--Ruskai,
arXiv:0903.2895v4, §4.2, lines 766--793, before specializing to the
...
This is the support-restricted conclusion called `(basiceq)` in
Jenčová--Ruskai, arXiv:0903.2895v4, §4.2, lines 766--793. -/
