...
\texttt{prop:mpu\_admissible\_index\_well\_defined}, and
\texttt{lem:mpu\_admissible\_index\_composition}. The tensor-product entry
\texttt{thm:mpu\_admissible\_index\_tensor} no longer needs full-support
data: it is stated for factors in canonical form II, and the representative
entry \texttt{thm:mpu\_representative\_index\_tensor\_product} covers all
positive-dimensional MPUs.
...
The common-block reduced-data version of composition additivity has a
distinct admissible label and feeds only the Admissible Index Theorem;
tensor-product additivity no longer has such a version, as described below. This
