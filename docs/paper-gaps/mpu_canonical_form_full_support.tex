...
\leanid{MPOTensor.IsMPUCanonicalFormII.blockTensor}. Its use in the
derived-tensor entries has not yet been consolidated. Physical adjunction
also preserves the bundled presentation, with the same recorded diagonal
matrix, by
\leanid{MPOTensor.IsMPUCanonicalFormII.physicalAdjointTensor}. Its
downstream uses likewise remain to be consolidated. Independent products,
separate conjugation and transposition comparisons, and composition retain
distinct obligations under \ghissue{6139}.
...
The thirteen consumers conclude,
...
constructors supply positive-blocking and physical-adjoint preservation of
the bundled presentation. The converse constructs a presentation on the
tensor carrying the supplied fixed pair. None of these constructions
transports source cuts or factors back to $\mathcal U$ from a derived tensor.
...
blocking and physical adjunction now preserve the presentation, but their
downstream uses have not been consolidated; the other operations remain open.
...
\begin{itemize}
    \item The proved converse of the stabilization theorem, namely
          ...
          and physical adjunction are supplied separately by the preservation
          constructors, without identifying source factors across tensors.
    \item Preservation of the bundled presentation along each operation the
          ...
          The other operations remain open. A preservation statement must deliver all four
...
independent tensor products, the four clauses are separately available, but
the assembled preservation statement remains missing. Such products preserve unitarity, carry product
...
and the twelve derived-tensor entries. Their positive-blocking and physical-adjoint cases
now have the required preservation theorems, but the downstream entries have
not yet been consolidated. Independent products, separate conjugation and
transposition comparisons, and composition still require their respective
preservation or reduction arguments.
