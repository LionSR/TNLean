...
\section{Downstream standard-form and index scope}
...
applies to two tensors carrying their own data.
...
index occurs. The continuity statement requires the associated simple tensors
to carry such data along the path; the continuous-standard-form corollary also
requires the data to vary continuously. These hypotheses propagate to the
index theorem and to every symmetry statement that uses the restricted
standard form or fundamental theorem.

No current result constructs these data for every simple block, proves their
preservation under blocking, tensor product, composition, or continuous
...
explicitly admissible tensors and operations just described. They do not give
the unrestricted same-tensor standard-form and index theorems stated in the
source.
