...
and in canonical form II \cite[line~356]{Cirac2017MPU}. Physical adjunction
...
\leanid{MPOTensor.IsMPUCanonicalFormII.tensorProduct}, respectively. Positive
blocking is addressed separately in \ghissue{6067}. Their downstream
derived-tensor entries have not yet been consolidated. Separate
...
The census behind the derived-tensor obstruction is historical. Before the
converse and the preservation constructors, sixteen formal declarations
mentioned the bundled presentation: the structure itself, thirteen that
consume it, and two that construct one. The thirteen consumers conclude,
...
reduction. The converse proved below now constructs a presentation on the
same tensor from its supplied fixed pair. None of the original sixteen, nor
this converse, carries a presentation on $\mathcal U$ to a
...
representative, as the last part of this subsection shows. The two
subsequently identified constructors preserve the bundled presentation for
physical adjunction and independent products; they do not identify
the source cuts or chosen source factors of a derived tensor with those of
$\mathcal U$.
...
entries whose restricted tensor is derived from $\mathcal U$ and remains open.
...
\begin{itemize}
    ...
    \item Preservation of the bundled presentation along each operation the
          ...
          and composition. Physical adjunction and independent products are
          proved by the constructors cited above; positive blocking is
          addressed separately in \ghissue{6067}. A preservation statement must deliver all four
...
The second item is not uniformly distant. For physical adjunction and
independent tensor products, all four clauses are assembled. Physical
adjunction retains the same ambient fixed matrix because a positive diagonal
matrix is entrywise real. For an independent
product, the ambient matrix is the reindexed Kronecker product of the two
recorded matrices. It is positive definite, diagonal, of trace one, and fixed
by the product transfer map. These preservation results do not transport raw
source cuts or chosen compact-SVD factors. Transposition and conjugation are
...
and the twelve derived-tensor entries. Their physical-adjoint and
independent-product cases now have bundled preservation theorems, but those
downstream entries have not yet been consolidated. Positive blocking is
tracked separately in \ghissue{6067}; conjugation and transposition
comparisons, symmetry transforms, and composition retain distinct
preservation or reduction obligations.
