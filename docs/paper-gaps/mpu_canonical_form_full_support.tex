...
For two such representatives, tensor-product additivity now follows without
...
the index unchanged. The remaining composition hypotheses below are not
removed by this tensor-product argument.
