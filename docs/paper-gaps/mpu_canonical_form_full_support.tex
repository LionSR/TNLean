...
Before the physical-adjoint and positive-blocking constructors, the recorded
census was the following.
Sixteen formal declarations mentioned the bundled presentation: the structure itself, thirteen
...
the bundled presentation. Neither transports source cuts or factors back to
$\mathcal U$.
...
derived-tensor entries. Their positive-blocking and physical-adjoint cases
