...
Theorem 6.6(1), but not its bound $m\leq D^2$ and not items~(2)--(4). The
corresponding Blueprint entry states this restriction explicitly and uses its
own specialization title.
...
complete-positivity hypothesis supplied by a finite Kraus representation and
with an additional positive-definite adjoint fixed point as explicit input. It
does not include the bound $m\leq D^2$ or items~(2)--(4). Derivation of the
fixed point and the abstract Schwarz-map cyclicity statement remain open at the
