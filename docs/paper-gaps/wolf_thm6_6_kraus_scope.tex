...
This is a \textbf{scope restriction}: the formal theorem proves Wolf Theorem
6.6 only under the stronger complete-positivity hypothesis supplied by a
finite Kraus representation. The abstract Schwarz-map case remains open.
