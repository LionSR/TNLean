...
\leanid{MPSTensor.rfp_implies_nncph_ground_state}.  Thus the forward
commutation axiom has been eliminated in the single-normal-tensor scope.
...
\begin{align}
  ...
  \text{ is a ground state of a NNCPH}.
\end{align}
The forward commutation implication now uses the basic-vector form in
