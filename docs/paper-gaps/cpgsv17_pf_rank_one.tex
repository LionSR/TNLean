...
not the claimed alternative all-sector factorization.
...
(ii)$\Rightarrow$(v) route still requires an alternative all-sector
factorization and the subsequent projector-controlled assembly.
