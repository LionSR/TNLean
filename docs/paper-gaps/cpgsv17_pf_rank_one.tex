...
sectors are nonminimal; their non-rank-one trace matrix refutes only that proof
path. A general coarsening theorem, or a counterexample to the existence of any
such factorization under the complete absorbed-representative hypotheses,
remains missing in \ghissue{6775}.
