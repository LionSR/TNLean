...
corollary.  A former formal definition juxtaposed a Markov state and a trace
matrix without relating them to each other or to an MPO tensor. It has
therefore been removed, together with the two results which merely assembled
these unrelated data.
