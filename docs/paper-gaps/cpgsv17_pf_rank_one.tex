...
\[
  ...
  \qquad H_N=Nh.
\]
Consequently $I_L=H_L+H_{N-L}-H_N=4-2h$, independently of $L$.  Thus the
tensor satisfies the strong area law mathematically.  This entropy calculation
is not yet a theorem about
\leanid{MPOTensor.ActiveSectorSpanningCounterexample.tensor}; in particular,
