...
The local simple-MPDO structure is constructed only through these two corrected
...
Theorem~4.9 cannot be obtained by the printed argument.  Their corrected
conditional forms remain available under positive semidefiniteness or the
appropriate linear-independence hypothesis, but those additional conditions
must not be attributed to the source theorem.
