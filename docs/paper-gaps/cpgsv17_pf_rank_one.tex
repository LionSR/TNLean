...
Propositions `prop2to3` and `prop2to5`. The explicit tensor-attached vertical
BNT coefficient problem tracked in \ghissue{5635} is a separate question and
is not used in this descent argument.
...
passage remains separate under issue \ghissue{5673}.
