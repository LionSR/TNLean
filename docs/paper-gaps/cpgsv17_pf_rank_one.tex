...
Consequently the normal Case-I structural theorem cannot yet be applied to
all absorbed BNT representatives. The constructions from an explicitly
supplied rank-one neighboring trace factorization remain valid restricted
results, but they do not establish the missing normality or the all-sector
factorization.
...
The printed absorbed-normality step is now formally refuted by the reusable
identity \leanid{MPSTensor.spectralRadius_transferMap_smul} and the explicit
two-sector, bond-one construction
\leanid{MPOTensor.CaseIIAbsorptionCounterexample.%
printed_absorbed_normality_step_is_false}.  Its normal representatives have
disjoint doubled-physical support, its global weights are
$(1/\sqrt2,1)$, its ambient physical-trace transfer is literally idempotent,
and its first absorbed representative has transfer spectral radius $1/2$ and
is not normal. This first construction decides the scalar normality inference
used in Proposition~\texttt{prop2to3}; it is not the counterexample to the
literal implication (iv)$\Rightarrow$(v).
...
The capstone packages the exact BNT canonical assembly and global unit-weight
...
predicate. The completed Case-II analytic inheritance likewise does not prove
that coefficient absorption preserves normality. The all-sector structural
passage therefore remains blocked at this normalization boundary, rather than
being an unfinished consequence of the analytic inheritance theorem.
...
paper's literal ZCL diagram. Independently, the repeated-copy capstone above
refutes the exact printed implication (iv)$\Rightarrow$(v). The source
(ii)$\Rightarrow$(v) route remains open at the common-weight absorption and
projector-controlled assembly boundary.
