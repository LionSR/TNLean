...
For the positive test matrix $H=\operatorname{diag}(20,1)$, the exact
positive-definite gap $H-\mathcal E_{\mathcal K}^*(H)>0$ has determinant
$19861/2000$. Pairing it with a positive-definite Perron eigenmatrix $\rho$
of $\mathcal E_{\mathcal K}$ gives the trace-adjoint identity
\begin{align}
  0
