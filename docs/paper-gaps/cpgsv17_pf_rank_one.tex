...
form a resolution of the one-site physical identity, and on one blocked site
the measured projection is the reindexed matrix $P_s\otimes I$. Compression
selects the matching absorbed representative at both required closure
lengths; its supplied channel is then applied. Thus the remaining gap in the
source implication is only the construction of one blocked channel pair for
every absorbed representative, by either \ghissue{6775} or \ghissue{6793}.
...
coarsening or sector-mixing argument. The later combination through the
orthogonal outer physical sectors remains \ghissue{6632}.
