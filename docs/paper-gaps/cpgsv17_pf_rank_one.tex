...
unit-modulus coefficient across the whole canonical form. It therefore does
not supply the sectorwise equations $|\mu_s|=1$ needed to invoke the normal
Case-I theorem for every $s$. This is the precise remaining obstruction in
Propositions `prop2to3` and `prop2to5`. For the rescaling-stable example, the
