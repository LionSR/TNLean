...
the source hypothesis boundary.  The normalized rank-one conclusion is
formalized in
...
hypotheses, and the normal Case-I theorem above completes the rank-one
conclusion at that boundary.  The structural corollary and the downstream
normalization step used after absorbing BNT coefficients remain unsettled; in
