...
representatives have been matched, to the nonzero coefficients of the
canonical forms.
...
\begin{enumerate}
  ...
  \item The SectorBNT equal-MPV declarations
    ...
    matched copy-weight identities on the SectorBNT surface. The SectorBNT
    equal-MPV theorem is obtained after the canonical-form supplier has put
...
positive copy count and every copy weight is nonzero, the nonzero-coefficient
convention of
...
covers the equal-ambient case.  It assumes that both tensors have the same
ambient bond dimension and that their canonical-form data satisfy the separate
weight normalization.  Exact reconstructions and a coisometry-alignment
argument then give ambient gauge equivalence.  This does not remove the
heterogeneous ambient-dimension obstruction of the printed corollary.
