...
\end{align}
This reading reproduces the printed fusion tensors
...
$|s\rangle^{\otimes3}$, with right vector $w$ after the first site and left
vector $v$ before the third. It prints $w=|\hat+\rangle$, $v=\langle\hat+|$
...
\end{align}
With $v=\langle1|$ and $v=-\langle0|$ both three-site decompositions hold and
$(v,w)$ are reductions of the action onto the exchanged state. The resulting
