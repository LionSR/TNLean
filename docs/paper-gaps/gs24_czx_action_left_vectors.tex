...
\begin{align}
    ...
    \label{eq:czx_mpu_tensor}
\end{align}
The reading~\eqref{eq:czx_mpu_tensor} reproduces the printed fusion tensors
...
$|s\rangle^{\otimes3}$ by the letters~\eqref{eq:czx_action_letters}, with
...
\begin{align}
    ...
    \label{eq:czx_corrected_left_vectors}
\end{align}
With the choices~\eqref{eq:czx_corrected_left_vectors}, $v=\langle1|$ and
