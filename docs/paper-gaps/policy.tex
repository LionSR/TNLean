...
displayed equation is identified by a source tag, the tag should appear on the
right of the display, while the surrounding prose refers to the mathematical
...
the local bibliography, and a model for right-hand source tags in displayed
equations.
