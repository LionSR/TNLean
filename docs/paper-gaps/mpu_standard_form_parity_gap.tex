...
support and carry the canonical-form-II weight $\rho=(1)$. Neither tensor is
zero, and both
source cuts have rank two. In the natural physical coordinates,
\begin{align}
...
factors cancel in $v$. The printed local equations
hold with $x=y=-I_2$ and $z=1$: the product $x\otimes y$ acts trivially on
