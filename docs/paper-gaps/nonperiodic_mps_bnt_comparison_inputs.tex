...
\]
and is stated in
\leanid{cumulative_pairSpanConsequences_of_injective_not_gaugePhaseEquiv}
(equal dimension) and \leanid{cumulative_pairSpanConsequences_of_isCanonicalFormBNT}
(BNT family).
