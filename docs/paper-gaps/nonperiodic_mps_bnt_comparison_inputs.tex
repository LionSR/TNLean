...
the source paper.  The former wrappers in
\path{TNLean/MPS/FundamentalTheorem/EqualProportional.lean} have been removed
from the source-facing theorem surface for this reason.
