...
now assembled.  Their construction is recorded in the QICLean paper-gap note
\path{https://sirui-lu.com/QICLean/paper-gaps/wolf_theorem6_14_fixed_point_projection_gap.pdf}.  For
...
in the same QICLean paper-gap note; it
