...
with $c_N$ allowed to vanish is kept: the relation $V=0\cdot V'$ is not a
projective statement, and the nonzero reading is the only proportionality
hypothesis of the formal development.
