...
\[
  ...
  =Q_2(\rho,\omega).
\]
This is the $\tau=\rho$, $\alpha=1,2$ specialization of the auxiliary
divergence and vector-state Jensen mechanism in
\cite[arXiv:1306.3142v4, Definition~5 and proof of Theorem~5]{MullerLennert2013Renyi},
followed by the endpoint Cauchy--Schwarz estimate.  The shortened endpoint proof
is not Beigi's interpolation argument.  Compression to the support of
...
\leanid{Matrix.PosSemidef.cfc_log_kronecker},
...
Thus the mathematical comparison tracked by
\href{https://github.com/LionSR/TNLean/issues/5209}{\#5209} is complete.
...
The faithful and singular relative-entropy comparisons are now proved, so the
mathematical task in
\href{https://github.com/LionSR/TNLean/issues/5209}{\#5209} is complete.  The
proof uses the relative-modular half-moment, support-aware Jensen, and
Hilbert--Schmidt Cauchy--Schwarz; it requires neither a general weighted
interpolation theorem nor an order-one limit.  The remaining work in
\href{https://github.com/LionSR/TNLean/issues/5211}{\#5211} is the
whitened-state/Choi identification and its Hilbert--Schmidt rank estimate.  The
