...
$1+\varepsilon\alpha_i$ between the joint probability
$m_{ij}(1+\varepsilon\alpha_i)$ and the row marginal
...
Write mutual information as $H(X)+H(Y)-H(X,Y)$ and use
\begin{align}
  \operatorname{negMulLog}(ab)
  =a\,\operatorname{negMulLog}(b)
   +b\,\operatorname{negMulLog}(a).
\end{align}
...
identity is \texttt{Real.negMulLog\_mul}.}
