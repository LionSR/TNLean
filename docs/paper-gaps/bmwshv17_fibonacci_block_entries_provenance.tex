...
each block, $O_1^0=2$ and $O_\tau^0=3$, so
$P_0=2w_1+3w_\tau=(2+3\phi)/(1+\phi^2)\neq 1$ acts on the one-dimensional
space of the empty chain and is not idempotent. The empty chain is read as a
