...
additional prefactor $1/\sqrt{d_Ad_D}$ and the source includes closed-loop
factors $v_a$; both fix a normalization of the unprinted tensor. The checked
statements concern the bare F-symbols (\ref{eq:fib_block}), and no operator
statement is made for a rescaled tensor. This is a choice of normalization for
an unprinted tensor, not an error in the source.\footnote{Review traceability:
    \path{Papers/2011.12127/TN-Review-main.tex}, lines 2613--2625.}
