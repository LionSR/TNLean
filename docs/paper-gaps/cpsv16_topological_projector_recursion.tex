...
\eqref{eq:source-commutator}, together with the terminal spectral refinement
\eqref{eq:formalized-terminal-spectral-refinement}, are now formalized.  A
faithful proof of the remainder still requires the construction of the
translationally invariant commuting nearest-neighbor Hamiltonian and the
identification of
\eqref{eq:formalized-terminal-density-refinement} with the Gibbs form in
\eqref{eq:source-gibbs-decomposition}.  The terminal refinement must not be
cited as the commuting Gibbs theorem of lines~1013--1016 until that remaining
step is proved.
