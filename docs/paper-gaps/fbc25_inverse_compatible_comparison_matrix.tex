...
comparison correct with no further change, which is why this is a local
...
reading; the formalization inserts the weight. This is a local correction, and
it changes no conclusion of the appendix argument.
...
inverse, exhibited explicitly. The elimination step is the formalization of the
appendix normalization that makes $K$ unitary; until it exists, the
$K^\dagger$ form of the pairing remains outside the formalized statement, and
the note stays open.
