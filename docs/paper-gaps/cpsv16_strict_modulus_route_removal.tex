...
declarations built on \eqref{eq:strict} lived in the now-deleted module
\path{TNLean/PiAlgebra/CanonicalFormSep.lean}; the consuming
injectivity-after-blocking results lived in
...
\path{docs/paper-gaps/cpsv16_nondominant_per_block_projection.tex}.\footnote{%
  See also \path{docs/audits/2026-05-13_cpsv16_ft_discharge_attempt.md} and
...
modulus-free non-vanishing of the sector coefficient
...
proof term, on \eqref{eq:strict} or on any declaration of the deleted
\path{TNLean/PiAlgebra/CanonicalFormSep.lean}. Removing the strict route therefore
