...
\leanid{sectorTensor_proportional_of_blockedMatch}, and
\leanid{periodicOverlap_gaugeEquiv_of_sector_match} in \leanid{SectorMatch.lean}.}
...
\leanid{sectorTensor_proportional_of_blockedMatch}. The
...
\leanid{sectorTensor_proportional_of_blockedMatch}.} The tensor-product scalar
...
$A_u^i/F_u$ building blocks that enter the first bullet above; the right-inverse
contraction of $F_u$ to \emph{eq:resultprop} and the global gauge assembly remain
open.
