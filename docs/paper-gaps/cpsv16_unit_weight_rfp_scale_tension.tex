...
\end{align}
This extra hypothesis is necessary. The compiled tensor
\leanid{MPOTensor.SimpleVanishingCounterexample.M}, whose sole local virtual
matrix is $\operatorname{diag}(1,-1)$, satisfies
\begin{align}
...
therefore proves normalized simplicity together with failure of source
simplicity. This witness is not an RFP claim and gives no rigidity statement
for BNT structure coefficients. For a fixed tensor, a theorem may also quantify
