...
\leanid{MPOTensor.SimpleVanishingCounterexample.M_isSimple_and_isSourceSimple_and_not_isNonvanishingSourceSimple} proves that
the tensor is normalized-simple and source-simple: $\rho_2(M)=2I\ne0$
