...
source's own conventions exclude: the Definition-4.1-normalized Example~4.12
carries the canonical-form weights $1/\sqrt2,1/\sqrt2$, and the dimer $R$
of the section below carries $\sqrt{337/512}$, so neither would be simple
under it. The library therefore reads line~246 as a
normalization the source may apply, not as a clause of Definition~4.7. The
predicates it once separated, and the counterexample module that separated
them, were removed; see
