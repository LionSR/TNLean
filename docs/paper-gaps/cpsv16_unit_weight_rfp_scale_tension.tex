...
tensor. Its singleton coefficient has modulus $\sqrt r>1$, so it does not obey
the line-246 unit-weight convention, which cannot be restored without losing
literal ZCL. Thus \ghissue{6775} remains open at the ambient source-context
boundary. The alternative direct construction of the blocked channel pair,
