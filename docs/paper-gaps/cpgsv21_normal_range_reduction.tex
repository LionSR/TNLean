...
The boundary comparison for $L_0+1<N$ is a reformulation of
Eq.~\ref{eq:cpgsv21_normal_range_reduction_printed_change_of_cut}, not a
different argument. The formal statement
...
relation read at the two windows that cross the cut; the bookkeeping is
heavier than the printed two lines, but the mathematics is the same.
