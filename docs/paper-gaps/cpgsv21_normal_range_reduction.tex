...
\footnote{Formal locations:
\path{TNLean/MPS/ParentHamiltonian/BoundaryClosingStripping.lean}:335 for
\path{MPSTensor.closure_property_boundary_restrictions_eq_of_groundSpaceMap},
and
\path{TNLean/MPS/ParentHamiltonian/BoundaryClosingStripping.lean}:367 for the use of
...
\path{TNLean/MPS/ParentHamiltonian/BoundaryClosingStripping.lean}:373--375.}
...
\path{TNLean/MPS/ParentHamiltonian/BoundaryClosingStripping.lean}:376 for its
use in
\leanid{MPSTensor.closure_property_boundary_restrictions_eq_of_groundSpaceMap}.}
