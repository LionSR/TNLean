...
\begin{document}
% TNLEAN_EXTERNAL_SOURCE_RANGES: 1706.07329v2 3124-3133,3815-3938,3839,3865,3973-3976
\maketitle
...
$\lambda\in\mathbb C$,
\footnote{The exact arXiv:1706.07329v2 source is recovered by
    \path{scripts/verify_external_paper_sources.py} with \texttt{--fetch}, as recorded in
    \path{Papers/external_sources.toml}.  The source coordinates are
    \path{build/paper-sources/1706.07329/cornerproblem.tex:3124--3133}.}
\begin{align}
    V_n(B)
        &=\lambda^n V_n(A)
