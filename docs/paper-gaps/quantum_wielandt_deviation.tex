...
The quantum Wielandt inequality of Sanz--P\'erez-Garc\'ia--Wolf--Cirac
is stated in \cite{Sanz2010Quantum}.\footnote{For
...
states that, if $\mathcal E_A$ is primitive, then
\[
  i(A)\leq (D^2-d+1)D^2.
\]
...
is injective. This is the dimension-growth argument used in the source proof.
The formal statement instead applies the argument only to a listed Kraus
...
The remaining difference is a provisional strengthening of the hypotheses in the
sharper cases.
