...
bijection of the basis sectors with gauge-phase equivalences.  The analysis below is retained
...
contradicting
\leanid{MPSTensor.SectorDecomposition.coeff_not_eventually_zero}.  The unrestricted
...
\leanid{MPSTensor.SectorDecomposition.coeff_not_eventually_zero}, this gives the
