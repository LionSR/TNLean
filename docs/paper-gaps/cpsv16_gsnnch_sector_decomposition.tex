...
The auxiliary single-bond presentation is the realization relation for
commuting-form data.\footnote{\raggedright Formal structure:
\leanid{MPOTensor.CommutingFormData}. Formal predicate:
\leanid{MPOTensor.CommutingFormData.Realizes}.} It has the form
\begin{align}
    \rho^{(N)}
