...
source-facing theorem now retains the joint five-identity package
\[
...
positivity is needed in this forward implication, exactly as suggested by the
short source proof.
...
The theorem derives the orthogonal commuting sector family from the printed
identities before applying the general direct-sum result.  No reverse
comparison with a single-bond predicate is needed.
...
projections.  The source-facing theorem combines these bonds with the BNT
copy-number identity while retaining \texttt{Apptralktrrk} and
\texttt{AppPsiPhi} in its statement and the common copy weights from the
preceding Case~II argument.  Proposition~\texttt{prop3to4} is therefore
formalized under precisely its printed identities and standing BNT context.
