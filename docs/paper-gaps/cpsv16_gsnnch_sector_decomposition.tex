...
\[
  ...
  \texttt{AppPsiPhi}.
\]
It also states the standing Case~II assumption that the full tensor generates
positive semidefinite operators and the source-native positivity of every BNT
bond dimension.  The latter is not stored by the bare sector-decomposition
type and is necessary because algebraic injectivity is vacuous in dimension
zero.
...
identities together with the standing Case~II MPDO assumption and positive BNT
bond dimensions.  This repairs the proposition by a chainwise argument; it
does not validate the printed invocation of Lemma~\texttt{lemmus} and does not
prove copy independence.
