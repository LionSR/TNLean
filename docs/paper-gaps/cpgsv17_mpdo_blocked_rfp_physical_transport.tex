...
The outer-support construction remains a valid conditional assembly relevant
to Proposition~\texttt{prop2to5}, which begins with condition~(ii) of
...
The printed route then invokes Proposition~\texttt{prop2to3} to supply a
...
Proposition~\texttt{3to5} can be combined over mutually orthogonal outer
physical supports when those factorizations are supplied; this does not prove
or refute the bare conclusion of Proposition~\texttt{prop2to5}.
