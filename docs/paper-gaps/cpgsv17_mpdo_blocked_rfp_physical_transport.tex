...
the bare conclusion of Proposition~C.15. The independent trace-norm
counterexample recorded below refutes that conclusion.
...
is refuted. More strongly, the trace-norm obstruction in
\path{docs/paper-gaps/cpsv16_prop_c15_blocking_channel_false.tex} excludes every
two-to-three refinement channel for an ambient tensor satisfying the complete
standing hypotheses. Thus the bare conclusion of
Proposition~\texttt{prop2to5} is false. The conditional transport theorem in
this note remains valid for supplied factorizations.
