...
The next missing results assemble the neighboring operators $\eta_{k,h}$ from
these sector tensors, prove their all-length cyclic contraction identity, and
establish primitivity of the sector trace matrix.  A further assembly step is
