...
The next missing result chooses a nonzero entry
$R_{\beta_3,\alpha_1}$ and divides the comparison to obtain the tensor
factorization displayed at lines 1434--1438.  It must then assemble the
neighboring operators and prove their all-length cyclic contraction identity.
...
The sector factorization, all-length identity, and primitivity statement of
