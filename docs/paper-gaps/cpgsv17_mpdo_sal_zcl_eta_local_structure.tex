...
Pairwise commutativity of all translates is now complete for every periodic
chain length at least two: the crossed two-site case, adjacent case, and
nonadjacent disjoint case are combined by the finite overlap classification.
...
For the conditional bond construction, all translated bonds commute pairwise
for every chain length $N\geq 2$, including the wraparound, crossed two-site,
and nonadjacent disjoint cases.  The finite-chain product realization remains
open.
