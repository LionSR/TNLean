...
the sector tensors above, prove their all-length cyclic contraction identity,
and establish primitivity of the sector trace matrix.  The four-site
decomposition now supplies the Hayashi witness required by the concrete sector
factorization; these remaining assertions are the passage from that local
factorization to the source identity at every chain length.
