...
What remains is the application of this finite-matrix lemma to the cyclic bond
formalism.  One must identify the two adjacent translates supplied by
\leanid{MPOTensor.EtaLocalStructureData} with the two abstract overlapping
lifts under a common three-site reindexing, and then transport the resulting
direct-sum decomposition through the translation-invariant family.
...
\begin{enumerate}
\item Prove the three-site reindexing bridge for the two overlapping translates
of the single bond in
