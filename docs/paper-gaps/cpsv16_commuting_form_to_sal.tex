...
one. The raw tensor is not the normal tensor assumed in Appendix~C.2 Case~I;
its normal representative fails the paper's literal ZCL diagram. Thus the
example isolates a normalization obstruction rather than refuting Lemma~C.5
