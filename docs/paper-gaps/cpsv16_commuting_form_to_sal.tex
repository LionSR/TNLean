...
one-letter span of the BNT representatives.  Combining that span with the
nonzero common weight,
\leanid{MPOTensor.commonWeightAbsorbedBasisMPOTensor_isInjective} supplies
one-site injectivity for every absorbed representative; no passage through
blocked SAL is needed.  Sector MPDO positivity and normality of the absorbed,
normalized sector remain explicit inputs.  They must be supplied independently,
...
before Proposition~\emph{prop4to2} is invoked.  The nonzero absorbed weight then
preserves one-site injectivity by
\leanid{MPOTensor.commonWeightAbsorbedBasisMPOTensor_isInjective}.  Thus there
is no unresolved injectivity gap in the Case~II application.  The all-cut
Hayashi decomposition applies directly to a canonical absorbed sector once
the theorem's remaining explicit hypotheses---sector MPDO positivity and
normality in the absorbed normalization---are supplied independently of
ambient SAL.
