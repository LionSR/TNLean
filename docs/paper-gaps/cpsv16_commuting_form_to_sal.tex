...
standing biCF hypothesis at source line~1628 is the simultaneous one-letter
span of the BNT representatives.  The formal implication
...
blocked SAL is needed.  The exact outer equality for the canonical BNT family
is provided by
...
representative gives its one-site injectivity.  The existing all-cut Hayashi
decomposition can therefore be applied directly to every canonical absorbed
sector while retaining the original one-site middle region.
...
injectivity of those sectors, so the single-sector theorem retains every
original cut.
