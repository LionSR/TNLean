...
projections and commuting sector products, but it does not yet discharge either
the all-positive-length exact equality or the marginal-support hypothesis.  The
local direct-sum implication does not use SAL-derived BNT projectors and hence
does not reason circularly.
