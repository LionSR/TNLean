...
bond spaces, physical first-site insertion equality, and invariant-projector
closure are complete.  The physical Figure-8/Gram proportionality and
conjugation argument, followed by the final vertical canonical-form theorem
with its coisometry, remain open.  The proved statements retain every inactive
listed coordinate with weight zero and do not use the unsupported
diagonal-restriction statement from \ghissue{2537}.
...
Literal Proposition~4.13 nevertheless remains open.  The physical Figure-8
argument of source lines~1909--1919 must still derive the Gram-conjugation and
positive proportionality identities for the grouped gauges.  These identities
must then be combined with the reducing vertical sectors to obtain the final
vertical canonical form and the coisometry satisfying $UU^\dagger=I$.  The
current results do not assert $U^\dagger U=I$.
