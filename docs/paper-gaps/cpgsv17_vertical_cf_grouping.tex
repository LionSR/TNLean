...
vertical corner, and vertical phase-class grouping with positive effective
coefficients, actual-grouped Figure~8, and unitary normalization of the grouped
gauges are now complete.  Construction of the normalized physical sector maps
and the final coisometry remain open.
...
gauge.  Under the stronger normalized BNT-refined hypothesis, the normalized gauges
are expressed on the representative bond spaces and composed with the physical
sector isometries in
...
Proposition~4.13, so the full literal theorem remains open.  Under the literal
...
separation, actual vertical phase-class grouping with positive effective
coefficients, the pairwise Figure~8 Gram-dressing identity, and the positive
relative Gram scalar are complete.  The actual grouped corners also satisfy
the Figure~8 Gram identity; every grouped gauge has Gram matrix
$\omega_{\alpha,q}\Id$ with $\omega_{\alpha,q}>0$, and inverse-square-root
rescaling makes it unitary.  Construction of the normalized physical sector
maps and the final vertical canonical-form theorem with its coisometry remain
open.  The proved statements retain every
...
Literal Proposition~4.13 nevertheless remains open.  Periodic exclusion,
the normal vertical corners with exact reconstruction
\eqref{eq:literal-normal-corners}, and their phase-class grouping with positive
effective coefficients, actual-grouped Figure~8, and unitary gauge normalization
are complete.  One must still construct the normalized physical sector maps
and obtain the final vertical canonical form and coisometry
satisfying $UU^\dagger=I$.  The current results do not assert
$U^\dagger U=I$.  This remaining
