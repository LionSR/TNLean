...
closure, the pairwise Figure~8 Gram-dressing identity, and the positive
relative Gram scalar are complete.  The two Figure~8 statements are conditional
on two vertical corners satisfying the displayed similarity equations; they do
not construct the actual representative groups or corners.  Literal periodic
exclusion and spectral grouping, normalized grouped sectors, and the final
vertical canonical-form theorem with its coisometry remain open.  The proved
statements retain every inactive listed coordinate with weight zero and do not
...
Literal Proposition~4.13 nevertheless remains open.  One must still construct
the actual vertical representative groups and their corners, prove periodic
exclusion and spectral grouping from literal canonical form, form the normalized
grouped sectors, and obtain the final vertical canonical form and coisometry
satisfying $UU^\dagger=I$.  The current results do not assert
$U^\dagger U=I$.  This remaining Proposition~4.13 work is independent of the
Appendix~C.4 positive-fusion question tracked by \ghissue{4648}.
