...
hypothesis.  Under literal CPSV canonical form, periodic exclusion and the
normal vertical block decomposition are now complete, but representative
BNT grouping, normalization, and the final coisometry remain open.
...
the normal vertical block decomposition, the pairwise Figure~8 Gram-dressing
identity, and the positive relative Gram scalar are complete.  The two
...
actual representative families.  Vertical BNT grouping, normalization of the
grouped sectors, and the final vertical canonical-form theorem with its
coisometry remain open.  The proved statements retain every inactive listed
coordinate with weight zero and do not
