...
\path{TNLean/MPS/MPDO/SectorTrace.lean}).  Under literal CPSV canonical form, the phase classes, their loop identities,
and the positivity of every grouped coefficient are supplied by the literal
specialization above.  For the
