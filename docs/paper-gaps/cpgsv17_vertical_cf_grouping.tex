...
coefficients are now complete.  Normalization of the grouped sectors and the
final coisometry remain open.
...
displayed similarity equations.  Normalization of the grouped sectors and the
final vertical canonical-form
...
effective coefficients are complete.  One must still normalize the grouped
sector maps and obtain the final vertical canonical form and coisometry
