...
trace-preserving normalization is eliminated from the statement with the
periods supplied.\footnote{Formal declaration:
\leanid{MPSTensor.fundamentalTheorem_periodic_equalCase_irreducibleForm}.} The
periods themselves are derived in the next section, which yields the
unrestricted source statement. Only
