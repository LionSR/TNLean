...
The longer-range theorem proved below does not yet establish this
$S+1$ interaction bound at the minimal ring length $N=S+1$.
The remaining assertion is periodic closure from the simultaneous span
(\ref{eq:block_parent_simultaneous_length}), without substituting the
larger separation bound derived from individual block injectivity.
