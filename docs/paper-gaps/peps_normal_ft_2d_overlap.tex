...
argument.  The remaining Step~4 work is to expand
(\ref{eq:peps_normal_ft_2d_overlap_formal_end_pair_insert_equality}), using the
boundary partition above, into precisely this single-bond contraction identity,
and then to formalize the composition argument for the maps
$O_1\mapsto X$ and $O_3^{\mathsf T}\mapsto X$.
