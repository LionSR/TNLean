...
(\path{TNLean/PEPS/TorusWindowChain.lean}). Of the two fiber-gluing engines above,
the corner-extension composition is landed
(\path{TNLean/PEPS/TorusWindowChain4.lean}); the shared-corner cancellation is the
piece not yet landed.
