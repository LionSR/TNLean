...
\begin{center}
\scriptsize
\path{MPSTensor.PositiveMinimalRealizationCounterexample.perBlockLinearExtension_not_positive}.
\end{center}
...
earlier implication from the renormalization fixed-point condition.  There the
physical trace-preserving completely positive maps $T$ and $S$ are already
hypotheses, and the maps on the sector algebras are the composites
$\tilde T=\tilde R_2TR_1$ and $\tilde S=\tilde R_1SR_2$ with positive
insertion and removal maps.  Their positivity therefore comes from the given
physical maps.  In the converse implication, the physical maps are defined
only after the matrices $U_\gamma$ have been declared unitary.  Those later
maps cannot prove positivity of the virtual extension without assuming the
unitary conclusion they are meant to establish.
