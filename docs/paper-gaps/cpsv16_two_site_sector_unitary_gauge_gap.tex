...
remains genuinely open.  Every counterexample to that proposed comparison
must use retained sectors whose terminal transfers are positive semidefinite.
In particular, any replacement bond-two witness must differ from the excluded
pair.  Conversely, terminal positivity alone
