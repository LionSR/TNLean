...
No result identifies $P$ with a two-site operator generated by $A$, or $P_X$
with one generated by $B$.  In particular, this calculation does not show that
$B$ fails an MPDO two-site test.
...
chosen $J$ and companion $P$; it is not a theorem about a two-site operator of
$A$ or $B$.
