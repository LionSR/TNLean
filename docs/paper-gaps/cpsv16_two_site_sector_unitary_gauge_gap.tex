...
Thus the concrete nonunitary deformation satisfies both tensor-attached
premises singled out in Theorem~4.14(ii): the BNT algebra clause and literal
horizontal CPSV canonical form.  It nevertheless fails positivity of the
length-two matrix product operator, and therefore is not an MPDO.  It is not a
full-contract counterexample to Theorem~4.14 and constructs no
\path{IdentityMarkedRealization}.
