...
The new obstruction does not construct a deformed tensor-attached BNT algebra
clause.  In particular, it is not a counterexample to that clause: the natural
deformation with nonscalar Gram matrix already fails the MPDO premise.  It also
does not construct the identity-dressed marked realization or prove the general
marked comparison.
...
from the full tensor-attached setting.  The bond-two calculation further
excludes the natural physical-similarity deformation whenever its Gram matrix
is nonscalar.  Neither result supplies the missing marked comparison.
...
Terminal sector positivity rules out the generic nonunitary witness.  The
bond-two calculation also rules out the natural physical-similarity deformation
whenever $X^\dagger X$ is nonscalar.  This is not a deformed tensor-attached BNT
algebra-clause counterexample and does not construct the required marked
realization.  Appendix~C.4 therefore does not presently justify the
