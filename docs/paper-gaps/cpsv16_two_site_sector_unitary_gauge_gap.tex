...
projections and obey the coefficient-one product law.  At every $L>0$, the
normalized representative $\widehat A=2^{-1/2}A$, together with the unique
multiplicity weight $\sqrt2$, has coefficient $2^{-L/2}$ and reconstructs
$A$.  The canonical
