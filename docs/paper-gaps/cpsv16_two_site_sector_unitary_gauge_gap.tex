...
% Verified against Lean head f0f8a921c3c25bdf3f0ac121d3d0dcb75bfe368d.
...
$YJY^{-1}$ and
$(Y\otimes Y)P(Y^{-1}\otimes Y^{-1})$ are Hermitian, then
\begin{equation}
  G=\omega\mathbf 1
  \qquad\text{for some }\omega>0.
...
$A$ or $B$.  In particular, the present result supplies neither an all-length
MPDO predicate nor a tensor-attached BNT algebra clause for the singleton.
The missing identification of the Bell projector with a singleton-derived
two-site operator, together with the all-length tensor-attached/base-model
construction, is recorded in
\href{https://github.com/LionSR/TNLean/issues/5290}{issue 5290}.
