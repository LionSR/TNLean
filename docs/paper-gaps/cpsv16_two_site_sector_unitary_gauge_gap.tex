...
The raw retained closed operators are diagonal indicators of cyclically
composable directed-edge words.  They are therefore orthogonal projections and
obey the coefficient-one product law.  The normalized representative
$\widehat A=2^{-1/2}A$, together with the unique multiplicity weight $\sqrt2$,
has coefficient $2^{-L/2}$ at length $L$ and reconstructs $A$.  The canonical
...
algebra clause for the all-length positive model $M$.
