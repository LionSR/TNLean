...
All four constructions are local, so they apply for every $N,M\ge 1$ once the
...
bonds. The contraction of the four tensors on this graph is therefore a
...
edges between neighbouring sites, and restate the four examples there. The
