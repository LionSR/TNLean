...
bonds. For each of the five constructions, the contraction on this graph is
therefore a different network from the source's at $w=2$ or $h=2$. For the RVB tensor
