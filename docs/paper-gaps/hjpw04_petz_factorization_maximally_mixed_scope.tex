...
$B_j^L\otimes B_j^R$, and chooses the Hayashi unitary $U_B^\dagger$. Total
positive-semidefinite normalization supplies the left density matrices and
chooses arbitrary normalized matrices only in zero-weight or complementary
sectors. Those fillers are not recovered physical states; their weighted
