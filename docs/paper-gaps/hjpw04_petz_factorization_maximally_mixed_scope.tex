...
normalizes these blocks into the quantum-Markov decomposition. It keeps the
supported recovered states as the positive-weight right factors and uses
arbitrary normalized matrices only when the final weight is zero.
