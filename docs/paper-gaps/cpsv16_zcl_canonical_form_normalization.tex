...
(\texttt{MPOTensor.IsZCL}) from a zero-correlation-length hypothesis by definitional
coercion --- the pattern in the simple-MPDO chain that uses an
\texttt{IsZCL} field directly as \texttt{MPOTensor.IsZCL} --- relies on an intermediate theorem the
