...
\begin{document}
\maketitle
\gapnote{definition-drift}{resolved}
...
PRFP equivalence remains open. In Theorem~4.9, the literal implication
...
independent of the copy label and absorb their common value. After that
