...
$\eta_{j,k_0}\cdot|\lambda_j/\lambda_{k_0}|<1$, which was the content of
the retired hypothesis.
...
\cite[Definition~4.2]{Cirac2021Matrix} make explicit. A geometric rate may
be derived from the spectral gap of the mixed transfer operator underlying
