...
claimed equality of BNT cardinalities fails.  Consequently
no rate-quantified overlap estimate is needed for the current fundamental
theorem.
The analysis below is retained as a record of the retired proof attempt.
...
\path{docs/audits/2026-05-13_cpsv16_ft_path_beta_pr2_5_design.md} and is
not addressed in this note. The current \leanid{SectorBNT} route instead
keeps the coefficient comparison and the combined-family linear
independence in \path{TNLean/MPS/FundamentalTheorem/SectorBNT}; any future
