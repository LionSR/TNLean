...
\leanid{MPOTensor.PeriodicSectorProjector.not_commute}. The stronger uniform predicate requiring this noncommutation at every length
for every displaced Hermitian idempotent was unused and has been deleted under
TNLean's no-public-API-compatibility policy. Neither active proof uses such a
uniform predicate.
