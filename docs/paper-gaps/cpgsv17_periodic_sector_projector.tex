...
\leanid{MPOTensor.PeriodicSectorProjector.not_commute}. The stronger retired
predicate required this noncommutation at every length for every displaced
projector; that uniform condition is used by neither proof and is not
formalized.
