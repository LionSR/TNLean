...
reasons. The normal Case-I form of Lemma~C.5 is complete. The Case-II passage
after coefficient absorption remains a missing statement with proof-path
drift. Separately, unequal raw repeated-copy weights refute the literal
implication (iv)$\Rightarrow$(v). The viable source route
(ii)$\Rightarrow$(v) remains open after ZCL-derived common-weight absorption
and projector-controlled channel assembly. The completed forward implication
uses no simplicity hypothesis.
