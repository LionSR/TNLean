...
The bare source conclusion (ii)$\Rightarrow$(v) is also false: the ambient
trace-norm obstruction of
\path{docs/paper-gaps/cpsv16_prop_c15_blocking_channel_false.tex} excludes the
two-to-three channel asserted by Proposition~C.15 and the twice-applied
two-to-four refinement map. The completed forward implication uses no
