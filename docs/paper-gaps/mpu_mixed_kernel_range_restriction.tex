...
$W_\rho=1_d\otimes\rho$. The valid interpretation retains the external
...
The fully expanded normalized source-$v$ metric is formalized by
\leanid{MPOTensor.IsMPU.normalized_sourceV_openTail_metric}. This theorem does
not identify that metric with the ordinary $Y_1$--$X_2$ mixed-kernel Gram
matrix, and no such equality is claimed as part of the paper-gate proof.
