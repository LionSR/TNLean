...
\begin{enumerate}
    ...
    \item Prove that the paper's regions $R$, $S$, and $T$ are injective
          ...
          The present normalized $5\times6$ local-window $T$ model is now known not to
          admit a rectangular-cover witness of the above form. The remaining
          coordinate work is to realign the source local and rotated $T$ covers
          with the finite PEPS geometry and translate these decompositions
          around every edge.
