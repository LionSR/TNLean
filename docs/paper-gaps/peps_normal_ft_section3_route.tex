...
adjacency lemmas available for the later translated edge blockings. The graph
edge vocabulary also distinguishes horizontal and vertical square-lattice
edges, and proves that every edge has exactly one of these two orientations.
The ordered endpoints are now also identified: horizontal edges go from left to
right, and vertical edges go from bottom to top. The coordinate rectangles are
...
injective regions used in the associated edge-blocked chain. The vertical
edge-blocking picture is now available in the same
coordinate-origin-parametric form, with its complementary region again
discharged by a rectangular cover, and with the analogous injective-chain
consequence. The normalized horizontal and vertical pictures are now recorded
as the coordinate-origin specializations of these translated pictures. The
...
complement, then the normal edge-blocking hypotheses follow. The realigned
local and rotated $T$ covers and the construction of these windows for every
edge remain open.
