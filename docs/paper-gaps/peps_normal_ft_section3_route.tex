...
$T$, and the rotated normalized $6\times5$ local-window model used for
vertical edges, are now also known not to admit such rectangular covers. This
local obstruction does not contradict the paper's statement; it shows that the
...
\begin{enumerate}
    ...
    \item Prove that the paper's regions $R$, $S$, and $T$ are injective
          ...
          The present normalized $5\times6$ local-window $T$ model and its
          rotated normalized $6\times5$ counterpart are now known not to admit
          rectangular-cover witnesses of the above form. The remaining
...
\begin{itemize}
    ...
    \item Obstruction to applying that criterion directly to the present
          normalized local-window $T$ models: blueprint
