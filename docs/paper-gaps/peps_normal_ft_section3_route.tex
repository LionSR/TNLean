...
the current open rectangular coordinate model, such data on coordinate right
and upward edges are now known to force the corresponding horizontal and
vertical margin inequalities. Consequently this margin package does not apply
to horizontal edges without enough left or right margin, nor to vertical edges
without enough bottom or top margin; the corresponding $7\times7$ examples are
recorded explicitly, including a single four-sided boundary obstruction. Thus
the remaining every-edge construction must include the boundary geometry rather
than only translating the interior margin package; in particular, no family of
this margin-cover data exists over all edges of the present open $7\times7$
graph. The realigned local and rotated $T$ covers and the construction of the
...
\begin{itemize}
    ...
    \item Conditional assembly from translated edge windows:
          ...
          injective regions at each edge. The forced margin inequalities for
          coordinate right and upward edges are now formalized, and the
          resulting open-boundary obstruction for horizontal edges without
          enough left or right margin and vertical edges without enough bottom
          or top margin is also formalized, including explicit $7\times7$
          examples and their four-sided conjunction. Thus the present margin
          package is a sufficient interior criterion rather than the final
          every-edge construction.
