...
the coordinate-origin-parametric layer. The realigned local and rotated $T$
covers and the full translated every-edge construction remain open.
...
\begin{enumerate}
    ...
    \item Prove that the edge-centered red, blue, and complementary regions form a
          ...
          the remaining work is the uniform every-edge construction. This is
          the normal analog of the injective edge-blocking bridge tracked by
          \ghissue{1366}.
