...
translated picture. The realigned local and rotated $T$ covers and the
construction of these windows for every edge remain open.
...
\begin{itemize}
    ...
    \item Conditional assembly from translated edge windows:
          ...
          corresponding translated windows.
