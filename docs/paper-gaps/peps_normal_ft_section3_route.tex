...
the supplied one-edge datum at each edge. The realigned local and rotated $T$
covers and the construction of this data for every edge remain open.
...
\begin{itemize}
    ...
    \item Conditional assembly from translated edge windows:
          ...
          assembled hypotheses recover the supplied datum at each edge.
