...
\begin{enumerate}
    \item Prove the tensor-level union-of-injective-regions lemma. The proof
          ...
          coefficient to vanish. The landed bridge machinery ports to this row;
          only the $\beta_1$-parametrized gathering (its gluing carries the extra
          $A$-boundary constraint) and the final host-reconstruction extraction
