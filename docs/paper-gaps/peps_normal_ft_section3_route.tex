...
translated frames, and the coordinate right/up window constructors now accept
these named predicates directly. Such data on coordinate right and upward edges
are now known to force the corresponding named margin predicates. Consequently
this margin package does not apply to horizontal edges without enough left or
right margin, nor to vertical edges without enough bottom or top margin; the
...
\begin{itemize}
    ...
    \item Conditional assembly from translated edge windows:
          ...
          predicates are now named, the coordinate right/up window constructors
          accept those predicates directly, the forced margin inequalities for
          coordinate right and upward edges are formalized using those
          predicates, and the resulting open-boundary obstruction for
