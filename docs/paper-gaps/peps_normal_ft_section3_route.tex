...
supplies the three injective regions used in the associated chain. For the
horizontal edge, local $T$-injectivity implies injectivity of all three blocks.
For the vertical edge, injectivity of the complementary block is still an
explicit hypothesis; the missing step is the source-faithful finite-geometry
proof that discharges this hypothesis from the rectangular assumptions and
union closure. The realigned local $T$ cover and the translated every-edge
...
\begin{itemize}
    ...
    \item Normalized horizontal and vertical red/blue/complement blocking data:
          ...
          The vertical complement injectivity is still conditional.
