...
one-edge blocking datum. The vertical edge-blocking picture is now available in
the same coordinate-origin-parametric form, with its complementary region again
discharged by a rectangular cover. The normalized horizontal and vertical
pictures are now recorded as the coordinate-origin specializations of these
translated pictures. The normalized edge data and the translated edge data are
kept in separate Lean modules, so the normalized source picture remains
available independently from the coordinate-origin-parametric layer. The
realigned local and rotated $T$ covers and the full translated every-edge
