...
translated frames. Such data on coordinate right and upward edges are now known
to force the corresponding named margin predicates. Consequently this margin
...
\begin{itemize}
    ...
    \item Conditional assembly from translated edge windows:
          ...
          predicates are now named, the forced margin inequalities for
