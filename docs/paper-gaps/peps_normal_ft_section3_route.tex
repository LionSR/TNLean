...
edges, and proves that every edge has exactly one of these two orientations. The
...
implies injectivity of all three blocks. For the vertical edge, a rectangular
cover of rotated local $T$ now implies injectivity of all three blocks by union
closure and rectangular injectivity. The realigned local and rotated $T$ covers
and the translated every-edge construction remain open.
...
\begin{itemize}
    ...
    \item Normalized horizontal and vertical red/blue/complement blocking data:
          ...
          vertical complement injectivity is reduced to a rotated
          $T$-cover.
