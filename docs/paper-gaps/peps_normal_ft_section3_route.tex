...
available for the analogous rectangular frame. The normalized horizontal and
...
implies injectivity of all three blocks. For the vertical edge, injectivity of
the complementary block is still an explicit hypothesis; the missing step is
the source-faithful finite-geometry proof that discharges this hypothesis from
the rectangular assumptions and union closure. The realigned local $T$ cover
...
\begin{enumerate}
    ...
    \item Prove that the paper's regions $R$, $S$, and $T$ are injective
          ...
          recorded set-theoretically, but injectivity of the vertical
          complementary block remains an explicit hypothesis. The present
          ...
          coordinate work is to realign the source local $T$ cover with the
          finite PEPS geometry, discharge the vertical complementary-block
          hypothesis, and translate this decomposition around every edge.
...
\begin{itemize}
    ...
    \item Normalized $5\times7$ top-collar decomposition of that block:
          ...
          collar identity for the analogous rectangular frame.
    \item Normalized horizontal and vertical red/blue/complement blocking data:
          ...
          vertical complement injectivity is still conditional.
