...
identified: horizontal edges go from left to right and vertical edges go from
bottom to top. The coordinate rectangles are
...
coordinate right or upward edge are recorded. The realigned local and rotated
$T$ covers and the construction of these windows for every edge remain open.
...
\begin{itemize}
    ...
    \item Conditional assembly from translated edge windows:
          ...
          actual coordinate right/up edges are explicit.
