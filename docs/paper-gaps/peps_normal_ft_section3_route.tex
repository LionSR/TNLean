...
their red, blue, and complementary regions: the edge endpoints lie in the red
and blue regions, respectively, and the three regions are disjoint and cover
the full finite square lattice. This one-edge datum is the local form of the
later every-edge blocking hypotheses, and a family of one-edge data now
