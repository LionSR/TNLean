...
vertical edge blockings are now both packaged with their red, blue, and
complementary regions: the edge endpoints lie in the red and blue regions,
respectively, and the three regions are disjoint and cover the full finite
square lattice. For the horizontal edge, local $T$-injectivity implies
injectivity of all three blocks. For the vertical edge, injectivity of the
complementary block is still an explicit hypothesis; the missing step is the
source-faithful finite-geometry proof that discharges this hypothesis from the
rectangular assumptions and union closure. The realigned local $T$ cover and
...
\begin{itemize}
    ...
    \item Normalized horizontal and vertical red/blue/complement blocking data:
          ...
          \#2004. The vertical complement injectivity is still conditional.
