...
discharged by a rectangular cover. The realigned local and rotated $T$ covers
and the full translated every-edge construction remain open.
...
\begin{itemize}
    ...
    \item Translated horizontal red/blue/complement blocking data:
          ...
          step toward the every-edge construction.
