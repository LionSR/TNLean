...
the supplied one-edge datum and its three injective regions at each edge. The
realigned local and rotated $T$ covers and the construction of this data for
...
\begin{itemize}
    ...
    \item Conditional assembly from translated edge windows:
          ...
          injective regions at each edge.
