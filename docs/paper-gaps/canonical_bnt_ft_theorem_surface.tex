...
=======
  \item The former strict canonical-form BNT equal-MPV declaration was only a
    strict representative form and is no longer part of the active Lean tree.
    The former proportional wrapper has also been removed because its one-shot
    coefficient hypotheses did not imply the full BNT matching conclusion.
  \item The sector-decomposition theorem
>>>>>>> 33c39579 (doc(audits): remove retired equal-MPV names)
...
=======
The former strict-representative equal-MPV declaration was therefore only a
special-case statement and has been removed from the active Lean tree. The
proportional wrapper that formerly assumed explicit coefficient data has also
>>>>>>> 33c39579 (doc(audits): remove retired equal-MPV names)
