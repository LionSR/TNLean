...
\begin{enumerate}
  ...
  \item The older strict canonical-form BNT wrappers, which assumed explicit
    coefficient arrays or common block data, are no longer part of the
    source-facing theorem surface.  Their restrictions are recorded in the
...
\[
  \sum_q \mu_{j,q}^N.
\]
The retired strict-representative declarations were therefore special-case
statements: the proportional comparison assumed explicit coefficient data, and
the equal-MPV common-block comparison assumed the repeated-copy structure had
already been matched into common weights and dimensions.  They should not be
cited as the general arXiv:1606.00608 theorem.  Heterogeneous variants that state the
