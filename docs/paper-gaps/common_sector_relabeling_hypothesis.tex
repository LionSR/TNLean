...
blockwise.  The mathematical assertion is that assembling the weighted
block-diagonal tensor before this relabeling gives the same MPV family as
assembling after the relabeling:
\[
...
\(R(A_k^{[p]})\) is the same tensor read through the explicit word relabeling
of blocked physical indices.
