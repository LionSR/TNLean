...
\]
The cyclic-sector construction fixes an explicit version of this identification
for every common blocked sector family \(F\).  The mathematical assertion is
that assembling the weighted block-diagonal tensor before this relabeling gives
the same MPV family as assembling after the relabeling:
\[
  \forall F,\quad
