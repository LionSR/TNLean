...
the main adapter names are
\path{MPSTensor.exists_bnt_sectorDecomp_pair_with_overlapSpan_of_block_span_eq},
\path{MPSTensor.exists_bnt_sectorDecomp_pair_with_overlapSpan_of_commonPhaseCover}, and
\path{MPSTensor.exists_bnt_sectorDecomp_pair_with_overlapSpan_of_proportionalDecompositionConclusion}.}
