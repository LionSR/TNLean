...
The target-paper coordinates in this note refer to
\path{Papers/2502.20257/main.tex}.  The external coordinates refer to the
following official arXiv sources and their named \LaTeX{} files.
\begin{itemize}
    \item Moln\'ar--Ge--Schuch--Cirac, \emph{A generalization of the
          injectivity condition for Projected Entangled Pair States},
          \href{https://arxiv.org/abs/1706.07329v2}{arXiv:1706.07329v2},
          \path{cornerproblem.tex}, under the arXiv non-exclusive distribution
          license 1.0.
    \item Garre-Rubio--Lootens--Moln\'ar, \emph{Classifying phases protected
          by matrix product operator symmetries using matrix product states},
          \href{https://arxiv.org/abs/2203.12563v3}{arXiv:2203.12563v3},
          \path{REsubmission.tex}, under CC BY 4.0.
    \item Garre-Rubio--Schuch, \emph{Fractional domain wall statistics in
          spin chains with anomalous symmetries},
          \href{https://arxiv.org/abs/2405.00439v2}{arXiv:2405.00439v2},
          \path{MPU-DW.tex}, under CC BY 4.0.
\end{itemize}
The line ranges below are citations into these named source files rather than
coordinates reconstructed from reformatted PDFs.
...
MPU realization.  The formula is compatible exactly as printed only in a
fusion gauge in which $\omega$ is one on $H\times H\times H$; for a general
$\omega$ with $\omega|_H=d\beta$ it can fail, and the correction is recorded
in \cite{gap:glm23_eq20_fusion_gauge}.
...
\begin{itemize}
    ...
    \item \leanid{TNLean.Algebra.H2} is the quotient of genuine
          ...
          The representative reconstruction
          (\ref{eq:fbc25_action_audit_l_reconstruction}) in a fusion gauge
          trivial on the stabilizer, the classification of scalar solutions
          up to action-tensor gauge, and the torsor of solution classes are
          formalized in
          \doclink{TNLean/Algebra/StabilizerCocycleReconstruction}.
