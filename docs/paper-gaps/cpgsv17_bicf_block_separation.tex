...
irreducibility, left-canonicality, and normalized self-overlap.  The public
horizontal canonical-form predicate now uses this representative-indexed BNT
formulation.  The flattened \texttt{HorizontalCFData} formulation remains as a
strictly stronger auxiliary hypothesis for the older per-copy results.
...
The horizontal canonical-form predicate and the first stage of the MPDO
application now use a \texttt{SectorDecomposition} satisfying
