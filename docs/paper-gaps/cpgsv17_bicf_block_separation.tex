...
$D^4$.  This is formalized by
\texttt{basis\_isNBlkInjective\_totalDim\_pow\_four}; the preceding
single-tensor statement is
\texttt{isNBlkInjective\_pow\_four\_of\_isNormal\_leftCanonical}.
No nonempty-family assumption is required: for an empty representative family
the universal statement is vacuous, while every use involving a chosen
representative supplies positivity from its bond dimension.
