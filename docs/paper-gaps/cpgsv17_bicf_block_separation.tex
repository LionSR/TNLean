...
formal development.\footnote{The criteria are
    ...
    \leanid{MPOTensor.HorizontalCFData.finiteWordTraceSeparation}. The constructors from these hypotheses to
    ...
    \leanid{MPSTensor.hasFiniteWordTraceSeparation_of_wordTupleSpanTop},
    \leanid{MPSTensor.hasFiniteWordTraceSeparation_of_wordEntryFamily_linearIndependent},
    \leanid{MPSTensor.hasFiniteWordTraceSeparation_of_propBlockInjective}, and corresponding
...
\leanid{MPOTensor.blockwise_insert_eq_of_mpv_agree}, which assumes \leanid{MPOTensor.HorizontalCFData.finiteWordTraceSeparation} for the
