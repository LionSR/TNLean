...
the family does not have zero correlation length is verified by an exact
finite-marginal obstruction.
...
effective and ambient tensors both fail that relation.  This argument does not
use the saturation obstruction, entropy, or spectral calculations.

Here ``source-facing'' refers to the nonzero up-to-positive-scalar relation for
the physical-trace transfer.  It is distinct from the legacy doubled-index
transfer-map idempotence convention.  No conclusion about that legacy
convention is made.
