...
literal Definition~4.2 diagram and for its scale-invariant repair.
...
effective and ambient tensors both fail that relation.  The declarations
...
diagram in Definition~4.2, lines 735--739.  The argument does not use the
