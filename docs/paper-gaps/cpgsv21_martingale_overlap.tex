...
$N\geq2m$, with no divisibility restriction.  Nothing survives from the deleted
development.  The pair of exact conjugation identities relating the blocked
parent interaction and the blocked range-two local terms to their original
range-$2p$ counterparts at block-aligned starts was retained at first, but it
had no consumer once the sparse-sum domination was gone, so it was deleted with
the rest.  No periodic boundary coercivity, comparison of unequal kernels,
