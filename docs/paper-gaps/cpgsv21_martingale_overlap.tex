...
only beyond its threshold $n_{l+1}$, while C3, at source lines~1083--1094,
assumes
\begin{align}
    \lVert G_{\Lambda_{n+1}\setminus\Lambda_{n-l}}E_n\rVert
        &\leq\epsilon_l
...
reuses the existing finite-dimensional spectral endpoint. These declarations
...
There is also a local endpoint in the scalar optimization. The printed proof
chooses
\begin{align}
    c_2
