...
Lemma~6.2. Its later prescribed-rate identification remains separate.
...
The source prefactor $k^2$ remains unmatched. This
...
the cited estimates recover the source prefactor in the present
normalization and blocking conventions. Existence of a
...
Hamiltonian after blocking. Recovering the source prefactor $k^2$ is a
separate comparison.

\section{Inverse-Gram reduction and the remaining prefactor comparison}
