...
\textbf{Verdict: scope restriction and a corrected prefactor.} The exact whole-increment algebra, the
...
including $c=k^2$, is this onset shown to equal the injectivity threshold, so
the printed assertion, with prefactor $k^2$ from that threshold, remains
unformalized.
