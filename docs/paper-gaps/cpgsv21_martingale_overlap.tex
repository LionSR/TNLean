...
\end{align}
The same $l$ works for every positive spectator length $K$. The theorem
\leanid{MPSTensor.IsPrimitiveMPS.exists_re_inner_openChain_anticommutator_ge_c3_threshold}
...
What remains unmatched is the source's assertion that the prefactor may be
...
reconstruction and its unidentified constant have been deleted. The remaining
restriction is the prefactor: the formal $c$ is the existential rate-dependent
constant of Lemma~5.2, and the source value $k^2$ is not asserted.
