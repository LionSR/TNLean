...
Ref.~\cite{Fannes1992Finitely}. The exact boundary defect and the estimate in
Equation~(5.9) are now given by
\leanid{MPSTensor.inner_fnwBoundaryMapCLM_sub_rhoWeighted} and
\leanid{MPSTensor.norm_inner_fnwBoundaryMapCLM_sub_rhoWeighted_le}. The exact
