...
\begin{itemize}
    ...
    whenever $L\geq L_0$, $c\lambda^L<1$, and $K,Q\geq1$,
    \begin{align}
        \left\lVert
    ...
    \end{align}
    The prefix length is positive, matching the domain of the martingale
    difference $E_n$. The prefactor $c$ is the existential rate-dependent
    constant of Lemma~5.2; the source value $k^2$ is not asserted.
...
proves, for every $K>0$ and every $l$ above an injective length with
$c\lambda^l<1$,
\begin{align}
    \left\lVert
