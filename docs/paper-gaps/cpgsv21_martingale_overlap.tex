...
A corrected eventual statement permits any prescribed $c>0$. Choose a rate
...
The onset depends on the state, rate, and prefactor. In particular, taking
$c=k^2$ in this eventual statement does not establish the printed assertion
from the original injectivity threshold.
