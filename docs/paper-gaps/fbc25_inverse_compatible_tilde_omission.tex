...
Ref.~\cite[lines~4559--4659]{FrancoRubio2025MPUGauging} make the role of the weight visible in coordinates. There $d=4$, $D=2$, the maintained gauge is the Pauli matrix $Y$, and the recorded weight is $\rho=I_2/2$. Writing
$\widehat X_1=(I_4\otimes\overline Y)Y_2^\dagger$ and
$\widehat Y_1=X_2^\dagger(Y^{\mathsf T}\otimes I_4)$ for the candidates of
(\ref{eq:fbc25_inverse_tilde_candidates}) on these factors, both candidates are the negatives of the displayed factors, and the three overlaps of
Ref.~\cite[lines~5438--5441]{FrancoRubio2025MPUGauging} take the values
\begin{align}
    X_1^\dagger\widehat X_1                 & =-2I_4,
    \label{eq:fbc25_inverse_tilde_czx_raw}            \\
    X_1^\dagger(I_4\otimes\rho)\widehat X_1 & =-I_4,
...
(\ref{eq:fbc25_inverse_tilde_weighted_comparison}), is unitary and recovers both displayed factors as $X_1=\widehat X_1K^\dagger$ and $Y_1=K\widehat Y_1$.
