...
| **Example 4.11** (`ExSALnoZCL`, l.908) | 908–925 | A mixed state saturates the area law but does not have ZCL | Blueprint `thm:cpsv_examples410_412_status`; `TNLean/MPS/MPDO/CPSVExamples410411Arithmetic.lean`; `docs/paper-gaps/cpsv16_examples_4_10_4_11_entropy.tex`; issue #6302 | **printed SAL claim refuted mathematically; scalar endpoints complete; formalization pending** — the exact integer comparison and log-ratio positivity are certified. The four-site spectra, entropy identity, literal-tensor link, and final non-SAL theorem remain open. Global normalization cannot restore saturation |
