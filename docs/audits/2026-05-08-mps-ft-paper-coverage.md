...
| **Example 4.10** (`ExZCLnoSAL`, l.898) | 898–906 | A mixed state has ZCL but does not saturate the area law | Blueprint `thm:cpsv_examples410_412_status`; `docs/paper-gaps/cpsv16_examples_4_10_4_11_entropy.tex`; issue #5984 | **source reconciled; formalization pending** — the printed channel repeats the left-qubit label; the corrected left-right flip reproduces the printed entropies, and exact spectra prove $I_2>I_1$ at $p=1/4$. The printed universal exception list also misses $p=1$ |
| **Example 4.11** (`ExSALnoZCL`, l.908) | 908–925 | A mixed state saturates the area law but does not have ZCL | Blueprint `thm:cpsv_examples410_412_status`; `docs/paper-gaps/cpsv16_examples_4_10_4_11_entropy.tex`; issue #5984 | **printed SAL claim refuted; formalization pending** — for the literal four-site periodic state, exact spectra and an integer logarithm comparison give $I_2>I_1$. Global normalization cannot restore saturation |
