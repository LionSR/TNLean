...
| Defn Puri-RFP (l.758) | 758–764 | Purification RFP | No current faithful Lean definition; the former `TNLean/MPS/MPDO/PRFP.lean` formalization was removed because it contradicted the source theorem relating Purification RFP to MPDO RFP/ZCL. | **open** — formalize the source Definition 4.4 after the trace-preserving-map RFP notion is in place. |
