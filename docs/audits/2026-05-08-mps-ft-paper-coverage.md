...
| **Proposition 4.13** (source label `Prop:IV.12`, l.945) | 945–952; proof 1863–1922 | Vertical CF: a tensor in literal CPSV CF is also in CF vertically, with the rectangular sector map and positive diagonal multiplicities | `TNLean/MPS/CanonicalForm/ActiveBNTRefinement.lean`; `TNLean/MPS/MPDO/CPSVRepresentativeGroupedLemmaL.lean`; `TNLean/MPS/MPDO/CPSVOriginalSpaceLemmaL.lean`; `TNLean/MPS/MPDO/InvariantProjection.lean`; `TNLean/MPS/MPDO/VerticalReduction.lean`; `TNLean/MPS/MPDO/CPSVFigureEight.lean`; stronger-hypothesis capstone `TNLean/MPS/MPDO/VerticalCanonicalForm.lean` | **partial** — active class-copy regrouping retains inactive zero-weight coordinates, and the active representative sector decomposition has weights $\lambda_{j,q}=\nu_{k(j,q)}\zeta_{k(j,q)}$. Eventual representative word-tuple span, positive-length MPV agreement, full-coordinate linear marking, marked Lemma L on the retained and original bond spaces, original-space `insertedTensor` equality, invariant-projector closure, the literal-CF pairwise Figure-8 Gram-dressing identity, and its positive relative Gram scalar for a normal representative are formalized. The pairwise theorems assume two corners satisfying the positive similarity equations; actual vertical representative groups and corners, literal periodic exclusion and spectral grouping, normalized grouped sectors, and the final vertical canonical-form/coisometric grouping remain open. The coisometry has orientation $VV^\dagger=I$; no unmarked length-zero MPV equality or insertion equality for an individual inactive block is claimed. This is Proposition 4.13 scope, not the Appendix C.4 positive-fusion question tracked by #4648. The theorem for normalized BNT-refined horizontal form is complete. Tracked by #3949 and the Proposition 4.13 gap note. |
...
| Proof of Prop IV.12 (l.1861–1922) | 1861–1922 | Vertical CF + rectangular coisometry proof | `TNLean/MPS/MPDO/CPSVOriginalSpaceLemmaL.lean`; `TNLean/MPS/MPDO/InvariantProjection.lean`; `TNLean/MPS/MPDO/VerticalReduction.lean`; `TNLean/MPS/MPDO/CPSVFigureEight.lean`; `TNLean/MPS/MPDO/VerticalCanonicalForm.lean` | **partial** — literal-CF first-site Lemma L, invariant-projector closure, the conditional pairwise Figure-8 Gram-dressing identity, and the positive relative Gram scalar are proved. Actual representative groups and corners, literal periodic exclusion and spectral grouping, normalized grouped sectors, and the final coisometric vertical grouping remain open. This is separate from Appendix C.4/#4648. |
