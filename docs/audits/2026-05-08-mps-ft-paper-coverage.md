...
| **Proposition 4.13** (source label `Prop:IV.12`, l.945) | 945–952; proof 1863–1922 | Vertical CF: a tensor in literal CPSV CF is also in CF vertically, with the rectangular sector map and positive diagonal multiplicities | `TNLean/MPS/CanonicalForm/ActiveBNTRefinement.lean`; `TNLean/MPS/MPDO/CPSVRepresentativeGroupedLemmaL.lean`; `TNLean/MPS/MPDO/CPSVOriginalSpaceLemmaL.lean`; `TNLean/MPS/MPDO/InvariantProjection.lean`; `TNLean/MPS/MPDO/CPSVPeriodicExclusion.lean`; `TNLean/MPS/MPDO/VerticalReduction.lean`; `TNLean/MPS/MPDO/CPSVFigureEight.lean`; stronger-hypothesis capstone `TNLean/MPS/MPDO/VerticalCanonicalForm.lean` | **partial** — active class-copy regrouping retains inactive zero-weight coordinates, and the active representative sector decomposition has weights $\lambda_{j,q}=\nu_{k(j,q)}\zeta_{k(j,q)}$. Eventual representative word-tuple span, positive-length MPV agreement, full-coordinate linear marking, marked Lemma L on the retained and original bond spaces, original-space `insertedTensor` equality, invariant-projector closure, displaced-idempotent noncommutation at some chain length, literal vertical periodic exclusion, and the normal vertical block decomposition with positive weights, orthogonal isometries, exact corner compression, and literal reconstruction are formalized. The literal-CF pairwise Figure-8 Gram-dressing identity and its positive relative Gram scalar are also formalized for two corners satisfying the positive similarity equations. Vertical BNT representative grouping, normalization of the actual grouped sectors, and the final vertical canonical-form/coisometric grouping remain open; the full proposition is not proved. The coisometry has orientation $VV^\dagger=I$; no unmarked length-zero MPV equality or insertion equality for an individual inactive block is claimed. The periodic argument proves the existence of one noncommuting length, not noncommutation at every length. This is Proposition 4.13 scope, not the Appendix C.4 positive-fusion question tracked by #4648. The theorem for normalized BNT-refined horizontal form is complete. Tracked by #3949 and the Proposition 4.13 gap note. |
...
| Proof of Prop IV.12 (l.1861–1922) | 1861–1922 | Vertical CF + rectangular coisometry proof | `TNLean/MPS/MPDO/CPSVOriginalSpaceLemmaL.lean`; `TNLean/MPS/MPDO/InvariantProjection.lean`; `TNLean/MPS/MPDO/CPSVPeriodicExclusion.lean`; `TNLean/MPS/MPDO/VerticalReduction.lean`; `TNLean/MPS/MPDO/CPSVFigureEight.lean`; `TNLean/MPS/MPDO/VerticalCanonicalForm.lean` | **partial** — literal-CF first-site Lemma L, invariant-projector closure, existential-length displaced-projector noncommutation, vertical periodic exclusion, and the normal vertical corners with positive weights and exact reconstruction are proved. The conditional pairwise Figure-8 Gram-dressing identity and positive relative Gram scalar are also proved. Vertical BNT representative grouping, normalization of the actual grouped sectors, and the final coisometric vertical grouping remain open; the full proposition is not proved. This is separate from Appendix C.4/#4648. |
