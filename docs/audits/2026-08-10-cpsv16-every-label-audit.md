...
| Appendix D `RFP-gauge` | none since the printed-status stub `thm:cpsv_rfp_gauge_printed_status` was removed; anchor on `thm:cpsv_canonical_form_flow_phase_obstruction` | cube-phase obstruction plus active issue #5920 |
...
- Proposition 4.5's monotonicity and finite-chain bounds are proved and retained
  ...
  cut.  Aperiodicity or convergence is a genuine boundary condition absent from
