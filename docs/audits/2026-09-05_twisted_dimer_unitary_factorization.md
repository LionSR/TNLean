...
Date: September 5, 2026. Scope: the project construction discussed in issues #7776 and #7751, read live on this date. Both issues were open. This note records mathematical provenance and a direct operator calculation, not a claim that the new Lean formalization compiles. The strict non-decoration specification in #7751 remains unresolved.
