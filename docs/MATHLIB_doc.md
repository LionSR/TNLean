...
# Mathlib Documentation Conventions

Canonical text: the `lean-conventions` skill —
[MATHLIB_doc.md](https://github.com/texra-ai/texra-lean-skills/blob/main/skills/lean-conventions/references/MATHLIB_doc.md).
