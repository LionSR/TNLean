...
| Operator-convexity axioms (`posMap_rpow_convex_jensen`, `posMap_log_concave_jensen`, `lieb_concavity_axiom`) | `TNLean/Axioms/OperatorConvexity.lean` | The concave real-power Jensen statement `posMap_rpow_concave_jensen` has been discharged. The former `trace_rpow_concave_axiom` / `trace_rpow_convex_axiom` have also been discharged; see `TNLean/Analysis/OperatorConvexity.lean`. |
