...
> Agent-assisted work carries disclosure and accountability requirements. The
> tenkz diagram package is developed in [LionSR/tenkz](https://github.com/LionSR/tenkz),
> not in this tree. See
