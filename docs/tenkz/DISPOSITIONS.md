...
- **Codemod** means every non-kernel spelling has a mechanical expansion in
  the §9 sugar ledger. The target codes below name that expansion.
...
| `C-record` | Expand atom, wire, span, skip, and port sugar to `\tn`, `\tnwire`, `\tnmark`, and typed `ports=` records. |
...
| `ch12_symmetry_string_order.tex` | — | L39, 352, 499, 866 `tenkz` → `C-record+C-species`<br>L73 `tenkz` → `C-policy+C-record+C-species`<br>L367, 513, 871 `tenkz` → `C-policy+C-record`<br>L396, 410, 453, 468, 549, 563 `tenkz` → `C-record` | — |
| `ch12_symmetry_virtual_and_cohomology.tex` | — | L180 `tenkz` → `C-record+C-species`<br>L195, 328, 456, 469 `tenkz` → `C-policy+C-record` | — |
...
| `ch20_mpdo_canonical_forms_first_site_contractions.tex` | L177, 182 `tenkz` → `P-grid` | L153, 159, 336 `tenkz` → `C-policy+C-record`<br>L232, 238 `tenkz` → `C-policy` | L433 `tenkz` → `R-record` |
...
| `ch21_mpdo_rfp_foundations.tex` | — | L63, 67 `tenkz` → `C-policy` | — |
...
| `ch21_mpdo_rfp_simple_local_primitivity_active_trace_matrix.tex` | L188 `tenkz` → `P-grid` | — | — |
...
| `ch21_mpdo_rfp_simple_local_structure_capstone.tex` | L259, 447, 453, 458 `tenkz` → `P-grid` | L443 `tenkz` → `C-policy` | — |
| `ch23_algebraic_ft_foundations.tex` | — | L47, 51, 167, 371, 375, 387, 391, 433, 437, 441, 450, 454 `tenkz` → `C-policy+C-record`<br>L171 `tenkz` → `C-record` | — |
...
| `ch26_mps_rfp_physical_blocking.tex` | — | L130, 155 `tenkz` → `C-policy+C-record`<br>L134, 149 `tenkz` → `C-record` | — |
...
### Preserve fixtures (23)

- `geom.tex` · `hard11_v3.tex` · `hard11_v4.tex` · `iso_a.tex` · `iso_g.tex` · `iso_h.tex` · `modes_dot_baseline.tex` · `p3_min1.tex`
- `p3_min2.tex` · `p3_probe_opmod.tex` · `p3_probe_opop.tex` · `p3_probe_opop2.tex` · `p_pitch.tex` · `p_species.tex` · `plane_experiment.tex` · `rv4061_flatonly.tex`
- `t2_staircase.tex` · `trace_probe.tex` · `trace_warn.tex` · `zz_geomdag.tex` · `zz_geomframe.tex` · `zz_geomsupport.tex` · `zz_wirescan.tex`

### Codemod fixtures (57)

- `audit3.tex` · `audit4.tex` · `boundary_test.tex` · `channel_test.tex` · `g06_stageB.tex` · `gr_t2_fsymbol.tex` · `hard01_v2.tex` · `hard02_v2.tex`
- `hard03_v3.tex` · `hard04_v3.tex` · `hard10_v3.tex` · `hard11_v2.tex` · `hdr.tex` · `iso_b.tex` · `iso_c.tex` · `iso_d.tex`
- `iso_e.tex` · `iso_f.tex` · `iso_i.tex` · `iso_j.tex` · `iso_k.tex` · `iso_t.tex` · `lrbox_probe.tex` · `p3_bisect_a.tex`
- `p3_bisect_d.tex` · `p3_bond_insertion.tex` · `p3_eq09.tex` · `p3_eq4_ortho.tex` · `p3_eq4_v2.tex` · `p3_eq5_fsymbol.tex` · `p3_eq5_v2.tex` · `p3_gauge.tex`
- `p3_lemma1.tex` · `p3_pitch_probe.tex` · `p3_trace_word.tex` · `p3_word.tex` · `p4067_braced.tex` · `p_newcup.tex` · `part_B1.tex` · `part_B2.tex`
- `part_B3.tex` · `part_B4.tex` · `part_B7.tex` · `regress_x_pbc.tex` · `rev4075_alias.tex` · `rv4061_cellset.tex` · `rv4061_cuporder.tex` · `rv4061_ex_boundary-doctrine.tex`
- `rv4061_ex_canonical-channel.tex` · `rv4061_ketptrace.tex` · `t2_fusion.tex` · `t2_lassodef.tex` · `t2_lassodef_v2.tex` · `t2_pentagon5.tex` · `t2_rhoR.tex` · `t2_twoshift.tex`
- `tree_test.tex`

### Redraw fixtures (184)

- `adv_brace.tex` · `adv_conj.tex` · `adv_envs.tex` · `adv_leak.tex` · `adv_nested.tex` · `atoms_test.tex` · `audit1.tex` · `audit2.tex`
- `audit_open.tex` · `cd_edge.tex` · `cd_test.tex` · `chain.tex` · `cups_edge.tex` · `cups_test.tex` · `ease_test.tex` · `feat.tex`
- `fig21d_cubic.tex` · `fig21d_cubic_v2.tex` · `fig21d_expect.tex` · `fig21d_pepo.tex` · `free.tex` · `free_modes.tex` · `free_test.tex` · `free_typed_joins_ex.tex`
- `g06_stageA.tex` · `g06_stageC.tex` · `gallery.tex` · `gr_t1_fusion.tex` · `gr_t3_action.tex` · `gr_t4_lasso.tex` · `gr_t5_zipper.tex` · `gr_t6_leftinv.tex`
- `gr_t7_coset.tex` · `gr_t8_sum.tex` · `grid_test.tex` · `hard01_ortho.tex` · `hard01_v3.tex` · `hard02_ALdef.tex` · `hard03_rdm.tex` · `hard03_v2.tex`
- `hard04_eig.tex` · `hard04_v2.tex` · `hard05_OL.tex` · `hard05_v2.tex` · `hard05_v4.tex` · `hard06_gauge2layer.tex` · `hard06_v2.tex` · `hard06_v3.tex`
- `hard06_v4.tex` · `hard07_peps.tex` · `hard07_v2.tex` · `hard08_mpu.tex` · `hard08_v2.tex` · `hard08_v3.tex` · `hard09_pull.tex` · `hard09_v2.tex`
- `hard10_pta.tex` · `hard10_v2.tex` · `hard11_circuit.tex` · `hard12_v2.tex` · `hard12_v3.tex` · `hard12_zcl.tex` · `lattice_test.tex` · `lpos_probe.tex`
- `modes_test.tex` · `notch.tex` · `p3_bisect_b.tex` · `p3_bisect_c.tex` · `p3_blocking.tex` · `p3_corner.tex` · `p3_eq08.tex` · `p3_eq10.tex`
- `p3_eq12.tex` · `p3_eq32.tex` · `p3_eq3_fusion.tex` · `p3_eq3_v2.tex` · `p3_eq8_action.tex` · `p3_eq8_v2.tex` · `p3_erase.tex` · `p3_ghostket_probe.tex`
- `p3_inverse.tex` · `p3_inverse_identity.tex` · `p3_multibond.tex` · `p3_multibond2.tex` · `p3_probe_pitch2.tex` · `p3_reduce.tex` · `p3_regions.tex` · `p3_slidecd.tex`
- `p3_sliding.tex` · `p3_wineq.tex` · `p4067_baseline.tex` · `p4067_gridbase.tex` · `p4067_pentagon.tex` · `p_arrowtn.tex` · `p_usagefree.tex` · `part_B8.tex`
- `pentagon_corrected.tex` · `plane_mirror_probe.tex` · `plane_stress.tex` · `plane_sweep1.tex` · `plane_sweep2.tex` · `plane_sweep2_v2.tex` · `plane_sweep3.tex` · `plane_test.tex`
- `planes_keys_test.tex` · `probe.tex` · `rem.tex` · `rev4075_sig.tex` · `rgn.tex` · `rmpfig2_test.tex` · `rv4061_ex_atoms-keys.tex` · `rv4061_ex_cups-channels.tex`
- `rv4061_ex_grid-benchmarks.tex` · `rv4061_ex_grid-mpo-stress.tex` · `rv4061_vertlabel.tex` · `rv4061_vertonly.tex` · `rv_probe.tex` · `sheets_a_role.tex` · `sheets_test.tex` · `sheets_warn_smoke.tex`
- `smoke.tex` · `stress.tex` · `t2_ared.tex` · `t2_ared_loop.tex` · `t2_blocking.tex` · `t2_braidpat1.tex` · `t2_condensanyon.tex` · `t2_czx.tex`
- `t2_eigladder.tex` · `t2_eq50_pull.tex` · `t2_eq54_ginj.tex` · `t2_finegrain.tex` · `t2_gs1d.tex` · `t2_gs2d.tex` · `t2_gs2d_lasso.tex` · `t2_hamil_gate.tex`
- `t2_hamilcommu.tex` · `t2_idempotent.tex` · `t2_isometry.tex` · `t2_lassoC.tex` · `t2_lhsrhs1.tex` · `t2_lhsrhs2.tex` · `t2_lhsrhs3.tex` · `t2_lhsrhs4.tex`
- `t2_lhsrhs5.tex` · `t2_lhsrhs6.tex` · `t2_mpo.tex` · `t2_mpublock.tex` · `t2_mpubrick.tex` · `t2_mpucond.tex` · `t2_mpuflow.tex` · `t2_mpusplit.tex`
- `t2_olvert.tex` · `t2_pairs.tex` · `t2_pentagon2.tex` · `t2_pentagon3.tex` · `t2_pentagon4.tex` · `t2_pepo5.tex` · `t2_peps.tex` · `t2_probe_pepoupdown.tex`
- `t2_probe_sides.tex` · `t2_purifyO.tex` · `t2_renorm13.tex` · `t2_rgfp4.tex` · `t2_seljbraid.tex` · `t2_sptgh_box.tex` · `t2_sptintertwin.tex` · `t2_sptmpo_cross.tex`
- `t2_sv17.tex` · `t2_tands.tex` · `t2_tcdual.tex` · `t2_tcdual_v2.tex` · `t2_tcprimal.tex` · `t2_tcprimal_v2.tex` · `t2_triangle.tex` · `t2_wrap9a.tex`
...
demolition checker passes over 3,038 tracked files and reports zero retired
