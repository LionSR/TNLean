...
position and the usual daylight without inventing visible glyph ink.  Regions
are painted on the background layer.  Unknown, empty,
or duplicate names stop compilation rather than silently dropping ink.
