...
| `PhysicalSectorFactorization.sum_eq_sum_activeSector_of_eq_zero` | helper theorem | Restricting a finite sector sum to the nonzero-weight subtype when inactive summands vanish | `TNLean/MPS/MPDO/PhysicalSectorTraceMatrix.lean` |
