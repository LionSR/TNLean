...
\subtitle{{\small 1595 lines $\cdot$ 13 modules $\cdot$ 0 sorries\;\;$\cdot$\;\;Mathlib v4.27.0\;\;$\cdot$\;\;arXiv:2011.12127}}
\date{}
\author{}
...
\vspace{0.3em}
\textbf{Expansion factor:} $\sim$3 pages of paper proof $ \longrightarrow $ 1595 lines of Lean $ \approx  10\times$ (typical)
\end{frame}
...
\node[box,done] (s5) at (0,0) {\proved{Block matching: equal sums $\Rightarrow$ pairwise match}};
\node[box,done] (s6) at (0,-0.8) {\proved{Apply single-block theorem per matched pair}};
\node[box,done] (s7) at (0,-1.6) {\proved{Assemble global gauge transform}};
\end{tikzpicture}
\end{center}
...
\vspace{0.8em}
\textcolor{leangreen}{\textbf{1595 lines\quad$\cdot$\quad 13 modules\quad$\cdot$\quad 0 sorries\quad$\cdot$\quad 0 axioms}}
\end{center}
\end{frame}
