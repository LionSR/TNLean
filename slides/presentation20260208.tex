...
\subtitle{{\small 1906 lines $\cdot$ 14 modules $\cdot$ 0 sorries\;\;$\cdot$\;\;Mathlib v4.27.0\;\;$\cdot$\;\;arXiv:2011.12127}}
\date{}
\author{}
...
\vspace{0.3em}
\textbf{Expansion factor:} $\sim$3 pages of paper proof $ \longrightarrow $ 1906 lines of Lean $ \approx  10\times$ (typical)
\end{frame}
...
\vspace{0.8em}
\textcolor{leangreen}{\textbf{1906 lines\quad$\cdot$\quad 14 modules\quad$\cdot$\quad 0 sorries\quad$\cdot$\quad 0 axioms}}
\end{center}
\end{frame}
